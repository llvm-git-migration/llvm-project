...
if not config.libbolt_rt_instr:
    llvm_bolt_args.add(f"--runtime-instrumentation-lib={config.libbolt_rt_instr}")

if not config.libbolt_rt_hugify:
    llvm_bolt_args.add(f"--runtime-hugify-lib={config.libbolt_rt_hugify}")
