...
.Lfunc_begin0:
	.file	0 "/subprogramRanges" "mainOther.cpp" md5 0x45fd34ef778739dca24be206894f1d15
...
_Z7doStuffOtheri.__part.1:                   # %if.then
	...
	.cfi_def_cfa %rbp, 16
	.cfi_offset %rbp, -16
	.loc	0 3 5 is_stmt 1                 # mainOther.cpp:3:5
	movl	-4(%rbp), %eax
	addl	$1, %eax
	movl	%eax, -4(%rbp)
...
_Z7doStuffOtheri.__part.2:                   # %if.end
	...
	.cfi_def_cfa %rbp, 16
	.cfi_offset %rbp, -16
	.loc	0 4 10                          # mainOther.cpp:4:10
	movl	-4(%rbp), %eax
	.loc	0 4 3 epilogue_begin is_stmt 0  # mainOther.cpp:4:3
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB_END0_2:
...
# %bb.0:                                # %entry
	...
	movq	%rsi, -16(%rbp)
.Ltmp2:
	.loc	0 8 21 prologue_end             # mainOther.cpp:8:21
	movl	-8(%rbp), %edi
	.loc	0 8 13 is_stmt 0                # mainOther.cpp:8:13
	callq	_Z7doStuffOtheri
	.loc	0 8 5 epilogue_begin            # mainOther.cpp:8:5
	addq	$16, %rsp
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB_END1_0:
	.cfi_endproc
.Lfunc_end1:
	.size	mainOther, .Lfunc_end1-mainOther
                                        # -- End function
...
.Ldebug_info_start0:
	...
	.byte	4                               # Abbrev [4] 0x43:0x26 DW_TAG_subprogram
	.byte	3                               # DW_AT_low_pc
	...
	.long	105                             # DW_AT_type
                                        # DW_AT_external
	.byte	3                               # Abbrev [3] 0x52:0xb DW_TAG_formal_parameter
	.byte	2                               # DW_AT_location
	.byte	145
	.byte	120
	.byte	8                               # DW_AT_name
	...
	.byte	7                               # DW_AT_decl_line
	.long	105                             # DW_AT_type
	.byte	3                               # Abbrev [3] 0x5d:0xb DW_TAG_formal_parameter
	.byte	2                               # DW_AT_location
	.byte	145
	.byte	112
	.byte	9                               # DW_AT_name
	...
	.long	109                             # DW_AT_type
	.byte	0                               # End Of Children Mark
	.byte	5                               # Abbrev [5] 0x69:0x4 DW_TAG_base_type
	.byte	5                               # DW_AT_name
	...
	.long	119                             # DW_AT_type
	.byte	7                               # Abbrev [7] 0x77:0x5 DW_TAG_const_type
	.long	124                             # DW_AT_type
	.byte	5                               # Abbrev [5] 0x7c:0x4 DW_TAG_base_type
	.byte	10                              # DW_AT_name
...
.Ldebug_ranges0:
	...
	.byte	0                               #   start index
	.uleb128 .LBB_END0_1-_Z7doStuffOtheri.__part.1 #   length
	.byte	3                               # DW_RLE_startx_length
	.byte	1                               #   start index
	.uleb128 .LBB_END0_2-_Z7doStuffOtheri.__part.2 #   length
	.byte	3                               # DW_RLE_startx_length
	.byte	2                               #   start index
...
.Linfo_string1:
	.asciz	"mainOther.cpp"                      # string offset=105
.Linfo_string2:
	.asciz	"/subprogramRanges" # string offset=114
.Linfo_string3:
	.asciz	"_Z7doStuffOtheri"                   # string offset=169
.Linfo_string4:
	.asciz	"doStuffOther"                       # string offset=181
.Linfo_string5:
	.asciz	"int"                           # string offset=189
.Linfo_string6:
	.asciz	"mainOther"                          # string offset=193
.Linfo_string7:
