...
.Lfunc_begin0:
	.file	1 "/subprogramRanges" "mainOther.cpp"
...
# %bb.0:                                # %entry
	...
	movl	%edi, -4(%rbp)
.Ltmp0:
	.loc	1 2 7 prologue_end              # mainOther.cpp:2:7
	cmpl	$0, -4(%rbp)
.Ltmp1:
	.loc	1 2 7 is_stmt 0                 # mainOther.cpp:2:7
...
_Z7doStuffOtheri.__part.1:                   # %if.then
	...
	.cfi_def_cfa %rbp, 16
	.cfi_offset %rbp, -16
	.loc	1 3 5 is_stmt 1                 # mainOther.cpp:3:5
	movl	-4(%rbp), %eax
	addl	$1, %eax
	movl	%eax, -4(%rbp)
...
_Z7doStuffOtheri.__part.2:                   # %if.end
	...
	.cfi_def_cfa %rbp, 16
	.cfi_offset %rbp, -16
	.loc	1 4 10                          # mainOther.cpp:4:10
	movl	-4(%rbp), %eax
	.loc	1 4 3 epilogue_begin is_stmt 0  # mainOther.cpp:4:3
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB_END0_2:
...
# %bb.0:                                # %entry
	...
	movq	%rsi, -16(%rbp)
.Ltmp2:
	.loc	1 8 21 prologue_end             # mainOther.cpp:8:21
	movl	-8(%rbp), %edi
	.loc	1 8 13 is_stmt 0                # mainOther.cpp:8:13
	callq	_Z7doStuffOtheri
	.loc	1 8 5 epilogue_begin            # mainOther.cpp:8:5
	addq	$16, %rsp
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
