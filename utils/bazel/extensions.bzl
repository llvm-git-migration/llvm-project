...
def _llvm_configure_extension_impl(ctx):
    ...
    #
    # See examples/bzlmod/README.md on how to set up "llvm-raw" in downstream
    # repositories.
    [
    ...
    http_archive(
        name = "vulkan_headers",
        build_file = "@llvm-project-overlay//third_party_build:vulkan_headers.BUILD",
    ...
    http_archive(
        name = "gmp",
        build_file = "@llvm-project-overlay//third_party_build:gmp.BUILD",
    ...
    http_archive(
        name = "mpfr",
        build_file = "@llvm-project-overlay//third_party_build:mpfr.BUILD",
    ...
    http_archive(
        name = "pfm",
        build_file = "@llvm-project-overlay//third_party_build:pfm.BUILD",
    ...
    http_archive(
        name = "pybind11",
        build_file = "@llvm-project-overlay//third_party_build:pybind.BUILD",
    ...
    http_archive(
        name = "nanobind",
        build_file = "@llvm-project-overlay//third_party_build:nanobind.BUILD",
