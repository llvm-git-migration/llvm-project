...
LLVM_CONFIG_H_SUBSTITUTIONS = (
    ...
    select({
        "//llvm/config:{}".format(triple): {
            '#define LLVM_DEFAULT_TARGET_TRIPLE "${LLVM_DEFAULT_TARGET_TRIPLE}"': '#define LLVM_DEFAULT_TARGET_TRIPLE "{}"'.format(triple),
        }
    ...
    select({
        "//llvm/config:{}".format(triple): cmakedefine_string("LLVM_HOST_TRIPLE", triple)
        for triple in TRIPLES
    }) |
    select({
    ...
    {
        "#cmakedefine01 LLVM_HAS_{}_TARGET".format(target): "#define LLVM_HAS_{}_TARGET {}".format(
            target,
    ...
    {
        "#define LLVM_VERSION_MAJOR ${LLVM_VERSION_MAJOR}": "#define LLVM_VERSION_MAJOR {}".format(LLVM_VERSION_MAJOR),
        "#define LLVM_VERSION_MINOR ${LLVM_VERSION_MINOR}": "#define LLVM_VERSION_MINOR {}".format(LLVM_VERSION_MINOR),
        "#define LLVM_VERSION_PATCH ${LLVM_VERSION_PATCH}": "#define LLVM_VERSION_PATCH {}".format(LLVM_VERSION_PATCH),
        '#define LLVM_VERSION_STRING "${PACKAGE_VERSION}"': '#define LLVM_VERSION_STRING "{}"'.format(PACKAGE_VERSION),
    } |
    ...
    {
        "#cmakedefine LLVM_BUILD_LLVM_DYLIB": "/* #undef LLVM_BUILD_LLVM_DYLIB */",
        "#cmakedefine LLVM_BUILD_SHARED_LIBS": "/* #undef LLVM_BUILD_SHARED_LIBS */",
    } |
    ...
    selects.with_or({
        ...
        (
            ...
            "#cmakedefine LLVM_ENABLE_PLUGINS": "/* #undef LLVM_ENABLE_PLUGINS */",
        },
