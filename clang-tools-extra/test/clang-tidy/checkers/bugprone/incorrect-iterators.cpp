...
void Test() {
  ...
  // CHECK-NOTES: :[[@LINE-1]]:3: warning: mismatched ranges supplied to 'find'
  ...
  // CHECK-NOTES: :[[@LINE-1]]:3: warning: mismatched ranges supplied to 'push_heap'
  ...
  // CHECK-NOTES: :[[@LINE-1]]:3: warning: mismatched ranges supplied to 'copy_backward'
  ...
  // CHECK-NOTES: :[[@LINE-1]]:3: warning: mismatched ranges supplied to 'equal'
  // CHECK-NOTES: :[[@LINE-2]]:34: note: range passed as the begin iterator
  ...
  // CHECK-NOTES: :[[@LINE-1]]:3: warning: mismatched ranges supplied to 'is_permutation'
