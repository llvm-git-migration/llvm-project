...
int checkNotEqualIntLiteralCompare1(void) {
  return (5 != 5);
// INDENTEXPR: :[[@LINE-1]]:13: warning: both sides of operator are equivalent [misc-redundant-expression]
}
...
int checkLessThanFloatLiteralCompare1(void) {
  return (5.14F < 5.14F);
// IDENTEXPR: :[[@LINE-1]]:17: warning: both sides of operator are equivalent [misc-redundant-expression]
}
