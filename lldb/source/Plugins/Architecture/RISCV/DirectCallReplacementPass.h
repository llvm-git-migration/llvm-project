...
// calls. This pass should be considered as temporary solution until a large
// code model will be approved.
class DirectCallReplacementPass : public llvm::FunctionPass {
...
public:
  ...
  DirectCallReplacementPass(const ExecutionContext &exe_ctx);
  ~DirectCallReplacementPass() override;
