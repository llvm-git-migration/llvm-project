...
public:
  ...
  bool ParentProcessIDIsValid() const { return m_parent_pid != LLDB_INVALID_PROCESS_ID; }
  ...
  bool ProcessGroupIDIsValid() const { return m_process_group_id != LLDB_INVALID_PROCESS_ID; }
