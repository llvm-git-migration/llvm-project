...
class AddressRangeTestCase(TestBase):
    ...
    # TODO: Enalbe once SBAddressRange::GetDescription() can get a pointer to the current target
    ...
    #     self.assertRegex(range_str, "^\[0x[1-9a-f]+\-0x[1-9a-f]+\]$")
    #     process.Kill()
    ...
    def test_address_range_print_not_resolved(self):
        ...
        self.assertRegex(range_str, "^a.out\[0x[1-9a-f]+\-0x[1-9a-f]+\]$")
