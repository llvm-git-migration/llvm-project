...
# RUN: llvm-mc -filetype=obj -triple=x86_64 debug-names-bad-aug-string.s \
# RUN:   -o debug-names-bad-aug-string.o
# RUN: llvm-mc -filetype=obj -triple=x86_64 b.s -o b.o
# RUN: ld.lld --debug-names debug-names-bad-aug-string.o b.o -o debug-names-bad-aug-string

# RUN: llvm-dwarfdump -debug-names debug-names-bad-aug-string \
# RUN:   | FileCheck %s --check-prefix=DWARF

# DWARF:      .debug_names contents:
# DWARF:      Name Index @ 0x0 {
# DWARF-NEXT:   Header {
# DWARF-NEXT:     Length: 0xC4
