...
# CHECK: .got PROGBITS 00000000000024a8
# CHECK: .got.plt PROGBITS 00000000000024d0

## Note: _GLOBAL_OFFSET_TABLE is at .got
## GOT (foo) is at .got + 24 == 0x24c0
## GOT (bar) is at .got + 32 == 0x24c8
## GOTPLT (foo) is at .got.plt + 0 == .got + 40 == 0x24d0
## GOTPLT (bar) is at .got.plt + 8 == .got + 48 == 0x24d8

# DISASM:      larl %r12, 0x24a8
# DISASM-NEXT: larl %r1, 0x24c0
# DISASM-NEXT: larl %r1, 0x24c8
# DISASM-NEXT: larl %r1, 0x24d0
# DISASM-NEXT: larl %r1, 0x24d8
