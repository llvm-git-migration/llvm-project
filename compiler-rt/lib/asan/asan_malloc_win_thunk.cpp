...
STATIC_MALLOC_INTERFACE void *_aligned_malloc_dbg(size_t size, size_t alignment) {
  return _aligned_malloc(size, alignment);
}

// _aligned_realloc

STATIC_MALLOC_INTERFACE void *_aligned_realloc(void *p, size_t size, size_t alignment) {
  return __asan_aligned_realloc(p, size, alignment);
}

STATIC_MALLOC_INTERFACE void *_aligned_realloc_dbg(void *p, size_t size, size_t alignment) {
...
STATIC_MALLOC_INTERFACE void *_aligned_offset_malloc(size_t size, size_t alignment,
                                                 size_t offset) {
...
STATIC_MALLOC_INTERFACE void *_aligned_offset_malloc_dbg(size_t size, size_t alignment,
                                                 size_t offset) {
...
STATIC_MALLOC_INTERFACE void _aligned_free_dbg(void *p) {
  _aligned_free(p);
}
