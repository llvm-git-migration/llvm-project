...
const struct InstructionSizeData {
  ...
  const char *comment;
    ...
    { 0, {0x83, 0xE4, 0x72}, 0, "83 E4 XX : and esp, XX"}, // should return size == 3
    { 0, {0x83, 0xEC, 0x72}, 0, "83 EC XX : sub esp, XX"}, // should return size == 3
    ...
    { 7, {0x8D, 0xA4, 0x24, 0x73, 0x74, 0x75, 0x76}, 0, "8D A4 24 XX XX XX XX : lea esp, [esp + XX XX XX XX]"}, // should return rel_offset == 3
    ...
    { 0, {0xf6, 0xc1, 0x72}, 0, "f6 c1 XX : test cl, XX"}, // should return size == 3
    ...
    { 8, {0x41, 0x81, 0x7c, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78}, 0, "41 81 7c ZZ YY XX XX XX XX : cmp DWORD PTR [reg+reg*n+YY], XX XX XX XX"}, // should return size == 9
