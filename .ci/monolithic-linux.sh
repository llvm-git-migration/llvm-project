...
if [[ "${runtimes}" != "" ]]; then
  ...
  ninja-targets "-vC "${RUNTIMES_BUILD_DIR}"" "-cpp03" "${runtimes_targets}"
  ...
  ninja-targets "-vC "${RUNTIMES_BUILD_DIR}"" "-cpp26" "${runtimes_targets}"
  ...
  ninja-targets "-vC "${RUNTIMES_BUILD_DIR}"" "-modules" "${runtimes_targets}"
fi
