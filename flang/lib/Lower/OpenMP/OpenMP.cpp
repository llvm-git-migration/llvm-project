...
static void extractMapVarsBaseOps(llvm::ArrayRef<mlir::Value> vars,
...
genTargetOp(lower::AbstractConverter &converter, lower::SymMap &symTable,
  ...
  extractMapVarsBaseOps(clauseOps.mapVars, mapVars);

  EntryBlockArgs args;
  // TODO: Add in_reduction syms and vars.
  args.map.syms = mapSyms;
  args.map.vars = mapVars;
...
genTargetDataOp(lower::AbstractConverter &converter, lower::SymMap &symTable,
  ...
  llvm::SmallVector<mlir::Value> useDeviceAddrVars, useDevicePtrVars;
  extractMapVarsBaseOps(clauseOps.useDeviceAddrVars, useDeviceAddrVars);
  extractMapVarsBaseOps(clauseOps.useDevicePtrVars, useDevicePtrVars);

  EntryBlockArgs args;
  args.useDeviceAddr.syms = useDeviceAddrSyms;
  args.useDeviceAddr.vars = useDeviceAddrVars;
  args.useDevicePtr.syms = useDevicePtrSyms;
  args.useDevicePtr.vars = useDevicePtrVars;
