...
! PRECISE-F64: {{%[A-Za-z0-9._]+}} = fir.call @llvm.fabs({{%[A-Za-z0-9._]+}}) {{.*}}: (f64) -> f64
...
! PRECISE-F64-DAG: func.func private @llvm.fabs(f64) -> f64 attributes {fir.bindc_name = "llvm.fabs", fir.runtime}
