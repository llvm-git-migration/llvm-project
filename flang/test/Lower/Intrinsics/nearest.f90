...
! CHECK-LABEL: c.func @_QPnearest_test1
  ...
  ! CHECK:       } else {
  ! CHECK:         %[[V_22:[0-9]+]] = arith.subi %[[V_12]], %c1{{.*}} : i16
  ! CHECK:         %[[V_23:[0-9]+]] = arith.addi %[[V_12]], %c1{{.*}} : i16
...
! CHECK-LABEL: c.func @_QPnearest_test2
  ...
  ! CHECK:         %[[V_26:[0-9]+]] = arith.subi %[[V_25]], %c1{{.*}} : i16
  ! CHECK:         %[[V_27:[0-9]+]] = arith.addi %[[V_25]], %c1{{.*}} : i16
...
! CHECK-LABEL: c.func @_QPnearest_test3
  ...
  ! CHECK:       } else {
  ! CHECK:         %[[V_22:[0-9]+]] = arith.subi %[[V_12]], %c1{{.*}} : i32
  ! CHECK:         %[[V_23:[0-9]+]] = arith.addi %[[V_12]], %c1{{.*}} : i32
...
! CHECK-LABEL: c.func @_QPnearest_test4
  ...
  ! CHECK:       } else {
  ! CHECK:         %[[V_22:[0-9]+]] = arith.subi %[[V_12]], %c1{{.*}} : i64
  ! CHECK:         %[[V_23:[0-9]+]] = arith.addi %[[V_12]], %c1{{.*}} : i64
...
! CHECK-LABEL: c.func @_QPnearest_test6
  ...
  ! CHECK:       } else {
  ! CHECK:         %[[V_22:[0-9]+]] = arith.subi %[[V_12]], %c1{{.*}} : i128
  ! CHECK:         %[[V_23:[0-9]+]] = arith.addi %[[V_12]], %c1{{.*}} : i128
...
! CHECK-LABEL: c.func @_QPnearest_test7
  ...
  ! CHECK:       } else {
  ! CHECK:         %[[V_23:[0-9]+]] = arith.subi %[[V_13]], %c1{{.*}} : i128
  ! CHECK:         %[[V_24:[0-9]+]] = arith.addi %[[V_13]], %c1{{.*}} : i128
