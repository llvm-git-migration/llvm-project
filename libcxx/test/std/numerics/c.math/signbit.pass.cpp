...
int main(int, char**) {
  ...
  types::for_each(
      types::concatenate_t<types::signed_integer_types, types::type_list<char, wchar_t>>(), TestSignedIntAndChar());
