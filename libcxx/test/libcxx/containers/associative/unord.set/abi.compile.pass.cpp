...
using unordered_map_alloc = std::unordered_set<T, std::hash<T>, std::equal_to<T>, Alloc>;

#if __SIZE_WIDTH__ == 64

static_assert(sizeof(unordered_map_alloc<int, std::allocator<int> >) == 40, "");
static_assert(sizeof(unordered_map_alloc<int, min_allocator<int> >) == 40, "");
static_assert(sizeof(unordered_map_alloc<int, test_allocator<int> >) == 64, "");
static_assert(sizeof(unordered_map_alloc<int, small_iter_allocator<int> >) == 12, "");
static_assert(sizeof(unordered_map_alloc<int, final_small_iter_allocator<int> >) == 16, "");

static_assert(sizeof(unordered_map_alloc<char, std::allocator<char> >) == 40, "");
static_assert(sizeof(unordered_map_alloc<char, min_allocator<char> >) == 40, "");
static_assert(sizeof(unordered_map_alloc<char, test_allocator<char> >) == 64, "");
static_assert(sizeof(unordered_map_alloc<char, small_iter_allocator<char> >) == 12, "");
static_assert(sizeof(unordered_map_alloc<char, final_small_iter_allocator<char> >) == 16, "");

static_assert(TEST_ALIGNOF(unordered_map_alloc<int, std::allocator<int> >) == 8, "");
static_assert(TEST_ALIGNOF(unordered_map_alloc<int, min_allocator<int> >) == 8, "");
static_assert(TEST_ALIGNOF(unordered_map_alloc<int, test_allocator<int> >) == 8, "");
static_assert(TEST_ALIGNOF(unordered_map_alloc<int, small_iter_allocator<int> >) == 4, "");
static_assert(TEST_ALIGNOF(unordered_map_alloc<int, final_small_iter_allocator<int> >) == 4, "");

static_assert(TEST_ALIGNOF(unordered_map_alloc<char, std::allocator<char> >) == 8, "");
static_assert(TEST_ALIGNOF(unordered_map_alloc<char, min_allocator<char> >) == 8, "");
static_assert(TEST_ALIGNOF(unordered_map_alloc<char, test_allocator<char> >) == 8, "");
static_assert(TEST_ALIGNOF(unordered_map_alloc<char, small_iter_allocator<char> >) == 4, "");
static_assert(TEST_ALIGNOF(unordered_map_alloc<char, final_small_iter_allocator<char> >) == 4, "");
