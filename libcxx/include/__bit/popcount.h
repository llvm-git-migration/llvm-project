...
// Constexpr implementation using constexpr if for C++17 and later
...
#else
// Equivalent constexpr implementation using SFINAE for C++11 and C++14
...
#  else
// Constexpr implementation for C++14 (non-constexpr for C++03, 98)
template < class _Tp, __enable_if_t<is_unsigned<_Tp>::value && (sizeof(_Tp) > sizeof(unsigned long long)), int> = 0 >
