...
template <class _Tp>
using __iterator_category _LIBCPP_NODEBUG = iterator_traits<_Tp>::iterator_category;

template <class _Tp>
using __iterator_concept _LIBCPP_NODEBUG = iterator_traits<_Tp>::iterator_concept;
