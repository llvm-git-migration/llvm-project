...
_LIBCPP_NODISCARD __simd_vector<_Tp, _Np> __load_vector(const _Tp* __ptr) noexcept {
...
template <class _Tp, size_t _Np>
_LIBCPP_NODISCARD bool __all_of(__simd_vector<_Tp, _Np> __vec) noexcept {
  return __builtin_reduce_and(__builtin_convertvector(__vec, __simd_vector<bool, _Np>));
}

template <class _Tp, size_t _Np>
_LIBCPP_NODISCARD size_t __find_first_set(__simd_vector<_Tp, _Np> __vec) noexcept {
...
template <class _Tp, size_t _Np>
_LIBCPP_NODISCARD size_t __find_first_not_set(__simd_vector<_Tp, _Np> __vec) noexcept {
