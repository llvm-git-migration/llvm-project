...
struct _LIBCPP_TEMPLATE_VIS allocator_traits {
  ...
  // template <class _Ap = _Alloc>
  // [[nodiscard]] _LIBCPP_HIDE_FROM_ABI constexpr static allocation_result<typename allocator_traits<_Ap>::pointer,
  // typename allocator_traits<_Ap>::size_type>
  template <class _Ap = _Alloc>
  [[nodiscard]] static constexpr allocation_result<pointer, size_type> allocate_at_least(_Ap& __alloc, size_type __n) {
