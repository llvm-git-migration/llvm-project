...
// [[msvc::no_unique_address]] seems to only affect empty classes, so the padding scheme for Itanium doesn't work.
#if !defined(_LIBCPP_ABI_NO_COMPRESSED_PAIR_PADDING) && defined(_LIBCPP_ABI_ITANIUM)
