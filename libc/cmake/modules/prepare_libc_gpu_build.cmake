...
elseif(PLATFORM_HAS_GPU)
  ...
  if(LIBC_TARGET_ARCHITECTURE_IS_AMDGPU)
    list(GET all_amdgpu_architectures -1 gpu_test_architecture)
  elseif(LIBC_TARGET_ARCHITECTURE_IS_NVPTX)
    list(GET all_nvptx_architectures -1 gpu_test_architecture)
  endif()
  message(STATUS "No GPU architecture detected or provided, defaulting to: "
                 "'${gpu_test_architecture}'")
endif()
