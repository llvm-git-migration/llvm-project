...
// COM: the pass, we see all the transposes disappear and exactly zero are left! so the pass enables this to happen.
// COM: we demonstrate here to show the results of just our pass, and @fold_transpose_into_reshape in canonicalize.mlir demonstrates
// COM: the folding of the transpose into the reshape.
...
// CHECK-LABEL: @test_unimplemented_transpose_tracks_to_non_nullifying_transpose__single_step
// CHECK: tosa.const
// CHECK-NEXT: tosa.transpose
// CHECK-NEXT: tosa.clamp
// CHECK-NEXT: tosa.const
// CHECK-NEXT: tosa.transpose
// CHECK-NEXT: return
func.func @test_unimplemented_transpose_tracks_to_non_nullifying_transpose__single_step(%arg0: tensor<1x2x3x4xi32>) -> tensor<1x2x4x3xi32> {
