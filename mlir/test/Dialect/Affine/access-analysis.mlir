...
func.func @loop_1d(%A : memref<?x?xf32>, %B : memref<?x?x?xf32>) {
   ...
   affine.for %i = 0 to %M {
     affine.for %j = 0 to %M {
       ...
       // expected-remark@-1 {{contiguous along loop 0}}
       affine.load %A[%c0, 8 * %i + %j] : memref<?x?xf32>
       // expected-remark@-1 {{contiguous along loop 1}}
      ...
      affine.for %arg3 = 0 to 14 {
        ...
        affine.for %arg4 = #map(%arg1) to #map1(%arg1) {
          affine.for %arg5 = #map(%arg3) to #map1(%arg3) {
            ...
            // expected-remark@-1 {{contiguous along loop 3}}
            affine.store %0, %alloc_0[0, %arg1 * -16 + %arg4, 0, %arg3 * -16 + %arg5] : memref<1x16x1x16xf32>
            // expected-remark@-1 {{contiguous along loop 4}}
            // expected-remark@-2 {{contiguous along loop 2}}
          }
        }
        affine.for %arg4 = #map(%arg1) to #map1(%arg1) {
          affine.for %arg5 = #map2(%arg2) to #map3(%arg2) {
            affine.for %arg6 = #map(%arg3) to #map1(%arg3) {
              ...
              // expected-remark@-1 {{contiguous along loop 5}}
              // expected-remark@-2 {{contiguous along loop 2}}
