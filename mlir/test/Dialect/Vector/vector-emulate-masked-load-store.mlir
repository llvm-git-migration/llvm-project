...
//   CHECK-DAG:   %[[C0:.*]] = arith.constant 0 : index
//   CHECK-DAG:   %[[C4:.*]] = arith.constant 4 : index
//       CHECK:   %[[S0:.*]] = vector.extract_strided_slice %[[ARG1]] {offsets = [0], sizes = [1], strides = [1]} : vector<4xf32> to vector<1xf32>
//       CHECK:   vector.store %[[S0]], %[[ARG0]][%[[C0]], %[[C4]]] : memref<4x5xf32>, vector<1xf32>
//       CHECK:   return
//       CHECK: }
func.func @vector_maskedstore_c1(%arg0 : memref<4x5xf32>, %arg1 : vector<4xf32>) {
   %idx_0 = arith.constant 0 : index
   %idx_1 = arith.constant 1 : index
   %idx_4 = arith.constant 4 : index
   %mask = vector.create_mask %idx_1 : vector<4xi1>
...
// CHECK-LABEL:  @vector_maskedstore_c2
//  CHECK-SAME:  (%[[ARG0:.*]]: memref<4x5xf32>, %[[ARG1:.*]]: vector<4xf32>) {
//   CHECK-DAG:   %[[C0:.*]] = arith.constant 0 : index
//   CHECK-DAG:   %[[C4:.*]] = arith.constant 4 : index
//       CHECK:   %[[S0:.*]] = vector.extract_strided_slice %[[ARG1]] {offsets = [0], sizes = [2], strides = [1]} : vector<4xf32> to vector<2xf32>
//       CHECK:   vector.store %[[S0]], %[[ARG0]][%[[C0]], %[[C4]]] : memref<4x5xf32>, vector<2xf32>
//       CHECK:   return
//       CHECK: }
...
// CHECK-LABEL:  @vector_maskedstore_c3
//  CHECK-SAME:  (%[[ARG0:.*]]: memref<4x5xf32>, %[[ARG1:.*]]: vector<4xf32>) {
//   CHECK-DAG:   %[[C0:.*]] = arith.constant 0 : index
//   CHECK-DAG:   %[[C4:.*]] = arith.constant 4 : index
//       CHECK:   %[[S0:.*]] = vector.extract_strided_slice %[[ARG1]] {offsets = [0], sizes = [3], strides = [1]} : vector<4xf32> to vector<3xf32>
//       CHECK:   vector.store %[[S0]], %[[ARG0]][%[[C0]], %[[C4]]] : memref<4x5xf32>, vector<3xf32>
//       CHECK:   return
//       CHECK: }
func.func @vector_maskedstore_c3(%arg0 : memref<4x5xf32>, %arg1 : vector<4xf32>) {
  %idx_0 = arith.constant 0 : index
  %idx_3 = arith.constant 3 : index
  %idx_4 = arith.constant 4 : index
  %mask = vector.create_mask %idx_3 : vector<4xi1>
