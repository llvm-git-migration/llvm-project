...
func.func @transfer_read_dims_mismatch_non_zero_indices(
  ...
  %v = vector.transfer_read %arg[%c0, %idx_1, %idx_2, %c0], %c0_i32 {in_bounds = array<i1: true, true, true>} :
...
func.func @transfer_read_dims_mismatch_non_contiguous_non_zero_indices(
  ...
  %8 = vector.transfer_read %arg[%c0, %idx_1, %idx_2, %c0], %cst_1 {in_bounds = array<i1: true, true>} :
...
func.func @transfer_read_leading_dynamic_dims(
  ...
  %c0 = arith.constant 0 : index
  %result = vector.transfer_read %arg[%idx_1, %idx_2, %c0, %c0], %c0_i8 {in_bounds = array<i1: true, true>} :
...
func.func @negative_transfer_read_dynamic_dim_to_flatten(
  ...
  %c0 = arith.constant 0 : index
  %c0_i32 = arith.constant 0 : i32
  %v = vector.transfer_read %m_in[%c0, %idx_1, %idx_2, %c0], %c0_i32 {in_bounds = array<i1: true, true, true>} :
...
func.func @transfer_write_dims_mismatch_non_zero_indices(
  ...
  %c0 = arith.constant 0 : index
  %c0_i32 = arith.constant 0 : i32
  vector.transfer_write %vec, %arg[%c0, %idx_1, %idx_2, %c0] {in_bounds = array<i1: true, true, true>} :
...
func.func @transfer_write_dims_mismatch_non_contiguous_non_zero_indices(
  ...
  %c0 = arith.constant 0 : index
  vector.transfer_write %value, %subview[%c0, %idx_1, %idx_2, %c0] {in_bounds = array<i1: true, true>} : vector<2x2xf32>, memref<1x3x3x2xf32, strided<[40, 10, 2, 1], offset: ?>>
  return
}
...
func.func @transfer_write_leading_dynamic_dims(
  ...
  %c0 = arith.constant 0 : index
  vector.transfer_write %vec, %arg[%idx_1, %idx_2, %c0, %c0] {in_bounds = array<i1: true, true>} :
...
func.func @negative_out_of_bound_transfer_read(
  ...
  %c0 = arith.constant 0 : index
  %cst = arith.constant 0 : i8
  %v = vector.transfer_read %arg[%c0, %c0, %c0, %c0], %cst {in_bounds = array<i1: false, true, true, true>} :
...
func.func @negative_out_of_bound_transfer_write(
  ...
  %c0 = arith.constant 0 : index
  vector.transfer_write %vec, %arg [%c0, %c0, %c0, %c0] {in_bounds = array<i1: false, true, true, true>} :
