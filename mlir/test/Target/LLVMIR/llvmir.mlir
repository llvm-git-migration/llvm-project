...
llvm.func @atomicrmw(
    ...
    %bf16_vec_ptr : !llvm.ptr, %bf16_vec : vector<2xbf16>) {
  ...
  %20 = llvm.atomicrmw fadd %bf16_vec_ptr, %bf16_vec monotonic : !llvm.ptr, vector<2xbf16>

  // CHECK: atomicrmw volatile
  // CHECK-SAME:  syncscope("singlethread")
  // CHECK-SAME:  align 8
  %21 = llvm.atomicrmw volatile udec_wrap %i32_ptr, %i32 syncscope("singlethread") monotonic {alignment = 8 : i64} : !llvm.ptr, i32
  llvm.return
}
