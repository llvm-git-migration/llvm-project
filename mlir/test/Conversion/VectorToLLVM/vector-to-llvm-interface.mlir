...
// PARTIAL-LABEL:   func.func @load_0d(
// PARTIAL-SAME:    %[[VAL_0:.*]]: memref<200x100xf32>,
// PARTIAL-SAME:    %[[VAL_1:.*]]: index,
// PARTIAL-SAME:    %[[VAL_2:.*]]: index) -> vector<f32> {
// PARTIAL:         %[[VAL_3:.*]] = builtin.unrealized_conversion_cast %[[VAL_2]] : index to i64
// PARTIAL:         %[[VAL_4:.*]] = builtin.unrealized_conversion_cast %[[VAL_1]] : index to i64
// PARTIAL:         %[[VAL_5:.*]] = builtin.unrealized_conversion_cast %[[VAL_0]] : memref<200x100xf32> to !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
// PARTIAL:         %[[VAL_6:.*]] = llvm.extractvalue %[[VAL_5]][1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
// PARTIAL:         %[[VAL_7:.*]] = llvm.mlir.constant(100 : index) : i64
// PARTIAL:         %[[VAL_8:.*]] = llvm.mul %[[VAL_4]], %[[VAL_7]] : i64
// PARTIAL:         %[[VAL_9:.*]] = llvm.add %[[VAL_8]], %[[VAL_3]] : i64
// PARTIAL:         %[[VAL_10:.*]] = llvm.getelementptr %[[VAL_6]]{{\[}}%[[VAL_9]]] : (!llvm.ptr, i64) -> !llvm.ptr, f32
// PARTIAL:         %[[VAL_11:.*]] = llvm.load %[[VAL_10]] {alignment = 4 : i64} : !llvm.ptr -> vector<1xf32>
// PARTIAL:         %[[VAL_12:.*]] = builtin.unrealized_conversion_cast %[[VAL_11]] : vector<1xf32> to vector<f32>
// PARTIAL:         return %[[VAL_12]] : vector<f32>

// NOTE: Lowering via  -convert-vector-to-llvm will go through
// `VectorLoadToMemrefLoadLowering`, but that should not be required. In fact,
// similar test in vector-to-llvm-interface.mlir lowers just fine.
// TODO: Audit and possibly remove.

// FULL-LABEL: func @load_0d
// FULL: %[[LOAD:.*]] = memref.load %{{.*}}[%{{.*}}, %{{.*}}]
// FULL: %[[VEC:.*]] = llvm.mlir.undef : vector<1xf32>
// FULL: %[[C0:.*]] = llvm.mlir.constant(0 : i32) : i32
// FULL: %[[INSERTED:.*]] = llvm.insertelement %[[LOAD]], %[[VEC]][%[[C0]] : i32] : vector<1xf32>
// FULL: %[[CAST:.*]] = builtin.unrealized_conversion_cast %[[INSERTED]] : vector<1xf32> to vector<f32>
// FULL: return %[[CAST]] : vector<f32>
...
// PARTIAL-LABEL:   func.func @store_0d(
// PARTIAL-SAME:      %[[VAL_0:.*]]: memref<200x100xf32>,
// PARTIAL-SAME:      %[[VAL_1:.*]]: index,
// PARTIAL-SAME:      %[[VAL_2:.*]]: index) {
// PARTIAL:           %[[VAL_3:.*]] = builtin.unrealized_conversion_cast %[[VAL_2]] : index to i64
// PARTIAL:           %[[VAL_4:.*]] = builtin.unrealized_conversion_cast %[[VAL_1]] : index to i64
// PARTIAL:           %[[VAL_5:.*]] = builtin.unrealized_conversion_cast %[[VAL_0]] : memref<200x100xf32> to !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
// PARTIAL:           %[[VAL_6:.*]] = arith.constant dense<1.100000e+01> : vector<f32>
// PARTIAL:           %[[VAL_7:.*]] = builtin.unrealized_conversion_cast %[[VAL_6]] : vector<f32> to vector<1xf32>
// PARTIAL:           %[[VAL_8:.*]] = llvm.extractvalue %[[VAL_5]][1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
// PARTIAL:           %[[VAL_9:.*]] = llvm.mlir.constant(100 : index) : i64
// PARTIAL:           %[[VAL_10:.*]] = llvm.mul %[[VAL_4]], %[[VAL_9]] : i64
// PARTIAL:           %[[VAL_11:.*]] = llvm.add %[[VAL_10]], %[[VAL_3]] : i64
// PARTIAL:           %[[VAL_12:.*]] = llvm.getelementptr %[[VAL_8]]{{\[}}%[[VAL_11]]] : (!llvm.ptr, i64) -> !llvm.ptr, f32
// PARTIAL:           llvm.store %[[VAL_7]], %[[VAL_12]] {alignment = 4 : i64} : vector<1xf32>, !llvm.ptr

// NOTE: Lowering via  -convert-vector-to-llvm will go through
// `VectorStoreToMemrefStoreLowering`, but that should not be required. In fact,
// similar test in vector-to-llvm-interface.mlir lowers just fine.

// TODO: Audit and possibly remove.
// FULL-LABEL: func @store_0d
// FULL: %[[VAL:.*]] = arith.constant dense<1.100000e+01> : vector<f32>
// FULL: %[[CAST:.*]] = builtin.unrealized_conversion_cast %[[VAL]] : vector<f32> to vector<1xf32>
// FULL: %[[C0:.*]] = llvm.mlir.constant(0 : index) : i64
// FULL: %[[EXTRACTED:.*]] = llvm.extractelement %[[CAST]][%[[C0]] : i64] : vector<1xf32>
// FULL: memref.store %[[EXTRACTED]], %{{.*}}[%{{.*}}, %{{.*}}]
