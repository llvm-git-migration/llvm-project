...
// CHECK: define internal void @_ZN5TemplIiE1fEv(ptr noundef nonnull readonly align {{[0-9]+}} dereferenceable(8) %this)
// CHECK: define internal void @_ZN5TemplIiE1gEv(ptr noundef nonnull readonly align {{[0-9]+}} dereferenceable(8) %this)
