...
// CHECK: %call = call noundef ptr @"_ZZ22TestNonCapturingLambdavENK3$_0cvPFivEEv"(ptr noundef nonnull readonly align 1 dereferenceable(1) %lambda)
// CHECK: musttail call noundef i32 %call()
...
// CHECK: musttail call void %0(ptr noundef nonnull readonly align 8 dereferenceable(8) %this1)
