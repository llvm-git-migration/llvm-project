...
// SPIR_NATIVE_HALF: %hlsl.rsqrt = call <2 x half> @llvm.[[ICF:spv]].rsqrt.v2f16
...
// SPIR_NATIVE_HALF: %hlsl.rsqrt = call <3 x half> @llvm.[[ICF:spv]].rsqrt.v3f16
...
// SPIR_NATIVE_HALF: %hlsl.rsqrt = call <4 x half> @llvm.[[ICF:spv]].rsqrt.v4f16
