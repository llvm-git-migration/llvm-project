...
// CHECK: %hlsl.rsqrt = call float @llvm.[[ICF]].rsqrt.f32(
...
// CHECK: %hlsl.rsqrt = call <2 x float> @llvm.[[ICF]].rsqrt.v2f32
...
// CHECK: %hlsl.rsqrt = call <3 x float> @llvm.[[ICF]].rsqrt.v3f32
...
// CHECK: %hlsl.rsqrt = call <4 x float> @llvm.[[ICF]].rsqrt.v4f32
