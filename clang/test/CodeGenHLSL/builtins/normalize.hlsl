...
// DXIL_NATIVE_HALF: call <2 x half> @llvm.[[ICF:dx]].normalize.v2f16(<2 x half>
// SPIR_NATIVE_HALF: call <2 x half> @llvm.[[ICF:spv]].normalize.v2f16(<2 x half>
...
// DXIL_NATIVE_HALF: call <3 x half> @llvm.[[ICF:dx]].normalize.v3f16(<3 x half>
// SPIR_NATIVE_HALF: call <3 x half> @llvm.[[ICF:spv]].normalize.v3f16(<3 x half>
...
// DXIL_NATIVE_HALF: call <4 x half> @llvm.[[ICF:dx]].normalize.v4f16(<4 x half>
// SPIR_NATIVE_HALF: call <4 x half> @llvm.[[ICF:spv]].normalize.v4f16(<4 x half>
...
// DXIL_CHECK: %hlsl.normalize = call <2 x float> @llvm.[[ICF:dx]].normalize.v2f32(
// SPIR_CHECK: %hlsl.normalize = call <2 x float> @llvm.[[ICF:spv]].normalize.v2f32(<2 x float>
...
// DXIL_CHECK: %hlsl.normalize = call <3 x float> @llvm.[[ICF:dx]].normalize.v3f32(
// SPIR_CHECK: %hlsl.normalize = call <3 x float> @llvm.[[ICF:spv]].normalize.v3f32(<3 x float>
...
// DXIL_CHECK: %hlsl.normalize = call <4 x float> @llvm.[[ICF:dx]].normalize.v4f32(
// SPIR_CHECK: %hlsl.normalize = call <4 x float> @llvm.[[ICF:spv]].normalize.v4f32(
