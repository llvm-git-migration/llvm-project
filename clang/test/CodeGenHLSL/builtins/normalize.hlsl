...
// NATIVE_HALF: call <2 x half> @llvm.[[ICF]].normalize.v2f16(<2 x half>
// NO_HALF: call <2 x float> @llvm.[[ICF]].normalize.v2f32(<2 x float>
...
// NATIVE_HALF: call <3 x half> @llvm.[[ICF]].normalize.v3f16(<3 x half>
// NO_HALF: call <3 x float> @llvm.[[ICF]].normalize.v3f32(<3 x float>
...
// NATIVE_HALF: call <4 x half> @llvm.[[ICF]].normalize.v4f16(<4 x half>
// NO_HALF: call <4 x float> @llvm.[[ICF]].normalize.v4f32(<4 x float>
...
// CHECK: call float @llvm.[[ICF]].normalize.f32(float
// CHECK: ret float
...
// CHECK: %hlsl.normalize = call <3 x float> @llvm.[[ICF]].normalize.v3f32(
...
// CHECK: %hlsl.normalize = call <4 x float> @llvm.[[ICF]].normalize.v4f32(
