...
// DXIL_NATIVE_HALF: %dx.umad = call <2 x i16>  @llvm.[[ICF:dx]].umad.v2i16(<2 x i16> %0, <2 x i16> %1, <2 x i16> %2)
...
// DXIL_NATIVE_HALF: %dx.umad = call <3 x i16>  @llvm.[[ICF:dx]].umad.v3i16(<3 x i16> %0, <3 x i16> %1, <3 x i16> %2)
...
// DXIL_NATIVE_HALF: %dx.umad = call <4 x i16>  @llvm.[[ICF:dx]].umad.v4i16(<4 x i16> %0, <4 x i16> %1, <4 x i16> %2)
...
// DXIL_NATIVE_HALF: %dx.imad = call i16 @llvm.[[ICF:dx]].imad.i16(i16 %0, i16 %1, i16 %2)
...
// DXIL_NATIVE_HALF: %dx.imad = call <2 x i16>  @llvm.[[ICF:dx]].imad.v2i16(<2 x i16> %0, <2 x i16> %1, <2 x i16> %2)
...
// DXIL_NATIVE_HALF: %dx.imad = call <3 x i16>  @llvm.[[ICF:dx]].imad.v3i16(<3 x i16> %0, <3 x i16> %1, <3 x i16> %2)
...
// DXIL_NATIVE_HALF: %dx.imad = call <4 x i16>  @llvm.[[ICF:dx]].imad.v4i16(<4 x i16> %0, <4 x i16> %1, <4 x i16> %2)
...
// DXIL_CHECK: %dx.imad = call i32 @llvm.[[ICF:dx]].imad.i32(i32 %0, i32 %1, i32 %2)
...
// DXIL_CHECK: %dx.imad = call <2 x i32>  @llvm.[[ICF:dx]].imad.v2i32(<2 x i32> %0, <2 x i32> %1, <2 x i32> %2)
...
// DXIL_CHECK: %dx.imad = call <3 x i32>  @llvm.[[ICF:dx]].imad.v3i32(<3 x i32> %0, <3 x i32> %1, <3 x i32> %2)
...
// DXIL_CHECK: %dx.imad = call <4 x i32>  @llvm.[[ICF:dx]].imad.v4i32(<4 x i32> %0, <4 x i32> %1, <4 x i32> %2)
...
// DXIL_CHECK: %dx.imad = call i64 @llvm.[[ICF:dx]].imad.i64(i64 %0, i64 %1, i64 %2)
...
// DXIL_CHECK: %dx.imad = call <2 x i64>  @llvm.[[ICF:dx]].imad.v2i64(<2 x i64> %0, <2 x i64> %1, <2 x i64> %2)
...
// DXIL_CHECK: %dx.imad = call <3 x i64>  @llvm.[[ICF:dx]].imad.v3i64(<3 x i64> %0, <3 x i64> %1, <3 x i64> %2)
...
// DXIL_CHECK: %dx.imad = call <4 x i64>  @llvm.[[ICF:dx]].imad.v4i64(<4 x i64> %0, <4 x i64> %1, <4 x i64> %2)
...
// DXIL_CHECK: %dx.umad = call i32 @llvm.[[ICF:dx]].umad.i32(i32 %0, i32 %1, i32 %2)
...
// DXIL_CHECK: %dx.umad = call <2 x i32>  @llvm.[[ICF:dx]].umad.v2i32(<2 x i32> %0, <2 x i32> %1, <2 x i32> %2)
...
// DXIL_CHECK: %dx.umad = call <3 x i32>  @llvm.[[ICF:dx]].umad.v3i32(<3 x i32> %0, <3 x i32> %1, <3 x i32> %2)
...
// DXIL_CHECK: %dx.umad = call <4 x i32>  @llvm.[[ICF:dx]].umad.v4i32(<4 x i32> %0, <4 x i32> %1, <4 x i32> %2)
...
// DXIL_CHECK: %dx.umad = call i64 @llvm.[[ICF:dx]].umad.i64(i64 %0, i64 %1, i64 %2)
...
// DXIL_CHECK: %dx.umad = call <2 x i64>  @llvm.[[ICF:dx]].umad.v2i64(<2 x i64> %0, <2 x i64> %1, <2 x i64> %2)
...
// DXIL_CHECK: %dx.umad = call <3 x i64>  @llvm.[[ICF:dx]].umad.v3i64(<3 x i64> %0, <3 x i64> %1, <3 x i64> %2)
...
// DXIL_CHECK: %dx.umad = call <4 x i64>  @llvm.[[ICF:dx]].umad.v4i64(<4 x i64> %0, <4 x i64> %1, <4 x i64> %2)
