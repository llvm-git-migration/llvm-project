...
// CHECK: %hlsl.frac = call float @llvm.[[ICF]].frac.f32(
...
// CHECK: %hlsl.frac = call <2 x float> @llvm.[[ICF]].frac.v2f32
...
// CHECK: %hlsl.frac = call <3 x float> @llvm.[[ICF]].frac.v3f32
...
// CHECK: %hlsl.frac = call <4 x float> @llvm.[[ICF]].frac.v4f32
