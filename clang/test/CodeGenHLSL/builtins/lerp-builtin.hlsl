...
// CHECK: %hlsl.lerp = call <3 x half> @llvm.[[ICF:dx]].lerp.v3f16(<3 x half> %0, <3 x half> %1, <3 x half> %2)
...
// CHECK: %hlsl.lerp = call <2 x float> @llvm.[[ICF:dx]].lerp.v2f32(<2 x float> %0, <2 x float> %1, <2 x float> %2)
