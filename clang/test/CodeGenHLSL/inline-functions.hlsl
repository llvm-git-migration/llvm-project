...
// CHECK_CS_OPTNONE: define internal void @_Z4mainj(i32 noundef %GI) [[IntAttr:\#[0-9]+]]
// CHECK_CS_OPTNONE: ret void
...
// CHECK_CS_OPTNONE: Function Attrs: {{.*}}noinline
// CHECK_CS_OPTNONE: define void @main() {{[a-z_ ]*}}[[EntryAttr:\#[0-9]+]]
// Make sure internal function is not inlined when optimization is disabled
// CHECK_CS_OPTNONE: call void @_Z4mainj
...
// CHECK_CS_OPTNONE: Function Attrs:{{.*}}optnone
// CHECK_CS_OPTNONE: define internal void @_Z6main10v() [[IntAttr]]
// CHECK_CS_OPTNONE: ret void
...
// CHECK_CS_OPTNONE: Function Attrs: {{.*}}noinline
// CHECK_CS_OPTNONE: define void @main10() {{[a-z_ ]*}}[[EntryAttr]]
// Make sure internal function is not inlined when optimization is disabled
// CHECK_CS_OPTNONE: call void @_Z6main10v
...
// CHECK_CS_OPTNONE: attributes [[ExtAttr]] ={{.*}} alwaysinline
// CHECK_CS_OPTNONE: attributes [[IntAttr]] = {{.*}} optnone
// CHECK_CS_OPTNONE: attributes [[EntryAttr]] = {{.*}} noinline
