...
// CHECK-PPC-LABEL: define dso_local signext i32 @test_false(
// CHECK-PPC-SAME: ) #[[ATTR0]] {
// CHECK-PPC-NEXT:  entry:
// CHECK-PPC-NEXT:    [[RETVAL:%.*]] = alloca i32, align 4
// CHECK-PPC-NEXT:    br i1 false, label [[IF_THEN:%.*]], label [[IF_END:%.*]]
// CHECK-PPC:       if.then:
// CHECK-PPC-NEXT:    store i32 0, ptr [[RETVAL]], align 4
// CHECK-PPC-NEXT:    br label [[RETURN:%.*]]
// CHECK-PPC:       if.end:
// CHECK-PPC-NEXT:    store i32 1, ptr [[RETVAL]], align 4
// CHECK-PPC-NEXT:    br label [[RETURN]]
// CHECK-PPC:       return:
// CHECK-PPC-NEXT:    [[TMP0:%.*]] = load i32, ptr [[RETVAL]], align 4
// CHECK-PPC-NEXT:    ret i32 [[TMP0]]
//
int test_false() {
  if (__builtin_cpu_is("ppc64le"))
    return 0;
  return 1;
}
#endif
