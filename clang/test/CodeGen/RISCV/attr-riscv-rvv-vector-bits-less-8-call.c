...
// CHECK-64-NEXT:    store <1 x i8> [[OP1]], ptr [[SAVED_VALUE]], align 1, !tbaa [[TBAA10]]
// CHECK-64-NEXT:    [[TMP0:%.*]] = load <vscale x 1 x i1>, ptr [[SAVED_VALUE]], align 1, !tbaa [[TBAA10]]
// CHECK-64-NEXT:    store <1 x i8> [[OP2]], ptr [[SAVED_VALUE2]], align 1, !tbaa [[TBAA10]]
// CHECK-64-NEXT:    [[TMP1:%.*]] = load <vscale x 1 x i1>, ptr [[SAVED_VALUE2]], align 1, !tbaa [[TBAA10]]
// CHECK-64-NEXT:    [[TMP2:%.*]] = tail call <vscale x 1 x i1> @llvm.riscv.vmand.nxv1i1.i64(<vscale x 1 x i1> [[TMP0]], <vscale x 1 x i1> [[TMP1]], i64 1)
// CHECK-64-NEXT:    store <vscale x 1 x i1> [[TMP2]], ptr [[SAVED_VALUE3]], align 1, !tbaa [[TBAA11:![0-9]+]]
// CHECK-64-NEXT:    [[TMP3:%.*]] = load <1 x i8>, ptr [[SAVED_VALUE3]], align 1, !tbaa [[TBAA10]]
...
// CHECK-64-NEXT:    store <vscale x 1 x i1> [[TMP1]], ptr [[SAVED_VALUE1]], align 1, !tbaa [[TBAA11]]
// CHECK-64-NEXT:    [[TMP2:%.*]] = load <1 x i8>, ptr [[SAVED_VALUE1]], align 1, !tbaa [[TBAA10]]
// CHECK-64-NEXT:    [[CAST_SCALABLE:%.*]] = tail call <vscale x 1 x i8> @llvm.vector.insert.nxv1i8.v1i8(<vscale x 1 x i8> undef, <1 x i8> [[TMP2]], i64 0)
// CHECK-64-NEXT:    ret <vscale x 1 x i8> [[CAST_SCALABLE]]
//
