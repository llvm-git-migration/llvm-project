...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf4x4", i8, i8, 1, 4) @test_vlsseg4e16_v_bf16mf4x4(
// CHECK-RV64-SAME: ptr noundef [[RS1:%.*]], i64 noundef [[RS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf4x4", i8, i8, 1, 4) @llvm.riscv.vlsseg4.triscv_mf4x4_i8_i8_1_4t.i64(target("riscv_mf4x4", i8, i8, 1, 4) poison, ptr [[RS1]], i64 [[RS2]], i64 [[VL]], i64 4)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x4", i8, i8, 2, 4) @test_vlsseg4e16_v_bf16mf2x4(
// CHECK-RV64-SAME: ptr noundef [[RS1:%.*]], i64 noundef [[RS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x4", i8, i8, 2, 4) @llvm.riscv.vlsseg4.triscv_mf2x4_i8_i8_2_4t.i64(target("riscv_mf2x4", i8, i8, 2, 4) poison, ptr [[RS1]], i64 [[RS2]], i64 [[VL]], i64 4)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x4", i8, i8, 3, 4) @test_vlsseg4e16_v_bf16m1x4(
// CHECK-RV64-SAME: ptr noundef [[RS1:%.*]], i64 noundef [[RS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x4", i8, i8, 3, 4) @llvm.riscv.vlsseg4.triscv_m1x4_i8_i8_3_4t.i64(target("riscv_m1x4", i8, i8, 3, 4) poison, ptr [[RS1]], i64 [[RS2]], i64 [[VL]], i64 4)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m2x4", i8, i8, 4, 4) @test_vlsseg4e16_v_bf16m2x4(
// CHECK-RV64-SAME: ptr noundef [[RS1:%.*]], i64 noundef [[RS2:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m2x4", i8, i8, 4, 4) @llvm.riscv.vlsseg4.triscv_m2x4_i8_i8_4_4t.i64(target("riscv_m2x4", i8, i8, 4, 4) poison, ptr [[RS1]], i64 [[RS2]], i64 [[VL]], i64 4)
