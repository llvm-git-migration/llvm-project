...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf4x7", i8, i8, 1, 7) @test_vlseg7e16_v_f16mf4x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf4x7", i8, i8, 1, 7) @llvm.riscv.vlseg7.triscv_mf4x7_i8_i8_1_7t.i64(target("riscv_mf4x7", i8, i8, 1, 7) poison, ptr [[BASE]], i64 [[VL]], i64 4)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x7", i8, i8, 2, 7) @test_vlseg7e16_v_f16mf2x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x7", i8, i8, 2, 7) @llvm.riscv.vlseg7.triscv_mf2x7_i8_i8_2_7t.i64(target("riscv_mf2x7", i8, i8, 2, 7) poison, ptr [[BASE]], i64 [[VL]], i64 4)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x7", i8, i8, 3, 7) @test_vlseg7e16_v_f16m1x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x7", i8, i8, 3, 7) @llvm.riscv.vlseg7.triscv_m1x7_i8_i8_3_7t.i64(target("riscv_m1x7", i8, i8, 3, 7) poison, ptr [[BASE]], i64 [[VL]], i64 4)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf4x7", i8, i8, 1, 7) @test_vlseg7e16_v_i16mf4x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf4x7", i8, i8, 1, 7) @llvm.riscv.vlseg7.triscv_mf4x7_i8_i8_1_7t.i64(target("riscv_mf4x7", i8, i8, 1, 7) poison, ptr [[BASE]], i64 [[VL]], i64 4)
// CHECK-RV64-NEXT:    ret target("riscv_mf4x7", i8, i8, 1, 7) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x7", i8, i8, 2, 7) @test_vlseg7e16_v_i16mf2x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x7", i8, i8, 2, 7) @llvm.riscv.vlseg7.triscv_mf2x7_i8_i8_2_7t.i64(target("riscv_mf2x7", i8, i8, 2, 7) poison, ptr [[BASE]], i64 [[VL]], i64 4)
// CHECK-RV64-NEXT:    ret target("riscv_mf2x7", i8, i8, 2, 7) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x7", i8, i8, 3, 7) @test_vlseg7e16_v_i16m1x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x7", i8, i8, 3, 7) @llvm.riscv.vlseg7.triscv_m1x7_i8_i8_3_7t.i64(target("riscv_m1x7", i8, i8, 3, 7) poison, ptr [[BASE]], i64 [[VL]], i64 4)
// CHECK-RV64-NEXT:    ret target("riscv_m1x7", i8, i8, 3, 7) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf4x7", i8, i8, 1, 7) @test_vlseg7e16_v_u16mf4x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf4x7", i8, i8, 1, 7) @llvm.riscv.vlseg7.triscv_mf4x7_i8_i8_1_7t.i64(target("riscv_mf4x7", i8, i8, 1, 7) poison, ptr [[BASE]], i64 [[VL]], i64 4)
// CHECK-RV64-NEXT:    ret target("riscv_mf4x7", i8, i8, 1, 7) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x7", i8, i8, 2, 7) @test_vlseg7e16_v_u16mf2x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x7", i8, i8, 2, 7) @llvm.riscv.vlseg7.triscv_mf2x7_i8_i8_2_7t.i64(target("riscv_mf2x7", i8, i8, 2, 7) poison, ptr [[BASE]], i64 [[VL]], i64 4)
// CHECK-RV64-NEXT:    ret target("riscv_mf2x7", i8, i8, 2, 7) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x7", i8, i8, 3, 7) @test_vlseg7e16_v_u16m1x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x7", i8, i8, 3, 7) @llvm.riscv.vlseg7.triscv_m1x7_i8_i8_3_7t.i64(target("riscv_m1x7", i8, i8, 3, 7) poison, ptr [[BASE]], i64 [[VL]], i64 4)
// CHECK-RV64-NEXT:    ret target("riscv_m1x7", i8, i8, 3, 7) [[TMP0]]
