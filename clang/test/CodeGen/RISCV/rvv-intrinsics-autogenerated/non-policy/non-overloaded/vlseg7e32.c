...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x7", i8, i8, 2, 7) @test_vlseg7e32_v_f32mf2x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x7", i8, i8, 2, 7) @llvm.riscv.vlseg7.triscv_mf2x7_i8_i8_2_7t.i64(target("riscv_mf2x7", i8, i8, 2, 7) poison, ptr [[BASE]], i64 [[VL]], i64 5)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x7", i8, i8, 3, 7) @test_vlseg7e32_v_f32m1x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x7", i8, i8, 3, 7) @llvm.riscv.vlseg7.triscv_m1x7_i8_i8_3_7t.i64(target("riscv_m1x7", i8, i8, 3, 7) poison, ptr [[BASE]], i64 [[VL]], i64 5)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x7", i8, i8, 2, 7) @test_vlseg7e32_v_i32mf2x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x7", i8, i8, 2, 7) @llvm.riscv.vlseg7.triscv_mf2x7_i8_i8_2_7t.i64(target("riscv_mf2x7", i8, i8, 2, 7) poison, ptr [[BASE]], i64 [[VL]], i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_mf2x7", i8, i8, 2, 7) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x7", i8, i8, 3, 7) @test_vlseg7e32_v_i32m1x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x7", i8, i8, 3, 7) @llvm.riscv.vlseg7.triscv_m1x7_i8_i8_3_7t.i64(target("riscv_m1x7", i8, i8, 3, 7) poison, ptr [[BASE]], i64 [[VL]], i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_m1x7", i8, i8, 3, 7) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x7", i8, i8, 2, 7) @test_vlseg7e32_v_u32mf2x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x7", i8, i8, 2, 7) @llvm.riscv.vlseg7.triscv_mf2x7_i8_i8_2_7t.i64(target("riscv_mf2x7", i8, i8, 2, 7) poison, ptr [[BASE]], i64 [[VL]], i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_mf2x7", i8, i8, 2, 7) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x7", i8, i8, 3, 7) @test_vlseg7e32_v_u32m1x7
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x7", i8, i8, 3, 7) @llvm.riscv.vlseg7.triscv_m1x7_i8_i8_3_7t.i64(target("riscv_m1x7", i8, i8, 3, 7) poison, ptr [[BASE]], i64 [[VL]], i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_m1x7", i8, i8, 3, 7) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x7", i8, i8, 2, 7) @test_vlseg7e32_v_f32mf2x7_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x7", i8, i8, 2, 7) @llvm.riscv.vlseg7.mask.triscv_mf2x7_i8_i8_2_7t.nxv1i1.i64(target("riscv_mf2x7", i8, i8, 2, 7) poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_mf2x7", i8, i8, 2, 7) [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x7", i8, i8, 3, 7) @test_vlseg7e32_v_f32m1x7_m
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x7", i8, i8, 3, 7) @llvm.riscv.vlseg7.mask.triscv_m1x7_i8_i8_3_7t.nxv2i1.i64(target("riscv_m1x7", i8, i8, 3, 7) poison, ptr [[BASE]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 3, i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_m1x7", i8, i8, 3, 7) [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x7", i8, i8, 2, 7) @test_vlseg7e32_v_i32mf2x7_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x7", i8, i8, 2, 7) @llvm.riscv.vlseg7.mask.triscv_mf2x7_i8_i8_2_7t.nxv1i1.i64(target("riscv_mf2x7", i8, i8, 2, 7) poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_mf2x7", i8, i8, 2, 7) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x7", i8, i8, 3, 7) @test_vlseg7e32_v_i32m1x7_m
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x7", i8, i8, 3, 7) @llvm.riscv.vlseg7.mask.triscv_m1x7_i8_i8_3_7t.nxv2i1.i64(target("riscv_m1x7", i8, i8, 3, 7) poison, ptr [[BASE]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 3, i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_m1x7", i8, i8, 3, 7) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x7", i8, i8, 2, 7) @test_vlseg7e32_v_u32mf2x7_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x7", i8, i8, 2, 7) @llvm.riscv.vlseg7.mask.triscv_mf2x7_i8_i8_2_7t.nxv1i1.i64(target("riscv_mf2x7", i8, i8, 2, 7) poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_mf2x7", i8, i8, 2, 7) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x7", i8, i8, 3, 7) @test_vlseg7e32_v_u32m1x7_m
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x7", i8, i8, 3, 7) @llvm.riscv.vlseg7.mask.triscv_m1x7_i8_i8_3_7t.nxv2i1.i64(target("riscv_m1x7", i8, i8, 3, 7) poison, ptr [[BASE]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 3, i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_m1x7", i8, i8, 3, 7) [[TMP0]]
