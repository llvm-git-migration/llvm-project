...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x2", i8, i8, 3, 2) @test_vlseg2e64_v_f64m1x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x2", i8, i8, 3, 2) @llvm.riscv.vlseg2.triscv_m1x2_i8_i8_3_2t.i64(target("riscv_m1x2", i8, i8, 3, 2) poison, ptr [[BASE]], i64 [[VL]], i64 6)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m2x2", i8, i8, 4, 2) @test_vlseg2e64_v_f64m2x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m2x2", i8, i8, 4, 2) @llvm.riscv.vlseg2.triscv_m2x2_i8_i8_4_2t.i64(target("riscv_m2x2", i8, i8, 4, 2) poison, ptr [[BASE]], i64 [[VL]], i64 6)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m4x2", i8, i8, 5, 2) @test_vlseg2e64_v_f64m4x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m4x2", i8, i8, 5, 2) @llvm.riscv.vlseg2.triscv_m4x2_i8_i8_5_2t.i64(target("riscv_m4x2", i8, i8, 5, 2) poison, ptr [[BASE]], i64 [[VL]], i64 6)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x2", i8, i8, 3, 2) @test_vlseg2e64_v_i64m1x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x2", i8, i8, 3, 2) @llvm.riscv.vlseg2.triscv_m1x2_i8_i8_3_2t.i64(target("riscv_m1x2", i8, i8, 3, 2) poison, ptr [[BASE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m1x2", i8, i8, 3, 2) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m2x2", i8, i8, 4, 2) @test_vlseg2e64_v_i64m2x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m2x2", i8, i8, 4, 2) @llvm.riscv.vlseg2.triscv_m2x2_i8_i8_4_2t.i64(target("riscv_m2x2", i8, i8, 4, 2) poison, ptr [[BASE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m2x2", i8, i8, 4, 2) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m4x2", i8, i8, 5, 2) @test_vlseg2e64_v_i64m4x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m4x2", i8, i8, 5, 2) @llvm.riscv.vlseg2.triscv_m4x2_i8_i8_5_2t.i64(target("riscv_m4x2", i8, i8, 5, 2) poison, ptr [[BASE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m4x2", i8, i8, 5, 2) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x2", i8, i8, 3, 2) @test_vlseg2e64_v_u64m1x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x2", i8, i8, 3, 2) @llvm.riscv.vlseg2.triscv_m1x2_i8_i8_3_2t.i64(target("riscv_m1x2", i8, i8, 3, 2) poison, ptr [[BASE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m1x2", i8, i8, 3, 2) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m2x2", i8, i8, 4, 2) @test_vlseg2e64_v_u64m2x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m2x2", i8, i8, 4, 2) @llvm.riscv.vlseg2.triscv_m2x2_i8_i8_4_2t.i64(target("riscv_m2x2", i8, i8, 4, 2) poison, ptr [[BASE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m2x2", i8, i8, 4, 2) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m4x2", i8, i8, 5, 2) @test_vlseg2e64_v_u64m4x2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m4x2", i8, i8, 5, 2) @llvm.riscv.vlseg2.triscv_m4x2_i8_i8_5_2t.i64(target("riscv_m4x2", i8, i8, 5, 2) poison, ptr [[BASE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m4x2", i8, i8, 5, 2) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x2", i8, i8, 3, 2) @test_vlseg2e64_v_f64m1x2_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x2", i8, i8, 3, 2) @llvm.riscv.vlseg2.mask.triscv_m1x2_i8_i8_3_2t.nxv1i1.i64(target("riscv_m1x2", i8, i8, 3, 2) poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m1x2", i8, i8, 3, 2) [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m2x2", i8, i8, 4, 2) @test_vlseg2e64_v_f64m2x2_m
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m2x2", i8, i8, 4, 2) @llvm.riscv.vlseg2.mask.triscv_m2x2_i8_i8_4_2t.nxv2i1.i64(target("riscv_m2x2", i8, i8, 4, 2) poison, ptr [[BASE]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m2x2", i8, i8, 4, 2) [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m4x2", i8, i8, 5, 2) @test_vlseg2e64_v_f64m4x2_m
// CHECK-RV64-SAME: (<vscale x 4 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m4x2", i8, i8, 5, 2) @llvm.riscv.vlseg2.mask.triscv_m4x2_i8_i8_5_2t.nxv4i1.i64(target("riscv_m4x2", i8, i8, 5, 2) poison, ptr [[BASE]], <vscale x 4 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m4x2", i8, i8, 5, 2) [[TMP0]]
//
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x2", i8, i8, 3, 2) @test_vlseg2e64_v_i64m1x2_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x2", i8, i8, 3, 2) @llvm.riscv.vlseg2.mask.triscv_m1x2_i8_i8_3_2t.nxv1i1.i64(target("riscv_m1x2", i8, i8, 3, 2) poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m1x2", i8, i8, 3, 2) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m2x2", i8, i8, 4, 2) @test_vlseg2e64_v_i64m2x2_m
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m2x2", i8, i8, 4, 2) @llvm.riscv.vlseg2.mask.triscv_m2x2_i8_i8_4_2t.nxv2i1.i64(target("riscv_m2x2", i8, i8, 4, 2) poison, ptr [[BASE]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m2x2", i8, i8, 4, 2) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m4x2", i8, i8, 5, 2) @test_vlseg2e64_v_i64m4x2_m
// CHECK-RV64-SAME: (<vscale x 4 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m4x2", i8, i8, 5, 2) @llvm.riscv.vlseg2.mask.triscv_m4x2_i8_i8_5_2t.nxv4i1.i64(target("riscv_m4x2", i8, i8, 5, 2) poison, ptr [[BASE]], <vscale x 4 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m4x2", i8, i8, 5, 2) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x2", i8, i8, 3, 2) @test_vlseg2e64_v_u64m1x2_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x2", i8, i8, 3, 2) @llvm.riscv.vlseg2.mask.triscv_m1x2_i8_i8_3_2t.nxv1i1.i64(target("riscv_m1x2", i8, i8, 3, 2) poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m1x2", i8, i8, 3, 2) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m2x2", i8, i8, 4, 2) @test_vlseg2e64_v_u64m2x2_m
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m2x2", i8, i8, 4, 2) @llvm.riscv.vlseg2.mask.triscv_m2x2_i8_i8_4_2t.nxv2i1.i64(target("riscv_m2x2", i8, i8, 4, 2) poison, ptr [[BASE]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m2x2", i8, i8, 4, 2) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m4x2", i8, i8, 5, 2) @test_vlseg2e64_v_u64m4x2_m
// CHECK-RV64-SAME: (<vscale x 4 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m4x2", i8, i8, 5, 2) @llvm.riscv.vlseg2.mask.triscv_m4x2_i8_i8_5_2t.nxv4i1.i64(target("riscv_m4x2", i8, i8, 5, 2) poison, ptr [[BASE]], <vscale x 4 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m4x2", i8, i8, 5, 2) [[TMP0]]
