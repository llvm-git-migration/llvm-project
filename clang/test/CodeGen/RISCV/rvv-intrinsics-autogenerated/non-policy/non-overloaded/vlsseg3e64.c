...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x3", i8, i8, 3, 3) @test_vlsseg3e64_v_f64m1x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[BSTRIDE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x3", i8, i8, 3, 3) @llvm.riscv.vlsseg3.triscv_m1x3_i8_i8_3_3t.i64(target("riscv_m1x3", i8, i8, 3, 3) poison, ptr [[BASE]], i64 [[BSTRIDE]], i64 [[VL]], i64 6)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m2x3", i8, i8, 4, 3) @test_vlsseg3e64_v_f64m2x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[BSTRIDE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m2x3", i8, i8, 4, 3) @llvm.riscv.vlsseg3.triscv_m2x3_i8_i8_4_3t.i64(target("riscv_m2x3", i8, i8, 4, 3) poison, ptr [[BASE]], i64 [[BSTRIDE]], i64 [[VL]], i64 6)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x3", i8, i8, 3, 3) @test_vlsseg3e64_v_i64m1x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[BSTRIDE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x3", i8, i8, 3, 3) @llvm.riscv.vlsseg3.triscv_m1x3_i8_i8_3_3t.i64(target("riscv_m1x3", i8, i8, 3, 3) poison, ptr [[BASE]], i64 [[BSTRIDE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m1x3", i8, i8, 3, 3) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m2x3", i8, i8, 4, 3) @test_vlsseg3e64_v_i64m2x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[BSTRIDE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m2x3", i8, i8, 4, 3) @llvm.riscv.vlsseg3.triscv_m2x3_i8_i8_4_3t.i64(target("riscv_m2x3", i8, i8, 4, 3) poison, ptr [[BASE]], i64 [[BSTRIDE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m2x3", i8, i8, 4, 3) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x3", i8, i8, 3, 3) @test_vlsseg3e64_v_u64m1x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[BSTRIDE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x3", i8, i8, 3, 3) @llvm.riscv.vlsseg3.triscv_m1x3_i8_i8_3_3t.i64(target("riscv_m1x3", i8, i8, 3, 3) poison, ptr [[BASE]], i64 [[BSTRIDE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m1x3", i8, i8, 3, 3) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m2x3", i8, i8, 4, 3) @test_vlsseg3e64_v_u64m2x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[BSTRIDE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m2x3", i8, i8, 4, 3) @llvm.riscv.vlsseg3.triscv_m2x3_i8_i8_4_3t.i64(target("riscv_m2x3", i8, i8, 4, 3) poison, ptr [[BASE]], i64 [[BSTRIDE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret target("riscv_m2x3", i8, i8, 4, 3) [[TMP0]]
