...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x5", i8, i8, 2, 5) @test_vlseg5e32_v_f32mf2x5
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x5", i8, i8, 2, 5) @llvm.riscv.vlseg5.triscv_mf2x5_i8_i8_2_5t.i64(target("riscv_mf2x5", i8, i8, 2, 5) poison, ptr [[BASE]], i64 [[VL]], i64 5)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x5", i8, i8, 3, 5) @test_vlseg5e32_v_f32m1x5
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x5", i8, i8, 3, 5) @llvm.riscv.vlseg5.triscv_m1x5_i8_i8_3_5t.i64(target("riscv_m1x5", i8, i8, 3, 5) poison, ptr [[BASE]], i64 [[VL]], i64 5)
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x5", i8, i8, 2, 5) @test_vlseg5e32_v_i32mf2x5
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x5", i8, i8, 2, 5) @llvm.riscv.vlseg5.triscv_mf2x5_i8_i8_2_5t.i64(target("riscv_mf2x5", i8, i8, 2, 5) poison, ptr [[BASE]], i64 [[VL]], i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_mf2x5", i8, i8, 2, 5) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x5", i8, i8, 3, 5) @test_vlseg5e32_v_i32m1x5
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x5", i8, i8, 3, 5) @llvm.riscv.vlseg5.triscv_m1x5_i8_i8_3_5t.i64(target("riscv_m1x5", i8, i8, 3, 5) poison, ptr [[BASE]], i64 [[VL]], i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_m1x5", i8, i8, 3, 5) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_mf2x5", i8, i8, 2, 5) @test_vlseg5e32_v_u32mf2x5
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_mf2x5", i8, i8, 2, 5) @llvm.riscv.vlseg5.triscv_mf2x5_i8_i8_2_5t.i64(target("riscv_mf2x5", i8, i8, 2, 5) poison, ptr [[BASE]], i64 [[VL]], i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_mf2x5", i8, i8, 2, 5) [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local target("riscv_m1x5", i8, i8, 3, 5) @test_vlseg5e32_v_u32m1x5
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call target("riscv_m1x5", i8, i8, 3, 5) @llvm.riscv.vlseg5.triscv_m1x5_i8_i8_3_5t.i64(target("riscv_m1x5", i8, i8, 3, 5) poison, ptr [[BASE]], i64 [[VL]], i64 5)
// CHECK-RV64-NEXT:    ret target("riscv_m1x5", i8, i8, 3, 5) [[TMP0]]
