...
// CHECK-DEF-SAME: (ptr noundef byval({ double, double }) align 8 [[W:%.*]], ptr noundef byval({ double, double }) align 8 [[X:%.*]], i32 noundef [[Y:%.*]]) #[[ATTR0]] {
// CHECK-DEF-NEXT:  entry:
// CHECK-DEF-NEXT:    [[Y_ADDR:%.*]] = alloca i32, align 4
// CHECK-DEF-NEXT:    store i32 [[Y]], ptr [[Y_ADDR]], align 4
...
// CHECK-GNU-SAME: ([4 x i32] noundef [[W_COERCE:%.*]], [4 x i32] noundef [[X_COERCE:%.*]], i32 noundef [[Y:%.*]]) #[[ATTR0]] {
// CHECK-GNU-NEXT:  entry:
// CHECK-GNU-NEXT:    [[W:%.*]] = alloca { double, double }, align 8
// CHECK-GNU-NEXT:    [[X:%.*]] = alloca { double, double }, align 8
// CHECK-GNU-NEXT:    [[Y_ADDR:%.*]] = alloca i32, align 4
...
//
int foo6(_Complex double w, _Complex double x, int y)
{
  return y;
}
