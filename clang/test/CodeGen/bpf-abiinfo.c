...
void sprog2(unsigned short, unsigned int, unsigned int);
void mprog3() {
  sprog2(-3, 4, -5);
// CHECK: call void @sprog2(i16 noundef zeroext -3, i32 noundef zeroext 4, i32 noundef zeroext -5)
}
void mprog4(unsigned long a, unsigned long b) {
  sprog2(a, b, b);
// CHECK: call void @sprog2(i16 noundef zeroext %{{[0-9a-z]+}}, i32 noundef zeroext %{{[0-9a-z]+}}, i32 noundef zeroext %{{[0-9a-z]+}})
}
