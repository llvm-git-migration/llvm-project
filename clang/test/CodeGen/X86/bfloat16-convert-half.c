...
// CHECK-LABEL: define dso_local i32 @test_convertvector_from_fp162_to_bf162(
// CHECK-SAME: i32 noundef [[IN_COERCE:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[RETVAL:%.*]] = alloca <2 x bfloat>, align 4
// CHECK-NEXT:    [[IN:%.*]] = alloca <2 x half>, align 4
...
// CHECK-NEXT:    store <2 x half> [[IN1]], ptr [[IN_ADDR]], align 4
// CHECK-NEXT:    [[TMP0:%.*]] = load <2 x half>, ptr [[IN_ADDR]], align 4
// CHECK-NEXT:    [[CONV:%.*]] = fpext <2 x half> [[TMP0]] to <2 x float>
// CHECK-NEXT:    [[CONV2:%.*]] = fptrunc <2 x float> [[CONV]] to <2 x bfloat>
// CHECK-NEXT:    store <2 x bfloat> [[CONV2]], ptr [[RETVAL]], align 4
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[RETVAL]], align 4
// CHECK-NEXT:    ret i32 [[TMP1]]
//
bfloat2 test_convertvector_from_fp162_to_bf162(half2 in) {
  return __builtin_convertvector(in, bfloat2);
}

// CHECK-LABEL: define dso_local i32 @test_convertvector_from_bf162_to_fp162(
// CHECK-SAME: i32 noundef [[IN_COERCE:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[RETVAL:%.*]] = alloca <2 x half>, align 4
// CHECK-NEXT:    [[IN:%.*]] = alloca <2 x bfloat>, align 4
...
// CHECK-NEXT:    store <2 x bfloat> [[IN1]], ptr [[IN_ADDR]], align 4
// CHECK-NEXT:    [[TMP0:%.*]] = load <2 x bfloat>, ptr [[IN_ADDR]], align 4
// CHECK-NEXT:    [[CONV:%.*]] = fpext <2 x bfloat> [[TMP0]] to <2 x float>
// CHECK-NEXT:    [[CONV2:%.*]] = fptrunc <2 x float> [[CONV]] to <2 x half>
// CHECK-NEXT:    store <2 x half> [[CONV2]], ptr [[RETVAL]], align 4
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[RETVAL]], align 4
// CHECK-NEXT:    ret i32 [[TMP1]]
//
half2 test_convertvector_from_bf162_to_fp162(bfloat2 in) {
  return __builtin_convertvector(in, half2);
}

// CHECK-LABEL: define dso_local double @test_convertvector_from_fp164_to_bf164(
// CHECK-SAME: double noundef [[IN_COERCE:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[RETVAL:%.*]] = alloca <4 x bfloat>, align 8
// CHECK-NEXT:    [[IN:%.*]] = alloca <4 x half>, align 8
...
// CHECK-NEXT:    store <4 x half> [[IN1]], ptr [[IN_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <4 x half>, ptr [[IN_ADDR]], align 8
// CHECK-NEXT:    [[CONV:%.*]] = fpext <4 x half> [[TMP0]] to <4 x float>
// CHECK-NEXT:    [[CONV2:%.*]] = fptrunc <4 x float> [[CONV]] to <4 x bfloat>
// CHECK-NEXT:    store <4 x bfloat> [[CONV2]], ptr [[RETVAL]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = load double, ptr [[RETVAL]], align 8
// CHECK-NEXT:    ret double [[TMP1]]
//
bfloat4 test_convertvector_from_fp164_to_bf164(half4 in) {
  return __builtin_convertvector(in, bfloat4);
}

// CHECK-LABEL: define dso_local double @test_convertvector_from_bf164_to_fp164(
// CHECK-SAME: double noundef [[IN_COERCE:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[RETVAL:%.*]] = alloca <4 x half>, align 8
// CHECK-NEXT:    [[IN:%.*]] = alloca <4 x bfloat>, align 8
...
// CHECK-NEXT:    store <4 x bfloat> [[IN1]], ptr [[IN_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <4 x bfloat>, ptr [[IN_ADDR]], align 8
// CHECK-NEXT:    [[CONV:%.*]] = fpext <4 x bfloat> [[TMP0]] to <4 x float>
// CHECK-NEXT:    [[CONV2:%.*]] = fptrunc <4 x float> [[CONV]] to <4 x half>
// CHECK-NEXT:    store <4 x half> [[CONV2]], ptr [[RETVAL]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = load double, ptr [[RETVAL]], align 8
// CHECK-NEXT:    ret double [[TMP1]]
//
half4 test_convertvector_from_bf164_to_fp164(bfloat4 in) {
