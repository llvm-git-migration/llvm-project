...
// FIXME: We should only issue one of these diagnostics
template<>
template<>
template<>
void A<int>::B<bool>::template g<short>() { } // expected-error{{'template' keyword not permitted here}}
                                              // expected-error@-1{{'template' cannot be used after a declarative}}
...
template<typename U>
template<typename V>
int A<T>::B<U>::template y<V**> = 0; // expected-error{{'template' keyword not permitted here}}
                                     // expected-error@-1{{'template' cannot be used after a declarative}}
...
template<>
template<>
int A<int>::B<bool>::template y<long> = 0; // expected-error{{'template' keyword not permitted here}}
                                           // expected-error@-1{{'template' cannot be used after a declarative}}
...
template<>
template<typename V>
int A<int>::B<bool>::template y<V**> = 0; // expected-error{{'template' keyword not permitted here}}
                                          // expected-error@-1{{'template' cannot be used after a declarative}}
template<typename T>
template<typename U>
...
struct F {
  ...
  // FIXME: We should parse the 'template' keyword and complain later
  friend void T::template f<int>();
