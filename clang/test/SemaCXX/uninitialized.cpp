...
void aggregate() {
  ...
  (void)agg;
  // expected-warning@#TYPE_INHERIT_WITH_EXPLICIT {{field in 'InheritWithExplicit<>' requires explicit initialization but is not explicitly initialized}} expected-note@#FIELD_G2 {{'g2' declared here}}
  ...
  // expected-warning@#TYPE_INHERIT_WITH_EXPLICIT {{field in 'Inherit<Special>' requires explicit initialization but is not explicitly initialized}} expected-note@#FIELD_G3 {{'g3' declared here}}
