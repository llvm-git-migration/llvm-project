...
struct bad_await_suspend_return_1 {
  bool await_ready();
  // expected-error@+1 {{return type of 'await_suspend' is required to be 'void' or 'bool' or convertible to 'std::coroutine_handle<>' (have 'char')}}
...
struct bad_await_suspend_return_2 {
  bool await_ready();
  // expected-error@+1 {{return type of 'await_suspend' is required to be 'void' or 'bool' or convertible to 'std::coroutine_handle<>' (have 'non_trivial_destruction_type')}}
...
struct await_suspend_type_test {
  bool await_ready();
  // expected-error@+2 {{return type of 'await_suspend' is required to be 'void' or 'bool' or convertible to 'std::coroutine_handle<>' (have 'bool &')}}
  // expected-error@+1 {{return type of 'await_suspend' is required to be 'void' or 'bool' or convertible to 'std::coroutine_handle<>' (have 'bool &&')}}
