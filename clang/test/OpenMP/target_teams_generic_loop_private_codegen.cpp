...
// CHECK13-NEXT:    call void @_ZN1SIfEC1Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[ARRAYCTOR_CUR]]) #[[ATTR4:[0-9]+]]
...
// CHECK13-NEXT:    call void @_ZN1SIfEC1Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[VAR]]) #[[ATTR4]]
...
// CHECK13-NEXT:    call void @_ZN1SIfED1Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[VAR]]) #[[ATTR5:[0-9]+]]
...
// CHECK13-NEXT:    call void @_ZN1SIfEC2Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[THIS1]]) #[[ATTR4]]
// CHECK13-NEXT:    ret void
//
//
...
// CHECK13:       arrayctor.loop:
// CHECK13-NEXT:    [[ARRAYCTOR_CUR:%.*]] = phi ptr [ [[ARRAY_BEGIN]], [[ENTRY:%.*]] ], [ [[ARRAYCTOR_NEXT:%.*]], [[ARRAYCTOR_LOOP]] ]
// CHECK13-NEXT:    call void @_ZN1SIiEC1Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[ARRAYCTOR_CUR]]) #[[ATTR4]]
// CHECK13-NEXT:    [[ARRAYCTOR_NEXT]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAYCTOR_CUR]], i64 1
// CHECK13-NEXT:    [[ARRAYCTOR_DONE:%.*]] = icmp eq ptr [[ARRAYCTOR_NEXT]], [[ARRAYCTOR_END]]
// CHECK13-NEXT:    br i1 [[ARRAYCTOR_DONE]], label [[ARRAYCTOR_CONT:%.*]], label [[ARRAYCTOR_LOOP]]
// CHECK13:       arrayctor.cont:
// CHECK13-NEXT:    call void @_ZN1SIiEC1Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[VAR]]) #[[ATTR4]]
...
// CHECK13-NEXT:    call void @_ZN1SIiED1Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[VAR]]) #[[ATTR5]]
...
// CHECK13-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// CHECK13-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
// CHECK13-NEXT:    call void @_ZN1SIiEC2Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[THIS1]]) #[[ATTR4]]
// CHECK13-NEXT:    ret void
//
//
...
// CHECK15-NEXT:    call void @_ZN1SIfEC1Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[ARRAYCTOR_CUR]]) #[[ATTR4:[0-9]+]]
...
// CHECK15-NEXT:    call void @_ZN1SIfEC1Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[VAR]]) #[[ATTR4]]
...
// CHECK15-NEXT:    call void @_ZN1SIfED1Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[VAR]]) #[[ATTR5:[0-9]+]]
...
// CHECK15-NEXT:    call void @_ZN1SIfEC2Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[THIS1]]) #[[ATTR4]]
// CHECK15-NEXT:    ret void
//
//
...
// CHECK15:       arrayctor.loop:
// CHECK15-NEXT:    [[ARRAYCTOR_CUR:%.*]] = phi ptr [ [[ARRAY_BEGIN]], [[ENTRY:%.*]] ], [ [[ARRAYCTOR_NEXT:%.*]], [[ARRAYCTOR_LOOP]] ]
// CHECK15-NEXT:    call void @_ZN1SIiEC1Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[ARRAYCTOR_CUR]]) #[[ATTR4]]
// CHECK15-NEXT:    [[ARRAYCTOR_NEXT]] = getelementptr inbounds [[STRUCT_S_0]], ptr [[ARRAYCTOR_CUR]], i32 1
// CHECK15-NEXT:    [[ARRAYCTOR_DONE:%.*]] = icmp eq ptr [[ARRAYCTOR_NEXT]], [[ARRAYCTOR_END]]
// CHECK15-NEXT:    br i1 [[ARRAYCTOR_DONE]], label [[ARRAYCTOR_CONT:%.*]], label [[ARRAYCTOR_LOOP]]
// CHECK15:       arrayctor.cont:
// CHECK15-NEXT:    call void @_ZN1SIiEC1Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[VAR]]) #[[ATTR4]]
...
// CHECK15-NEXT:    call void @_ZN1SIiED1Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[VAR]]) #[[ATTR5]]
...
// CHECK15-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 4
// CHECK15-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 4
// CHECK15-NEXT:    call void @_ZN1SIiEC2Ev(ptr noundef nonnull readonly align 4 dereferenceable(4) [[THIS1]]) #[[ATTR4]]
// CHECK15-NEXT:    ret void
//
//
