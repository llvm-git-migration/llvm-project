...
// CHECK1-NEXT:    call void @__clang_call_terminate(ptr [[TMP34]]) #[[ATTR8]]
// CHECK1-NEXT:    unreachable
//
//
...
// CHECK1-SAME: () #[[ATTR7:[0-9]+]] section ".text.startup" {
// CHECK1-NEXT:  entry:
...
// CHECK5-NEXT:    call void @__clang_call_terminate(ptr [[TMP34]]) #[[ATTR8]]
// CHECK5-NEXT:    unreachable
//
//
...
// CHECK5-SAME: () #[[ATTR7:[0-9]+]] section ".text.startup" {
// CHECK5-NEXT:  entry:
