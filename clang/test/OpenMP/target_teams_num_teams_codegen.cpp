...
// CHECK1-NEXT:    [[CALL:%.*]] = call noundef signext i32 @_ZN2S12r1Ei(ptr noundef nonnull readonly align 8 dereferenceable(8) [[S]], i32 noundef signext [[TMP0]])
...
// CHECK3-NEXT:    [[CALL:%.*]] = call noundef i32 @_ZN2S12r1Ei(ptr noundef nonnull readonly align 4 dereferenceable(8) [[S]], i32 noundef [[TMP0]])
