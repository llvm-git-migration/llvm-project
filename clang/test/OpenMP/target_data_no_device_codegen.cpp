...
// CHECK-SAME: (ptr noundef nonnull readonly align 8 dereferenceable(8) [[THIS:%.*]]) #[[ATTR0:[0-9]+]] align 2 {
// CHECK-NEXT:  entry:
...
// SIMD-ONLY0-SAME: (ptr noundef nonnull readonly align 8 dereferenceable(8) [[THIS:%.*]]) #[[ATTR0:[0-9]+]] align 2 {
