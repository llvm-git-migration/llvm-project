...
// CHECK1-NEXT:    [[CALL:%.*]] = call nonnull align 8 dereferenceable(8) ptr @_ZN2TTIxcEixEi(ptr nonnull readonly align 8 dereferenceable(16) [[TMP7]], i32 0) #[[ATTR10:[0-9]+]]
...
// CHECK1-SAME: (ptr nonnull readonly align 8 dereferenceable(16) [[THIS:%.*]], i32 [[I:%.*]]) #[[ATTR5:[0-9]+]] comdat align 2 {
// CHECK1-NEXT:  entry:
...
// CHECK2-NEXT:    [[CALL:%.*]] = call nonnull align 8 dereferenceable(8) ptr @_ZN2TTIxcEixEi(ptr nonnull readonly align 8 dereferenceable(16) [[TMP7]], i32 0) #[[ATTR10:[0-9]+]]
...
// CHECK2-SAME: (ptr nonnull readonly align 8 dereferenceable(16) [[THIS:%.*]], i32 [[I:%.*]]) #[[ATTR5:[0-9]+]] comdat align 2 {
// CHECK2-NEXT:  entry:
