...
// RUN: %clang -x cl -ccc-print-phases --save-temps -c %s 2>&1 | FileCheck %s -check-prefix=CHECK-PHASES
...
// CHECK-PHASES: 4: assembler, {3}, object
// CHECK-PHASES: 5: bind-arch, {{.*}}, {4}, object
