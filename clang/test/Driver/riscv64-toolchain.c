...
// CXX-RV64-BAREMETAL-LP64: "-lstdc++" "-lsupc++" "-lm" "--start-group" "-lc" "-lgloss" "--end-group" "-lgcc"
...
// CXX-RV64-BAREMETAL-NOSYSROOT-LP64: "-lstdc++" "-lsupc++" "-lm" "--start-group" "-lc" "-lgloss" "--end-group" "-lgcc"
