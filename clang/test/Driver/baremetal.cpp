...
// CHECK-V6M-TREE-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
...
// CHECK-ARMV7M-PER-TARGET: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-ARMV7M-PER-TARGET: "--target2=rel" "-o" "{{.*}}.out"
...
// CHECK-V6M-DEFAULTCXX-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-V6M-DEFAULTCXX-SAME: "--target2=rel" "-o" "{{.*}}.out"
...
// CHECK-V6M-LIBCXX-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-V6M-LIBCXX-SAME: "--target2=rel" "-o" "{{.*}}.out"
...
// CHECK-V6M-LIBSTDCXX-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-V6M-LIBSTDCXX-SAME: "--target2=rel" "-o" "{{.*}}.out"
...
// CHECK-V6M-LIBCXX-USR-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-V6M-LIBCXX-USR-SAME: "--target2=rel" "-o" "{{.*}}.out"
...
// CHECK-RV64-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
...
// CHECK-RV64-DEFAULTCXX-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-RV64-DEFAULTCXX-SAME: "-o" "{{.*}}.out"
...
// CHECK-RV64-LIBCXX-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-RV64-LIBCXX-SAME: "-o" "{{.*}}.out"
...
// CHECK-RV64-LIBSTDCXX-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-RV64-LIBSTDCXX-SAME: "-o" "{{.*}}.out"
...
// CHECK-RV32-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-RV32-SAME: "-o" "{{.*}}.out"
...
// CHECK-RV32-DEFAULTCXX-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-RV32-DEFAULTCXX-SAME: "-o" "{{.*}}.out"
...
// CHECK-RV32-LIBCXX-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-RV32-LIBCXX-SAME: "-o" "{{.*}}.out"
...
// CHECK-RV32-LIBSTDCXX-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-RV32-LIBSTDCXX-SAME: "-o" "{{.*}}.out"
...
// CHECK-PPCEABI-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-PPCEABI-SAME: "-o" "{{.*}}.out"
...
// CHECK-PPC64EABI-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-PPC64EABI-SAME: "-o" "{{.*}}.out"
...
// CHECK-PPCLEEABI-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-PPCLEEABI-SAME: "-o" "{{.*}}.out"
...
// CHECK-PPC64LEEABI-SAME: "-lm" "-lc" "{{[^"]*}}libclang_rt.builtins.a"
// CHECK-PPC64LEEABI-SAME: "-o" "{{.*}}.out"
