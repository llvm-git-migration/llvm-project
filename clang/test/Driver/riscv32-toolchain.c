...
// CXX-RV32-BAREMETAL-ILP32: "-lstdc++" "-lsupc++" "-lm" "--start-group" "-lc" "-lgloss" "--end-group" "-lgcc"
...
// CXX-RV32-BAREMETAL-NOSYSROOT-ILP32: "-lstdc++" "-lsupc++" "-lm" "--start-group" "-lc" "-lgloss" "--end-group" "-lgcc"
