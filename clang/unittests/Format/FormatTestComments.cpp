...
TEST_F(FormatTestComments, KeepsParameterWithTrailingCommentsOnTheirOwnLine) {
  ...
  BreakAlways.BinPackParameters = FormatStyle::BPPS_BreakAlways;
  EXPECT_EQ("SomeFunction(a,\n"
            "             b, // comment\n"
            "             c,\n"
            "             d);",
...
TEST_F(FormatTestComments, UnderstandsBlockComments) {
  ...
  NoBinPacking.BinPackParameters = FormatStyle::BPPS_CurrentLine;
  verifyFormat("aaaaaaaa(/* parameter 1 */ aaaaaa,\n"
               "         /* parameter 2 */ aaaaaa,\n"
               "         /* parameter 3 */ aaaaaa,\n"
               "         /* parameter 4 */ aaaaaa);",
               NoBinPacking);
  NoBinPacking.BinPackParameters = FormatStyle::BPPS_BreakAlways;
  verifyFormat("aaaaaaaa(/* parameter 1 */ aaaaaa,\n"
               "         /* parameter 2 */ aaaaaa,\n"
               "         /* parameter 3 */ aaaaaa,\n"
               "         /* parameter 4 */ aaaaaa);",
