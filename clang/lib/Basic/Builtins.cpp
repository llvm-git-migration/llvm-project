        ...
        if (DebugHackTargetIsX86 && ID == X86::BI__builtin_ia32_packsswb128) {
          if (I.getName(Shard) != "__builtin_ia32_packsswb128")
            llvm::report_fatal_error(
                ...
                I.getName(Shard) + "'!!!");
        } else if (DebugHackTargetIsAArch64 && ID == SVE::BI__builtin_sve_svundef_u8) {
          ...
          if (I.getName(Shard) != "__ldrexd")
            llvm::report_fatal_error(
                llvm::Twine("Name for __ldrexd is: '") +
                I.getName(Shard) + "'!!!");
        } else if (DebugHackTargetIsHexagon && ID == Hexagon::BI__builtin_HEXAGON_V6_vsub_sf_bf) {
