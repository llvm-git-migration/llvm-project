...
static Value *handleHlslSplitdouble(const CallExpr *E, CodeGenFunction *CGF) {
  ...
  if (CGF->CGM.getTarget().getTriple().isDXIL()) {
    ...
    if (!Op0->getType()->isVectorTy()) {
      ...
      FixedVectorType *UintVec4 = FixedVectorType::get(CGF->Int32Ty, 4);
      ...
      case 2: {
        auto [LB, HB] = EmitVectorCode(Op0, &CGF->Builder, UintVec4);
        LowBits = LB;
        HighBits = HB;
        break;
      }
      ...
      case 3: {
        ...
        auto [LB, HB] = EmitVectorCode(Shuff, &CGF->Builder, UintVec4);
      ...
      case 4: {
        ...
        auto [LB1, HB1] = EmitVectorCode(Shuff1, &CGF->Builder, UintVec4);

        auto *Shuff2 = CGF->Builder.CreateShuffleVector(Op0, {2, 3});
        auto [LB2, HB2] = EmitVectorCode(Shuff2, &CGF->Builder, UintVec4);
