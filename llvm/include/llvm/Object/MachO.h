...
public:
  ...
  Expected<MachO::section> getSection(const LoadCommandInfo &L, unsigned Index) const;
  Expected<MachO::section_64> getSection64(const LoadCommandInfo &L,unsigned Index) const;
