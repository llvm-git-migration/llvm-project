...
public:
  enum class FPVariant {
    IEEE_FLOAT = 0x0,
    VARIANT_FLOAT_1 = 0x1, // BRAIN_FLOAT
    VARIANT_FLOAT_2 = 0x2, // TENSOR_FLOAT
    VARIANT_FLOAT_3 = 0x3, // PPC_FLOAT
    VARIANT_FLOAT_4 = 0x4, // FP80
  ...
  static constexpr LLT bfloat8() { return floatingPoint(8, FPVariant::VARIANT_FLOAT_1); }
  
  // Get a 16-bit brain float value.
  static constexpr LLT bfloat16() { return floatingPoint(16, FPVariant::VARIANT_FLOAT_1); }

  /// Get a 16-bit IEEE half value.
  static constexpr LLT float16() { return floatingPoint(16, FPVariant::IEEE_FLOAT); }

  /// Get a 32-bit IEEE float value.
  static constexpr LLT float32() { return floatingPoint(32, FPVariant::IEEE_FLOAT); }

  /// Get a 64-bit IEEE double value.
  static constexpr LLT float64() { return floatingPoint(64, FPVariant::IEEE_FLOAT); }

  /// Get a 80-bit X86 floating point value.
  static constexpr LLT x86fp80() { return floatingPoint(80, FPVariant::VARIANT_FLOAT_1); }

  /// Get a 128-bit IEEE quad value.
  static constexpr LLT float128() { return floatingPoint(128, FPVariant::IEEE_FLOAT); }

  /// Get a 128-bit PowerPC double double value.
  static constexpr LLT ppcf128() { return floatingPoint(128, FPVariant::VARIANT_FLOAT_1); }
  ...
  constexpr bool isIEEEFloat(unsigned Size) const { return isVariantFloat(Size, FPVariant::IEEE_FLOAT); }
  constexpr bool isBFloat(unsigned Size) const { return isVariantFloat(Size, FPVariant::VARIANT_FLOAT_1); }
  constexpr bool isX86FP80() const { return isVariantFloat(80, FPVariant::VARIANT_FLOAT_1); }
  constexpr bool isPPCF128() const { return isVariantFloat(128, FPVariant::VARIANT_FLOAT_1); }
