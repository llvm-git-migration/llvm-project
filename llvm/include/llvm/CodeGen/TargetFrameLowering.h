...
public:
  ...
  /// enableAsyncCFIFixup - Returns true if we may need to fix up the function
  /// unwind information at a basic block level (for async unwind tables).
  virtual bool enableAsyncCFIFixup(const MachineFunction &MF) const {
