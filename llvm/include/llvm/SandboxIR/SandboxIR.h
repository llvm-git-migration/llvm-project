...
public:
  static bool classof(const Instruction *From) {
    auto Opc = From->getOpcode();
    return Opc == Instruction::Opcode::Call ||
           Opc == Instruction::Opcode::Invoke ||
           Opc == Instruction::Opcode::CallBr;
  }
  static bool classof(const Value *From) {
...
class CallInst : public CallBase {
  ...
  CallInst(ClassID SubclassID, llvm::Instruction *I, Context &Ctx)
      : CallBase(SubclassID, Opcode::Call, I, Ctx) {}
