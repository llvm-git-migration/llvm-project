...
private:
  ...
  struct DebugVariables {
    /// Maps the name of an llvm::Function to a DenseSet of VarIDs before an
    /// optimization pass has run.
    DenseMap<const Function *, DenseSet<VarID>> DebugVariablesBefore;
    /// Maps the name of an llvm::Function to a DenseSet of VarIDs after an
    /// optimization pass has run.
    DenseMap<const Function *, DenseSet<VarID>> DebugVariablesAfter;
  };

  /// A stack of DebugVariables for every pass. A stack is used because an
  /// optimization pass can call other passes.
  SmallVector<DebugVariables> DebugVariablesStack;
