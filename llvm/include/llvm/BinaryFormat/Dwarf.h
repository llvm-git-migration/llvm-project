...
toDW_LNAME(SourceLanguage language) {
  ...
  case DW_LANG_C:
    return {{DW_LNAME_C, 0}};
  case DW_LANG_C89:
    return {{DW_LNAME_C, 198912}}; // FIXME: Look up the correct months.
  case DW_LANG_C99:
    return {{DW_LNAME_C, 199912}}; // FIXME: Look up the correct months.
  case DW_LANG_C11:
    return {{DW_LNAME_C, 201112}}; // FIXME: Look up the correct months.
  case DW_LANG_C17:
    return {{DW_LNAME_C, 201712}}; // FIXME: Look up the correct months.
