...
TEST(APIntTest, Average) {
  ...
  EXPECT_EQ(Ap0, APIntOps::avgFloorU(Ap0, Ap0));
  EXPECT_EQ(Ap0, APIntOps::avgCeilU(Ap0, Ap0));
  ...
  EXPECT_EQ(Ap0, APIntOps::avgFloorS(Ap0, Ap0));
  EXPECT_EQ(Ap0, APIntOps::avgCeilS(Ap0, Ap0));
