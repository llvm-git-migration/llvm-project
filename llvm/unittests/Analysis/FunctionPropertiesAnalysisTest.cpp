...
if.then:                                          ; preds = %entry
  ...
  ;call fastcc void @f2(ptr noundef %destatep, i32 noundef 39, i32 noundef 600)
...
sw.bb:                                            ; preds = %if.then
  ...
  ;call fastcc void @_ZL5BoostP19DetectEncodingStateii(ptr noundef %destatep, i32 noundef 56, i32 noundef 60)
  br label %if.end

sw.bb1:                                           ; preds = %if.then, %if.then
  call fastcc void @f2(ptr noundef %destatep, i32 noundef 56, i32 noundef 600) #34
  ;call fastcc void @_ZL5BoostP19DetectEncodingStateii(ptr noundef %destatep, i32 noundef 57, i32 noundef 60)
  br label %if.end
