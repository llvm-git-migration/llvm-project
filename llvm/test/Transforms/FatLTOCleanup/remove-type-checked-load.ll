...
; CHECK-NEXT:    [[TMP1:%.*]] = insertvalue { ptr, i1 } poison, ptr [[VFUNC]], 0
; CHECK-NEXT:    [[TMP2:%.*]] = insertvalue { ptr, i1 } [[TMP1]], i1 true, 1
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[VTABLE:%.*]] = load ptr, ptr [[P1]], align 8
; CHECK-NEXT:    [[VFUNC:%.*]] = call ptr @llvm.load.relative.i32(ptr [[VTABLE]], i32 0)
; CHECK-NEXT:    [[TMP1:%.*]] = insertvalue { ptr, i1 } poison, ptr [[VFUNC]], 0
; CHECK-NEXT:    [[TMP2:%.*]] = insertvalue { ptr, i1 } [[TMP1]], i1 true, 1
; CHECK-NEXT:    [[TMP3:%.*]] = extractvalue { ptr, i1 } [[TMP2]], 1
; CHECK-NEXT:    br i1 [[TMP3]], label %[[CONT2:.*]], label %[[TRAP1:.*]]
