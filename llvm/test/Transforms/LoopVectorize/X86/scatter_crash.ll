...
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT58:%.*]] = insertelement <8 x i1> poison, i1 [[TOBOOL6]], i64 0
; CHECK-NEXT:    [[BROADCAST_SPLAT73:%.*]] = shufflevector <8 x i1> [[BROADCAST_SPLATINSERT58]], <8 x i1> poison, <8 x i32> zeroinitializer
