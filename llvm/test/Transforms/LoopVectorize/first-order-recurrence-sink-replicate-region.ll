...
; CHECK-NEXT:   EMIT vp<{{.+}}> = extract-recurrence-resume ir<%0>
; CHECK-NEXT: No successors
; CHECK-NEXT: }
;
entry:
...
; CHECK-EMPTY:
; CHECK-NEXT: middle.block:
; CHECK-NEXT:   EMIT vp<{{.+}}> = extract-recurrence-resume ir<%recur>
; CHECK-NEXT: No successors
; CHECK-NEXT: }
;
entry:
...
; CHECK-EMPTY:
; CHECK-NEXT: middle.block:
; CHECK-NEXT:  EMIT vp<{{.+}}> = extract-recurrence-resume ir<%.pn>
; CHECK-NEXT: No successors
; CHECK-NEXT: }
;
entry:
