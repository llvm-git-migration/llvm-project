...
; VSCALEFORTUNING1: Cost for VF vscale x 2: 11 (Estimated cost per lane: 5.5)
; VSCALEFORTUNING1: Cost for VF vscale x 4: 11 (Estimated cost per lane: 2.8)
; VSCALEFORTUNING1: LV: Selecting VF: vscale x 16

; VSCALEFORTUNING2: Cost for VF vscale x 2: 11 (Estimated cost per lane: 2.8)
; VSCALEFORTUNING2: Cost for VF vscale x 4: 11 (Estimated cost per lane: 1.4)
; VSCALEFORTUNING2: LV: Selecting VF: vscale x 16

; NEOVERSEV2: Cost for VF vscale x 2: 11 (Estimated cost per lane: 5.5)
; NEOVERSEV2: Cost for VF vscale x 4: 11 (Estimated cost per lane: 2.8)
