...
; IF-EVL-NEXT:     vp<%7> = vector-pointer ir<%arrayidx>
; IF-EVL-NEXT:     WIDEN ir<%0> = vp.load vp<%7>, vp<%5>
; IF-EVL-NEXT:     WIDEN-CAST vp<%8> = vp.fpext ir<%0>, vp<%5>
; IF-EVL-NEXT:     CLONE ir<%arrayidx4> = getelementptr inbounds ir<%a>, vp<%6>
; IF-EVL-NEXT:     vp<%9> = vector-pointer ir<%arrayidx4>
; IF-EVL-NEXT:     WIDEN vp.store vp<%9>, vp<%8>, vp<%5>
; IF-EVL-NEXT:     SCALAR-CAST vp<%10> = zext vp<%5> to i64
...
; IF-EVL-NEXT:     vp<%7> = vector-pointer ir<%arrayidx>
; IF-EVL-NEXT:     WIDEN ir<%0> = vp.load vp<%7>, vp<%5>
; IF-EVL-NEXT:     WIDEN-CAST vp<%8> = vp.fptrunc ir<%0>, vp<%5>
; IF-EVL-NEXT:     CLONE ir<%arrayidx4> = getelementptr inbounds ir<%a>, vp<%6>
; IF-EVL-NEXT:     vp<%9> = vector-pointer ir<%arrayidx4>
; IF-EVL-NEXT:     WIDEN vp.store vp<%9>, vp<%8>, vp<%5>
; IF-EVL-NEXT:     SCALAR-CAST vp<%10> = zext vp<%5> to i64
...
; IF-EVL-NEXT:     vp<%7> = vector-pointer ir<%arrayidx>
; IF-EVL-NEXT:     WIDEN ir<%0> = vp.load vp<%7>, vp<%5>
; IF-EVL-NEXT:     WIDEN-CAST vp<%8> = vp.fptosi ir<%0>, vp<%5>
; IF-EVL-NEXT:     CLONE ir<%arrayidx4> = getelementptr inbounds ir<%a>, vp<%6>
; IF-EVL-NEXT:     vp<%9> = vector-pointer ir<%arrayidx4>
; IF-EVL-NEXT:     WIDEN vp.store vp<%9>, vp<%8>, vp<%5>
; IF-EVL-NEXT:     SCALAR-CAST vp<%10> = zext vp<%5> to i64
...
; IF-EVL-NEXT:     vp<%7> = vector-pointer ir<%arrayidx>
; IF-EVL-NEXT:     WIDEN ir<%0> = vp.load vp<%7>, vp<%5>
; IF-EVL-NEXT:     WIDEN-CAST vp<%8> = vp.fptoui ir<%0>, vp<%5>
; IF-EVL-NEXT:     CLONE ir<%arrayidx4> = getelementptr inbounds ir<%a>, vp<%6>
; IF-EVL-NEXT:     vp<%9> = vector-pointer ir<%arrayidx4>
; IF-EVL-NEXT:     WIDEN vp.store vp<%9>, vp<%8>, vp<%5>
; IF-EVL-NEXT:     SCALAR-CAST vp<%10> = zext vp<%5> to i64
...
; IF-EVL-NEXT:     vp<%7> = vector-pointer ir<%arrayidx>
; IF-EVL-NEXT:     WIDEN ir<%0> = vp.load vp<%7>, vp<%5>
; IF-EVL-NEXT:     WIDEN-CAST vp<%8> = vp.sitofp ir<%0>, vp<%5>
; IF-EVL-NEXT:     CLONE ir<%arrayidx4> = getelementptr inbounds ir<%a>, vp<%6>
; IF-EVL-NEXT:     vp<%9> = vector-pointer ir<%arrayidx4>
; IF-EVL-NEXT:     WIDEN vp.store vp<%9>, vp<%8>, vp<%5>
; IF-EVL-NEXT:     SCALAR-CAST vp<%10> = zext vp<%5> to i64
...
; IF-EVL-NEXT:     vp<%7> = vector-pointer ir<%arrayidx>
; IF-EVL-NEXT:     WIDEN ir<%0> = vp.load vp<%7>, vp<%5>
; IF-EVL-NEXT:     WIDEN-CAST vp<%8> = vp.uitofp ir<%0>, vp<%5>
; IF-EVL-NEXT:     CLONE ir<%arrayidx4> = getelementptr inbounds ir<%a>, vp<%6>
; IF-EVL-NEXT:     vp<%9> = vector-pointer ir<%arrayidx4>
; IF-EVL-NEXT:     WIDEN vp.store vp<%9>, vp<%8>, vp<%5>
; IF-EVL-NEXT:     SCALAR-CAST vp<%10> = zext vp<%5> to i64
