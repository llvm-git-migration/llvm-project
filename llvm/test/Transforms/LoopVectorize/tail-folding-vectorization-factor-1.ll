...
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[PTR1]], i64 [[TMP4]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[PTR1]], i64 [[TMP6]]
; CHECK-NEXT:    store double 0.000000e+00, ptr [[TMP7]], align 8
...
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[PTR1]], i64 [[TMP8]]
...
; CHECK-NEXT:    [[TMP10:%.*]] = add i64 [[OFFSET_IDX]], 24
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr i8, ptr [[PTR1]], i64 [[TMP10]]
