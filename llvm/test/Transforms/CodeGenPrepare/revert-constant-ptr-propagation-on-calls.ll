...
define available_externally dllimport ptr @getS_dllimport_function() {
entry:
  ret ptr @g_getS
}
...
; Cannot revert propagation due to non-unifrom returned constant.
define i32 @caller_2(i1 %cond) {
; CHECK-LABEL: @caller_2(
; CHECK-NEXT:    [[GETS_OR_GETX_PTR:%.*]] = call nonnull align 1 dereferenceable(1) ptr @getS_or_getX(i1 [[COND:%.*]])
; CHECK-NEXT:    [[GETI:%.*]] = call i32 @S_getI(ptr nonnull align 1 dereferenceable(1) @g_getS)
; CHECK-NEXT:    ret i32 [[GETI]]
;
  %getS_or_getX_ptr = call nonnull align 1 dereferenceable(1) ptr @getS_or_getX(i1 %cond)
  %getI = call i32 @S_getI(ptr nonnull align 1 dereferenceable(1) @g_getS)
  ret i32 %getI
}
...
; CHECK-NEXT:    [[GETS_PTR:%.*]] = call nonnull align 1 dereferenceable(1) ptr @getS_weak_function()
; CHECK-NEXT:    [[GETI:%.*]] = call i32 @S_getI(ptr nonnull align 1 dereferenceable(1) @g_getS)
; CHECK-NEXT:    ret i32 [[GETI]]
;
  %getS_ptr = call nonnull align 1 dereferenceable(1) ptr @getS_weak_function()
  %getI = call i32 @S_getI(ptr nonnull align 1 dereferenceable(1) @g_getS)
  ret i32 %getI
}
...
; CHECK-NEXT:    [[GETS_PTR:%.*]] = call nonnull align 1 dereferenceable(1) ptr @getS_dec()
; CHECK-NEXT:    [[GETI:%.*]] = call i32 @S_getI(ptr nonnull align 1 dereferenceable(1) @g_getS)
; CHECK-NEXT:    ret i32 [[GETI]]
;
  %getS_ptr = call nonnull align 1 dereferenceable(1) ptr @getS_dec()
  %getI = call i32 @S_getI(ptr nonnull align 1 dereferenceable(1) @g_getS)
  ret i32 %getI
}
...
; CHECK-NEXT:    [[GETS_PTR:%.*]] = call nonnull align 1 dereferenceable(1) ptr @getS_dllimport_function()
; CHECK-NEXT:    [[GETI:%.*]] = call i32 @S_getI(ptr nonnull align 1 dereferenceable(1) @g_getS)
; CHECK-NEXT:    ret i32 [[GETI]]
;
  %getS_ptr = call nonnull align 1 dereferenceable(1) ptr @getS_dllimport_function()
  %getI = call i32 @S_getI(ptr nonnull align 1 dereferenceable(1) @g_getS)
  ret i32 %getI
}
