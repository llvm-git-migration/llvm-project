...
; RUN: opt < %s -module-summary -passes='memprof-use<profile-filename=%t.memprofdata>' -S | FileCheck %s
...
; CHECK: ^1 = gv: (name: "_Z3fooi", summaries: {{.*}}(type: notcold, stackIds: (1985258834072910425, 1985258834072910425, 1985258834072910425, 1985258834072910425, 1985258834072910425, 1985258834072910425, 1985258834072910425, 1985258834072910425, 1985258834072910425, 8256520048276991898)){{.*}}
