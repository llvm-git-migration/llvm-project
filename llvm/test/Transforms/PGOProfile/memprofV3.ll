;; This tests backwards compatibility of memprof. Copy of memprof.ll, but with version 3 of binaries. 
...
;; Generate indexed profiles of all combinations:a
; RUN: llvm-profdata merge %S/Inputs/memprof_v3.memprofraw --profiled-binary %S/Inputs/memprof_v3.exe -o %t.memprofdata
; RUN: llvm-profdata merge %S/Inputs/memprof_pgo.proftext %S/Inputs/memprof_v3.memprofraw --profiled-binary %S/Inputs/memprof_v3.exe -o %t.pgomemprofdata
; RUN: llvm-profdata merge %S/Inputs/memprof_pgo.proftext -o %t.pgoprofdata
; RUN: llvm-profdata merge %S/Inputs/memprof_v3.nocolinfo.memprofraw --profiled-binary %S/Inputs/memprof_v3.nocolinfo.exe -o %t.nocolinfo.memprofdata
