...
; CHECK-NEXT:    [[CMP:%.*]] = icmp ult i32 [[X:%.*]], -7
; CHECK-NEXT:    [[ADD:%.*]] = add nuw i32 [[X]], 9
; CHECK-NEXT:    [[COND:%.*]] = select i1 [[CMP]], i32 [[ADD]], i32 -1
; CHECK-NEXT:    ret i32 [[COND]]
;
  %cmp = icmp ule i32 %x, -8
  %add = add nuw i32 %x, 9
  %cond = select i1 %cmp, i32 %add, i32 -1
  ret i32 %cond
}
...
define i32 @uadd_sat_flipped6_neg_no_nuw(i32 %x) {
; CHECK-LABEL: @uadd_sat_flipped6_neg_no_nuw(
; CHECK-NEXT:    [[CMP:%.*]] = icmp ult i32 [[X:%.*]], -7
; CHECK-NEXT:    [[ADD:%.*]] = add i32 [[X]], 9
; CHECK-NEXT:    [[COND:%.*]] = select i1 [[CMP]], i32 [[ADD]], i32 -1
; CHECK-NEXT:    ret i32 [[COND]]
...
define i32 @uadd_sat_flipped7_neg_no_nuw(i32 %x) {
; CHECK-LABEL: @uadd_sat_flipped7_neg_no_nuw(
; CHECK-NEXT:    [[CMP:%.*]] = icmp ugt i32 [[X:%.*]], -9
; CHECK-NEXT:    [[ADD:%.*]] = add i32 [[X]], 9
; CHECK-NEXT:    [[COND:%.*]] = select i1 [[CMP]], i32 -1, i32 [[ADD]]
; CHECK-NEXT:    ret i32 [[COND]]
...
define i32 @uadd_sat_flipped8_neg_no_nuw(i32 %x) {
; CHECK-LABEL: @uadd_sat_flipped8_neg_no_nuw(
; CHECK-NEXT:    [[CMP:%.*]] = icmp ugt i32 [[X:%.*]], -9
; CHECK-NEXT:    [[ADD:%.*]] = add i32 [[X]], 9
; CHECK-NEXT:    [[COND:%.*]] = select i1 [[CMP]], i32 -1, i32 [[ADD]]
; CHECK-NEXT:    ret i32 [[COND]]
