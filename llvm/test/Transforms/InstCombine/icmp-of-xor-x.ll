...
; X s< X^Neg_C --> X s< 0
define <2 x i1> @src_slt_xnx_to_slt_0_i8_vec_allone(<2 x i8> %x) {
; CHECK-LABEL: @src_slt_xnx_to_slt_0_i8_vec_allone(
...
define <2 x i1> @src_slt_xnx_to_slt_0_i8_vec_min(<2 x i8> %x) {
; CHECK-LABEL: @src_slt_xnx_to_slt_0_i8_vec_min(
...
; X s> X^Neg_C  -->  X s> -1
define <2 x i1> @src_sgt_xnx_to_sgt_n1_i8_vec_allone(<2 x i8> %x) {
; CHECK-LABEL: @src_sgt_xnx_to_sgt_n1_i8_vec_allone(
; CHECK-NEXT:    [[NOT:%.*]] = xor <2 x i8> [[X:%.*]], <i8 -1, i8 -1>
...
define <2 x i1> @src_sgt_xnx_to_sgt_n1_i8_vec_min(<2 x i8> %x) {
; CHECK-LABEL: @src_sgt_xnx_to_sgt_n1_i8_vec_min(
; CHECK-NEXT:    [[NOT:%.*]] = xor <2 x i8> [[X:%.*]], <i8 -128, i8 -128>
; CHECK-NEXT:    [[CMP:%.*]] = icmp slt <2 x i8> [[NOT]], [[X]]
; CHECK-NEXT:    ret <2 x i1> [[CMP]]
;
...
define <2 x i1> @src_sle_xnx_to_slt_0_i8_vec_allone(<2 x i8> %x) {
; CHECK-LABEL: @src_sle_xnx_to_slt_0_i8_vec_allone(
; CHECK-NEXT:    [[NOT:%.*]] = xor <2 x i8> [[X:%.*]], <i8 -1, i8 -1>
; CHECK-NEXT:    [[CMP:%.*]] = icmp sgt <2 x i8> [[NOT]], [[X]]
; CHECK-NEXT:    ret <2 x i1> [[CMP]]
;
...
define <2 x i1> @src_sle_xnx_to_slt_0_i8_vec_min(<2 x i8> %x) {
; CHECK-LABEL: @src_sle_xnx_to_slt_0_i8_vec_min(
; CHECK-NEXT:    [[NOT:%.*]] = xor <2 x i8> [[X:%.*]], <i8 -128, i8 -128>
; CHECK-NEXT:    [[CMP:%.*]] = icmp sgt <2 x i8> [[NOT]], [[X]]
; CHECK-NEXT:    ret <2 x i1> [[CMP]]
;
...
define <2 x i1> @src_sge_xnx_to_sgt_n1_i8_vec_allone(<2 x i8> %x) {
; CHECK-LABEL: @src_sge_xnx_to_sgt_n1_i8_vec_allone(
; CHECK-NEXT:    [[NOT:%.*]] = xor <2 x i8> [[X:%.*]], <i8 -1, i8 -1>
; CHECK-NEXT:    [[CMP:%.*]] = icmp slt <2 x i8> [[NOT]], [[X]]
; CHECK-NEXT:    ret <2 x i1> [[CMP]]
;
...
define <2 x i1> @src_sge_xnx_to_sgt_n1_i8_vec_min(<2 x i8> %x) {
; CHECK-LABEL: @src_sge_xnx_to_sgt_n1_i8_vec_min(
; CHECK-NEXT:    [[NOT:%.*]] = xor <2 x i8> [[X:%.*]], <i8 -128, i8 -128>
; CHECK-NEXT:    [[CMP:%.*]] = icmp slt <2 x i8> [[NOT]], [[X]]
; CHECK-NEXT:    ret <2 x i1> [[CMP]]
;
