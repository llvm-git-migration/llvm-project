...
; CHECK-NEXT:    [[TMP1:%.*]] = shl i32 [[N:%.*]], 1
; CHECK-NEXT:    [[RES:%.*]] = and i32 [[TMP1]], -4
; CHECK-NEXT:    [[OV_INV:%.*]] = icmp sgt i32 [[N]], -1
; CHECK-NEXT:    [[RET:%.*]] = select i1 [[OV_INV]], i32 [[RES]], i32 -1
...
; CHECK-NEXT:    ret { <4 x i8>, <4 x i1> } { <4 x i8> splat (i8 -128), <4 x i1> <i1 true, i1 true, i1 true, i1 true> }
;
...
; CHECK-NEXT:    ret { <4 x i8>, <4 x i1> } { <4 x i8> splat (i8 127), <4 x i1> <i1 true, i1 true, i1 true, i1 true> }
;
...
; CHECK-NEXT:    ret { <4 x i8>, <4 x i1> } { <4 x i8> splat (i8 -1), <4 x i1> <i1 true, i1 true, i1 true, i1 true> }
;
...
; CHECK-NEXT:    ret { <4 x i8>, <4 x i1> } { <4 x i8> splat (i8 -3), <4 x i1> <i1 true, i1 true, i1 true, i1 true> }
;
