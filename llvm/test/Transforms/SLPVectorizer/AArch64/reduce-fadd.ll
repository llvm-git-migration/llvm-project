...
;
; NEOV2-LABEL: define half @reduce_fast_half2(
; NEOV2-SAME: <2 x half> [[VEC2:%.*]]) #[[ATTR0:[0-9]+]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT0:%.*]] = extractelement <2 x half> [[VEC2]], i64 0
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <2 x half> [[VEC2]], i64 1
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd fast half [[ELT1]], [[ELT0]]
; NEOV2-NEXT:    ret half [[ADD1]]
;
entry:
...
; CHECK-NEXT:    ret half [[ADD1]]
;
; NEOV2-LABEL: define half @reduce_half2(
; NEOV2-SAME: <2 x half> [[VEC2:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT0:%.*]] = extractelement <2 x half> [[VEC2]], i64 0
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <2 x half> [[VEC2]], i64 1
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd half [[ELT1]], [[ELT0]]
; NEOV2-NEXT:    ret half [[ADD1]]
;
entry:
  %elt0 = extractelement <2 x half> %vec2, i64 0
...
; CHECK-SAME: <4 x half> [[VEC4:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call fast half @llvm.vector.reduce.fadd.v4f16(half 0xH8000, <4 x half> [[VEC4]])
; CHECK-NEXT:    ret half [[TMP0]]
;
; NEOV2-LABEL: define half @reduce_fast_half4(
; NEOV2-SAME: <4 x half> [[VEC4:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[TMP0:%.*]] = call fast half @llvm.vector.reduce.fadd.v4f16(half 0xH8000, <4 x half> [[VEC4]])
; NEOV2-NEXT:    ret half [[TMP0]]
;
entry:
...
;
; NEOV2-LABEL: define half @reduce_half4(
; NEOV2-SAME: <4 x half> [[VEC4:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT0:%.*]] = extractelement <4 x half> [[VEC4]], i64 0
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <4 x half> [[VEC4]], i64 1
; NEOV2-NEXT:    [[ELT2:%.*]] = extractelement <4 x half> [[VEC4]], i64 2
; NEOV2-NEXT:    [[ELT3:%.*]] = extractelement <4 x half> [[VEC4]], i64 3
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd half [[ELT1]], [[ELT0]]
; NEOV2-NEXT:    [[ADD2:%.*]] = fadd half [[ELT2]], [[ADD1]]
; NEOV2-NEXT:    [[ADD3:%.*]] = fadd half [[ELT3]], [[ADD2]]
; NEOV2-NEXT:    ret half [[ADD3]]
;
entry:
  %elt0 = extractelement <4 x half> %vec4, i64 0
  %elt1 = extractelement <4 x half> %vec4, i64 1
...
;
; NEOV2-LABEL: define half @reduce_fast_half8(
; NEOV2-SAME: <8 x half> [[VEC8:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT4:%.*]] = extractelement <8 x half> [[VEC8]], i64 4
; NEOV2-NEXT:    [[ELT5:%.*]] = extractelement <8 x half> [[VEC8]], i64 5
; NEOV2-NEXT:    [[ELT6:%.*]] = extractelement <8 x half> [[VEC8]], i64 6
; NEOV2-NEXT:    [[ELT7:%.*]] = extractelement <8 x half> [[VEC8]], i64 7
; NEOV2-NEXT:    [[TMP0:%.*]] = shufflevector <8 x half> [[VEC8]], <8 x half> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; NEOV2-NEXT:    [[TMP1:%.*]] = call fast half @llvm.vector.reduce.fadd.v4f16(half 0xH8000, <4 x half> [[TMP0]])
; NEOV2-NEXT:    [[OP_RDX:%.*]] = fadd fast half [[TMP1]], [[ELT4]]
; NEOV2-NEXT:    [[OP_RDX1:%.*]] = fadd fast half [[ELT5]], [[ELT6]]
; NEOV2-NEXT:    [[OP_RDX2:%.*]] = fadd fast half [[OP_RDX]], [[OP_RDX1]]
; NEOV2-NEXT:    [[OP_RDX3:%.*]] = fadd fast half [[OP_RDX2]], [[ELT7]]
; NEOV2-NEXT:    ret half [[OP_RDX3]]
;
entry:
...
;
; NEOV2-LABEL: define half @reduce_half8(
; NEOV2-SAME: <8 x half> [[VEC8:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT0:%.*]] = extractelement <8 x half> [[VEC8]], i64 0
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <8 x half> [[VEC8]], i64 1
; NEOV2-NEXT:    [[ELT2:%.*]] = extractelement <8 x half> [[VEC8]], i64 2
; NEOV2-NEXT:    [[ELT3:%.*]] = extractelement <8 x half> [[VEC8]], i64 3
; NEOV2-NEXT:    [[ELT4:%.*]] = extractelement <8 x half> [[VEC8]], i64 4
; NEOV2-NEXT:    [[ELT5:%.*]] = extractelement <8 x half> [[VEC8]], i64 5
; NEOV2-NEXT:    [[ELT6:%.*]] = extractelement <8 x half> [[VEC8]], i64 6
; NEOV2-NEXT:    [[ELT7:%.*]] = extractelement <8 x half> [[VEC8]], i64 7
...
; NEOV2-NEXT:    [[ADD2:%.*]] = fadd half [[ELT2]], [[ADD1]]
; NEOV2-NEXT:    [[ADD3:%.*]] = fadd half [[ELT3]], [[ADD2]]
; NEOV2-NEXT:    [[ADD4:%.*]] = fadd half [[ELT4]], [[ADD3]]
; NEOV2-NEXT:    [[ADD5:%.*]] = fadd half [[ELT5]], [[ADD4]]
; NEOV2-NEXT:    [[ADD6:%.*]] = fadd half [[ELT6]], [[ADD5]]
; NEOV2-NEXT:    [[ADD7:%.*]] = fadd half [[ELT7]], [[ADD6]]
; NEOV2-NEXT:    ret half [[ADD7]]
;
entry:
  %elt0 = extractelement <8 x half> %vec8, i64 0
  %elt1 = extractelement <8 x half> %vec8, i64 1
...
; CHECK-SAME: <16 x half> [[VEC16:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[OP_RDX8:%.*]] = call fast half @llvm.vector.reduce.fadd.v16f16(half 0xH8000, <16 x half> [[VEC16]])
; CHECK-NEXT:    ret half [[OP_RDX8]]
;
; NEOV2-LABEL: define half @reduce_fast_half16(
; NEOV2-SAME: <16 x half> [[VEC16:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT4:%.*]] = extractelement <16 x half> [[VEC16]], i64 4
; NEOV2-NEXT:    [[ELT5:%.*]] = extractelement <16 x half> [[VEC16]], i64 5
; NEOV2-NEXT:    [[ELT6:%.*]] = extractelement <16 x half> [[VEC16]], i64 6
; NEOV2-NEXT:    [[ELT7:%.*]] = extractelement <16 x half> [[VEC16]], i64 7
; NEOV2-NEXT:    [[ELT12:%.*]] = extractelement <16 x half> [[VEC16]], i64 12
; NEOV2-NEXT:    [[ELT13:%.*]] = extractelement <16 x half> [[VEC16]], i64 13
; NEOV2-NEXT:    [[ELT14:%.*]] = extractelement <16 x half> [[VEC16]], i64 14
; NEOV2-NEXT:    [[ELT15:%.*]] = extractelement <16 x half> [[VEC16]], i64 15
; NEOV2-NEXT:    [[TMP0:%.*]] = shufflevector <16 x half> [[VEC16]], <16 x half> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; NEOV2-NEXT:    [[TMP1:%.*]] = call fast half @llvm.vector.reduce.fadd.v4f16(half 0xH8000, <4 x half> [[TMP0]])
; NEOV2-NEXT:    [[TMP2:%.*]] = shufflevector <16 x half> [[VEC16]], <16 x half> poison, <4 x i32> <i32 8, i32 9, i32 10, i32 11>
; NEOV2-NEXT:    [[TMP3:%.*]] = call fast half @llvm.vector.reduce.fadd.v4f16(half 0xH8000, <4 x half> [[TMP2]])
; NEOV2-NEXT:    [[OP_RDX:%.*]] = fadd fast half [[TMP1]], [[TMP3]]
; NEOV2-NEXT:    [[OP_RDX1:%.*]] = fadd fast half [[OP_RDX]], [[ELT4]]
; NEOV2-NEXT:    [[OP_RDX2:%.*]] = fadd fast half [[ELT5]], [[ELT6]]
; NEOV2-NEXT:    [[OP_RDX3:%.*]] = fadd fast half [[ELT7]], [[ELT12]]
; NEOV2-NEXT:    [[OP_RDX4:%.*]] = fadd fast half [[ELT13]], [[ELT14]]
; NEOV2-NEXT:    [[OP_RDX5:%.*]] = fadd fast half [[OP_RDX1]], [[OP_RDX2]]
; NEOV2-NEXT:    [[OP_RDX6:%.*]] = fadd fast half [[OP_RDX3]], [[OP_RDX4]]
; NEOV2-NEXT:    [[OP_RDX7:%.*]] = fadd fast half [[OP_RDX5]], [[OP_RDX6]]
; NEOV2-NEXT:    [[OP_RDX8:%.*]] = fadd fast half [[OP_RDX7]], [[ELT15]]
; NEOV2-NEXT:    ret half [[OP_RDX8]]
;
entry:
...
;
; NEOV2-LABEL: define half @reduce_half16(
; NEOV2-SAME: <16 x half> [[VEC16:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT0:%.*]] = extractelement <16 x half> [[VEC16]], i64 0
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <16 x half> [[VEC16]], i64 1
; NEOV2-NEXT:    [[ELT2:%.*]] = extractelement <16 x half> [[VEC16]], i64 2
; NEOV2-NEXT:    [[ELT3:%.*]] = extractelement <16 x half> [[VEC16]], i64 3
; NEOV2-NEXT:    [[ELT4:%.*]] = extractelement <16 x half> [[VEC16]], i64 4
; NEOV2-NEXT:    [[ELT5:%.*]] = extractelement <16 x half> [[VEC16]], i64 5
; NEOV2-NEXT:    [[ELT6:%.*]] = extractelement <16 x half> [[VEC16]], i64 6
; NEOV2-NEXT:    [[ELT7:%.*]] = extractelement <16 x half> [[VEC16]], i64 7
; NEOV2-NEXT:    [[ELT8:%.*]] = extractelement <16 x half> [[VEC16]], i64 8
; NEOV2-NEXT:    [[ELT9:%.*]] = extractelement <16 x half> [[VEC16]], i64 9
; NEOV2-NEXT:    [[ELT10:%.*]] = extractelement <16 x half> [[VEC16]], i64 10
; NEOV2-NEXT:    [[ELT11:%.*]] = extractelement <16 x half> [[VEC16]], i64 11
; NEOV2-NEXT:    [[ELT12:%.*]] = extractelement <16 x half> [[VEC16]], i64 12
; NEOV2-NEXT:    [[ELT13:%.*]] = extractelement <16 x half> [[VEC16]], i64 13
; NEOV2-NEXT:    [[ELT14:%.*]] = extractelement <16 x half> [[VEC16]], i64 14
; NEOV2-NEXT:    [[ELT15:%.*]] = extractelement <16 x half> [[VEC16]], i64 15
...
; NEOV2-NEXT:    [[ADD6:%.*]] = fadd half [[ELT6]], [[ADD5]]
; NEOV2-NEXT:    [[ADD7:%.*]] = fadd half [[ELT7]], [[ADD6]]
; NEOV2-NEXT:    [[ADD8:%.*]] = fadd half [[ELT8]], [[ADD7]]
; NEOV2-NEXT:    [[ADD9:%.*]] = fadd half [[ELT9]], [[ADD8]]
; NEOV2-NEXT:    [[ADD10:%.*]] = fadd half [[ELT10]], [[ADD9]]
; NEOV2-NEXT:    [[ADD11:%.*]] = fadd half [[ELT11]], [[ADD10]]
; NEOV2-NEXT:    [[ADD12:%.*]] = fadd half [[ELT12]], [[ADD11]]
; NEOV2-NEXT:    [[ADD13:%.*]] = fadd half [[ELT13]], [[ADD12]]
; NEOV2-NEXT:    [[ADD14:%.*]] = fadd half [[ELT14]], [[ADD13]]
; NEOV2-NEXT:    [[ADD15:%.*]] = fadd half [[ELT15]], [[ADD14]]
; NEOV2-NEXT:    ret half [[ADD15]]
;
entry:
  %elt0 = extractelement <16 x half> %vec16, i64 0
  %elt1 = extractelement <16 x half> %vec16, i64 1
...
;
; NEOV2-LABEL: define float @reduce_fast_float2(
; NEOV2-SAME: <2 x float> [[VEC2:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT0:%.*]] = extractelement <2 x float> [[VEC2]], i64 0
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <2 x float> [[VEC2]], i64 1
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd fast float [[ELT1]], [[ELT0]]
; NEOV2-NEXT:    ret float [[ADD1]]
;
entry:
...
; CHECK-NEXT:    ret float [[ADD1]]
;
; NEOV2-LABEL: define float @reduce_float2(
; NEOV2-SAME: <2 x float> [[VEC2:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT0:%.*]] = extractelement <2 x float> [[VEC2]], i64 0
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <2 x float> [[VEC2]], i64 1
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd float [[ELT1]], [[ELT0]]
; NEOV2-NEXT:    ret float [[ADD1]]
;
entry:
  %elt0 = extractelement <2 x float> %vec2, i64 0
...
; CHECK-SAME: <4 x float> [[VEC4:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call fast float @llvm.vector.reduce.fadd.v4f32(float -0.000000e+00, <4 x float> [[VEC4]])
; CHECK-NEXT:    ret float [[TMP0]]
;
; NEOV2-LABEL: define float @reduce_fast_float4(
; NEOV2-SAME: <4 x float> [[VEC4:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[TMP0:%.*]] = call fast float @llvm.vector.reduce.fadd.v4f32(float -0.000000e+00, <4 x float> [[VEC4]])
; NEOV2-NEXT:    ret float [[TMP0]]
;
entry:
...
;
; NEOV2-LABEL: define float @reduce_float4(
; NEOV2-SAME: <4 x float> [[VEC4:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT0:%.*]] = extractelement <4 x float> [[VEC4]], i64 0
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <4 x float> [[VEC4]], i64 1
; NEOV2-NEXT:    [[ELT2:%.*]] = extractelement <4 x float> [[VEC4]], i64 2
; NEOV2-NEXT:    [[ELT3:%.*]] = extractelement <4 x float> [[VEC4]], i64 3
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd float [[ELT1]], [[ELT0]]
; NEOV2-NEXT:    [[ADD2:%.*]] = fadd float [[ELT2]], [[ADD1]]
; NEOV2-NEXT:    [[ADD3:%.*]] = fadd float [[ELT3]], [[ADD2]]
; NEOV2-NEXT:    ret float [[ADD3]]
;
entry:
  %elt0 = extractelement <4 x float> %vec4, i64 0
  %elt1 = extractelement <4 x float> %vec4, i64 1
...
; CHECK-SAME: <8 x float> [[VEC8:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call fast float @llvm.vector.reduce.fadd.v8f32(float -0.000000e+00, <8 x float> [[VEC8]])
; CHECK-NEXT:    ret float [[TMP0]]
;
; NEOV2-LABEL: define float @reduce_fast_float8(
; NEOV2-SAME: <8 x float> [[VEC8:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[TMP0:%.*]] = call fast float @llvm.vector.reduce.fadd.v8f32(float -0.000000e+00, <8 x float> [[VEC8]])
; NEOV2-NEXT:    ret float [[TMP0]]
;
entry:
...
;
; NEOV2-LABEL: define float @reduce_float8(
; NEOV2-SAME: <8 x float> [[VEC8:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT0:%.*]] = extractelement <8 x float> [[VEC8]], i64 0
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <8 x float> [[VEC8]], i64 1
; NEOV2-NEXT:    [[ELT2:%.*]] = extractelement <8 x float> [[VEC8]], i64 2
; NEOV2-NEXT:    [[ELT3:%.*]] = extractelement <8 x float> [[VEC8]], i64 3
; NEOV2-NEXT:    [[ELT4:%.*]] = extractelement <8 x float> [[VEC8]], i64 4
; NEOV2-NEXT:    [[ELT5:%.*]] = extractelement <8 x float> [[VEC8]], i64 5
; NEOV2-NEXT:    [[ELT6:%.*]] = extractelement <8 x float> [[VEC8]], i64 6
; NEOV2-NEXT:    [[ELT7:%.*]] = extractelement <8 x float> [[VEC8]], i64 7
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd float [[ELT1]], [[ELT0]]
; NEOV2-NEXT:    [[ADD2:%.*]] = fadd float [[ELT2]], [[ADD1]]
; NEOV2-NEXT:    [[ADD3:%.*]] = fadd float [[ELT3]], [[ADD2]]
; NEOV2-NEXT:    [[ADD4:%.*]] = fadd float [[ELT4]], [[ADD3]]
; NEOV2-NEXT:    [[ADD5:%.*]] = fadd float [[ELT5]], [[ADD4]]
; NEOV2-NEXT:    [[ADD6:%.*]] = fadd float [[ELT6]], [[ADD5]]
; NEOV2-NEXT:    [[ADD7:%.*]] = fadd float [[ELT7]], [[ADD6]]
; NEOV2-NEXT:    ret float [[ADD7]]
;
entry:
  %elt0 = extractelement <8 x float> %vec8, i64 0
  %elt1 = extractelement <8 x float> %vec8, i64 1
...
;
; NEOV2-LABEL: define double @reduce_fast_double2(
; NEOV2-SAME: <2 x double> [[VEC2:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT0:%.*]] = extractelement <2 x double> [[VEC2]], i64 0
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <2 x double> [[VEC2]], i64 1
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd fast double [[ELT1]], [[ELT0]]
; NEOV2-NEXT:    ret double [[ADD1]]
;
entry:
...
; CHECK-NEXT:    ret double [[ADD1]]
;
; NEOV2-LABEL: define double @reduce_double2(
; NEOV2-SAME: <2 x double> [[VEC2:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT0:%.*]] = extractelement <2 x double> [[VEC2]], i64 0
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <2 x double> [[VEC2]], i64 1
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd double [[ELT1]], [[ELT0]]
; NEOV2-NEXT:    ret double [[ADD1]]
;
entry:
  %elt0 = extractelement <2 x double> %vec2, i64 0
...
; CHECK-SAME: <4 x double> [[VEC4:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call fast double @llvm.vector.reduce.fadd.v4f64(double -0.000000e+00, <4 x double> [[VEC4]])
; CHECK-NEXT:    ret double [[TMP0]]
;
; NEOV2-LABEL: define double @reduce_fast_double4(
; NEOV2-SAME: <4 x double> [[VEC4:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[TMP0:%.*]] = call fast double @llvm.vector.reduce.fadd.v4f64(double -0.000000e+00, <4 x double> [[VEC4]])
; NEOV2-NEXT:    ret double [[TMP0]]
;
entry:
...
;
; NEOV2-LABEL: define double @reduce_double4(
; NEOV2-SAME: <4 x double> [[VEC4:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ELT0:%.*]] = extractelement <4 x double> [[VEC4]], i64 0
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <4 x double> [[VEC4]], i64 1
; NEOV2-NEXT:    [[ELT2:%.*]] = extractelement <4 x double> [[VEC4]], i64 2
; NEOV2-NEXT:    [[ELT3:%.*]] = extractelement <4 x double> [[VEC4]], i64 3
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd double [[ELT1]], [[ELT0]]
; NEOV2-NEXT:    [[ADD2:%.*]] = fadd double [[ELT2]], [[ADD1]]
; NEOV2-NEXT:    [[ADD3:%.*]] = fadd double [[ELT3]], [[ADD2]]
; NEOV2-NEXT:    ret double [[ADD3]]
;
entry:
  %elt0 = extractelement <4 x double> %vec4, i64 0
  %elt1 = extractelement <4 x double> %vec4, i64 1
...
;
; NEOV2-LABEL: define float @reduce_fast_float_case1(
; NEOV2-SAME: ptr [[A:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[LOAD:%.*]] = load float, ptr [[A]], align 4
; NEOV2-NEXT:    [[GEP:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 4
; NEOV2-NEXT:    [[LOAD1:%.*]] = load float, ptr [[GEP]], align 4
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd fast float [[LOAD1]], [[LOAD]]
; NEOV2-NEXT:    [[GEP2:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 8
; NEOV2-NEXT:    [[LOAD2:%.*]] = load float, ptr [[GEP2]], align 4
; NEOV2-NEXT:    [[ADD2:%.*]] = fadd fast float [[LOAD2]], [[ADD1]]
; NEOV2-NEXT:    [[GEP3:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 12
; NEOV2-NEXT:    [[LOAD3:%.*]] = load float, ptr [[GEP3]], align 4
; NEOV2-NEXT:    [[ADD3:%.*]] = fadd fast float [[LOAD3]], [[ADD2]]
; NEOV2-NEXT:    [[GEP4:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 16
; NEOV2-NEXT:    [[LOAD4:%.*]] = load float, ptr [[GEP4]], align 4
; NEOV2-NEXT:    [[ADD4:%.*]] = fadd fast float [[LOAD4]], [[ADD3]]
; NEOV2-NEXT:    ret float [[ADD4]]
;
entry:
...
; CHECK-NEXT:    ret float [[ADD4]]
;
; NEOV2-LABEL: define float @reduce_float_case1(
; NEOV2-SAME: ptr [[A:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[LOAD:%.*]] = load float, ptr [[A]], align 4
; NEOV2-NEXT:    [[GEP:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 4
; NEOV2-NEXT:    [[LOAD1:%.*]] = load float, ptr [[GEP]], align 4
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd float [[LOAD1]], [[LOAD]]
; NEOV2-NEXT:    [[GEP2:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 8
; NEOV2-NEXT:    [[LOAD2:%.*]] = load float, ptr [[GEP2]], align 4
; NEOV2-NEXT:    [[ADD2:%.*]] = fadd float [[LOAD2]], [[ADD1]]
; NEOV2-NEXT:    [[GEP3:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 12
; NEOV2-NEXT:    [[LOAD3:%.*]] = load float, ptr [[GEP3]], align 4
; NEOV2-NEXT:    [[ADD3:%.*]] = fadd float [[LOAD3]], [[ADD2]]
; NEOV2-NEXT:    [[GEP4:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 16
; NEOV2-NEXT:    [[LOAD4:%.*]] = load float, ptr [[GEP4]], align 4
; NEOV2-NEXT:    [[ADD4:%.*]] = fadd float [[LOAD4]], [[ADD3]]
; NEOV2-NEXT:    ret float [[ADD4]]
;
entry:
  %load = load float, ptr %a
...
;
; NEOV2-LABEL: define float @reduce_fast_float_case2(
; NEOV2-SAME: ptr [[A:%.*]], ptr [[B:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[GEPA2:%.*]] = getelementptr inbounds float, ptr [[A]], i32 2
; NEOV2-NEXT:    [[GEPA3:%.*]] = getelementptr inbounds float, ptr [[A]], i32 3
; NEOV2-NEXT:    [[GEPB2:%.*]] = getelementptr inbounds float, ptr [[B]], i32 2
; NEOV2-NEXT:    [[GEPB3:%.*]] = getelementptr inbounds float, ptr [[B]], i32 3
; NEOV2-NEXT:    [[LOADA2:%.*]] = load float, ptr [[GEPA2]], align 4
; NEOV2-NEXT:    [[LOADA3:%.*]] = load float, ptr [[GEPA3]], align 4
; NEOV2-NEXT:    [[LOADB2:%.*]] = load float, ptr [[GEPB2]], align 4
; NEOV2-NEXT:    [[LOADB3:%.*]] = load float, ptr [[GEPB3]], align 4
; NEOV2-NEXT:    [[TMP0:%.*]] = load <2 x float>, ptr [[A]], align 4
; NEOV2-NEXT:    [[TMP1:%.*]] = load <2 x float>, ptr [[B]], align 4
; NEOV2-NEXT:    [[TMP2:%.*]] = fadd fast <2 x float> [[TMP0]], [[TMP1]]
; NEOV2-NEXT:    [[ADD2:%.*]] = fadd fast float [[LOADA3]], [[LOADB2]]
; NEOV2-NEXT:    [[ADD3:%.*]] = fadd fast float [[LOADA2]], [[LOADB3]]
; NEOV2-NEXT:    [[TMP3:%.*]] = extractelement <2 x float> [[TMP2]], i32 0
; NEOV2-NEXT:    [[TMP4:%.*]] = extractelement <2 x float> [[TMP2]], i32 1
; NEOV2-NEXT:    [[RED1:%.*]] = fadd fast float [[TMP3]], [[TMP4]]
; NEOV2-NEXT:    [[RED2:%.*]] = fadd fast float [[ADD2]], [[RED1]]
; NEOV2-NEXT:    [[RED3:%.*]] = fadd fast float [[ADD3]], [[RED2]]
; NEOV2-NEXT:    ret float [[RED3]]
;
entry:
...
; CHECK-NEXT:    ret float [[RED3]]
;
; NEOV2-LABEL: define float @reduce_float_case2(
; NEOV2-SAME: ptr [[A:%.*]], ptr [[B:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[GEPA2:%.*]] = getelementptr inbounds float, ptr [[A]], i32 2
; NEOV2-NEXT:    [[GEPA3:%.*]] = getelementptr inbounds float, ptr [[A]], i32 3
...
; NEOV2-NEXT:    [[TMP0:%.*]] = load <2 x float>, ptr [[A]], align 4
; NEOV2-NEXT:    [[TMP1:%.*]] = load <2 x float>, ptr [[B]], align 4
; NEOV2-NEXT:    [[TMP2:%.*]] = fadd <2 x float> [[TMP0]], [[TMP1]]
; NEOV2-NEXT:    [[ADD2:%.*]] = fadd float [[LOADA3]], [[LOADB2]]
; NEOV2-NEXT:    [[ADD3:%.*]] = fadd float [[LOADA2]], [[LOADB3]]
; NEOV2-NEXT:    [[TMP3:%.*]] = extractelement <2 x float> [[TMP2]], i32 0
; NEOV2-NEXT:    [[TMP4:%.*]] = extractelement <2 x float> [[TMP2]], i32 1
; NEOV2-NEXT:    [[RED1:%.*]] = fadd float [[TMP3]], [[TMP4]]
; NEOV2-NEXT:    [[RED2:%.*]] = fadd float [[ADD2]], [[RED1]]
; NEOV2-NEXT:    [[RED3:%.*]] = fadd float [[ADD3]], [[RED2]]
; NEOV2-NEXT:    ret float [[RED3]]
;
entry:
  %gepa1 = getelementptr inbounds float, ptr %a, i32 1
...
; CHECK-NEXT:    ret float [[ADD7]]
;
; NEOV2-LABEL: define float @reduce_fast_float_case3(
; NEOV2-SAME: ptr [[A:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[GEP1:%.*]] = getelementptr inbounds float, ptr [[A]], i32 1
; NEOV2-NEXT:    [[GEP2:%.*]] = getelementptr inbounds float, ptr [[A]], i32 2
; NEOV2-NEXT:    [[GEP3:%.*]] = getelementptr inbounds float, ptr [[A]], i32 3
; NEOV2-NEXT:    [[GEP4:%.*]] = getelementptr inbounds float, ptr [[A]], i32 4
; NEOV2-NEXT:    [[GEP5:%.*]] = getelementptr inbounds float, ptr [[A]], i32 5
; NEOV2-NEXT:    [[GEP6:%.*]] = getelementptr inbounds float, ptr [[A]], i32 6
; NEOV2-NEXT:    [[GEP7:%.*]] = getelementptr inbounds float, ptr [[A]], i32 7
; NEOV2-NEXT:    [[LOAD:%.*]] = load float, ptr [[A]], align 4
; NEOV2-NEXT:    [[LOAD1:%.*]] = load float, ptr [[GEP1]], align 4
; NEOV2-NEXT:    [[LOAD2:%.*]] = load float, ptr [[GEP2]], align 4
; NEOV2-NEXT:    [[LOAD3:%.*]] = load float, ptr [[GEP3]], align 4
; NEOV2-NEXT:    [[LOAD4:%.*]] = load float, ptr [[GEP4]], align 4
; NEOV2-NEXT:    [[LOAD5:%.*]] = load float, ptr [[GEP5]], align 4
; NEOV2-NEXT:    [[LOAD6:%.*]] = load float, ptr [[GEP6]], align 4
; NEOV2-NEXT:    [[LOAD7:%.*]] = load float, ptr [[GEP7]], align 4
; NEOV2-NEXT:    [[LOG:%.*]] = call fast float @llvm.log.f32(float [[LOAD]])
; NEOV2-NEXT:    [[LOG1:%.*]] = call fast float @llvm.log.f32(float [[LOAD1]])
; NEOV2-NEXT:    [[LOG2:%.*]] = call fast float @llvm.log.f32(float [[LOAD2]])
; NEOV2-NEXT:    [[LOG3:%.*]] = call fast float @llvm.log.f32(float [[LOAD3]])
; NEOV2-NEXT:    [[LOG4:%.*]] = call fast float @llvm.log.f32(float [[LOAD4]])
; NEOV2-NEXT:    [[LOG5:%.*]] = call fast float @llvm.log.f32(float [[LOAD5]])
; NEOV2-NEXT:    [[LOG6:%.*]] = call fast float @llvm.log.f32(float [[LOAD6]])
; NEOV2-NEXT:    [[LOG7:%.*]] = call fast float @llvm.log.f32(float [[LOAD7]])
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd fast float [[LOG]], [[LOG1]]
; NEOV2-NEXT:    [[ADD2:%.*]] = fadd fast float [[ADD1]], [[LOG2]]
; NEOV2-NEXT:    [[ADD3:%.*]] = fadd fast float [[ADD2]], [[LOG3]]
; NEOV2-NEXT:    [[ADD4:%.*]] = fadd fast float [[ADD3]], [[LOG4]]
; NEOV2-NEXT:    [[ADD5:%.*]] = fadd fast float [[ADD4]], [[LOG5]]
; NEOV2-NEXT:    [[ADD6:%.*]] = fadd fast float [[ADD5]], [[LOG6]]
; NEOV2-NEXT:    [[ADD7:%.*]] = fadd fast float [[ADD6]], [[LOG7]]
; NEOV2-NEXT:    ret float [[ADD7]]
;
entry:
...
; CHECK-NEXT:    ret float [[ADD7]]
;
; NEOV2-LABEL: define float @reduce_float_case3(
; NEOV2-SAME: ptr [[A:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[GEP1:%.*]] = getelementptr inbounds float, ptr [[A]], i32 1
; NEOV2-NEXT:    [[GEP2:%.*]] = getelementptr inbounds float, ptr [[A]], i32 2
...
; NEOV2-NEXT:    [[LOAD6:%.*]] = load float, ptr [[GEP6]], align 4
; NEOV2-NEXT:    [[LOAD7:%.*]] = load float, ptr [[GEP7]], align 4
; NEOV2-NEXT:    [[LOG:%.*]] = call float @llvm.log.f32(float [[LOAD]])
; NEOV2-NEXT:    [[LOG1:%.*]] = call float @llvm.log.f32(float [[LOAD1]])
; NEOV2-NEXT:    [[LOG2:%.*]] = call float @llvm.log.f32(float [[LOAD2]])
; NEOV2-NEXT:    [[LOG3:%.*]] = call float @llvm.log.f32(float [[LOAD3]])
; NEOV2-NEXT:    [[LOG4:%.*]] = call float @llvm.log.f32(float [[LOAD4]])
; NEOV2-NEXT:    [[LOG5:%.*]] = call float @llvm.log.f32(float [[LOAD5]])
; NEOV2-NEXT:    [[LOG6:%.*]] = call float @llvm.log.f32(float [[LOAD6]])
; NEOV2-NEXT:    [[LOG7:%.*]] = call float @llvm.log.f32(float [[LOAD7]])
; NEOV2-NEXT:    [[ADD1:%.*]] = fadd float [[LOG]], [[LOG1]]
; NEOV2-NEXT:    [[ADD2:%.*]] = fadd float [[ADD1]], [[LOG2]]
; NEOV2-NEXT:    [[ADD3:%.*]] = fadd float [[ADD2]], [[LOG3]]
; NEOV2-NEXT:    [[ADD4:%.*]] = fadd float [[ADD3]], [[LOG4]]
; NEOV2-NEXT:    [[ADD5:%.*]] = fadd float [[ADD4]], [[LOG5]]
; NEOV2-NEXT:    [[ADD6:%.*]] = fadd float [[ADD5]], [[LOG6]]
; NEOV2-NEXT:    [[ADD7:%.*]] = fadd float [[ADD6]], [[LOG7]]
; NEOV2-NEXT:    ret float [[ADD7]]
;
entry:
  %gep1 = getelementptr inbounds float, ptr %a, i32 1
...
; CHECK-SAME: <4 x half> [[VEC4:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[ADD3:%.*]] = call fast half @llvm.vector.reduce.fadd.v4f16(half 0xH8000, <4 x half> [[VEC4]])
; CHECK-NEXT:    ret half [[ADD3]]
;
; NEOV2-LABEL: define half @reduce_unordered_fast_half4(
; NEOV2-SAME: <4 x half> [[VEC4:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[ADD3:%.*]] = call fast half @llvm.vector.reduce.fadd.v4f16(half 0xH8000, <4 x half> [[VEC4]])
; NEOV2-NEXT:    ret half [[ADD3]]
;
entry:
  %elt0 = extractelement <4 x half> %vec4, i64 0
...
; CHECK-NEXT:    [[ELT1:%.*]] = extractelement <2 x half> [[TMP2]], i32 0
; CHECK-NEXT:    [[ADD2:%.*]] = extractelement <2 x half> [[TMP2]], i32 1
; CHECK-NEXT:    [[ADD3:%.*]] = fadd half [[ELT1]], [[ADD2]]
; CHECK-NEXT:    ret half [[ADD3]]
;
; NEOV2-LABEL: define half @reduce_unordered_half4(
; NEOV2-SAME: <4 x half> [[VEC4:%.*]]) #[[ATTR0]] {
; NEOV2-NEXT:  [[ENTRY:.*:]]
; NEOV2-NEXT:    [[TMP0:%.*]] = shufflevector <4 x half> [[VEC4]], <4 x half> poison, <2 x i32> <i32 1, i32 2>
; NEOV2-NEXT:    [[TMP1:%.*]] = shufflevector <4 x half> [[VEC4]], <4 x half> poison, <2 x i32> <i32 0, i32 3>
; NEOV2-NEXT:    [[TMP2:%.*]] = fadd <2 x half> [[TMP0]], [[TMP1]]
; NEOV2-NEXT:    [[ELT1:%.*]] = extractelement <2 x half> [[TMP2]], i32 0
; NEOV2-NEXT:    [[ADD2:%.*]] = extractelement <2 x half> [[TMP2]], i32 1
; NEOV2-NEXT:    [[ADD3:%.*]] = fadd half [[ELT1]], [[ADD2]]
; NEOV2-NEXT:    ret half [[ADD3]]
;
entry:
  %elt0 = extractelement <4 x half> %vec4, i64 0
