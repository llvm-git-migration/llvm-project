...
; TUNIT-NEXT:    [[NEWGEP2:%.*]] = getelementptr ptr, ptr [[LOCAL1]], i64 2147483647
; TUNIT-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[NEWGEP2]], align 8
; TUNIT-NEXT:    [[NEWGEP2_B8:%.*]] = getelementptr i8, ptr [[NEWGEP2]], i64 8
; TUNIT-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[NEWGEP2_B8]], align 8
; TUNIT-NEXT:    [[NEWGEP2_B16:%.*]] = getelementptr i8, ptr [[NEWGEP2]], i64 16
; TUNIT-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[NEWGEP2_B16]], align 8
