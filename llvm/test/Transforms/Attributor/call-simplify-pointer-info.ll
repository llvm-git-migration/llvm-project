...
; TUNIT-NEXT:    [[NEWGEP2:%.*]] = getelementptr ptr, ptr [[I52]], i64 -52
...
; TUNIT-NEXT:    [[NEWGEP3:%.*]] = getelementptr ptr, ptr [[I54]], i64 -53
; TUNIT-NEXT:    store i8 4, ptr [[NEWGEP3]], align 2
; TUNIT-NEXT:    [[SEL:%.*]] = select i1 [[COND]], ptr [[I51]], ptr [[I52]]
; TUNIT-NEXT:    [[NEWGEP:%.*]] = getelementptr ptr, ptr [[I53]], i64 -50
; TUNIT-NEXT:    [[R:%.*]] = call i8 @sum_two_different_loads(ptr nocapture nofree nonnull readonly dereferenceable(972) [[SEL]], ptr nocapture nofree noundef nonnull readonly dereferenceable(971) [[NEWGEP]]) #[[ATTR3]]
; TUNIT-NEXT:    ret i8 [[R]]
;
