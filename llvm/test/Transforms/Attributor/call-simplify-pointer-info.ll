...
; TUNIT-NEXT:    [[NEWGEP3:%.*]] = getelementptr ptr, ptr [[I52]], i64 -52
; TUNIT-NEXT:    store i8 2, ptr [[NEWGEP3]], align 4
; TUNIT-NEXT:    [[I53:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES1]], i64 0, i64 53
; TUNIT-NEXT:    [[NEWGEP5:%.*]] = getelementptr ptr, ptr [[I53]], i64 -50
; TUNIT-NEXT:    store i8 3, ptr [[NEWGEP5]], align 1
; TUNIT-NEXT:    [[I54:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES1]], i64 0, i64 54
; TUNIT-NEXT:    [[NEWGEP4:%.*]] = getelementptr ptr, ptr [[I54]], i64 -53
; TUNIT-NEXT:    store i8 4, ptr [[NEWGEP4]], align 2
; TUNIT-NEXT:    [[SEL:%.*]] = select i1 [[COND]], ptr [[I51]], ptr [[I52]]
; TUNIT-NEXT:    [[NEWGEP:%.*]] = getelementptr ptr, ptr [[SEL]], i64 -52
; TUNIT-NEXT:    [[NEWGEP2:%.*]] = getelementptr ptr, ptr [[I53]], i64 -50
; TUNIT-NEXT:    [[R:%.*]] = call i8 @sum_two_different_loads(ptr nocapture nofree nonnull readonly dereferenceable(972) [[NEWGEP]], ptr nocapture nofree noundef nonnull readonly dereferenceable(971) [[NEWGEP2]]) #[[ATTR3]]
; TUNIT-NEXT:    ret i8 [[R]]
;
