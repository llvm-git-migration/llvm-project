...
; CHECK:       then:
; CHECK-NEXT:    [[GEP23:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES1]], i64 0, i64 23
; CHECK-NEXT:    [[NEWGEP5:%.*]] = getelementptr ptr, ptr [[GEP23]], i64 22
; CHECK-NEXT:    store i8 21, ptr [[NEWGEP5]], align 4
...
; CHECK-NEXT:    [[NEWGEP4:%.*]] = getelementptr ptr, ptr [[GEP29]], i64 27
; CHECK-NEXT:    store i8 42, ptr [[NEWGEP4]], align 4
; CHECK-NEXT:    [[NEWGEP2:%.*]] = getelementptr ptr, ptr [[PHI_PTR]], i64 31
...
; CHECK-NEXT:    [[PHI_PTR:%.*]] = phi ptr [ [[GEP23]], [[THEN]] ], [ [[GEP31]], [[ELSE]] ]
; CHECK-NEXT:    [[NEWGEP2:%.*]] = getelementptr ptr, ptr [[PHI_PTR]], i64 31
; CHECK-NEXT:    store i8 21, ptr [[NEWGEP2]], align 4
