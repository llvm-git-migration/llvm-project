...
; TUNIT-LABEL: define {{[^@]+}}@select_offsets_simplifiable_2
; TUNIT-SAME: (i1 [[CND1:%.*]], i1 [[CND2:%.*]]) #[[ATTR1:[0-9]+]] {
; TUNIT-NEXT:  entry:
; TUNIT-NEXT:    [[BYTES:%.*]] = alloca [1024 x i8], align 16
; TUNIT-NEXT:    [[BYTES1:%.*]] = alloca [4 x i8], align 1
; TUNIT-NEXT:    [[GEP23:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 23
; TUNIT-NEXT:    store i8 23, ptr [[GEP23]], align 4
; TUNIT-NEXT:    [[GEP29:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 29
; TUNIT-NEXT:    [[NEWGEP2:%.*]] = getelementptr ptr, ptr [[GEP29]], i64 -27
; TUNIT-NEXT:    store i8 29, ptr [[NEWGEP2]], align 4
; TUNIT-NEXT:    [[GEP7:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 7
; TUNIT-NEXT:    [[NEWGEP:%.*]] = getelementptr ptr, ptr [[GEP7]], i64 -4
; TUNIT-NEXT:    store i8 7, ptr [[NEWGEP]], align 4
; TUNIT-NEXT:    [[GEP31:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 31
; TUNIT-NEXT:    [[SEL0:%.*]] = select i1 [[CND1]], i64 20, i64 26
; TUNIT-NEXT:    [[SEL1:%.*]] = select i1 [[CND2]], i64 [[SEL0]], i64 4
; TUNIT-NEXT:    [[GEP_SEL:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 [[SEL1]]
; TUNIT-NEXT:    [[GEP_PLUS:%.*]] = getelementptr inbounds i8, ptr [[GEP_SEL]], i64 3
; TUNIT-NEXT:    [[I:%.*]] = load i8, ptr [[GEP_PLUS]], align 4
; TUNIT-NEXT:    ret i8 [[I]]
;
; CGSCC: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
; CGSCC-LABEL: define {{[^@]+}}@select_offsets_simplifiable_2
; CGSCC-SAME: (i1 [[CND1:%.*]], i1 [[CND2:%.*]]) #[[ATTR1:[0-9]+]] {
; CGSCC-NEXT:  entry:
; CGSCC-NEXT:    [[BYTES:%.*]] = alloca [1024 x i8], align 16
; CGSCC-NEXT:    [[BYTES1:%.*]] = alloca [4 x i8], align 1
; CGSCC-NEXT:    [[GEP23:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 23
; CGSCC-NEXT:    store i8 23, ptr [[GEP23]], align 4
; CGSCC-NEXT:    [[GEP29:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 29
; CGSCC-NEXT:    [[NEWGEP:%.*]] = getelementptr ptr, ptr [[GEP29]], i64 -27
; CGSCC-NEXT:    store i8 29, ptr [[NEWGEP]], align 4
; CGSCC-NEXT:    [[GEP7:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 7
; CGSCC-NEXT:    store i8 7, ptr [[GEP7]], align 4
; CGSCC-NEXT:    [[GEP31:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 31
; CGSCC-NEXT:    [[SEL0:%.*]] = select i1 [[CND1]], i64 20, i64 26
; CGSCC-NEXT:    [[SEL1:%.*]] = select i1 [[CND2]], i64 [[SEL0]], i64 4
; CGSCC-NEXT:    [[GEP_SEL:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 [[SEL1]]
; CGSCC-NEXT:    [[GEP_PLUS:%.*]] = getelementptr inbounds i8, ptr [[GEP_SEL]], i64 3
; CGSCC-NEXT:    [[I:%.*]] = load i8, ptr [[GEP_PLUS]], align 4
; CGSCC-NEXT:    ret i8 [[I]]
;
entry:
...
; CHECK-NEXT:    [[NEWGEP:%.*]] = getelementptr ptr, ptr [[GEP32]], i64 -32
; CHECK-NEXT:    store i8 100, ptr [[NEWGEP]], align 16
; CHECK-NEXT:    [[GEP_SEL:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 [[SEL1]]
...
; CHECK-NEXT:    [[NEWGEP:%.*]] = getelementptr ptr, ptr [[GEP_FIXED]], i64 -69
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[BYTES1:%.*]] = alloca [3 x i8], align 1
; CHECK-NEXT:    [[GEP3:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES1]], i64 0, i64 3
; CHECK-NEXT:    [[NEWGEP:%.*]] = getelementptr ptr, ptr [[GEP3]], i64 -1
...
; CHECK-NEXT:    [[GEP7:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES1]], i64 0, i64 7
; CHECK-NEXT:    [[NEWGEP2:%.*]] = getelementptr ptr, ptr [[GEP7]], i64 -6
; CHECK-NEXT:    store i8 1, ptr [[NEWGEP2]], align 4
; CHECK-NEXT:    [[GEP23:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES1]], i64 0, i64 23
; CHECK-NEXT:    [[SEL_PTR:%.*]] = select i1 [[CND1]], ptr [[GEP7]], ptr [[GEP23]]
; CHECK-NEXT:    [[NEWGEP:%.*]] = getelementptr ptr, ptr [[SEL_PTR]], i64 -23
...
; CHECK:       else:
; CHECK-NEXT:    [[GEP31:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 31
; CHECK-NEXT:    [[NEWGEP:%.*]] = getelementptr ptr, ptr [[GEP31]], i64 -31
; CHECK-NEXT:    store i8 21, ptr [[NEWGEP]], align 4
; CHECK-NEXT:    br label [[JOIN]]
; CHECK:       join:
...
; CHECK-NEXT:    [[BYTES1:%.*]] = alloca [3 x i8], align 1
; CHECK-NEXT:    [[GEP29:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 29
; CHECK-NEXT:    [[NEWGEP:%.*]] = getelementptr ptr, ptr [[GEP29]], i64 -27
; CHECK-NEXT:    store i8 42, ptr [[NEWGEP]], align 4
; CHECK-NEXT:    br i1 [[CND1]], label [[THEN:%.*]], label [[ELSE:%.*]]
; CHECK:       then:
; CHECK-NEXT:    [[GEP23:%.*]] = getelementptr inbounds [1024 x i8], ptr [[BYTES]], i64 0, i64 23
...
;.
; TUNIT: attributes #[[ATTR0:[0-9]+]] = { allockind("alloc,zeroed") allocsize(0,1) "alloc-family"="malloc" }
...
;.
; CGSCC: attributes #[[ATTR0:[0-9]+]] = { allockind("alloc,zeroed") allocsize(0,1) "alloc-family"="malloc" }
; CGSCC: attributes #[[ATTR1]] = { mustprogress nofree norecurse nosync nounwind willreturn memory(none) }
; CGSCC: attributes #[[ATTR2]] = { mustprogress nofree norecurse nosync nounwind willreturn memory(write) }
; CGSCC: attributes #[[ATTR3]] = { mustprogress nofree norecurse nosync nounwind willreturn }
;.
