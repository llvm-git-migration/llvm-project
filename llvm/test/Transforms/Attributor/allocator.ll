...
; CGSCC-NEXT:    [[NEWGEP:%.*]] = getelementptr ptr, ptr [[INDEX1]], i64 -36
; CGSCC-NEXT:    store i32 100, ptr [[NEWGEP]], align 4
; CGSCC-NEXT:    [[INDEX2:%.*]] = getelementptr inbounds [10 x i32], ptr [[ARRAY1]], i32 0, i32 5
; CGSCC-NEXT:    [[NEWGEP3:%.*]] = getelementptr ptr, ptr [[INDEX2]], i64 -16
; CGSCC-NEXT:    store i32 [[VAL]], ptr [[NEWGEP3]], align 4
; CGSCC-NEXT:    [[INDEX3:%.*]] = getelementptr inbounds [10 x i32], ptr [[ARRAY1]], i32 0, i32 3
; CGSCC-NEXT:    [[NEWGEP4:%.*]] = getelementptr ptr, ptr [[INDEX3]], i64 -4
; CGSCC-NEXT:    store i32 [[VAL]], ptr [[NEWGEP4]], align 4
