...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds <16 x i16>, ptr [[IN_PTR]], i64 [[IN_IDX1]]
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds <16 x i16>, ptr [[TMP0]], i64 2
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds <16 x i16>, ptr [[IN_PTR]], i64 [[IN_IDX1]]
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr <16 x i16>, ptr [[TMP2]], i64 24
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr <16 x i16>, ptr [[IN_PTR]], i64 [[IN_IDX2]]
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr <16 x i16>, ptr [[TMP4]], i64 6
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr <16 x i16>, ptr [[IN_PTR]], i64 [[IN_IDX2]]
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr <16 x i16>, ptr [[TMP6]], i64 28
; CHECK-NEXT:    ret void
;
entry:
