...
; COMMON-NEXT:    ptrue p0.b
; COMMON-NEXT:    mov x8, xzr
; COMMON-NEXT:    add x9, x0, x2
; COMMON-NEXT:    ptrue p1.h
; COMMON-NEXT:  .LBB1_1: // %for.body
; COMMON-NEXT:    // =>This Inner Loop Header: Depth=1
; COMMON-NEXT:    add x10, x0, x8
; COMMON-NEXT:    ld1b { z0.b }, p0/z, [x0, x8]
; COMMON-NEXT:    add x11, x9, x8
; COMMON-NEXT:    ld1b { z1.b }, p0/z, [x9, x8]
; COMMON-NEXT:    ld1b { z2.b }, p0/z, [x10, #1, mul vl]
; COMMON-NEXT:    ld1b { z3.b }, p0/z, [x11, #1, mul vl]
...
; COMMON-NEXT:    st1b { z1.h }, p1, [x10, #1, mul vl]
