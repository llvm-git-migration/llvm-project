...
; CHECK: [[GV_CLONE_0:@.*]] = internal addrspace(3) global %struct.GV undef, align 8
...
; CHECK-NEXT:   store i32 %x, ptr addrspace(3) %p, align 4
; CHECK-NEXT:   %0 = getelementptr [[STRUCT_GV]], ptr addrspace(3) [[GV_CLONE_0]], i64 1, i32 2, i32 1, i64 5, i64 12
; CHECK-NEXT:   store i32 %x, ptr addrspace(3) %0, align 4
; CHECK-NEXT:   %1 = getelementptr [[STRUCT_GV]], ptr addrspace(3) [[GV_CLONE_0]], i64 1, i32 2, i32 1, i64 5, i64 1
; CHECK-NEXT:   %2 = getelementptr [[STRUCT_GV]], ptr addrspace(3) [[GV_CLONE_0]], i64 1, i32 2, i32 1, i64 5, i64 11
; CHECK-NEXT:   store ptr addrspace(3) %2, ptr addrspace(3) %1, align 4
; CHECK-NEXT:   %3 = getelementptr [[STRUCT_GV]], ptr addrspace(3) [[GV_CLONE_0]], i64 6
; CHECK-NEXT:   %gep.ascast = load i8, ptr addrspace(3) %3, align 1
; CHECK-NEXT:   br i1 %cond, label %bb.1, label %bb.2
; CHECK:      bb.1:                                             ; preds = %entry
; CHECK-NEXT:   br label %sink
; CHECK:      bb.2:                                             ; preds = %entry
