...
; CHECK-NEXT:    [[TMP11:%.*]] = shl i64 [[TMP4]], 8
; CHECK-NEXT:    [[TMP5:%.*]] = ashr i64 [[TMP11]], 8
...
; CHECK-NEXT:    [[TMP16:%.*]] = shl i64 [[TMP10]], 8
; CHECK-NEXT:    [[TMP20:%.*]] = ashr i64 [[TMP16]], 8
; CHECK-NEXT:    [[TMP12:%.*]] = ashr i64 [[TMP20]], 4
...
; CHECK-NEXT:    [[TMP21:%.*]] = shl i64 [[TMP15]], 8
; CHECK-NEXT:    [[TMP19:%.*]] = ashr i64 [[TMP21]], 8
; CHECK-NEXT:    [[TMP17:%.*]] = ashr i64 [[TMP19]], 4
