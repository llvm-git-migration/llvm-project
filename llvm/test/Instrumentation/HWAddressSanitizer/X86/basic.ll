...
; ABORT-INLINE-NEXT:    [[TMP7:%.*]] = shl i64 [[TMP0]], 7
; ABORT-INLINE-NEXT:    [[TMP1:%.*]] = ashr i64 [[TMP7]], 7
...
; ABORT-INLINE-NEXT:    [[TMP13:%.*]] = shl i64 [[TMP4]], 7
; ABORT-INLINE-NEXT:    [[TMP14:%.*]] = ashr i64 [[TMP13]], 7
; ABORT-INLINE-NEXT:    [[TMP8:%.*]] = ashr i64 [[TMP14]], 4
...
; ABORT-INLINE:       14:
; ABORT-INLINE-NEXT:    [[TMP15:%.*]] = icmp ugt i8 [[TMP10]], 15
; ABORT-INLINE-NEXT:    br i1 [[TMP15]], label [[TMP20:%.*]], label [[TMP25:%.*]], !prof [[PROF1]]
; ABORT-INLINE:       16:
...
; ABORT-INLINE-NEXT:    br i1 [[TMP19]], label [[TMP20]], label [[TMP28:%.*]], !prof [[PROF1]]
; ABORT-INLINE:       22:
; ABORT-INLINE-NEXT:    [[TMP21:%.*]] = or i64 [[TMP4]], 15
...
; ABORT-INLINE-NEXT:    br i1 [[TMP24]], label [[TMP20]], label [[TMP27:%.*]], !prof [[PROF1]]
; ABORT-INLINE:       27:
...
; RECOVER-INLINE-NEXT:    [[TMP7:%.*]] = shl i64 [[TMP0]], 7
; RECOVER-INLINE-NEXT:    [[TMP1:%.*]] = ashr i64 [[TMP7]], 7
...
; RECOVER-INLINE-NEXT:    [[TMP13:%.*]] = shl i64 [[TMP4]], 7
; RECOVER-INLINE-NEXT:    [[TMP14:%.*]] = ashr i64 [[TMP13]], 7
; RECOVER-INLINE-NEXT:    [[TMP8:%.*]] = ashr i64 [[TMP14]], 4
...
; RECOVER-INLINE:       14:
; RECOVER-INLINE-NEXT:    [[TMP15:%.*]] = icmp ugt i8 [[TMP10]], 15
; RECOVER-INLINE-NEXT:    br i1 [[TMP15]], label [[TMP20:%.*]], label [[TMP27:%.*]], !prof [[PROF1]]
; RECOVER-INLINE:       16:
...
; RECOVER-INLINE-NEXT:    br i1 [[TMP19]], label [[TMP20]], label [[TMP28:%.*]], !prof [[PROF1]]
; RECOVER-INLINE:       22:
; RECOVER-INLINE-NEXT:    [[TMP21:%.*]] = or i64 [[TMP4]], 15
...
; RECOVER-INLINE-NEXT:    br i1 [[TMP24]], label [[TMP20]], label [[TMP25]], !prof [[PROF1]]
; RECOVER-INLINE:       27:
...
; ABORT-INLINE-NEXT:  entry:
; ABORT-INLINE-NEXT:    [[TMP0:%.*]] = load i64, ptr @__hwasan_tls, align 8
; ABORT-INLINE-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP0]], 7
; ABORT-INLINE-NEXT:    [[TMP1:%.*]] = ashr i64 [[TMP5]], 7
; ABORT-INLINE-NEXT:    [[TMP2:%.*]] = or i64 [[TMP1]], 4294967295
; ABORT-INLINE-NEXT:    [[HWASAN_SHADOW:%.*]] = add i64 [[TMP2]], 1
; ABORT-INLINE-NEXT:    [[TMP3:%.*]] = inttoptr i64 [[HWASAN_SHADOW]] to ptr
; ABORT-INLINE-NEXT:    [[TMP4:%.*]] = ptrtoint ptr [[A]] to i64
...
; RECOVER-INLINE-NEXT:  entry:
; RECOVER-INLINE-NEXT:    [[TMP0:%.*]] = load i64, ptr @__hwasan_tls, align 8
; RECOVER-INLINE-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP0]], 7
; RECOVER-INLINE-NEXT:    [[TMP1:%.*]] = ashr i64 [[TMP5]], 7
; RECOVER-INLINE-NEXT:    [[TMP2:%.*]] = or i64 [[TMP1]], 4294967295
; RECOVER-INLINE-NEXT:    [[HWASAN_SHADOW:%.*]] = add i64 [[TMP2]], 1
; RECOVER-INLINE-NEXT:    [[TMP3:%.*]] = inttoptr i64 [[HWASAN_SHADOW]] to ptr
; RECOVER-INLINE-NEXT:    [[TMP4:%.*]] = ptrtoint ptr [[A]] to i64
...
; ABORT-INLINE-NEXT:    [[TMP5:%.*]] = lshr i64 [[TMP4]], 57
; ABORT-INLINE-NEXT:    [[TMP6:%.*]] = trunc i64 [[TMP5]] to i8
; ABORT-INLINE-NEXT:    [[TMP12:%.*]] = shl i64 [[TMP4]], 7
; ABORT-INLINE-NEXT:    [[TMP13:%.*]] = ashr i64 [[TMP12]], 7
; ABORT-INLINE-NEXT:    [[TMP8:%.*]] = ashr i64 [[TMP13]], 4
; ABORT-INLINE-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[TMP3]], i64 [[TMP8]]
; ABORT-INLINE-NEXT:    [[TMP10:%.*]] = load i8, ptr [[TMP9]], align 1
; ABORT-INLINE-NEXT:    [[TMP11:%.*]] = icmp ne i8 [[TMP6]], [[TMP10]]
; ABORT-INLINE-NEXT:    br i1 [[TMP11]], label [[TMP14:%.*]], label [[TMP26:%.*]], !prof [[PROF1]]
; ABORT-INLINE:       14:
; ABORT-INLINE-NEXT:    [[TMP15:%.*]] = icmp ugt i8 [[TMP10]], 15
; ABORT-INLINE-NEXT:    br i1 [[TMP15]], label [[TMP20:%.*]], label [[TMP25:%.*]], !prof [[PROF1]]
; ABORT-INLINE:       16:
...
; RECOVER-INLINE-NEXT:    [[TMP5:%.*]] = lshr i64 [[TMP4]], 57
; RECOVER-INLINE-NEXT:    [[TMP6:%.*]] = trunc i64 [[TMP5]] to i8
; RECOVER-INLINE-NEXT:    [[TMP12:%.*]] = shl i64 [[TMP4]], 7
; RECOVER-INLINE-NEXT:    [[TMP13:%.*]] = ashr i64 [[TMP12]], 7
; RECOVER-INLINE-NEXT:    [[TMP8:%.*]] = ashr i64 [[TMP13]], 4
; RECOVER-INLINE-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[TMP3]], i64 [[TMP8]]
; RECOVER-INLINE-NEXT:    [[TMP10:%.*]] = load i8, ptr [[TMP9]], align 1
; RECOVER-INLINE-NEXT:    [[TMP11:%.*]] = icmp ne i8 [[TMP6]], [[TMP10]]
; RECOVER-INLINE-NEXT:    br i1 [[TMP11]], label [[TMP14:%.*]], label [[TMP26:%.*]], !prof [[PROF1]]
; RECOVER-INLINE:       14:
; RECOVER-INLINE-NEXT:    [[TMP15:%.*]] = icmp ugt i8 [[TMP10]], 15
; RECOVER-INLINE-NEXT:    br i1 [[TMP15]], label [[TMP20:%.*]], label [[TMP27:%.*]], !prof [[PROF1]]
; RECOVER-INLINE:       16:
