...
; CHECK-NEXT:    [[TMP25:%.*]] = shl i64 [[TMP19]], 8
; CHECK-NEXT:    [[TMP20:%.*]] = ashr i64 [[TMP25]], 8
...
; CHECK-NEXT:    [[TMP30:%.*]] = shl i64 [[TMP24]], 8
; CHECK-NEXT:    [[TMP34:%.*]] = ashr i64 [[TMP30]], 8
; CHECK-NEXT:    [[TMP26:%.*]] = ashr i64 [[TMP34]], 4
...
; CHECK-NEXT:    [[TMP35:%.*]] = shl i64 [[TMP29]], 8
; CHECK-NEXT:    [[TMP33:%.*]] = ashr i64 [[TMP35]], 8
; CHECK-NEXT:    [[TMP31:%.*]] = ashr i64 [[TMP33]], 4
