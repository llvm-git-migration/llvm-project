...
; RUN: opt -S -passes=asan -asan-use-stack-safety=0 -asan-max-inline-poisoning-size=0 \
...
; RUN: opt -S -passes=asan -asan-use-stack-safety=0 -asan-max-inline-poisoning-size=0 -asan-instrumentation-with-call-threshold=0  \
