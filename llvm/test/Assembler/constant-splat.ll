...
@constant.splat.f16 = constant <4 x half> splat (half f0xBC00)
...
@constant.splat.128 = constant <2 x fp128> splat (fp128 f0x80000000000000000000000000000001)

; CHECK: @constant.splat.bf16 = constant <4 x bfloat> splat (bfloat f0xC0A0)
@constant.splat.bf16 = constant <4 x bfloat> splat (bfloat f0xC0A0)

; CHECK: @constant.splat.x86_fp80 = constant <3 x x86_fp80> splat (x86_fp80 f0x4000C8F5C28F5C28F800)
@constant.splat.x86_fp80 = constant <3 x x86_fp80> splat (x86_fp80 f0x4000C8F5C28F5C28F800)

; CHECK: @constant.splat.ppc_fp128 = constant <1 x ppc_fp128> splat (ppc_fp128 f0x00000000000000008000000000000000)
@constant.splat.ppc_fp128 = constant <1 x ppc_fp128> splat (ppc_fp128 f0x00000000000000008000000000000000)
