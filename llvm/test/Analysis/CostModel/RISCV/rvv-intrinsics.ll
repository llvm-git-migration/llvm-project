...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %8 = inttoptr <vscale x 2 x i32> undef to <vscale x 2 x ptr>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %9 = inttoptr <vscale x 4 x i32> undef to <vscale x 4 x ptr>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %10 = inttoptr <vscale x 8 x i32> undef to <vscale x 8 x ptr>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %11 = call <1 x ptr> @llvm.vp.inttoptr.v1p0.v1i32(<1 x i32> undef, <1 x i1> undef, i32 undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %12 = call <2 x ptr> @llvm.vp.inttoptr.v2p0.v2i32(<2 x i32> undef, <2 x i1> undef, i32 undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %13 = call <4 x ptr> @llvm.vp.inttoptr.v4p0.v4i32(<4 x i32> undef, <4 x i1> undef, i32 undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %14 = call <8 x ptr> @llvm.vp.inttoptr.v8p0.v8i32(<8 x i32> undef, <8 x i1> undef, i32 undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %15 = call <16 x ptr> @llvm.vp.inttoptr.v16p0.v16i32(<16 x i32> undef, <16 x i1> undef, i32 undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %16 = call <vscale x 1 x ptr> @llvm.vp.inttoptr.nxv1p0.nxv1i32(<vscale x 1 x i32> undef, <vscale x 1 x i1> undef, i32 undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %17 = call <vscale x 2 x ptr> @llvm.vp.inttoptr.nxv2p0.nxv2i32(<vscale x 2 x i32> undef, <vscale x 2 x i1> undef, i32 undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %18 = call <vscale x 4 x ptr> @llvm.vp.inttoptr.nxv4p0.nxv4i32(<vscale x 4 x i32> undef, <vscale x 4 x i1> undef, i32 undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %19 = call <vscale x 8 x ptr> @llvm.vp.inttoptr.nxv8p0.nxv8i32(<vscale x 8 x i32> undef, <vscale x 8 x i1> undef, i32 undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret void
;
; TYPEBASED-LABEL: 'int_inttoptr'
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %1 = inttoptr i32 undef to ptr
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %2 = inttoptr <1 x i32> undef to <1 x ptr>
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %3 = inttoptr <2 x i32> undef to <2 x ptr>
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %4 = inttoptr <4 x i32> undef to <4 x ptr>
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %5 = inttoptr <8 x i32> undef to <8 x ptr>
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %6 = inttoptr <16 x i32> undef to <16 x ptr>
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %7 = inttoptr <vscale x 1 x i32> undef to <vscale x 1 x ptr>
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %8 = inttoptr <vscale x 2 x i32> undef to <vscale x 2 x ptr>
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %9 = inttoptr <vscale x 4 x i32> undef to <vscale x 4 x ptr>
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %10 = inttoptr <vscale x 8 x i32> undef to <vscale x 8 x ptr>
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %11 = call <1 x ptr> @llvm.vp.inttoptr.v1p0.v1i32(<1 x i32> undef, <1 x i1> undef, i32 undef)
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %12 = call <2 x ptr> @llvm.vp.inttoptr.v2p0.v2i32(<2 x i32> undef, <2 x i1> undef, i32 undef)
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %13 = call <4 x ptr> @llvm.vp.inttoptr.v4p0.v4i32(<4 x i32> undef, <4 x i1> undef, i32 undef)
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %14 = call <8 x ptr> @llvm.vp.inttoptr.v8p0.v8i32(<8 x i32> undef, <8 x i1> undef, i32 undef)
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %15 = call <16 x ptr> @llvm.vp.inttoptr.v16p0.v16i32(<16 x i32> undef, <16 x i1> undef, i32 undef)
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %16 = call <vscale x 1 x ptr> @llvm.vp.inttoptr.nxv1p0.nxv1i32(<vscale x 1 x i32> undef, <vscale x 1 x i1> undef, i32 undef)
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %17 = call <vscale x 2 x ptr> @llvm.vp.inttoptr.nxv2p0.nxv2i32(<vscale x 2 x i32> undef, <vscale x 2 x i1> undef, i32 undef)
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %18 = call <vscale x 4 x ptr> @llvm.vp.inttoptr.nxv4p0.nxv4i32(<vscale x 4 x i32> undef, <vscale x 4 x i1> undef, i32 undef)
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %19 = call <vscale x 8 x ptr> @llvm.vp.inttoptr.nxv8p0.nxv8i32(<vscale x 8 x i32> undef, <vscale x 8 x i1> undef, i32 undef)
; TYPEBASED-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret void
;
  inttoptr i32 undef to ptr
  inttoptr <1 x i32> undef to <1 x ptr>
  inttoptr <2 x i32> undef to <2 x ptr>
  inttoptr <4 x i32> undef to <4 x ptr>
  inttoptr <8 x i32> undef to <8 x ptr>
  inttoptr <16 x i32> undef to <16 x ptr>
  inttoptr <vscale x 1 x i32> undef to <vscale x 1 x ptr>
  inttoptr <vscale x 2 x i32> undef to <vscale x 2 x ptr>
  inttoptr <vscale x 4 x i32> undef to <vscale x 4 x ptr>
  inttoptr <vscale x 8 x i32> undef to <vscale x 8 x ptr>
  call <1 x ptr> @llvm.vp.inttoptr.v1p0.v1i32(<1 x i32> undef, <1 x i1> undef, i32 undef)
  call <2 x ptr> @llvm.vp.inttoptr.v2p0.v2i32(<2 x i32> undef, <2 x i1> undef, i32 undef)
  call <4 x ptr> @llvm.vp.inttoptr.v4p0.v4i32(<4 x i32> undef, <4 x i1> undef, i32 undef)
  call <8 x ptr> @llvm.vp.inttoptr.v8p0.v8i32(<8 x i32> undef, <8 x i1> undef, i32 undef)
  call <16 x ptr> @llvm.vp.inttoptr.v16p0.v16i32(<16 x i32> undef, <16 x i1> undef, i32 undef)
  call <vscale x 1 x ptr> @llvm.vp.inttoptr.nxv1p0.nxv1i32(<vscale x 1 x i32> undef, <vscale x 1 x i1> undef, i32 undef)
  call <vscale x 2 x ptr> @llvm.vp.inttoptr.nxv2p0.nxv2i32(<vscale x 2 x i32> undef, <vscale x 2 x i1> undef, i32 undef)
  call <vscale x 4 x ptr> @llvm.vp.inttoptr.nxv4p0.nxv4i32(<vscale x 4 x i32> undef, <vscale x 4 x i1> undef, i32 undef)
  call <vscale x 8 x ptr> @llvm.vp.inttoptr.nxv8p0.nxv8i32(<vscale x 8 x i32> undef, <vscale x 8 x i1> undef, i32 undef)
  ret void
}
