...
;; Check that we create one extra section with -basic-block-sections.
; MFS-BBSECTIONS:             callq  bar
; MFS-BBSECTIONS:             .section        .text.hot.foo1
; MFS-BBSECTIONS-NEXT:        foo1.__part.1:
; MFS-BBSECTIONS:             callq  baz
; MFS_NOBBSECTIONS-NOT:       .section        .text.hot.foo1
