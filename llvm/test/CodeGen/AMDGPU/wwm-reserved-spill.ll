...
; GFX9-O0-NEXT:    buffer_store_dword v5, off, s[0:3], s33 offset:28 ; 4-byte Folded Spill
...
; GFX9-O0-NEXT:    v_writelane_b32 v8, s38, 0
; GFX9-O0-NEXT:    v_writelane_b32 v8, s39, 1
...
; GFX9-O0-NEXT:    v_writelane_b32 v8, s44, 2
; GFX9-O0-NEXT:    v_writelane_b32 v8, s45, 3
; GFX9-O0-NEXT:    v_writelane_b32 v8, s46, 4
; GFX9-O0-NEXT:    v_writelane_b32 v8, s47, 5
; GFX9-O0-NEXT:    ; kill: def $sgpr34 killed $sgpr34 def $sgpr34_sgpr35
...
; GFX9-O0-NEXT:    v_readlane_b32 s34, v8, 0
; GFX9-O0-NEXT:    v_readlane_b32 s35, v8, 1
; GFX9-O0-NEXT:    v_readlane_b32 s36, v8, 2
; GFX9-O0-NEXT:    v_readlane_b32 s37, v8, 3
; GFX9-O0-NEXT:    v_readlane_b32 s38, v8, 4
; GFX9-O0-NEXT:    v_readlane_b32 s39, v8, 5
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, v0
; GFX9-O0-NEXT:    v_mov_b32_e32 v3, v1
...
; GFX9-O0-NEXT:    buffer_load_dword v5, off, s[0:3], s33 offset:28 ; 4-byte Folded Reload
...
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[34:35], -1
; GFX9-O0-NEXT:    buffer_store_dword v47, off, s[0:3], s32 offset:160 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
...
; GFX9-O0-NEXT:    v_mov_b32_e32 v32, s5
...
; GFX9-O0-NEXT:    v_mov_b32_e32 v37, s15
; GFX9-O0-NEXT:    v_mov_b32_e32 v36, s16
; GFX9-O0-NEXT:    v_mov_b32_e32 v35, s17
; GFX9-O0-NEXT:    v_mov_b32_e32 v34, s18
; GFX9-O0-NEXT:    v_mov_b32_e32 v33, s19
; GFX9-O0-NEXT:    v_mov_b32_e32 v1, s20
; GFX9-O0-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:120 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    v_mov_b32_e32 v46, s21
; GFX9-O0-NEXT:    v_mov_b32_e32 v45, s22
; GFX9-O0-NEXT:    v_mov_b32_e32 v44, s23
; GFX9-O0-NEXT:    v_mov_b32_e32 v43, s24
; GFX9-O0-NEXT:    v_mov_b32_e32 v42, s25
; GFX9-O0-NEXT:    v_mov_b32_e32 v41, s26
; GFX9-O0-NEXT:    v_mov_b32_e32 v40, s27
; GFX9-O0-NEXT:    v_mov_b32_e32 v39, s28
; GFX9-O0-NEXT:    v_mov_b32_e32 v38, s29
...
; GFX9-O0-NEXT:    v_mov_b32_e32 v1, v32
; GFX9-O0-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:156 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, v32
; GFX9-O0-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:152 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_mov_b32_e32 v3, v32
; GFX9-O0-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:148 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_mov_b32_e32 v4, v32
; GFX9-O0-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:144 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_mov_b32_e32 v5, v32
; GFX9-O0-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:140 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_mov_b32_e32 v6, v32
; GFX9-O0-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:136 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_mov_b32_e32 v7, v32
; GFX9-O0-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:132 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_mov_b32_e32 v8, v32
; GFX9-O0-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:128 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_mov_b32_e32 v9, v32
; GFX9-O0-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:124 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_mov_b32_e32 v10, v32
; GFX9-O0-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:120 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    v_mov_b32_e32 v11, v37
; GFX9-O0-NEXT:    buffer_load_dword v37, off, s[0:3], s32 offset:96 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    v_mov_b32_e32 v12, v36
; GFX9-O0-NEXT:    buffer_load_dword v36, off, s[0:3], s32 offset:100 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    v_mov_b32_e32 v13, v35
; GFX9-O0-NEXT:    buffer_load_dword v35, off, s[0:3], s32 offset:104 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    v_mov_b32_e32 v14, v34
; GFX9-O0-NEXT:    buffer_load_dword v34, off, s[0:3], s32 offset:108 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    v_mov_b32_e32 v15, v33
; GFX9-O0-NEXT:    buffer_load_dword v33, off, s[0:3], s32 offset:112 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(5)
; GFX9-O0-NEXT:    v_mov_b32_e32 v16, v32
; GFX9-O0-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:116 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    v_mov_b32_e32 v17, v46
; GFX9-O0-NEXT:    v_mov_b32_e32 v18, v45
; GFX9-O0-NEXT:    v_mov_b32_e32 v19, v44
; GFX9-O0-NEXT:    v_mov_b32_e32 v20, v43
; GFX9-O0-NEXT:    v_mov_b32_e32 v21, v42
; GFX9-O0-NEXT:    v_mov_b32_e32 v22, v41
; GFX9-O0-NEXT:    v_mov_b32_e32 v23, v40
; GFX9-O0-NEXT:    v_mov_b32_e32 v24, v39
; GFX9-O0-NEXT:    v_mov_b32_e32 v25, v38
; GFX9-O0-NEXT:    s_waitcnt vmcnt(5)
; GFX9-O0-NEXT:    v_mov_b32_e32 v26, v37
; GFX9-O0-NEXT:    s_waitcnt vmcnt(4)
; GFX9-O0-NEXT:    v_mov_b32_e32 v27, v36
; GFX9-O0-NEXT:    s_waitcnt vmcnt(3)
; GFX9-O0-NEXT:    v_mov_b32_e32 v28, v35
; GFX9-O0-NEXT:    s_waitcnt vmcnt(2)
; GFX9-O0-NEXT:    v_mov_b32_e32 v29, v34
; GFX9-O0-NEXT:    s_waitcnt vmcnt(1)
; GFX9-O0-NEXT:    v_mov_b32_e32 v30, v33
; GFX9-O0-NEXT:    ; kill: def $vgpr31 killed $vgpr32 killed $exec
...
; GFX9-O0-NEXT:    ; kill: def $vgpr10_vgpr11 killed $vgpr10_vgpr11 killed $exec
; GFX9-O0-NEXT:    ; kill: def $vgpr8_vgpr9 killed $vgpr8_vgpr9 killed $exec
; GFX9-O0-NEXT:    ; kill: def $vgpr6_vgpr7 killed $vgpr6_vgpr7 killed $exec
; GFX9-O0-NEXT:    ; kill: def $vgpr4_vgpr5 killed $vgpr4_vgpr5 killed $exec
; GFX9-O0-NEXT:    ; kill: def $vgpr2_vgpr3 killed $vgpr2_vgpr3 killed $exec
...
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[34:35], -1
; GFX9-O0-NEXT:    buffer_load_dword v47, off, s[0:3], s32 offset:160 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-O3-NEXT:    ; kill: def $vgpr1_vgpr2 killed $vgpr1_vgpr2 killed $exec
; GFX9-O3-NEXT:    ; kill: def $vgpr3_vgpr4 killed $vgpr3_vgpr4 killed $exec
; GFX9-O3-NEXT:    ; kill: def $vgpr5_vgpr6 killed $vgpr5_vgpr6 killed $exec
; GFX9-O3-NEXT:    ; kill: def $vgpr7_vgpr8 killed $vgpr7_vgpr8 killed $exec
; GFX9-O3-NEXT:    ; kill: def $vgpr9_vgpr10 killed $vgpr9_vgpr10 killed $exec
; GFX9-O3-NEXT:    s_nop 0
