...
; CHECK-NEXT:    br i1 [[TMP39]], label [[ASAN_REPORT:%.*]], label [[TMP42:%.*]], !prof [[PROF1:![0-9]+]]
; CHECK:       asan.report:
...
; CHECK-NEXT:    [[TMP46:%.*]] = lshr i64 [[TMP45]], 3
...
; CHECK-NEXT:    [[TMP51:%.*]] = and i64 [[TMP45]], 7
; CHECK-NEXT:    [[TMP52:%.*]] = add i64 [[TMP51]], 3
...
; CHECK-NEXT:    br i1 [[TMP57]], label [[ASAN_REPORT1:%.*]], label [[TMP60:%.*]], !prof [[PROF1]]
; CHECK:       asan.report1:
; CHECK-NEXT:    br i1 [[TMP55]], label [[TMP58:%.*]], label [[TMP59:%.*]]
; CHECK:       58:
; CHECK-NEXT:    call void @__asan_report_store4(i64 [[TMP45]]) #[[ATTR6]]
; CHECK-NEXT:    call void @llvm.amdgcn.unreachable()
