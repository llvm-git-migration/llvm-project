...
; CHECK-NEXT:    v_cmp_gt_i32_e32 vcc, 0, v0
...
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v1, v3
; CHECK-NEXT:    v_ashrrev_i32_e32 v2, 12, v2
; CHECK-NEXT:    v_ashrrev_i32_e32 v3, 12, v3
; CHECK-NEXT:    v_sub_i32_e32 v4, vcc, 0, v2
; CHECK-NEXT:    v_sub_i32_e32 v5, vcc, 0, v3
; CHECK-NEXT:    v_cmp_gt_i32_e32 vcc, 0, v0
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v2, v4, vcc
; CHECK-NEXT:    v_cmp_gt_i32_e32 vcc, 0, v1
