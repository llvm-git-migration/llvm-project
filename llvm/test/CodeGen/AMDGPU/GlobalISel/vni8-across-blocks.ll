...
; GFX906-NEXT:    s_lshr_b32 s2, s4, 16
...
; GFX906-NEXT:    global_store_byte v1, v0, s[0:1] offset:2
...
; GFX906-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
; GFX906-NEXT:    v_cmp_gt_u32_e32 vcc, 15, v0
; GFX906-NEXT:    s_mov_b32 s5, 0
; GFX906-NEXT:    s_and_saveexec_b64 s[2:3], vcc
; GFX906-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX906-NEXT:    s_lshr_b32 s2, s5, 8
; GFX906-NEXT:    v_mov_b32_e32 v0, s5
; GFX906-NEXT:    v_mov_b32_e32 v1, 0
; GFX906-NEXT:    s_lshr_b32 s3, s5, 16
; GFX906-NEXT:    s_waitcnt lgkmcnt(0)
; GFX906-NEXT:    global_store_byte v1, v0, s[0:1]
; GFX906-NEXT:    v_mov_b32_e32 v0, s2
; GFX906-NEXT:    s_lshr_b32 s6, s5, 24
; GFX906-NEXT:    global_store_byte v1, v0, s[0:1] offset:1
; GFX906-NEXT:    v_mov_b32_e32 v0, s3
; GFX906-NEXT:    global_store_byte v1, v0, s[0:1] offset:2
; GFX906-NEXT:    v_mov_b32_e32 v0, s6
; GFX906-NEXT:    global_store_byte v1, v0, s[0:1] offset:3
; GFX906-NEXT:    v_mov_b32_e32 v0, s5
; GFX906-NEXT:    global_store_byte v1, v0, s[0:1] offset:4
; GFX906-NEXT:    s_endpgm
entry:
  %idx = call i32 @llvm.amdgcn.workitem.id.x()
