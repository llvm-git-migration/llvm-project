...
; GFX9-NEXT:    v_cmp_lt_u32_e64 s[0:1], 42, v3
; GFX9-NEXT:    v_subrev_u32_e32 v2, 1, v3
; GFX9-NEXT:    s_or_b64 s[0:1], vcc, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v2, 42, s[0:1]
...
; GFX10-NEXT:    v_cmp_lt_u32_e64 s0, 42, v3
; GFX10-NEXT:    v_subrev_nc_u32_e32 v2, 1, v3
; GFX10-NEXT:    s_or_b32 s0, vcc_lo, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v2, v2, 42, s0
...
; GFX11-NEXT:    v_cmp_lt_u32_e64 s0, 42, v3
; GFX11-NEXT:    v_subrev_nc_u32_e32 v2, 1, v3
; GFX11-NEXT:    s_or_b32 s0, vcc_lo, s0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    v_cndmask_b32_e64 v2, v2, 42, s0
...
; CI-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x0
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    s_load_dwordx2 s[2:3], s[6:7], 0x8
; CI-NEXT:    s_add_u32 s0, s6, 32
; CI-NEXT:    s_addc_u32 s1, s7, 0
; CI-NEXT:    v_mov_b32_e32 v0, s0
...
; CI-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[4:5]
; CI-NEXT:    v_cmp_lt_u64_e64 s[0:1], 42, v[4:5]
; CI-NEXT:    v_subrev_i32_e64 v2, s[2:3], 1, v4
; CI-NEXT:    v_subbrev_u32_e64 v3, s[2:3], 0, v5, s[2:3]
; CI-NEXT:    s_or_b64 s[0:1], vcc, s[0:1]
; CI-NEXT:    v_cndmask_b32_e64 v2, v2, 42, s[0:1]
; CI-NEXT:    v_cndmask_b32_e64 v3, v3, 0, s[0:1]
...
; VI-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x0
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_load_dwordx2 s[2:3], s[6:7], 0x20
...
; VI-NEXT:    v_cmp_lt_u64_e64 s[0:1], 42, v[4:5]
; VI-NEXT:    v_subrev_u32_e64 v2, s[2:3], 1, v4
; VI-NEXT:    v_subbrev_u32_e64 v3, s[2:3], 0, v5, s[2:3]
; VI-NEXT:    s_or_b64 s[0:1], vcc, s[0:1]
; VI-NEXT:    v_cndmask_b32_e64 v2, v2, 42, s[0:1]
; VI-NEXT:    v_cndmask_b32_e64 v3, v3, 0, s[0:1]
