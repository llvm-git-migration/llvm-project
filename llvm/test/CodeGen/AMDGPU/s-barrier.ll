...
; GFX12-GISEL-NEXT:    s_load_b32 s2, s[4:5], 0x2c
; GFX12-GISEL-NEXT:    s_mov_b32 m0, 0xc0002
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v31, v0
; GFX12-GISEL-NEXT:    s_barrier_init m0
; GFX12-GISEL-NEXT:    s_add_nc_u64 s[8:9], s[4:5], 48
; GFX12-GISEL-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX12-GISEL-NEXT:    s_mov_b32 s32, 0
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    s_lshr_b32 s2, s2, 4
; GFX12-GISEL-NEXT:    s_wait_alu 0xfffe
; GFX12-GISEL-NEXT:    s_and_b32 s2, s2, 63
; GFX12-GISEL-NEXT:    s_wait_alu 0xfffe
; GFX12-GISEL-NEXT:    s_or_b32 s3, s2, 0x90000
; GFX12-GISEL-NEXT:    s_wait_alu 0xfffe
...
; GFX12-GISEL-NEXT:    s_get_barrier_state s2, 2
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    s_get_barrier_state s2, m0
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    s_getpc_b64 s[2:3]
; GFX12-GISEL-NEXT:    s_wait_alu 0xfffe
; GFX12-GISEL-NEXT:    s_sext_i32_i16 s3, s3
; GFX12-GISEL-NEXT:    s_add_co_u32 s2, s2, func1@gotpcrel32@lo+12
; GFX12-GISEL-NEXT:    s_wait_alu 0xfffe
; GFX12-GISEL-NEXT:    s_add_co_ci_u32 s3, s3, func1@gotpcrel32@hi+24
; GFX12-GISEL-NEXT:    s_barrier_signal -1
...
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    s_mov_b64 s[10:11], s[6:7]
; GFX12-GISEL-NEXT:    s_getpc_b64 s[6:7]
; GFX12-GISEL-NEXT:    s_wait_alu 0xfffe
; GFX12-GISEL-NEXT:    s_sext_i32_i16 s7, s7
; GFX12-GISEL-NEXT:    s_add_co_u32 s6, s6, func2@gotpcrel32@lo+12
; GFX12-GISEL-NEXT:    s_wait_alu 0xfffe
; GFX12-GISEL-NEXT:    s_add_co_ci_u32 s7, s7, func2@gotpcrel32@hi+24
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v31, v0
; GFX12-GISEL-NEXT:    s_load_b64 s[12:13], s[6:7], 0x0
