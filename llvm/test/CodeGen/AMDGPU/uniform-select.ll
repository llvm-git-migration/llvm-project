...
for.body:                                     ; preds = %for.body, %entry
  %x1 = phi <4 x i32> [ %0, %entry ], [ %4, %for.body ]
  %x2 = phi <4 x i32> [ zeroinitializer, %entry ], [ %2, %for.body ]
  %idxprom = zext i32 %q to i64
  %1 = extractelement <4 x i32> %x2, i64 %idxprom
  %add = or i32 %1, %p
  %2 = insertelement <4 x i32> %x2, i32 %add, i64 %idxprom
  %3 = extractelement <4 x i32> %x1, i64 %idxprom
  %4 = insertelement <4 x i32> %x1, i32 %3, i64 0
  br label %for.body
}
