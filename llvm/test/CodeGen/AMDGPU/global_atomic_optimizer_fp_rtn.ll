...
; IR-ITERATIVE-NEXT:    [[TMP21:%.*]] = trunc i64 [[TMP20]] to i32
; IR-ITERATIVE-NEXT:    [[TMP22:%.*]] = call i32 @llvm.amdgcn.readfirstlane(i32 [[TMP19]])
; IR-ITERATIVE-NEXT:    [[TMP23:%.*]] = call i32 @llvm.amdgcn.readfirstlane(i32 [[TMP21]])
...
; IR-ITERATIVE-NEXT:    [[TMP27:%.*]] = uitofp i32 [[TMP8]] to double
; IR-ITERATIVE-NEXT:    [[TMP28:%.*]] = fmul double [[VAL]], [[TMP27]]
; IR-ITERATIVE-NEXT:    [[TMP29:%.*]] = fadd double [[TMP26]], [[TMP28]]
...
; IR-DPP-NEXT:    [[TMP22:%.*]] = call i32 @llvm.amdgcn.readfirstlane(i32 [[TMP19]])
; IR-DPP-NEXT:    [[TMP23:%.*]] = call i32 @llvm.amdgcn.readfirstlane(i32 [[TMP21]])
...
; IR-DPP-NEXT:    [[TMP27:%.*]] = uitofp i32 [[TMP8]] to double
; IR-DPP-NEXT:    [[TMP28:%.*]] = fmul double [[VAL]], [[TMP27]]
; IR-DPP-NEXT:    [[TMP29:%.*]] = fadd double [[TMP26]], [[TMP28]]
...
; IR-ITERATIVE-NEXT:    ret double [[RESULT]]
;
...
; IR-ITERATIVE-NEXT:    [[TMP18:%.*]] = call i32 @llvm.amdgcn.readfirstlane(i32 [[TMP15]])
; IR-ITERATIVE-NEXT:    [[TMP19:%.*]] = call i32 @llvm.amdgcn.readfirstlane(i32 [[TMP17]])
...
; IR-ITERATIVE-NEXT:    [[TMP23:%.*]] = uitofp i32 [[TMP8]] to double
; IR-ITERATIVE-NEXT:    [[TMP24:%.*]] = select i1 [[TMP9]], double 0x7FF0000000000000, double [[VAL]]
; IR-ITERATIVE-NEXT:    [[TMP25:%.*]] = call double @llvm.minnum.f64(double [[TMP22]], double [[TMP24]])
...
; IR-DPP-NEXT:    [[TMP18:%.*]] = call i32 @llvm.amdgcn.readfirstlane(i32 [[TMP15]])
; IR-DPP-NEXT:    [[TMP19:%.*]] = call i32 @llvm.amdgcn.readfirstlane(i32 [[TMP17]])
...
; IR-DPP-NEXT:    [[TMP23:%.*]] = uitofp i32 [[TMP8]] to double
; IR-DPP-NEXT:    [[TMP24:%.*]] = select i1 [[TMP9]], double 0x7FF0000000000000, double [[VAL]]
; IR-DPP-NEXT:    [[TMP25:%.*]] = call double @llvm.minnum.f64(double [[TMP22]], double [[TMP24]])
...
; IR-ITERATIVE-LABEL: @global_atomic__fmax_double_uni_address_div_value_agent_scope_unsafe_structfp(
; IR-ITERATIVE-NEXT:    [[RESULT:%.*]] = atomicrmw fmax ptr addrspace(1) [[PTR:%.*]], double [[VAL:%.*]] syncscope("agent") monotonic, align 8
; IR-ITERATIVE-NEXT:    ret double [[RESULT]]
;
; IR-DPP-LABEL: @global_atomic__fmax_double_uni_address_div_value_agent_scope_unsafe_structfp(
...
; IR-ITERATIVE-LABEL: @global_atomic__fmax_double_div_address_uni_value_agent_scope_unsafe_structfp(
; IR-ITERATIVE-NEXT:    [[RESULT:%.*]] = atomicrmw fmax ptr addrspace(1) [[PTR:%.*]], double [[VAL:%.*]] syncscope("agent") monotonic, align 8
; IR-ITERATIVE-NEXT:    ret double [[RESULT]]
;
; IR-DPP-LABEL: @global_atomic__fmax_double_div_address_uni_value_agent_scope_unsafe_structfp(
; IR-DPP-NEXT:    [[RESULT:%.*]] = atomicrmw fmax ptr addrspace(1) [[PTR:%.*]], double [[VAL:%.*]] syncscope("agent") monotonic, align 8
; IR-DPP-NEXT:    ret double [[RESULT]]
;
  %result = atomicrmw fmax ptr addrspace(1) %ptr, double %val syncscope("agent") monotonic
...
; IR-ITERATIVE-LABEL: @global_atomic__fmax_double_div_address_div_value_agent_scope_unsafe_structfp(
; IR-ITERATIVE-NEXT:    [[RESULT:%.*]] = atomicrmw fmax ptr addrspace(1) [[PTR:%.*]], double [[VAL:%.*]] syncscope("agent") monotonic, align 8
; IR-ITERATIVE-NEXT:    ret double [[RESULT]]
;
; IR-DPP-LABEL: @global_atomic__fmax_double_div_address_div_value_agent_scope_unsafe_structfp(
; IR-DPP-NEXT:    [[RESULT:%.*]] = atomicrmw fmax ptr addrspace(1) [[PTR:%.*]], double [[VAL:%.*]] syncscope("agent") monotonic, align 8
; IR-DPP-NEXT:    ret double [[RESULT]]
;
  %result = atomicrmw fmax ptr addrspace(1) %ptr, double %val syncscope("agent") monotonic
