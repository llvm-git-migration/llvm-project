...
; GISEL12-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GISEL12-NEXT:    s_and_b32 s8, vcc_lo, exec_lo
; GISEL12-NEXT:    s_wait_alu 0xfffe
...
; GISEL10-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GISEL10-NEXT:    s_and_b32 s8, vcc_lo, exec_lo
...
; GISEL12-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GISEL12-NEXT:    s_and_b32 s9, vcc_lo, exec_lo
; GISEL12-NEXT:    s_wait_alu 0xfffe
...
; GISEL10-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GISEL10-NEXT:    s_and_b32 s9, vcc_lo, exec_lo
...
; GISEL12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
; GISEL12-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v13
; GISEL12-NEXT:    s_and_b32 s8, vcc_lo, exec_lo
; GISEL12-NEXT:    s_wait_alu 0xfffe
...
; GISEL10-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v13
; GISEL10-NEXT:    s_and_b32 s8, vcc_lo, exec_lo
