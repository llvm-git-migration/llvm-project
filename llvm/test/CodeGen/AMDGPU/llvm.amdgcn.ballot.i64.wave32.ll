...
; DAGISEL-LABEL: compare_ints:
; DAGISEL:       ; %bb.0:
; DAGISEL-NEXT:    v_cmp_eq_u32_e64 s0, v0, v1
; DAGISEL-NEXT:    s_mov_b32 s1, 0
; DAGISEL-NEXT:    ; return to shader part epilog
;
; GISEL-LABEL: compare_ints:
; GISEL:       ; %bb.0:
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v0, v1
; GISEL-NEXT:    s_mov_b32 s1, 0
; GISEL-NEXT:    s_and_b32 s0, vcc_lo, exec_lo
; GISEL-NEXT:    ; return to shader part epilog
  %cmp = icmp eq i32 %x, %y
...
; GISEL:       ; %bb.0:
; GISEL-NEXT:    v_cmp_le_i32_e32 vcc_lo, 0x63, v0
; GISEL-NEXT:    s_mov_b32 s1, 0
; GISEL-NEXT:    s_and_b32 s0, vcc_lo, exec_lo
; GISEL-NEXT:    ; return to shader part epilog
...
; DAGISEL-LABEL: compare_floats:
; DAGISEL:       ; %bb.0:
; DAGISEL-NEXT:    v_cmp_gt_f32_e64 s0, v0, v1
; DAGISEL-NEXT:    s_mov_b32 s1, 0
; DAGISEL-NEXT:    ; return to shader part epilog
;
; GISEL-LABEL: compare_floats:
; GISEL:       ; %bb.0:
; GISEL-NEXT:    v_cmp_gt_f32_e32 vcc_lo, v0, v1
; GISEL-NEXT:    s_mov_b32 s1, 0
; GISEL-NEXT:    s_and_b32 s0, vcc_lo, exec_lo
; GISEL-NEXT:    ; return to shader part epilog
...
; DAGISEL-NEXT:    v_cmp_gt_f32_e64 s0, v0, v1
; DAGISEL-NEXT:    s_mov_b32 s1, 0
; DAGISEL-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; DAGISEL-NEXT:    ; return to shader part epilog
;
