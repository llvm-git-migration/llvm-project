...
; GFX8-NEXT:    s_ff1_i32_b64 s4, s[0:1]
...
; GFX1064-NEXT:    s_ff1_i32_b64 s7, s[0:1]
...
; GFX1032-NEXT:    v_readlane_b32 s5, v0, s1
; GFX1032-NEXT:    s_lshl_b32 s6, 1, s1
; GFX1032-NEXT:    v_writelane_b32 v1, s4, s1
; GFX1032-NEXT:    s_andn2_b32 s0, s0, s6
...
; GFX1164-NEXT:    s_ctz_i32_b64 s7, s[0:1]
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX1164-NEXT:    v_readlane_b32 s8, v1, s7
; GFX1164-NEXT:    s_lshl_b64 s[4:5], 1, s7
; GFX1164-NEXT:    v_writelane_b32 v0, s6, s7
...
; GFX1132-NEXT:    s_lshl_b32 s6, 1, s1
; GFX1132-NEXT:    v_writelane_b32 v0, s4, s1
; GFX1132-NEXT:    s_and_not1_b32 s0, s0, s6
...
; GFX1264:       ; %bb.0: ; %entry
; GFX1264-NEXT:    v_and_b32_e32 v1, 0x3ff, v0
; GFX1264-NEXT:    s_mov_b64 s[0:1], exec
...
; GFX1264-NEXT:    s_ctz_i32_b64 s7, s[0:1]
; GFX1264-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX1264-NEXT:    v_readlane_b32 s8, v1, s7
; GFX1264-NEXT:    s_lshl_b64 s[4:5], 1, s7
; GFX1264-NEXT:    v_writelane_b32 v0, s6, s7
; GFX1264-NEXT:    s_and_not1_b64 s[0:1], s[0:1], s[4:5]
; GFX1264-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1264-NEXT:    s_add_co_i32 s6, s6, s8
; GFX1264-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX1264-NEXT:    s_cbranch_scc1 .LBB2_1
; GFX1264-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX1264-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1264-NEXT:    v_mbcnt_lo_u32_b32 v1, exec_lo, 0
; GFX1264-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1264-NEXT:    v_mbcnt_hi_u32_b32 v1, exec_hi, v1
; GFX1264-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v1
; GFX1264-NEXT:    ; implicit-def: $vgpr1
...
; GFX1264-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1264-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1264-NEXT:    v_add_nc_u32_e32 v0, s2, v0
; GFX1264-NEXT:    s_mov_b32 s2, -1
; GFX1264-NEXT:    buffer_store_b32 v0, off, s[0:3], null
; GFX1264-NEXT:    s_nop 0
; GFX1264-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GFX1232:       ; %bb.0: ; %entry
; GFX1232-NEXT:    v_and_b32_e32 v1, 0x3ff, v0
...
; GFX1232-NEXT:    s_ctz_i32_b32 s1, s0
; GFX1232-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX1232-NEXT:    v_readlane_b32 s5, v1, s1
; GFX1232-NEXT:    s_lshl_b32 s6, 1, s1
; GFX1232-NEXT:    v_writelane_b32 v0, s4, s1
; GFX1232-NEXT:    s_and_not1_b32 s0, s0, s6
; GFX1232-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1232-NEXT:    s_add_co_i32 s4, s4, s5
; GFX1232-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1232-NEXT:    s_cbranch_scc1 .LBB2_1
; GFX1232-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX1232-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1232-NEXT:    v_mbcnt_lo_u32_b32 v1, exec_lo, 0
; GFX1232-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1232-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v1
; GFX1232-NEXT:    ; implicit-def: $vgpr1
...
; GFX1232-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1232-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1232-NEXT:    v_add_nc_u32_e32 v0, s2, v0
; GFX1232-NEXT:    s_mov_b32 s2, -1
; GFX1232-NEXT:    buffer_store_b32 v0, off, s[0:3], null
; GFX1232-NEXT:    s_nop 0
; GFX1232-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GFX1164-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164-NEXT:    s_mov_b32 s6, -1
; GFX1164-NEXT:    s_mov_b32 s11, s7
; GFX1164-NEXT:    s_mov_b32 s10, s6
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    s_mov_b32 s8, s2
; GFX1164-NEXT:    s_mov_b32 s9, s3
; GFX1164-NEXT:    s_mov_b32 s4, s0
; GFX1164-NEXT:    buffer_atomic_add_u64 v[0:1], off, s[8:11], 0 glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    buffer_gl1_inv
; GFX1164-NEXT:    buffer_gl0_inv
; GFX1164-NEXT:    s_mov_b32 s5, s1
; GFX1164-NEXT:    buffer_store_b64 v[0:1], off, s[4:7], 0
; GFX1164-NEXT:    s_nop 0
; GFX1164-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1164-NEXT:    s_endpgm
...
; GFX1132-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1132-NEXT:    s_mov_b32 s6, -1
; GFX1132-NEXT:    s_mov_b32 s11, s7
; GFX1132-NEXT:    s_mov_b32 s10, s6
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    s_mov_b32 s8, s2
; GFX1132-NEXT:    s_mov_b32 s9, s3
; GFX1132-NEXT:    s_mov_b32 s4, s0
; GFX1132-NEXT:    buffer_atomic_add_u64 v[0:1], off, s[8:11], 0 glc
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    buffer_gl1_inv
; GFX1132-NEXT:    buffer_gl0_inv
; GFX1132-NEXT:    s_mov_b32 s5, s1
; GFX1132-NEXT:    buffer_store_b64 v[0:1], off, s[4:7], 0
; GFX1132-NEXT:    s_nop 0
; GFX1132-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1132-NEXT:    s_endpgm
...
; GFX1264-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1264-NEXT:    s_mov_b32 s6, -1
; GFX1264-NEXT:    s_mov_b32 s11, s7
; GFX1264-NEXT:    s_mov_b32 s10, s6
; GFX1264-NEXT:    s_wait_kmcnt 0x0
; GFX1264-NEXT:    s_mov_b32 s8, s2
; GFX1264-NEXT:    s_mov_b32 s9, s3
; GFX1264-NEXT:    s_mov_b32 s4, s0
; GFX1264-NEXT:    global_wb scope:SCOPE_DEV
; GFX1264-NEXT:    buffer_atomic_add_u64 v[0:1], off, s[8:11], null th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX1264-NEXT:    s_wait_loadcnt 0x0
; GFX1264-NEXT:    global_inv scope:SCOPE_DEV
; GFX1264-NEXT:    s_mov_b32 s5, s1
; GFX1264-NEXT:    buffer_store_b64 v[0:1], off, s[4:7], null
; GFX1264-NEXT:    s_nop 0
; GFX1264-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1264-NEXT:    s_endpgm
...
; GFX1232-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1232-NEXT:    s_mov_b32 s6, -1
; GFX1232-NEXT:    s_mov_b32 s11, s7
; GFX1232-NEXT:    s_mov_b32 s10, s6
; GFX1232-NEXT:    s_wait_kmcnt 0x0
; GFX1232-NEXT:    s_mov_b32 s8, s2
; GFX1232-NEXT:    s_mov_b32 s9, s3
; GFX1232-NEXT:    s_mov_b32 s4, s0
; GFX1232-NEXT:    global_wb scope:SCOPE_DEV
; GFX1232-NEXT:    buffer_atomic_add_u64 v[0:1], off, s[8:11], null th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX1232-NEXT:    s_wait_loadcnt 0x0
; GFX1232-NEXT:    global_inv scope:SCOPE_DEV
; GFX1232-NEXT:    s_mov_b32 s5, s1
; GFX1232-NEXT:    buffer_store_b64 v[0:1], off, s[4:7], null
; GFX1232-NEXT:    s_nop 0
; GFX1232-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1232-NEXT:    s_endpgm
