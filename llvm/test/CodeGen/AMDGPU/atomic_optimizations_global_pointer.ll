...
; GFX1264-NEXT:    s_mov_b32 s9, s3
; GFX1264-NEXT:    global_wb scope:SCOPE_DEV
; GFX1264-NEXT:    buffer_atomic_add_u32 v0, off, s[8:11], null th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX1264-NEXT:    s_wait_loadcnt 0x0
; GFX1264-NEXT:    global_inv scope:SCOPE_DEV
; GFX1264-NEXT:  .LBB2_4:
; GFX1264-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX1232-NEXT:    s_mov_b32 s9, s3
; GFX1232-NEXT:    global_wb scope:SCOPE_DEV
; GFX1232-NEXT:    buffer_atomic_add_u32 v0, off, s[8:11], null th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX1232-NEXT:    s_wait_loadcnt 0x0
; GFX1232-NEXT:    global_inv scope:SCOPE_DEV
; GFX1232-NEXT:  .LBB2_4:
...
; GFX12-NEXT:    buffer_atomic_add_u64 v[0:1], off, s[8:11], null th:TH_ATOMIC_RETURN scope:SCOPE_DEV
...
; GFX1264-NEXT:    s_mov_b32 s9, s3
; GFX1264-NEXT:    global_wb scope:SCOPE_DEV
; GFX1264-NEXT:    buffer_atomic_sub_u32 v0, off, s[8:11], null th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX1264-NEXT:    s_wait_loadcnt 0x0
; GFX1264-NEXT:    global_inv scope:SCOPE_DEV
; GFX1264-NEXT:  .LBB8_4:
; GFX1264-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX1232-NEXT:    s_mov_b32 s9, s3
; GFX1232-NEXT:    global_wb scope:SCOPE_DEV
; GFX1232-NEXT:    buffer_atomic_sub_u32 v0, off, s[8:11], null th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX1232-NEXT:    s_wait_loadcnt 0x0
; GFX1232-NEXT:    global_inv scope:SCOPE_DEV
; GFX1232-NEXT:  .LBB8_4:
; GFX1232-NEXT:    s_or_b32 exec_lo, exec_lo, s5
...
; GFX12-NEXT:    s_mov_b32 s4, s0
; GFX12-NEXT:    global_wb scope:SCOPE_DEV
; GFX12-NEXT:    buffer_atomic_sub_u64 v[0:1], off, s[8:11], null th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-NEXT:    s_mov_b32 s5, s1
; GFX12-NEXT:    buffer_store_b64 v[0:1], off, s[4:7], null
