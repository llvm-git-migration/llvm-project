...
; GFX9-G-NEXT:    v_addc_co_u32_e32 v6, vcc, v1, v5, vcc
; GFX9-G-NEXT:    v_addc_co_u32_e32 v0, vcc, 0, v2, vcc
; GFX9-G-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v3, vcc
; GFX9-G-NEXT:    v_lshlrev_b64 v[4:5], 31, v[0:1]
; GFX9-G-NEXT:    v_lshrrev_b32_e32 v0, 1, v6
; GFX9-G-NEXT:    v_or_b32_e32 v0, v0, v4
; GFX9-G-NEXT:    v_ashrrev_i32_e32 v4, 31, v1
; GFX9-G-NEXT:    v_ashrrev_i32_e32 v6, 1, v1
; GFX9-G-NEXT:    v_sub_co_u32_e32 v1, vcc, 0, v0
; GFX9-G-NEXT:    v_subb_co_u32_e32 v7, vcc, 0, v5, vcc
; GFX9-G-NEXT:    v_subb_co_u32_e32 v8, vcc, 0, v6, vcc
; GFX9-G-NEXT:    v_subb_co_u32_e32 v9, vcc, 0, v4, vcc
; GFX9-G-NEXT:    v_cmp_gt_i64_e32 vcc, 0, v[2:3]
; GFX9-G-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GFX9-G-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[2:3]
; GFX9-G-NEXT:    v_cndmask_b32_e64 v2, v10, 0, vcc
; GFX9-G-NEXT:    v_and_b32_e32 v2, 1, v2
; GFX9-G-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; GFX9-G-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; GFX9-G-NEXT:    v_cndmask_b32_e32 v1, v5, v7, vcc
; GFX9-G-NEXT:    v_cndmask_b32_e32 v2, v6, v8, vcc
; GFX9-G-NEXT:    v_cndmask_b32_e32 v3, v4, v9, vcc
; GFX9-G-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-G-O0-NEXT:    buffer_load_dword v2, off, s[0:3], s32 ; 4-byte Folded Reload
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v6, v3
; GFX9-G-O0-NEXT:    s_mov_b32 s4, 31
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v0, s4
; GFX9-G-O0-NEXT:    v_ashrrev_i32_e64 v0, v0, v6
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v3, v0
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v4, v0
; GFX9-G-O0-NEXT:    s_mov_b32 s6, 31
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v0, s6
; GFX9-G-O0-NEXT:    v_lshrrev_b64 v[4:5], v0, v[3:4]
; GFX9-G-O0-NEXT:    s_mov_b64 s[4:5], 0
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v3, v4
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v0, v5
; GFX9-G-O0-NEXT:    s_mov_b32 s10, 0
...
; GFX9-G-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-G-O0-NEXT:    v_add_co_u32_e64 v2, s[8:9], v2, v3
; GFX9-G-O0-NEXT:    v_addc_co_u32_e64 v1, s[8:9], v1, v0, s[8:9]
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v0, s10
; GFX9-G-O0-NEXT:    v_addc_co_u32_e64 v7, s[8:9], v9, v0, s[8:9]
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v0, s7
; GFX9-G-O0-NEXT:    v_addc_co_u32_e64 v4, s[8:9], v6, v0, s[8:9]
...
; GFX9-G-O0-NEXT:    v_lshlrev_b64 v[7:8], v2, v[7:8]
...
; GFX9-G-O0-NEXT:    v_sub_co_u32_e64 v8, s[6:7], v4, v0
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v4, s10
; GFX9-G-O0-NEXT:    v_subb_co_u32_e64 v7, s[6:7], v4, v1, s[6:7]
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v4, s9
; GFX9-G-O0-NEXT:    v_subb_co_u32_e64 v5, s[6:7], v4, v2, s[6:7]
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v4, s8
; GFX9-G-O0-NEXT:    v_subb_co_u32_e64 v4, s[6:7], v4, v3, s[6:7]
; GFX9-G-O0-NEXT:    ; kill: def $vgpr9 killed $vgpr9 def $vgpr9_vgpr10 killed $exec
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v10, v6
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v12, s5
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v11, s4
; GFX9-G-O0-NEXT:    v_cmp_lt_i64_e64 s[8:9], v[9:10], v[11:12]
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v12, s5
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v11, s4
; GFX9-G-O0-NEXT:    v_cmp_eq_u64_e64 s[4:5], v[9:10], v[11:12]
; GFX9-G-O0-NEXT:    s_mov_b32 s6, 0
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v9, 1
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v6, 0
; GFX9-G-O0-NEXT:    v_cndmask_b32_e64 v6, v6, v9, s[8:9]
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v9, s6
; GFX9-G-O0-NEXT:    v_cndmask_b32_e64 v6, v6, v9, s[4:5]
; GFX9-G-O0-NEXT:    v_and_b32_e32 v9, 1, v6
; GFX9-G-O0-NEXT:    v_cmp_ne_u32_e64 s[4:5], 0, v9
; GFX9-G-O0-NEXT:    v_cndmask_b32_e64 v0, v0, v8, s[4:5]
; GFX9-G-O0-NEXT:    v_cndmask_b32_e64 v1, v1, v7, s[4:5]
; GFX9-G-O0-NEXT:    v_and_b32_e32 v6, 1, v6
; GFX9-G-O0-NEXT:    v_cmp_ne_u32_e64 s[4:5], 0, v6
; GFX9-G-O0-NEXT:    v_cndmask_b32_e64 v2, v2, v5, s[4:5]
; GFX9-G-O0-NEXT:    v_cndmask_b32_e64 v3, v3, v4, s[4:5]
; GFX9-G-O0-NEXT:    s_setpc_b64 s[30:31]
