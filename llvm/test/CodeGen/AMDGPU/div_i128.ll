...
; GFX9-G:       ; %bb.0:
; GFX9-G-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-G-NEXT:    v_ashrrev_i32_e32 v0, 31, v3
; GFX9-G-NEXT:    v_mov_b32_e32 v4, v1
; GFX9-G-NEXT:    v_mov_b32_e32 v1, v0
; GFX9-G-NEXT:    v_lshlrev_b64 v[0:1], 31, v[0:1]
; GFX9-G-NEXT:    v_add_co_u32_e32 v5, vcc, v2, v0
; GFX9-G-NEXT:    v_addc_co_u32_e32 v6, vcc, v3, v1, vcc
; GFX9-G-NEXT:    v_lshlrev_b64 v[0:1], 31, v[5:6]
; GFX9-G-NEXT:    v_lshrrev_b32_e32 v2, 1, v4
; GFX9-G-NEXT:    v_or_b32_e32 v0, v2, v0
; GFX9-G-NEXT:    v_ashrrev_i32_e32 v3, 31, v6
; GFX9-G-NEXT:    v_ashrrev_i32_e32 v2, 1, v6
; GFX9-G-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-G-O0-NEXT:    s_mov_b32 s4, 31
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v0, s4
; GFX9-G-O0-NEXT:    v_lshlrev_b64 v[5:6], v0, v[4:5]
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v4, v5
; GFX9-G-O0-NEXT:    v_mov_b32_e32 v0, v6
; GFX9-G-O0-NEXT:    v_add_co_u32_e64 v5, s[6:7], v2, v4
