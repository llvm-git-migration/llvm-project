...
; GFX906-NEXT:    br label [[BB_2]]
; GFX906:       bb.2:
; GFX906-NEXT:    [[TMP5_TC_BC:%.*]] = phi <8 x i8> [ [[VEC1]], [[ENTRY:%.*]] ], [ [[VEC2]], [[BB_1]] ]
...
; GFX906:       bb.3:
; GFX906-NEXT:    [[TMP7_TC_BC:%.*]] = phi <8 x i8> [ [[VEC2]], [[BB_1]] ], [ [[TMP5_TC_BC]], [[BB_2]] ]
...
; GFX906-NEXT:    br label [[BB_3]]
; GFX906:       bb.3:
; GFX906-NEXT:    [[TMP5_TC_BC:%.*]] = phi <8 x i8> [ [[VEC1]], [[ENTRY:%.*]] ], [ [[VEC2]], [[BB_1]] ], [ [[VEC2]], [[BB_2]] ]
