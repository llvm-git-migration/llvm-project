...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_movk_i32 s0, 0xf000
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_movk_i32 s0, 0xefff
; GFX12-NEXT:    s_mov_b32 s1, -1
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[2:3], s[0:1]
; GFX12-NEXT:    s_load_u8 s0, s[0:1], 0x0
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_movk_i32 s0, 0xeffe
; GFX12-NEXT:    s_mov_b32 s1, -1
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[2:3], s[0:1]
; GFX12-NEXT:    s_load_u8 s0, s[0:1], 0x0
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_movk_i32 s0, 0xf800
; GFX12-NEXT:    s_mov_b32 s1, -1
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[2:3], s[0:1]
; GFX12-NEXT:    s_load_u8 s0, s[0:1], 0x0
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_movk_i32 s0, 0xf7ff
; GFX12-NEXT:    s_mov_b32 s1, -1
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[2:3], s[0:1]
; GFX12-NEXT:    s_load_u8 s0, s[0:1], 0x0
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_movk_i32 s0, 0xf7fe
; GFX12-NEXT:    s_mov_b32 s1, -1
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[2:3], s[0:1]
; GFX12-NEXT:    s_load_u8 s0, s[0:1], 0x0
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b32 s0, 0xff800000
; GFX12-NEXT:    s_mov_b32 s1, -1
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[2:3], s[0:1]
; GFX12-NEXT:    s_load_u8 s0, s[0:1], 0x0
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: global_load_saddr_i8_offset_0x100000000:
; GFX12:       ; %bb.0:
...
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    s_mov_b32 s0, 1
; GFX12-GISEL-NEXT:    s_mov_b32 s1, 1
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-GISEL-NEXT:    s_add_nc_u64 s[0:1], s[2:3], s[0:1]
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: global_load_saddr_i8_offset_0x100000FFF:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_movk_i32 s0, 0xfff
; GFX12-NEXT:    s_mov_b32 s1, 1
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[2:3], s[0:1]
; GFX12-NEXT:    s_load_u8 s0, s[0:1], 0x0
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: global_load_saddr_i8_offset_0x100001000:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_movk_i32 s0, 0x1000
; GFX12-NEXT:    s_mov_b32 s1, 1
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[2:3], s[0:1]
; GFX12-NEXT:    s_load_u8 s0, s[0:1], 0x0
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: global_load_saddr_i8_offset_neg0xFFFFFFFF:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b32 s0, 1
; GFX12-NEXT:    s_mov_b32 s1, -1
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: global_load_saddr_i8_offset_neg0x100000000:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b32 s0, 0
; GFX12-NEXT:    s_mov_b32 s1, -1
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: global_load_saddr_i8_offset_neg0x100000001:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b32 s0, -1
...
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[2:3], s[4:5]
; GFX12-NEXT:    s_movk_i32 s2, 0xffe8
