...
; GFX12-NEXT:    s_wait_storecnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_min_num_f32_e32 v5, v4, v8
...
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_min_f32_e32 v5, v4, v8
...
; GFX10-NEXT:    s_mov_b32 s6, exec_lo
; GFX10-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-NEXT:    v_min_f32_e32 v5, v4, v8
...
; GFX7-NEXT:    v_min_f32_e32 v5, v4, v8
...
; GFX6-NEXT:    v_min_f32_e32 v5, v4, v8
...
; GFX6-NEXT:    v_min_f64 v[0:1], v[0:1], v[4:5]
; GFX6-NEXT:    s_waitcnt expcnt(0)
...
; GFX940-NEXT:    v_min_f64 v[10:11], v[0:1], v[4:5]
...
; GFX10-NEXT:    s_mov_b32 s6, exec_lo
; GFX10-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-NEXT:    v_min_f64 v[11:12], v[0:1], v[4:5]
...
; GFX90A-NEXT:    v_min_f64 v[10:11], v[0:1], v[4:5]
...
; GFX7-NEXT:    s_mov_b64 s[12:13], exec
; GFX7-NEXT:    v_min_f64 v[11:12], v[0:1], v[4:5]
...
; GFX6-NEXT:    s_mov_b64 s[12:13], exec
; GFX6-NEXT:    v_min_f64 v[11:12], v[0:1], v[4:5]
