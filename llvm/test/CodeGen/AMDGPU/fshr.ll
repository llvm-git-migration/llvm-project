...
; SI-NEXT:    v_alignbit_b32 v0, s6, v0, v1
...
; GFX9-NEXT:    v_alignbit_b32 v1, s6, v1, v2
...
; GFX10-NEXT:    v_alignbit_b32 v0, s6, s7, v0
...
; GFX11-NEXT:    v_alignbit_b32 v0, s6, s7, v0
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s7
; VI-NEXT:    v_alignbit_b32 v2, s6, v0, 7
; VI-NEXT:    v_mov_b32_e32 v0, s4
; VI-NEXT:    v_mov_b32_e32 v1, s5
; VI-NEXT:    flat_store_dword v[0:1], v2
; VI-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_alignbit_b32 v1, s6, s7, 7
