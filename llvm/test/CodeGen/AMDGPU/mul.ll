...
; VI-NEXT:    v_mul_lo_u32 v16, v5, v2
; VI-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], v0, v4, 0
; VI-NEXT:    v_mul_lo_u32 v17, v7, v0
; VI-NEXT:    v_add_u32_e32 v7, vcc, v13, v10
; VI-NEXT:    v_mov_b32_e32 v10, v3
; VI-NEXT:    v_mad_u64_u32 v[14:15], s[0:1], v1, v4, v[10:11]
; VI-NEXT:    v_add_u32_e32 v13, vcc, v7, v16
; VI-NEXT:    v_mul_lo_u32 v18, v6, v1
; VI-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], v6, v0, v[12:13]
; VI-NEXT:    v_mov_b32_e32 v10, v14
; VI-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], v0, v5, v[10:11]
; VI-NEXT:    v_add_u32_e32 v7, vcc, v17, v7
; VI-NEXT:    v_add_u32_e32 v10, vcc, v15, v4
; VI-NEXT:    v_addc_u32_e64 v11, s[0:1], 0, 0, vcc
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], v1, v5, v[10:11]
; VI-NEXT:    v_add_u32_e32 v5, vcc, v18, v7
; VI-NEXT:    v_add_u32_e32 v4, vcc, v0, v6
