...
; RUN: llc -mtriple=amdgcn -mcpu=gfx940 < %s | FileCheck -check-prefix=GFX940 %s
...
; GFX940-NEXT:    v_min_f16_e32 v3, 4.0, v3
...
; GFX940-NEXT:    v_min_f16_e32 v4, 4.0, v4
...
; GFX940-NEXT:    v_min_f16_e32 v1, 4.0, v1
...
; GFX940-NEXT:    v_min_f16_e32 v2, 4.0, v2
...
; GFX940-NEXT:    s_nop 0
; GFX940-NEXT:    v_min_f32_e32 v3, 4.0, v3
...
; GFX940-NEXT:    s_nop 0
; GFX940-NEXT:    v_min_f32_e32 v4, 4.0, v4
