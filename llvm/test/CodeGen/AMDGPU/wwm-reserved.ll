...
; GFX9-O3-NEXT:    s_getpc_b64 s[10:11]
; GFX9-O3-NEXT:    s_add_u32 s10, s10, called@rel32@lo+4
; GFX9-O3-NEXT:    s_addc_u32 s11, s11, called@rel32@hi+12
; GFX9-O3-NEXT:    s_mov_b64 exec, s[8:9]
; GFX9-O3-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-O3-NEXT:    v_mov_b32_e32 v2, s2
; GFX9-O3-NEXT:    s_not_b64 exec, s[8:9]
...
; GFX9-O3-NEXT:    s_swappc_b64 s[30:31], s[10:11]
...
; GFX9-O3-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-O3-NEXT:    s_or_saveexec_b64 s[6:7], -1
; GFX9-O3-NEXT:    s_getpc_b64 s[0:1]
; GFX9-O3-NEXT:    s_add_u32 s0, s0, called_i64@gotpcrel32@lo+4
; GFX9-O3-NEXT:    s_addc_u32 s1, s1, called_i64@gotpcrel32@hi+12
; GFX9-O3-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0x0
; GFX9-O3-NEXT:    s_mov_b64 exec, s[6:7]
; GFX9-O3-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-O3-NEXT:    v_mov_b32_e32 v6, s2
; GFX9-O3-NEXT:    v_mov_b32_e32 v7, s3
; GFX9-O3-NEXT:    s_not_b64 exec, s[6:7]
...
; GFX9-O3-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GFX9-O3-NEXT:    s_getpc_b64 s[10:11]
; GFX9-O3-NEXT:    s_add_u32 s10, s10, strict_wwm_called@rel32@lo+4
; GFX9-O3-NEXT:    s_addc_u32 s11, s11, strict_wwm_called@rel32@hi+12
; GFX9-O3-NEXT:    s_mov_b64 exec, s[8:9]
; GFX9-O3-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-O3-NEXT:    v_mov_b32_e32 v2, s2
; GFX9-O3-NEXT:    s_not_b64 exec, s[8:9]
...
; GFX9-O3-NEXT:    s_or_saveexec_b64 s[6:7], -1
; GFX9-O3-NEXT:    s_getpc_b64 s[0:1]
; GFX9-O3-NEXT:    s_add_u32 s0, s0, strict_wwm_called_i64@gotpcrel32@lo+4
; GFX9-O3-NEXT:    s_addc_u32 s1, s1, strict_wwm_called_i64@gotpcrel32@hi+12
; GFX9-O3-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0x0
; GFX9-O3-NEXT:    s_mov_b64 exec, s[6:7]
; GFX9-O3-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-O3-NEXT:    v_mov_b32_e32 v6, s2
