...
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[6:7], -1
; GFX9-O0-NEXT:    v_writelane_b32 v3, s6, 4
; GFX9-O0-NEXT:    v_writelane_b32 v3, s7, 5
...
; GFX9-O0-NEXT:    v_writelane_b32 v3, s16, 6
; GFX9-O0-NEXT:    v_writelane_b32 v3, s17, 7
; GFX9-O0-NEXT:    v_writelane_b32 v3, s18, 8
; GFX9-O0-NEXT:    v_writelane_b32 v3, s19, 9
...
; GFX9-O0-NEXT:    v_readlane_b32 s0, v3, 6
; GFX9-O0-NEXT:    v_readlane_b32 s1, v3, 7
; GFX9-O0-NEXT:    v_readlane_b32 s2, v3, 8
; GFX9-O0-NEXT:    v_readlane_b32 s3, v3, 9
; GFX9-O0-NEXT:    v_readlane_b32 s6, v3, 4
; GFX9-O0-NEXT:    v_readlane_b32 s7, v3, 5
; GFX9-O0-NEXT:    v_readlane_b32 s4, v3, 10
; GFX9-O0-NEXT:    v_mov_b32_e32 v3, v0
...
; GFX9-O0-NEXT:    v_writelane_b32 v8, s8, 4
; GFX9-O0-NEXT:    v_writelane_b32 v8, s9, 5
; GFX9-O0-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-O0-NEXT:    v_writelane_b32 v8, s16, 6
; GFX9-O0-NEXT:    v_writelane_b32 v8, s17, 7
; GFX9-O0-NEXT:    v_writelane_b32 v8, s18, 8
; GFX9-O0-NEXT:    v_writelane_b32 v8, s19, 9
...
; GFX9-O0-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-O0-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; GFX9-O0-NEXT:    v_readlane_b32 s0, v8, 6
; GFX9-O0-NEXT:    v_readlane_b32 s1, v8, 7
; GFX9-O0-NEXT:    v_readlane_b32 s2, v8, 8
; GFX9-O0-NEXT:    v_readlane_b32 s3, v8, 9
