...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -amdgcn-verify-memory-legalizer < %s | FileCheck --check-prefixes=GFX12-WGP %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -mattr=+cumode -amdgcn-verify-memory-legalizer < %s | FileCheck --check-prefixes=GFX12-CU %s
