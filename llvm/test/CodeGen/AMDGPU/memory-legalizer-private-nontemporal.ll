...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -amdgpu-verify-memory-legalizer < %s | FileCheck --check-prefixes=GFX12-WGP %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -mattr=+cumode -amdgpu-verify-memory-legalizer < %s | FileCheck --check-prefixes=GFX12-CU %s
