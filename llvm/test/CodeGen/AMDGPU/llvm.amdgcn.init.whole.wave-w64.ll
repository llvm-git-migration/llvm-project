...
; GISEL12-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GISEL12-NEXT:    s_and_b64 s[12:13], vcc, exec
; GISEL12-NEXT:    s_wait_alu 0xfffe
; GISEL12-NEXT:    v_mov_b32_e32 v0, s12
; GISEL12-NEXT:    v_mov_b32_e32 v1, s13
; GISEL12-NEXT:    s_mov_b64 exec, s[10:11]
; GISEL12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
...
; GISEL10-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GISEL10-NEXT:    s_and_b64 s[12:13], vcc, exec
