...
; GFX9-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x4
...
; GFX9-NEXT:    s_add_u32 s16, s16, indirect@rel32@lo+4
; GFX9-NEXT:    s_addc_u32 s17, s17, indirect@rel32@hi+12
; GFX9-NEXT:    v_mad_u32_u24 v3, v1, s9, v3
