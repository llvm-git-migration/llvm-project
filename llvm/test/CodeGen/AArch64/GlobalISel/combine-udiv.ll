...
; GISEL-NEXT:    neg v1.16b, v1.16b
; GISEL-NEXT:    ushl v1.16b, v0.16b, v1.16b
; GISEL-NEXT:    umull2 v3.8h, v1.16b, v2.16b
; GISEL-NEXT:    umull v1.8h, v1.8b, v2.8b
; GISEL-NEXT:    ldr q2, [x8, :lo12:.LCPI4_0]
; GISEL-NEXT:    mov w8, #7 // =0x7
; GISEL-NEXT:    fmov s4, w8
; GISEL-NEXT:    shl v2.16b, v2.16b, #7
; GISEL-NEXT:    uzp2 v1.16b, v1.16b, v3.16b
; GISEL-NEXT:    neg v3.16b, v4.16b
...
; GISEL-NEXT:    fmov s7, w9
; GISEL-NEXT:    mov v2.h[1], v1.h[0]
; GISEL-NEXT:    adrp x9, .LCPI5_0
; GISEL-NEXT:    mov v3.h[1], v3.h[0]
; GISEL-NEXT:    mov v2.h[2], v1.h[0]
; GISEL-NEXT:    mov v3.h[2], v4.h[0]
; GISEL-NEXT:    fmov s4, w8
; GISEL-NEXT:    mov w8, #32768 // =0x8000
; GISEL-NEXT:    fmov s5, w8
; GISEL-NEXT:    mov w8, #35545 // =0x8ad9
; GISEL-NEXT:    mov v2.h[3], v1.h[0]
; GISEL-NEXT:    mov v3.h[3], v4.h[0]
; GISEL-NEXT:    mov v4.h[1], v5.h[0]
; GISEL-NEXT:    mov v2.h[4], v1.h[0]
; GISEL-NEXT:    mov v3.h[4], v6.h[0]
; GISEL-NEXT:    fmov s6, w8
; GISEL-NEXT:    mov v4.h[2], v1.h[0]
; GISEL-NEXT:    mov w8, #6 // =0x6
; GISEL-NEXT:    mov v2.h[5], v1.h[0]
; GISEL-NEXT:    mov v3.h[5], v6.h[0]
; GISEL-NEXT:    fmov s6, w8
; GISEL-NEXT:    mov v4.h[3], v1.h[0]
; GISEL-NEXT:    mov w8, #2115 // =0x843
; GISEL-NEXT:    mov v2.h[6], v1.h[0]
; GISEL-NEXT:    mov v16.h[1], v6.h[0]
; GISEL-NEXT:    mov v3.h[6], v7.h[0]
; GISEL-NEXT:    fmov s7, w8
; GISEL-NEXT:    mov v4.h[4], v1.h[0]
; GISEL-NEXT:    mov w8, #12 // =0xc
; GISEL-NEXT:    mov v2.h[7], v1.h[0]
; GISEL-NEXT:    mov v16.h[2], v6.h[0]
; GISEL-NEXT:    mov v3.h[7], v7.h[0]
; GISEL-NEXT:    fmov s7, w8
; GISEL-NEXT:    mov v4.h[5], v1.h[0]
; GISEL-NEXT:    mov w8, #14 // =0xe
; GISEL-NEXT:    neg v2.8h, v2.8h
; GISEL-NEXT:    mov v16.h[3], v7.h[0]
; GISEL-NEXT:    mov v4.h[6], v1.h[0]
; GISEL-NEXT:    ushl v2.8h, v0.8h, v2.8h
; GISEL-NEXT:    mov v4.h[7], v5.h[0]
; GISEL-NEXT:    ldr d5, [x9, :lo12:.LCPI5_0]
; GISEL-NEXT:    umull2 v7.4s, v2.8h, v3.8h
; GISEL-NEXT:    umull v2.4s, v2.4h, v3.4h
; GISEL-NEXT:    fmov s3, w8
; GISEL-NEXT:    mov w8, #4 // =0x4
; GISEL-NEXT:    mov v16.h[4], v3.h[0]
; GISEL-NEXT:    uzp2 v2.8h, v2.8h, v7.8h
; GISEL-NEXT:    mov v16.h[5], v6.h[0]
; GISEL-NEXT:    sub v3.8h, v0.8h, v2.8h
; GISEL-NEXT:    mov v16.h[6], v1.h[0]
; GISEL-NEXT:    umull2 v1.4s, v3.8h, v4.8h
; GISEL-NEXT:    umull v3.4s, v3.4h, v4.4h
; GISEL-NEXT:    fmov s4, w8
; GISEL-NEXT:    mov v16.h[7], v4.h[0]
; GISEL-NEXT:    uzp2 v1.8h, v3.8h, v1.8h
; GISEL-NEXT:    ushll v3.8h, v5.8b, #0
; GISEL-NEXT:    shl v3.8h, v3.8h, #15
; GISEL-NEXT:    add v1.8h, v1.8h, v2.8h
; GISEL-NEXT:    neg v2.8h, v16.8h
