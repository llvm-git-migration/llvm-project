...
; AARCH64-NEXT:    ret
entry:
  %c = call nnan <3 x float> @llvm.maximumnum(<3 x float> %a, <3 x float> %b)
  ret <3 x float> %c
}
...
; AARCH64-NEXT:    ret
entry:
  %c = call nnan <5 x float> @llvm.maximumnum(<5 x float> %a, <5 x float> %b)
  ret <5 x float> %c
}
...
; AARCH64-NEXT:    ret
entry:
  %c = call nnan <9 x half> @llvm.maximumnum(<9 x half> %a, <9 x half> %b)
  ret <9 x half> %c
}
...
; AARCH64-NEXT:    ret
entry:
  %c = call nnan <3 x double> @llvm.minimumnum(<3 x double> %a, <3 x double> %b)
  ret <3 x double> %c
}
...
; AARCH64-NEXT:    ret
entry:
  %c = call nnan <3 x float> @llvm.minimumnum(<3 x float> %a, <3 x float> %b)
  ret <3 x float> %c
}
...
; AARCH64-NEXT:    ret
entry:
  %c = call nnan <5 x float> @llvm.minimumnum(<5 x float> %a, <5 x float> %b)
  ret <5 x float> %c
}
...
; AARCH64-NEXT:    ret
entry:
  %c = call nnan <9 x half> @llvm.minimumnum(<9 x half> %a, <9 x half> %b)
  ret <9 x half> %c
}
