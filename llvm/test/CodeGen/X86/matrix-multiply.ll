...
; AVX512VL-NEXT:    vmulpd %xmm6, %xmm10, %xmm7
; AVX512VL-NEXT:    vaddpd %xmm7, %xmm9, %xmm7
; AVX512VL-NEXT:    vmulsd %xmm1, %xmm2, %xmm1
; AVX512VL-NEXT:    vmulsd %xmm4, %xmm5, %xmm4
; AVX512VL-NEXT:    vaddsd %xmm4, %xmm1, %xmm1
; AVX512VL-NEXT:    vmulsd %xmm10, %xmm8, %xmm4
; AVX512VL-NEXT:    vaddsd %xmm4, %xmm1, %xmm1
; AVX512VL-NEXT:    vinsertf128 $1, %xmm1, %ymm7, %ymm1
; AVX512VL-NEXT:    vmovddup {{.*#+}} xmm4 = mem[0,0]
...
; AVX1-NEXT:    vaddps %ymm9, %ymm8, %ymm8
; AVX1-NEXT:    vmovaps %ymm8, (%rsp) # 32-byte Spill
...
; AVX1-NEXT:    vbroadcastss 120(%rbp), %ymm13
; AVX1-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX1-NEXT:    vmulps %ymm2, %ymm13, %ymm12
; AVX1-NEXT:    vbroadcastss 124(%rbp), %ymm13
; AVX1-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX1-NEXT:    vmulps %ymm3, %ymm13, %ymm12
; AVX1-NEXT:    vbroadcastss 128(%rbp), %ymm13
; AVX1-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX1-NEXT:    vmulps %ymm4, %ymm13, %ymm12
; AVX1-NEXT:    vbroadcastss 132(%rbp), %ymm13
; AVX1-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX1-NEXT:    vmulps %ymm5, %ymm13, %ymm12
; AVX1-NEXT:    vbroadcastss 136(%rbp), %ymm13
; AVX1-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX1-NEXT:    vmulps %ymm6, %ymm13, %ymm12
; AVX1-NEXT:    vbroadcastss 140(%rbp), %ymm13
; AVX1-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX1-NEXT:    vmulps %ymm7, %ymm13, %ymm12
; AVX1-NEXT:    vbroadcastss 144(%rbp), %ymm13
; AVX1-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX1-NEXT:    vmulps %ymm0, %ymm13, %ymm12
...
; AVX1-NEXT:    vbroadcastss 244(%rbp), %ymm8
; AVX1-NEXT:    vmulps %ymm0, %ymm15, %ymm0
; AVX1-NEXT:    vmulps %ymm1, %ymm8, %ymm1
; AVX1-NEXT:    vbroadcastss 248(%rbp), %ymm8
; AVX1-NEXT:    vaddps %ymm1, %ymm0, %ymm0
; AVX1-NEXT:    vmulps %ymm2, %ymm8, %ymm1
; AVX1-NEXT:    vbroadcastss 252(%rbp), %ymm2
; AVX1-NEXT:    vaddps %ymm1, %ymm0, %ymm0
; AVX1-NEXT:    vmulps %ymm2, %ymm3, %ymm1
; AVX1-NEXT:    vbroadcastss 256(%rbp), %ymm2
; AVX1-NEXT:    vaddps %ymm1, %ymm0, %ymm0
; AVX1-NEXT:    vmulps %ymm2, %ymm4, %ymm1
; AVX1-NEXT:    vbroadcastss 260(%rbp), %ymm2
; AVX1-NEXT:    vaddps %ymm1, %ymm0, %ymm0
; AVX1-NEXT:    vmulps %ymm2, %ymm5, %ymm1
; AVX1-NEXT:    vbroadcastss 264(%rbp), %ymm2
; AVX1-NEXT:    vaddps %ymm1, %ymm0, %ymm0
; AVX1-NEXT:    vmulps %ymm2, %ymm6, %ymm1
; AVX1-NEXT:    vbroadcastss 268(%rbp), %ymm2
; AVX1-NEXT:    vaddps %ymm1, %ymm0, %ymm0
; AVX1-NEXT:    vmulps %ymm2, %ymm7, %ymm1
; AVX1-NEXT:    vaddps %ymm1, %ymm0, %ymm0
...
; AVX2-NEXT:    vaddps %ymm9, %ymm8, %ymm8
; AVX2-NEXT:    vmovaps %ymm8, (%rsp) # 32-byte Spill
...
; AVX2-NEXT:    vbroadcastss 120(%rbp), %ymm13
; AVX2-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX2-NEXT:    vmulps %ymm2, %ymm13, %ymm12
; AVX2-NEXT:    vbroadcastss 124(%rbp), %ymm13
; AVX2-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX2-NEXT:    vmulps %ymm3, %ymm13, %ymm12
; AVX2-NEXT:    vbroadcastss 128(%rbp), %ymm13
; AVX2-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX2-NEXT:    vmulps %ymm4, %ymm13, %ymm12
; AVX2-NEXT:    vbroadcastss 132(%rbp), %ymm13
; AVX2-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX2-NEXT:    vmulps %ymm5, %ymm13, %ymm12
; AVX2-NEXT:    vbroadcastss 136(%rbp), %ymm13
; AVX2-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX2-NEXT:    vmulps %ymm6, %ymm13, %ymm12
; AVX2-NEXT:    vbroadcastss 140(%rbp), %ymm13
; AVX2-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX2-NEXT:    vmulps %ymm7, %ymm13, %ymm12
; AVX2-NEXT:    vbroadcastss 144(%rbp), %ymm13
; AVX2-NEXT:    vaddps %ymm12, %ymm11, %ymm11
; AVX2-NEXT:    vmulps %ymm0, %ymm13, %ymm12
...
; AVX2-NEXT:    vbroadcastss 244(%rbp), %ymm8
; AVX2-NEXT:    vmulps %ymm0, %ymm15, %ymm0
; AVX2-NEXT:    vmulps %ymm1, %ymm8, %ymm1
; AVX2-NEXT:    vbroadcastss 248(%rbp), %ymm8
; AVX2-NEXT:    vaddps %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vmulps %ymm2, %ymm8, %ymm1
; AVX2-NEXT:    vbroadcastss 252(%rbp), %ymm2
; AVX2-NEXT:    vaddps %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vmulps %ymm2, %ymm3, %ymm1
; AVX2-NEXT:    vbroadcastss 256(%rbp), %ymm2
; AVX2-NEXT:    vaddps %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vmulps %ymm2, %ymm4, %ymm1
; AVX2-NEXT:    vbroadcastss 260(%rbp), %ymm2
; AVX2-NEXT:    vaddps %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vmulps %ymm2, %ymm5, %ymm1
; AVX2-NEXT:    vbroadcastss 264(%rbp), %ymm2
; AVX2-NEXT:    vaddps %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vmulps %ymm2, %ymm6, %ymm1
; AVX2-NEXT:    vbroadcastss 268(%rbp), %ymm2
; AVX2-NEXT:    vaddps %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vmulps %ymm2, %ymm7, %ymm1
; AVX2-NEXT:    vaddps %ymm1, %ymm0, %ymm0
...
; AVX2-NEXT:    vmovaps (%rsp), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, (%rdi)
...
; AVX1-NEXT:    movq %rsp, %rbp
; AVX1-NEXT:    andq $-32, %rsp
; AVX1-NEXT:    subq $416, %rsp # imm = 0x1A0
; AVX1-NEXT:    vmovapd %ymm1, %ymm13
; AVX1-NEXT:    vmovapd %ymm0, %ymm9
; AVX1-NEXT:    movq %rdi, %rax
; AVX1-NEXT:    vmovapd 48(%rbp), %ymm14
; AVX1-NEXT:    vbroadcastsd 272(%rbp), %ymm8
; AVX1-NEXT:    vmovapd 16(%rbp), %ymm15
; AVX1-NEXT:    vmulpd %ymm1, %ymm8, %ymm12
; AVX1-NEXT:    vbroadcastsd 280(%rbp), %ymm10
; AVX1-NEXT:    vmulpd %ymm0, %ymm8, %ymm8
; AVX1-NEXT:    vmulpd %ymm3, %ymm10, %ymm11
; AVX1-NEXT:    vaddpd %ymm11, %ymm12, %ymm1
; AVX1-NEXT:    vmulpd %ymm2, %ymm10, %ymm10
; AVX1-NEXT:    vaddpd %ymm10, %ymm8, %ymm0
; AVX1-NEXT:    vbroadcastsd 288(%rbp), %ymm10
; AVX1-NEXT:    vmovapd %ymm4, %ymm8
; AVX1-NEXT:    vmulpd %ymm4, %ymm10, %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm11, %ymm0
; AVX1-NEXT:    vmulpd %ymm5, %ymm10, %ymm10
; AVX1-NEXT:    vbroadcastsd 296(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
; AVX1-NEXT:    vmulpd %ymm7, %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
; AVX1-NEXT:    vmulpd %ymm6, %ymm11, %ymm10
...
; AVX1-NEXT:    vbroadcastsd 312(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
; AVX1-NEXT:    vmulpd 112(%rbp), %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
; AVX1-NEXT:    vmulpd 80(%rbp), %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
...
; AVX1-NEXT:    vmulpd %ymm3, %ymm10, %ymm11
; AVX1-NEXT:    vmovapd %ymm3, %ymm13
; AVX1-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX1-NEXT:    vmulpd %ymm0, %ymm9, %ymm0
; AVX1-NEXT:    vmulpd %ymm2, %ymm10, %ymm10
; AVX1-NEXT:    vmovapd %ymm2, %ymm3
; AVX1-NEXT:    vbroadcastsd 352(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd %ymm11, %ymm8, %ymm10
; AVX1-NEXT:    vmovapd %ymm8, %ymm12
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd %ymm5, %ymm11, %ymm10
...
; AVX1-NEXT:    vbroadcastsd 368(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd %ymm11, %ymm15, %ymm10
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd %ymm11, %ymm14, %ymm10
; AVX1-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
...
; AVX1-NEXT:    vbroadcastsd 384(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmovapd 144(%rbp), %ymm14
; AVX1-NEXT:    vmulpd %ymm11, %ymm14, %ymm10
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmovapd 176(%rbp), %ymm15
; AVX1-NEXT:    vmulpd %ymm11, %ymm15, %ymm10
; AVX1-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
...
; AVX1-NEXT:    vmovapd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vmulpd 208(%rbp), %ymm10, %ymm1
; AVX1-NEXT:    vbroadcastsd 400(%rbp), %ymm10
; AVX1-NEXT:    vaddpd %ymm1, %ymm0, %ymm0
; AVX1-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vmulpd %ymm4, %ymm10, %ymm0
; AVX1-NEXT:    vmovapd %ymm4, %ymm2
; AVX1-NEXT:    vbroadcastsd 408(%rbp), %ymm1
; AVX1-NEXT:    vmovapd %ymm13, %ymm5
; AVX1-NEXT:    vmulpd %ymm1, %ymm13, %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm11, %ymm0
...
; AVX1-NEXT:    vbroadcastsd 440(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd 112(%rbp), %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd 80(%rbp), %ymm11, %ymm10
...
; AVX1-NEXT:    vbroadcastsd 456(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd 240(%rbp), %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vmovapd 208(%rbp), %ymm0
; AVX1-NEXT:    vmulpd %ymm0, %ymm11, %ymm0
; AVX1-NEXT:    vaddpd %ymm0, %ymm1, %ymm0
; AVX1-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vbroadcastsd 464(%rbp), %ymm0
; AVX1-NEXT:    vmulpd %ymm0, %ymm2, %ymm1
...
; AVX1-NEXT:    vbroadcastsd 480(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd %ymm4, %ymm11, %ymm10
...
; AVX1-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX1-NEXT:    vmulpd %ymm6, %ymm10, %ymm10
; AVX1-NEXT:    vbroadcastsd 496(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmovapd 16(%rbp), %ymm2
; AVX1-NEXT:    vmulpd %ymm2, %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmovapd 48(%rbp), %ymm14
; AVX1-NEXT:    vmulpd %ymm11, %ymm14, %ymm10
; AVX1-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
...
; AVX1-NEXT:    vmulpd %ymm3, %ymm10, %ymm10
; AVX1-NEXT:    vbroadcastsd 512(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmovapd 144(%rbp), %ymm3
; AVX1-NEXT:    vmulpd %ymm3, %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd 176(%rbp), %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
...
; AVX1-NEXT:    vmovapd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vmulpd 208(%rbp), %ymm10, %ymm1
; AVX1-NEXT:    vbroadcastsd 528(%rbp), %ymm10
; AVX1-NEXT:    vaddpd %ymm1, %ymm0, %ymm0
; AVX1-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vmulpd %ymm10, %ymm12, %ymm0
; AVX1-NEXT:    vbroadcastsd 536(%rbp), %ymm1
; AVX1-NEXT:    vmulpd %ymm1, %ymm5, %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm11, %ymm0
...
; AVX1-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX1-NEXT:    vmulpd %ymm10, %ymm8, %ymm10
; AVX1-NEXT:    vbroadcastsd 552(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd %ymm7, %ymm11, %ymm10
; AVX1-NEXT:    vmovapd %ymm7, %ymm13
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd %ymm6, %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
...
; AVX1-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX1-NEXT:    vmulpd %ymm10, %ymm14, %ymm10
; AVX1-NEXT:    vbroadcastsd 568(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmovapd 112(%rbp), %ymm2
; AVX1-NEXT:    vmulpd %ymm2, %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
...
; AVX1-NEXT:    vbroadcastsd 584(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
...
; AVX1-NEXT:    vmulpd %ymm0, %ymm12, %ymm1
; AVX1-NEXT:    vbroadcastsd 600(%rbp), %ymm10
; AVX1-NEXT:    vmulpd %ymm5, %ymm10, %ymm11
; AVX1-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX1-NEXT:    vmulpd %ymm0, %ymm4, %ymm0
; AVX1-NEXT:    vmulpd %ymm10, %ymm9, %ymm10
; AVX1-NEXT:    vbroadcastsd 608(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd %ymm11, %ymm15, %ymm10
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd %ymm11, %ymm8, %ymm10
...
; AVX1-NEXT:    vbroadcastsd 624(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmovapd 16(%rbp), %ymm13
; AVX1-NEXT:    vmulpd %ymm11, %ymm13, %ymm10
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd 48(%rbp), %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
; AVX1-NEXT:    vbroadcastsd 632(%rbp), %ymm10
; AVX1-NEXT:    vmulpd %ymm2, %ymm10, %ymm11
; AVX1-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX1-NEXT:    vmulpd 80(%rbp), %ymm10, %ymm10
; AVX1-NEXT:    vbroadcastsd 640(%rbp), %ymm11
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmovapd 144(%rbp), %ymm6
; AVX1-NEXT:    vmulpd %ymm6, %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX1-NEXT:    vmulpd 176(%rbp), %ymm11, %ymm10
; AVX1-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
...
; AVX1-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX1-NEXT:    vmovapd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vmovapd 208(%rbp), %ymm11
; AVX1-NEXT:    vmulpd %ymm10, %ymm11, %ymm1
; AVX1-NEXT:    vbroadcastsd 656(%rbp), %ymm2
; AVX1-NEXT:    vaddpd %ymm1, %ymm0, %ymm0
; AVX1-NEXT:    vmovapd %ymm0, (%rsp) # 32-byte Spill
; AVX1-NEXT:    vmulpd %ymm2, %ymm12, %ymm0
; AVX1-NEXT:    vbroadcastsd 664(%rbp), %ymm1
; AVX1-NEXT:    vmulpd %ymm1, %ymm5, %ymm14
; AVX1-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX1-NEXT:    vmulpd %ymm2, %ymm4, %ymm2
; AVX1-NEXT:    vmulpd %ymm1, %ymm9, %ymm1
; AVX1-NEXT:    vaddpd %ymm1, %ymm2, %ymm1
; AVX1-NEXT:    vbroadcastsd 672(%rbp), %ymm2
; AVX1-NEXT:    vmulpd %ymm2, %ymm15, %ymm14
; AVX1-NEXT:    vaddpd %ymm1, %ymm14, %ymm1
; AVX1-NEXT:    vmulpd %ymm2, %ymm8, %ymm2
; AVX1-NEXT:    vbroadcastsd 680(%rbp), %ymm14
; AVX1-NEXT:    vaddpd %ymm2, %ymm0, %ymm0
; AVX1-NEXT:    vmovapd %ymm3, %ymm10
; AVX1-NEXT:    vmulpd %ymm3, %ymm14, %ymm2
; AVX1-NEXT:    vaddpd %ymm2, %ymm0, %ymm0
; AVX1-NEXT:    vmulpd %ymm7, %ymm14, %ymm2
; AVX1-NEXT:    vaddpd %ymm2, %ymm1, %ymm1
; AVX1-NEXT:    vbroadcastsd 688(%rbp), %ymm2
; AVX1-NEXT:    vmulpd %ymm2, %ymm13, %ymm14
; AVX1-NEXT:    vaddpd %ymm1, %ymm14, %ymm1
; AVX1-NEXT:    vmulpd 48(%rbp), %ymm2, %ymm2
; AVX1-NEXT:    vbroadcastsd 696(%rbp), %ymm14
; AVX1-NEXT:    vaddpd %ymm2, %ymm0, %ymm0
; AVX1-NEXT:    vmulpd 112(%rbp), %ymm14, %ymm2
; AVX1-NEXT:    vaddpd %ymm2, %ymm0, %ymm0
; AVX1-NEXT:    vmulpd 80(%rbp), %ymm14, %ymm2
; AVX1-NEXT:    vaddpd %ymm2, %ymm1, %ymm1
; AVX1-NEXT:    vbroadcastsd 704(%rbp), %ymm2
; AVX1-NEXT:    vmulpd %ymm2, %ymm6, %ymm14
; AVX1-NEXT:    vaddpd %ymm1, %ymm14, %ymm14
; AVX1-NEXT:    vmulpd 176(%rbp), %ymm2, %ymm1
; AVX1-NEXT:    vbroadcastsd 712(%rbp), %ymm2
; AVX1-NEXT:    vaddpd %ymm1, %ymm0, %ymm0
; AVX1-NEXT:    vmovapd 240(%rbp), %ymm13
; AVX1-NEXT:    vmulpd %ymm2, %ymm13, %ymm1
; AVX1-NEXT:    vaddpd %ymm1, %ymm0, %ymm1
; AVX1-NEXT:    vmulpd %ymm2, %ymm11, %ymm0
; AVX1-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX1-NEXT:    vbroadcastsd 720(%rbp), %ymm2
; AVX1-NEXT:    vmulpd %ymm2, %ymm12, %ymm3
; AVX1-NEXT:    vmulpd %ymm2, %ymm4, %ymm2
; AVX1-NEXT:    vbroadcastsd 728(%rbp), %ymm4
; AVX1-NEXT:    vmulpd %ymm4, %ymm5, %ymm5
; AVX1-NEXT:    vaddpd %ymm5, %ymm3, %ymm3
; AVX1-NEXT:    vmulpd %ymm4, %ymm9, %ymm4
; AVX1-NEXT:    vbroadcastsd 736(%rbp), %ymm5
; AVX1-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX1-NEXT:    vmulpd %ymm5, %ymm15, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX1-NEXT:    vmulpd %ymm5, %ymm8, %ymm4
...
; AVX1-NEXT:    vbroadcastsd 752(%rbp), %ymm5
; AVX1-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX1-NEXT:    vmulpd 16(%rbp), %ymm5, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX1-NEXT:    vmulpd 48(%rbp), %ymm5, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm3, %ymm3
; AVX1-NEXT:    vbroadcastsd 760(%rbp), %ymm4
; AVX1-NEXT:    vmulpd 112(%rbp), %ymm4, %ymm5
; AVX1-NEXT:    vaddpd %ymm5, %ymm3, %ymm3
; AVX1-NEXT:    vmulpd 80(%rbp), %ymm4, %ymm4
; AVX1-NEXT:    vbroadcastsd 768(%rbp), %ymm5
; AVX1-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX1-NEXT:    vmulpd %ymm5, %ymm6, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX1-NEXT:    vmulpd 176(%rbp), %ymm5, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm3, %ymm3
; AVX1-NEXT:    vbroadcastsd 776(%rbp), %ymm4
; AVX1-NEXT:    vmulpd %ymm4, %ymm13, %ymm5
; AVX1-NEXT:    vaddpd %ymm5, %ymm3, %ymm3
; AVX1-NEXT:    vmulpd %ymm4, %ymm11, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
...
; AVX2-NEXT:    movq %rsp, %rbp
; AVX2-NEXT:    andq $-32, %rsp
; AVX2-NEXT:    subq $416, %rsp # imm = 0x1A0
; AVX2-NEXT:    vmovapd %ymm1, %ymm13
; AVX2-NEXT:    vmovapd %ymm0, %ymm9
; AVX2-NEXT:    movq %rdi, %rax
; AVX2-NEXT:    vmovapd 48(%rbp), %ymm14
; AVX2-NEXT:    vbroadcastsd 272(%rbp), %ymm8
; AVX2-NEXT:    vmovapd 16(%rbp), %ymm15
; AVX2-NEXT:    vmulpd %ymm1, %ymm8, %ymm12
; AVX2-NEXT:    vbroadcastsd 280(%rbp), %ymm10
; AVX2-NEXT:    vmulpd %ymm0, %ymm8, %ymm8
; AVX2-NEXT:    vmulpd %ymm3, %ymm10, %ymm11
; AVX2-NEXT:    vaddpd %ymm11, %ymm12, %ymm1
; AVX2-NEXT:    vmulpd %ymm2, %ymm10, %ymm10
; AVX2-NEXT:    vaddpd %ymm10, %ymm8, %ymm0
; AVX2-NEXT:    vbroadcastsd 288(%rbp), %ymm10
; AVX2-NEXT:    vmovapd %ymm4, %ymm8
; AVX2-NEXT:    vmulpd %ymm4, %ymm10, %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm11, %ymm0
; AVX2-NEXT:    vmulpd %ymm5, %ymm10, %ymm10
; AVX2-NEXT:    vbroadcastsd 296(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
; AVX2-NEXT:    vmulpd %ymm7, %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
; AVX2-NEXT:    vmulpd %ymm6, %ymm11, %ymm10
...
; AVX2-NEXT:    vbroadcastsd 312(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
; AVX2-NEXT:    vmulpd 112(%rbp), %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
; AVX2-NEXT:    vmulpd 80(%rbp), %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
...
; AVX2-NEXT:    vmulpd %ymm3, %ymm10, %ymm11
; AVX2-NEXT:    vmovapd %ymm3, %ymm13
; AVX2-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX2-NEXT:    vmulpd %ymm0, %ymm9, %ymm0
; AVX2-NEXT:    vmulpd %ymm2, %ymm10, %ymm10
; AVX2-NEXT:    vmovapd %ymm2, %ymm3
; AVX2-NEXT:    vbroadcastsd 352(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd %ymm11, %ymm8, %ymm10
; AVX2-NEXT:    vmovapd %ymm8, %ymm12
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd %ymm5, %ymm11, %ymm10
...
; AVX2-NEXT:    vbroadcastsd 368(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd %ymm11, %ymm15, %ymm10
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd %ymm11, %ymm14, %ymm10
; AVX2-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
...
; AVX2-NEXT:    vbroadcastsd 384(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmovapd 144(%rbp), %ymm14
; AVX2-NEXT:    vmulpd %ymm11, %ymm14, %ymm10
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmovapd 176(%rbp), %ymm15
; AVX2-NEXT:    vmulpd %ymm11, %ymm15, %ymm10
; AVX2-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
...
; AVX2-NEXT:    vmovapd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmulpd 208(%rbp), %ymm10, %ymm1
; AVX2-NEXT:    vbroadcastsd 400(%rbp), %ymm10
; AVX2-NEXT:    vaddpd %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmulpd %ymm4, %ymm10, %ymm0
; AVX2-NEXT:    vmovapd %ymm4, %ymm2
; AVX2-NEXT:    vbroadcastsd 408(%rbp), %ymm1
; AVX2-NEXT:    vmovapd %ymm13, %ymm5
; AVX2-NEXT:    vmulpd %ymm1, %ymm13, %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm11, %ymm0
...
; AVX2-NEXT:    vbroadcastsd 440(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd 112(%rbp), %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd 80(%rbp), %ymm11, %ymm10
...
; AVX2-NEXT:    vbroadcastsd 456(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd 240(%rbp), %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovapd 208(%rbp), %ymm0
; AVX2-NEXT:    vmulpd %ymm0, %ymm11, %ymm0
; AVX2-NEXT:    vaddpd %ymm0, %ymm1, %ymm0
; AVX2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vbroadcastsd 464(%rbp), %ymm0
; AVX2-NEXT:    vmulpd %ymm0, %ymm2, %ymm1
...
; AVX2-NEXT:    vbroadcastsd 480(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd %ymm4, %ymm11, %ymm10
...
; AVX2-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX2-NEXT:    vmulpd %ymm6, %ymm10, %ymm10
; AVX2-NEXT:    vbroadcastsd 496(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmovapd 16(%rbp), %ymm2
; AVX2-NEXT:    vmulpd %ymm2, %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmovapd 48(%rbp), %ymm14
; AVX2-NEXT:    vmulpd %ymm11, %ymm14, %ymm10
; AVX2-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
...
; AVX2-NEXT:    vmulpd %ymm3, %ymm10, %ymm10
; AVX2-NEXT:    vbroadcastsd 512(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmovapd 144(%rbp), %ymm3
; AVX2-NEXT:    vmulpd %ymm3, %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd 176(%rbp), %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
...
; AVX2-NEXT:    vmovapd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmulpd 208(%rbp), %ymm10, %ymm1
; AVX2-NEXT:    vbroadcastsd 528(%rbp), %ymm10
; AVX2-NEXT:    vaddpd %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmulpd %ymm10, %ymm12, %ymm0
; AVX2-NEXT:    vbroadcastsd 536(%rbp), %ymm1
; AVX2-NEXT:    vmulpd %ymm1, %ymm5, %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm11, %ymm0
...
; AVX2-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX2-NEXT:    vmulpd %ymm10, %ymm8, %ymm10
; AVX2-NEXT:    vbroadcastsd 552(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd %ymm7, %ymm11, %ymm10
; AVX2-NEXT:    vmovapd %ymm7, %ymm13
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd %ymm6, %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
...
; AVX2-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX2-NEXT:    vmulpd %ymm10, %ymm14, %ymm10
; AVX2-NEXT:    vbroadcastsd 568(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmovapd 112(%rbp), %ymm2
; AVX2-NEXT:    vmulpd %ymm2, %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
...
; AVX2-NEXT:    vmulpd %ymm3, %ymm10, %ymm11
; AVX2-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX2-NEXT:    vmovapd 176(%rbp), %ymm7
; AVX2-NEXT:    vmulpd %ymm7, %ymm10, %ymm10
; AVX2-NEXT:    vbroadcastsd 584(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
...
; AVX2-NEXT:    vmulpd %ymm0, %ymm12, %ymm1
; AVX2-NEXT:    vbroadcastsd 600(%rbp), %ymm10
; AVX2-NEXT:    vmulpd %ymm5, %ymm10, %ymm11
; AVX2-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX2-NEXT:    vmulpd %ymm0, %ymm4, %ymm0
; AVX2-NEXT:    vmulpd %ymm10, %ymm9, %ymm10
; AVX2-NEXT:    vbroadcastsd 608(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd %ymm11, %ymm15, %ymm10
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd %ymm11, %ymm8, %ymm10
...
; AVX2-NEXT:    vbroadcastsd 624(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmovapd 16(%rbp), %ymm13
; AVX2-NEXT:    vmulpd %ymm11, %ymm13, %ymm10
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd 48(%rbp), %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
; AVX2-NEXT:    vbroadcastsd 632(%rbp), %ymm10
; AVX2-NEXT:    vmulpd %ymm2, %ymm10, %ymm11
; AVX2-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX2-NEXT:    vmulpd 80(%rbp), %ymm10, %ymm10
; AVX2-NEXT:    vbroadcastsd 640(%rbp), %ymm11
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmovapd 144(%rbp), %ymm6
; AVX2-NEXT:    vmulpd %ymm6, %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm0, %ymm10, %ymm0
; AVX2-NEXT:    vmulpd 176(%rbp), %ymm11, %ymm10
; AVX2-NEXT:    vaddpd %ymm1, %ymm10, %ymm1
...
; AVX2-NEXT:    vaddpd %ymm1, %ymm11, %ymm1
; AVX2-NEXT:    vmovapd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovapd 208(%rbp), %ymm11
; AVX2-NEXT:    vmulpd %ymm10, %ymm11, %ymm1
; AVX2-NEXT:    vbroadcastsd 656(%rbp), %ymm2
; AVX2-NEXT:    vaddpd %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vmovapd %ymm0, (%rsp) # 32-byte Spill
; AVX2-NEXT:    vmulpd %ymm2, %ymm12, %ymm0
; AVX2-NEXT:    vbroadcastsd 664(%rbp), %ymm1
; AVX2-NEXT:    vmulpd %ymm1, %ymm5, %ymm14
; AVX2-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX2-NEXT:    vmulpd %ymm2, %ymm4, %ymm2
; AVX2-NEXT:    vmulpd %ymm1, %ymm9, %ymm1
; AVX2-NEXT:    vaddpd %ymm1, %ymm2, %ymm1
; AVX2-NEXT:    vbroadcastsd 672(%rbp), %ymm2
; AVX2-NEXT:    vmulpd %ymm2, %ymm15, %ymm14
; AVX2-NEXT:    vaddpd %ymm1, %ymm14, %ymm1
; AVX2-NEXT:    vmulpd %ymm2, %ymm8, %ymm2
; AVX2-NEXT:    vbroadcastsd 680(%rbp), %ymm14
; AVX2-NEXT:    vaddpd %ymm2, %ymm0, %ymm0
; AVX2-NEXT:    vmovapd %ymm3, %ymm10
; AVX2-NEXT:    vmulpd %ymm3, %ymm14, %ymm2
; AVX2-NEXT:    vaddpd %ymm2, %ymm0, %ymm0
; AVX2-NEXT:    vmulpd %ymm7, %ymm14, %ymm2
; AVX2-NEXT:    vaddpd %ymm2, %ymm1, %ymm1
; AVX2-NEXT:    vbroadcastsd 688(%rbp), %ymm2
; AVX2-NEXT:    vmulpd %ymm2, %ymm13, %ymm14
; AVX2-NEXT:    vaddpd %ymm1, %ymm14, %ymm1
; AVX2-NEXT:    vmulpd 48(%rbp), %ymm2, %ymm2
; AVX2-NEXT:    vbroadcastsd 696(%rbp), %ymm14
; AVX2-NEXT:    vaddpd %ymm2, %ymm0, %ymm0
; AVX2-NEXT:    vmulpd 112(%rbp), %ymm14, %ymm2
; AVX2-NEXT:    vaddpd %ymm2, %ymm0, %ymm0
; AVX2-NEXT:    vmulpd 80(%rbp), %ymm14, %ymm2
; AVX2-NEXT:    vaddpd %ymm2, %ymm1, %ymm1
; AVX2-NEXT:    vbroadcastsd 704(%rbp), %ymm2
; AVX2-NEXT:    vmulpd %ymm2, %ymm6, %ymm14
; AVX2-NEXT:    vaddpd %ymm1, %ymm14, %ymm14
; AVX2-NEXT:    vmulpd 176(%rbp), %ymm2, %ymm1
; AVX2-NEXT:    vbroadcastsd 712(%rbp), %ymm2
; AVX2-NEXT:    vaddpd %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vmovapd 240(%rbp), %ymm13
; AVX2-NEXT:    vmulpd %ymm2, %ymm13, %ymm1
; AVX2-NEXT:    vaddpd %ymm1, %ymm0, %ymm1
; AVX2-NEXT:    vmulpd %ymm2, %ymm11, %ymm0
; AVX2-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX2-NEXT:    vbroadcastsd 720(%rbp), %ymm2
; AVX2-NEXT:    vmulpd %ymm2, %ymm12, %ymm3
; AVX2-NEXT:    vmulpd %ymm2, %ymm4, %ymm2
; AVX2-NEXT:    vbroadcastsd 728(%rbp), %ymm4
; AVX2-NEXT:    vmulpd %ymm4, %ymm5, %ymm5
; AVX2-NEXT:    vaddpd %ymm5, %ymm3, %ymm3
; AVX2-NEXT:    vmulpd %ymm4, %ymm9, %ymm4
; AVX2-NEXT:    vbroadcastsd 736(%rbp), %ymm5
; AVX2-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX2-NEXT:    vmulpd %ymm5, %ymm15, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX2-NEXT:    vmulpd %ymm5, %ymm8, %ymm4
...
; AVX2-NEXT:    vbroadcastsd 752(%rbp), %ymm5
; AVX2-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX2-NEXT:    vmulpd 16(%rbp), %ymm5, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX2-NEXT:    vmulpd 48(%rbp), %ymm5, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm3, %ymm3
; AVX2-NEXT:    vbroadcastsd 760(%rbp), %ymm4
; AVX2-NEXT:    vmulpd 112(%rbp), %ymm4, %ymm5
; AVX2-NEXT:    vaddpd %ymm5, %ymm3, %ymm3
; AVX2-NEXT:    vmulpd 80(%rbp), %ymm4, %ymm4
; AVX2-NEXT:    vbroadcastsd 768(%rbp), %ymm5
; AVX2-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX2-NEXT:    vmulpd %ymm5, %ymm6, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX2-NEXT:    vmulpd 176(%rbp), %ymm5, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm3, %ymm3
; AVX2-NEXT:    vbroadcastsd 776(%rbp), %ymm4
; AVX2-NEXT:    vmulpd %ymm4, %ymm13, %ymm5
; AVX2-NEXT:    vaddpd %ymm5, %ymm3, %ymm3
; AVX2-NEXT:    vmulpd %ymm4, %ymm11, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
...
; AVX512-NEXT:    vmulpd 128(%rbp){1to8}, %zmm6, %zmm11
; AVX512-NEXT:    vaddpd %zmm10, %zmm9, %zmm9
; AVX512-NEXT:    vaddpd %zmm11, %zmm9, %zmm9
; AVX512-NEXT:    vmulpd 136(%rbp){1to8}, %zmm7, %zmm10
; AVX512-NEXT:    vmulpd 144(%rbp){1to8}, %zmm0, %zmm11
; AVX512-NEXT:    vmulpd 152(%rbp){1to8}, %zmm1, %zmm12
; AVX512-NEXT:    vaddpd %zmm10, %zmm9, %zmm9
; AVX512-NEXT:    vaddpd %zmm12, %zmm11, %zmm10
...
; AVX512-NEXT:    vmulpd 184(%rbp){1to8}, %zmm5, %zmm12
; AVX512-NEXT:    vaddpd %zmm11, %zmm10, %zmm10
; AVX512-NEXT:    vaddpd %zmm12, %zmm10, %zmm10
...
; AVX512-NEXT:    vmulpd 240(%rbp){1to8}, %zmm4, %zmm13
; AVX512-NEXT:    vaddpd %zmm12, %zmm11, %zmm11
; AVX512-NEXT:    vaddpd %zmm13, %zmm11, %zmm11
...
; AVX512-NEXT:    vmulpd 272(%rbp){1to8}, %zmm0, %zmm13
; AVX512-NEXT:    vaddpd %zmm12, %zmm11, %zmm11
; AVX512-NEXT:    vmulpd 280(%rbp){1to8}, %zmm1, %zmm12
; AVX512-NEXT:    vaddpd %zmm12, %zmm13, %zmm12
; AVX512-NEXT:    vmulpd 288(%rbp){1to8}, %zmm2, %zmm13
; AVX512-NEXT:    vmulpd 296(%rbp){1to8}, %zmm3, %zmm14
; AVX512-NEXT:    vaddpd %zmm13, %zmm12, %zmm12
; AVX512-NEXT:    vaddpd %zmm14, %zmm12, %zmm12
...
; AVX512-NEXT:    vmulpd 328(%rbp){1to8}, %zmm7, %zmm14
; AVX512-NEXT:    vaddpd %zmm13, %zmm12, %zmm12
; AVX512-NEXT:    vaddpd %zmm14, %zmm12, %zmm12
; AVX512-NEXT:    vmulpd 336(%rbp){1to8}, %zmm0, %zmm13
; AVX512-NEXT:    vmulpd 344(%rbp){1to8}, %zmm1, %zmm14
; AVX512-NEXT:    vmulpd 352(%rbp){1to8}, %zmm2, %zmm15
; AVX512-NEXT:    vaddpd %zmm14, %zmm13, %zmm13
; AVX512-NEXT:    vaddpd %zmm15, %zmm13, %zmm13
...
; AVX512-NEXT:    vmulpd 384(%rbp){1to8}, %zmm6, %zmm15
; AVX512-NEXT:    vaddpd %zmm14, %zmm13, %zmm13
; AVX512-NEXT:    vaddpd %zmm15, %zmm13, %zmm13
; AVX512-NEXT:    vmulpd 392(%rbp){1to8}, %zmm7, %zmm14
; AVX512-NEXT:    vmulpd 400(%rbp){1to8}, %zmm0, %zmm15
; AVX512-NEXT:    vmulpd 408(%rbp){1to8}, %zmm1, %zmm16
; AVX512-NEXT:    vaddpd %zmm14, %zmm13, %zmm13
; AVX512-NEXT:    vaddpd %zmm16, %zmm15, %zmm14
...
; AVX512-NEXT:    vmulpd 440(%rbp){1to8}, %zmm5, %zmm16
; AVX512-NEXT:    vaddpd %zmm15, %zmm14, %zmm14
; AVX512-NEXT:    vaddpd %zmm16, %zmm14, %zmm14
...
; AVX512-NEXT:    vmulpd 496(%rbp){1to8}, %zmm4, %zmm2
; AVX512-NEXT:    vaddpd %zmm1, %zmm0, %zmm0
