...
; AVX1-NEXT:    vblendvpd %xmm5, %xmm1, %xmm7, %xmm5
; AVX1-NEXT:    vextractf128 $1, %ymm1, %xmm1
; AVX1-NEXT:    vpxor %xmm4, %xmm1, %xmm8
; AVX1-NEXT:    vpcmpgtq %xmm8, %xmm6, %xmm8
; AVX1-NEXT:    vblendvpd %xmm8, %xmm1, %xmm7, %xmm1
; AVX1-NEXT:    vpxor %xmm4, %xmm0, %xmm8
; AVX1-NEXT:    vpcmpgtq %xmm8, %xmm6, %xmm8
; AVX1-NEXT:    vblendvpd %xmm8, %xmm0, %xmm7, %xmm8
...
; AVX1-NEXT:    vinsertf128 $1, %xmm5, %ymm8, %ymm1
...
; AVX2-NEXT:    vbroadcastsd {{.*#+}} ymm4 = [4294967295,4294967295,4294967295,4294967295]
...
; AVX2-NEXT:    vpxor %ymm5, %ymm1, %ymm3
...
; AVX512F-NEXT:    vpminuq {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %zmm0, %zmm0
...
; AVX512BW-NEXT:    vpminuq {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %zmm0, %zmm0
...
; AVX512BW-NEXT:    retq
  ...
  call void @llvm.masked.store.v8i32.p0(<8 x i32> %d, ptr %p, i32 1, <8 x i1> %a)
  ret void
}
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm7 = [9223372039002259456,9223372039002259456]
...
; SSE4:       # %bb.0:
; SSE4-NEXT:    movdqa %xmm0, %xmm6
; SSE4-NEXT:    movapd {{.*#+}} xmm8 = [65535,65535]
; SSE4-NEXT:    movdqa {{.*#+}} xmm9 = [9223372036854775808,9223372036854775808]
; SSE4-NEXT:    movdqa %xmm1, %xmm10
; SSE4-NEXT:    pxor %xmm9, %xmm10
; SSE4-NEXT:    movdqa {{.*#+}} xmm7 = [9223372036854841343,9223372036854841343]
; SSE4-NEXT:    movdqa %xmm7, %xmm0
; SSE4-NEXT:    pcmpgtq %xmm10, %xmm0
; SSE4-NEXT:    movapd %xmm8, %xmm10
; SSE4-NEXT:    blendvpd %xmm0, %xmm1, %xmm10
; SSE4-NEXT:    movdqa %xmm6, %xmm1
; SSE4-NEXT:    pxor %xmm9, %xmm1
; SSE4-NEXT:    movdqa %xmm7, %xmm0
; SSE4-NEXT:    pcmpgtq %xmm1, %xmm0
; SSE4-NEXT:    movapd %xmm8, %xmm1
; SSE4-NEXT:    blendvpd %xmm0, %xmm6, %xmm1
; SSE4-NEXT:    pxor %xmm6, %xmm6
; SSE4-NEXT:    packusdw %xmm10, %xmm1
...
; SSE4-NEXT:    pxor %xmm2, %xmm9
; SSE4-NEXT:    pcmpgtq %xmm9, %xmm7
; SSE4-NEXT:    movdqa %xmm7, %xmm0
; SSE4-NEXT:    blendvpd %xmm0, %xmm2, %xmm8
; SSE4-NEXT:    packusdw %xmm10, %xmm8
; SSE4-NEXT:    packusdw %xmm8, %xmm1
...
; AVX1-NEXT:    vpxor %xmm3, %xmm7, %xmm8
; AVX1-NEXT:    vpcmpgtq %xmm8, %xmm5, %xmm8
; AVX1-NEXT:    vmovddup {{.*#+}} xmm9 = [65535,65535]
; AVX1-NEXT:    # xmm9 = mem[0,0]
; AVX1-NEXT:    vblendvpd %xmm8, %xmm7, %xmm9, %xmm7
; AVX1-NEXT:    vpxor %xmm3, %xmm6, %xmm8
; AVX1-NEXT:    vpxor %xmm3, %xmm1, %xmm3
; AVX1-NEXT:    vpcmpgtq %xmm3, %xmm5, %xmm3
; AVX1-NEXT:    vblendvpd %xmm3, %xmm1, %xmm9, %xmm1
; AVX1-NEXT:    vpcmpgtq %xmm8, %xmm5, %xmm3
; AVX1-NEXT:    vpackusdw %xmm7, %xmm1, %xmm1
; AVX1-NEXT:    vblendvpd %xmm3, %xmm6, %xmm9, %xmm3
; AVX1-NEXT:    vblendvpd %xmm4, %xmm0, %xmm9, %xmm0
...
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm5 = [9223372036854775808,9223372036854775808,9223372036854775808,9223372036854775808]
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm6 = [9223372036854841343,9223372036854841343,9223372036854841343,9223372036854841343]
; AVX2-NEXT:    vpxor %ymm5, %ymm1, %ymm7
; AVX2-NEXT:    vpcmpgtq %ymm7, %ymm6, %ymm7
; AVX2-NEXT:    vblendvpd %ymm7, %ymm1, %ymm4, %ymm1
; AVX2-NEXT:    vpxor %ymm5, %ymm0, %ymm5
; AVX2-NEXT:    vpcmpgtq %ymm5, %ymm6, %ymm5
; AVX2-NEXT:    vblendvpd %ymm5, %ymm0, %ymm4, %ymm0
...
; AVX512BWVL-NEXT:    retq
  ...
  call void @llvm.masked.store.v8i16.p0(<8 x i16> %d, ptr %p, i32 1, <8 x i1> %a)
  ret void
}
...
; AVX2-NEXT:    vblendvpd %ymm6, %ymm1, %ymm3, %ymm1
; AVX2-NEXT:    vpxor %ymm4, %ymm0, %ymm4
; AVX2-NEXT:    vpcmpgtq %ymm4, %ymm7, %ymm4
...
; AVX2-NEXT:    vpcmpeqd %ymm5, %ymm2, %ymm1
; AVX2-NEXT:    vmovmskps %ymm1, %eax
; AVX2-NEXT:    notl %eax
; AVX2-NEXT:    testb $1, %al
...
; AVX512BWVL-NEXT:    retq
  ...
  call void @llvm.masked.store.v8i8.p0(<8 x i8> %d, ptr %p, i32 1, <8 x i1> %a)
  ret void
}
...
; AVX512BW-NEXT:    retq
  ...
  call void @llvm.masked.store.v4i32.p0(<4 x i32> %d, ptr %p, i32 1, <4 x i1> %a)
  ret void
}
...
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm3 = [9223372036854775808,9223372036854775808,9223372036854775808,9223372036854775808]
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm4 = [9223372036854841342,9223372036854841342,9223372036854841342,9223372036854841342]
; AVX2-NEXT:    vpxor %ymm3, %ymm0, %ymm3
; AVX2-NEXT:    vpcmpgtq %ymm4, %ymm3, %ymm3
; AVX2-NEXT:    vblendvpd %ymm3, %ymm2, %ymm0, %ymm0
...
; AVX512BWVL-NEXT:    retq
  ...
  call void @llvm.masked.store.v4i16.p0(<4 x i16> %d, ptr %p, i32 1, <4 x i1> %a)
  ret void
}
...
; AVX512BWVL-NEXT:    retq
  ...
  call void @llvm.masked.store.v4i8.p0(<4 x i8> %d, ptr %p, i32 1, <4 x i1> %a)
  ret void
}

define void @truncstore_v2i64_v2i32(<2 x i64> %x, ptr %p, <2 x i64> %mask) {
...
; AVX512BW-NEXT:    retq
  ...
  call void @llvm.masked.store.v2i32.p0(<2 x i32> %d, ptr %p, i32 1, <2 x i1> %a)
  ret void
}

define void @truncstore_v2i64_v2i16(<2 x i64> %x, ptr %p, <2 x i64> %mask) {
...
; AVX-NEXT:    vpcmpgtq {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm2, %xmm2
; AVX-NEXT:    vblendvpd %xmm2, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
...
; AVX512BWVL-NEXT:    retq
  ...
  call void @llvm.masked.store.v2i16.p0(<2 x i16> %d, ptr %p, i32 1, <2 x i1> %a)
  ret void
}

define void @truncstore_v2i64_v2i8(<2 x i64> %x, ptr %p, <2 x i64> %mask) {
...
; AVX512BWVL-NEXT:    retq
  ...
  call void @llvm.masked.store.v2i8.p0(<2 x i8> %d, ptr %p, i32 1, <2 x i1> %a)
  ret void
}

define void @truncstore_v16i32_v16i16(<16 x i32> %x, ptr %p, <16 x i32> %mask) {
...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vptestmd %zmm1, %zmm1, %k1
; AVX512BW-NEXT:    vpminud {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to16}, %zmm0, %zmm0
...
; AVX512BWVL-NEXT:    retq
  ...
  call void @llvm.masked.store.v16i16.p0(<16 x i16> %d, ptr %p, i32 1, <16 x i1> %a)
  ret void
}

define void @truncstore_v16i32_v16i8(<16 x i32> %x, ptr %p, <16 x i32> %mask) {
...
; AVX512BWVL-NEXT:    retq
  ...
  call void @llvm.masked.store.v16i8.p0(<16 x i8> %d, ptr %p, i32 1, <16 x i1> %a)
  ret void
}
...
define void @truncstore_v4i32_v4i16(<4 x i32> %x, ptr %p, <4 x i32> %mask) {
...
define void @truncstore_v4i32_v4i8(<4 x i32> %x, ptr %p, <4 x i32> %mask) {
...
define void @truncstore_v32i16_v32i8(<32 x i16> %x, ptr %p, <32 x i8> %mask) {
...
; AVX512BW-NEXT:    vpminuw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm0
...
; AVX512BWVL-NEXT:    retq
  ...
  call void @llvm.masked.store.v32i8.p0(<32 x i8> %d, ptr %p, i32 1, <32 x i1> %a)
  ret void
}

define void @truncstore_v16i16_v16i8(<16 x i16> %x, ptr %p, <16 x i8> %mask) {
...
define void @truncstore_v8i16_v8i8(<8 x i16> %x, ptr %p, <8 x i16> %mask) {
; SSE2-LABEL: truncstore_v8i16_v8i8:
; SSE2:       # %bb.0:
; SSE2-NEXT:    pxor %xmm2, %xmm2
; SSE2-NEXT:    movdqa %xmm0, %xmm3
; SSE2-NEXT:    psubusw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm3
