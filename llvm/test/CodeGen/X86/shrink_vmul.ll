...
; X86-SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm1[2,3,2,3]
...
; X86-SSE-NEXT:    movd %edx, %xmm1
; X86-SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm0[1,1,1,1]
; X86-SSE-NEXT:    movd %xmm3, %ecx
...
; X86-SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm0[3,3,3,3]
; X86-SSE-NEXT:    movd %xmm3, %ecx
...
; X86-SSE-NEXT:    pmuludq %xmm3, %xmm1
...
; X64-SSE-NEXT:    pextrw $4, %xmm2, %r9d
; X64-SSE-NEXT:    pextrw $0, %xmm2, %r10d
; X64-SSE-NEXT:    pextrw $1, %xmm2, %edi
; X64-SSE-NEXT:    pextrw $3, %xmm2, %r8d
; X64-SSE-NEXT:    movdqa %xmm2, %xmm5
; X64-SSE-NEXT:    movdqa %xmm2, %xmm4
; X64-SSE-NEXT:    punpcklwd {{.*#+}} xmm4 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3]
; X64-SSE-NEXT:    punpckhwd {{.*#+}} xmm5 = xmm5[4],xmm3[4],xmm5[5],xmm3[5],xmm5[6],xmm3[6],xmm5[7],xmm3[7]
...
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm5[2,3,2,3]
; X64-SSE-NEXT:    movd %xmm3, %eax
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm1[2,3,2,3]
...
; X64-SSE-NEXT:    movd %edx, %xmm2
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm5 = xmm5[1,1,1,1]
; X64-SSE-NEXT:    movd %xmm5, %eax
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[1,1,1,1]
; X64-SSE-NEXT:    movd %xmm1, %r9d
; X64-SSE-NEXT:    xorl %edx, %edx
...
; X64-SSE-NEXT:    movd %edx, %xmm1
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm0[1,1,1,1]
; X64-SSE-NEXT:    movd %xmm3, %r9d
; X64-SSE-NEXT:    movl %edi, %eax
; X64-SSE-NEXT:    xorl %edx, %edx
; X64-SSE-NEXT:    divl %r9d
; X64-SSE-NEXT:    movd %edx, %xmm3
; X64-SSE-NEXT:    punpckldq {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[1],xmm3[1]
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm0[3,3,3,3]
...
; X64-SSE-NEXT:    pmuludq %xmm0, %xmm3
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm3[0,2,2,3]
