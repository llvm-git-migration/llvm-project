...
; X64-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %r8 # 8-byte Reload
; X64-NEXT:    movq 120(%r8), %rdi
; X64-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; X64-NEXT:    imulq %rax, %rdi
; X64-NEXT:    movq 112(%r8), %rbx
; X64-NEXT:    movq %rax, %rbp
; X64-NEXT:    mulq %rbx
; X64-NEXT:    movq %rax, %r10
