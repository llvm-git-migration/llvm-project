...
; i686-NEXT:    movzbl %cl, %esi
; i686-NEXT:    movl 8(%esp,%esi), %ebp
...
; i686-NEXT:    andb $15, %cl
; i686-NEXT:    negb %cl
; i686-NEXT:    movsbl %cl, %edi
; i686-NEXT:    movl 32(%esp,%edi), %ebp
; i686-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; i686-NEXT:    movl %eax, %ecx
; i686-NEXT:    shll %cl, %ebp
; i686-NEXT:    movl %ebp, (%esp) # 4-byte Spill
; i686-NEXT:    notb %cl
; i686-NEXT:    movl 28(%esp,%edi), %ebx
...
; i686-NEXT:    movl 24(%esp,%edi), %edi
; i686-NEXT:    orl (%esp), %edx # 4-byte Folded Reload
