...
; RUN: llc < %s -mtriple=x86_64-linux-gnu -mattr=+avx512bf16,+avx512vl | FileCheck %s --check-prefix=X64-AVX512
...
; X64-NEXT:    retq
;
; X64-AVX512-LABEL: bfloat_to_float:
; X64-AVX512:       # %bb.0:
; X64-AVX512-NEXT:    pushq %rax
; X64-AVX512-NEXT:    .cfi_def_cfa_offset 16
; X64-AVX512-NEXT:    movq a@GOTPCREL(%rip), %rax
; X64-AVX512-NEXT:    movzwl (%rax), %edi
; X64-AVX512-NEXT:    callq __extendbfsf2@PLT
; X64-AVX512-NEXT:    popq %rax
; X64-AVX512-NEXT:    .cfi_def_cfa_offset 8
...
; X64-NEXT:    retq
;
; X64-AVX512-LABEL: bfloat_to_double:
; X64-AVX512:       # %bb.0:
; X64-AVX512-NEXT:    pushq %rax
; X64-AVX512-NEXT:    .cfi_def_cfa_offset 16
; X64-AVX512-NEXT:    movq a@GOTPCREL(%rip), %rax
; X64-AVX512-NEXT:    movzwl (%rax), %edi
; X64-AVX512-NEXT:    callq __extendbfsf2@PLT
; X64-AVX512-NEXT:    vcvtss2sd %xmm0, %xmm0, %xmm0
; X64-AVX512-NEXT:    popq %rax
; X64-AVX512-NEXT:    .cfi_def_cfa_offset 8
; X64-AVX512-NEXT:    retq
  %1 = load bfloat, ptr @a, align 2
...
; X64-NEXT:    retq
;
; X64-AVX512-LABEL: float_to_bfloat:
; X64-AVX512:       # %bb.0:
; X64-AVX512-NEXT:    pushq %rax
; X64-AVX512-NEXT:    .cfi_def_cfa_offset 16
; X64-AVX512-NEXT:    callq __truncsfbf2@PLT
; X64-AVX512-NEXT:    movq a@GOTPCREL(%rip), %rcx
; X64-AVX512-NEXT:    movw %ax, (%rcx)
; X64-AVX512-NEXT:    popq %rax
; X64-AVX512-NEXT:    .cfi_def_cfa_offset 8
; X64-AVX512-NEXT:    retq
...
; X64-NEXT:    retq
;
; X64-AVX512-LABEL: double_to_bfloat:
; X64-AVX512:       # %bb.0:
; X64-AVX512-NEXT:    pushq %rax
; X64-AVX512-NEXT:    .cfi_def_cfa_offset 16
; X64-AVX512-NEXT:    callq __truncdfbf2@PLT
; X64-AVX512-NEXT:    movq a@GOTPCREL(%rip), %rcx
; X64-AVX512-NEXT:    movw %ax, (%rcx)
; X64-AVX512-NEXT:    popq %rax
; X64-AVX512-NEXT:    .cfi_def_cfa_offset 8
...
; X64-AVX512-NEXT:    movzwl (%rax), %edi
; X64-AVX512-NEXT:    callq __extendbfsf2@PLT
; X64-AVX512-NEXT:    vmovss %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; X64-AVX512-NEXT:    movq b@GOTPCREL(%rip), %rax
; X64-AVX512-NEXT:    movzwl (%rax), %edi
; X64-AVX512-NEXT:    callq __extendbfsf2@PLT
; X64-AVX512-NEXT:    vaddss {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 4-byte Folded Reload
; X64-AVX512-NEXT:    callq __truncsfbf2@PLT
; X64-AVX512-NEXT:    movq c@GOTPCREL(%rip), %rcx
; X64-AVX512-NEXT:    movw %ax, (%rcx)
; X64-AVX512-NEXT:    popq %rax
; X64-AVX512-NEXT:    .cfi_def_cfa_offset 8
; X64-AVX512-NEXT:    retq
