...
; X86-NEXT:    movl 148(%esp,%edx), %ebx
; X86-NEXT:    movl 152(%esp,%edx), %eax
; X86-NEXT:    movb %ch, %cl
...
; X86-NEXT:    movl 104(%esp,%ebx), %edx
; X86-NEXT:    movl 100(%esp,%ebx), %esi
; X86-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NEXT:    movl %esi, %ebp
; X86-NEXT:    movb %ch, %cl
; X86-NEXT:    shrdl %cl, %edx, %ebp
; X86-NEXT:    movl 92(%esp,%ebx), %edi
; X86-NEXT:    movl 96(%esp,%ebx), %eax
; X86-NEXT:    movl %eax, %ebx
...
; X86-NEXT:    movl %esi, 8(%ebx)
; X86-NEXT:    movl %edi, 12(%ebx)
; X86-NEXT:    movl {{[0-9]+}}(%esp), %eax
