...
; X86-SSE-WIN-NEXT:    movups {{[0-9]+}}(%esp), %xmm0
; X86-SSE-WIN-NEXT:    movups %xmm0, (%esp)
...
; X86-SSE-LIN:       # %bb.0:
; X86-SSE-LIN-NEXT:    subl $28, %esp
; X86-SSE-LIN-NEXT:    movaps {{[0-9]+}}(%esp), %xmm0
; X86-SSE-LIN-NEXT:    movups %xmm0, (%esp)
