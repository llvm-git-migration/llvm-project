...
; AVX512F-NEXT:    vbroadcastss {{.*#+}} ymm3 = [-0.0E+0,-0.0E+0,-0.0E+0,-0.0E+0,-0.0E+0,-0.0E+0,-0.0E+0,-0.0E+0]
; AVX512F-NEXT:    vptestmq %zmm0, %zmm0, %k1
; AVX512F-NEXT:    vmovaps %zmm2, %zmm3 {%k1}
; AVX512F-NEXT:    vaddps %ymm1, %ymm3, %ymm0
; AVX512F-NEXT:    retq
;
...
; AVX512F-NEXT:    vpmovsxwq %xmm0, %zmm0
; AVX512F-NEXT:    vpsllq $63, %zmm0, %zmm0
; AVX512F-NEXT:    vbroadcastss {{.*#+}} ymm3 = [1.0E+0,1.0E+0,1.0E+0,1.0E+0,1.0E+0,1.0E+0,1.0E+0,1.0E+0]
; AVX512F-NEXT:    vptestmq %zmm0, %zmm0, %k1
; AVX512F-NEXT:    vmovaps %zmm2, %zmm3 {%k1}
; AVX512F-NEXT:    vmulps %ymm1, %ymm3, %ymm0
; AVX512F-NEXT:    retq
;
...
; SSE2-NEXT:    mulps %xmm1, %xmm0
; SSE2-NEXT:    mulps %xmm8, %xmm7
; SSE2-NEXT:    mulps %xmm3, %xmm2
; SSE2-NEXT:    mulps %xmm4, %xmm9
; SSE2-NEXT:    movaps %xmm7, %xmm1
; SSE2-NEXT:    movaps %xmm9, %xmm3
; SSE2-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpmovsxbd %xmm0, %zmm3
; AVX512-NEXT:    vdivps %zmm2, %zmm1, %zmm0
; AVX512-NEXT:    vpslld $31, %zmm3, %zmm2
...
; SSE2-NEXT:    por %xmm10, %xmm0
; SSE2-NEXT:    divps %xmm1, %xmm0
; SSE2-NEXT:    divps %xmm8, %xmm7
; SSE2-NEXT:    divps %xmm3, %xmm2
; SSE2-NEXT:    divps %xmm4, %xmm9
; SSE2-NEXT:    movaps %xmm7, %xmm1
; SSE2-NEXT:    movaps %xmm9, %xmm3
; SSE2-NEXT:    retq
;
...
; SSE42-NEXT:    pmovzxbd {{.*#+}} xmm6 = [16,32,64,128]
; SSE42-NEXT:    movdqa %xmm5, %xmm0
...
; SSE42-NEXT:    movaps %xmm6, %xmm7
; SSE42-NEXT:    blendvps %xmm0, %xmm3, %xmm7
; SSE42-NEXT:    pmovsxbd {{.*#+}} xmm0 = [1,2,4,8]
...
; AVX2-NEXT:    vpmovzxbd {{.*#+}} ymm3 = [1,2,4,8,16,32,64,128]
...
; AVX2-NEXT:    vbroadcastsd {{.*#+}} ymm7 = [-0.0E+0,-0.0E+0,-0.0E+0,-0.0E+0]
...
; AVX2-NEXT:    vblendvpd %ymm4, %ymm2, %ymm7, %ymm2
...
; SSE2-LABEL: fsub_v8f32_cast_cond:
; SSE2:       # %bb.0:
; SSE2-NEXT:    movd %edi, %xmm4
; SSE2-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,0,0]
; SSE2-NEXT:    movdqa {{.*#+}} xmm5 = [16,32,64,128]
...
; SSE2-NEXT:    subps %xmm4, %xmm0
; SSE2-NEXT:    subps %xmm6, %xmm1
; SSE2-NEXT:    retq
;
; SSE42-LABEL: fsub_v8f32_cast_cond:
; SSE42:       # %bb.0:
; SSE42-NEXT:    movd %edi, %xmm4
; SSE42-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,0,0]
; SSE42-NEXT:    pmovzxbd {{.*#+}} xmm5 = [16,32,64,128]
...
; AVX2-NEXT:    vpmovzxbq {{.*#+}} ymm5 = [16,32,64,128]
; AVX2-NEXT:    vpand %ymm5, %ymm4, %ymm6
; AVX2-NEXT:    vbroadcastsd {{.*#+}} ymm7 = [1.0E+0,1.0E+0,1.0E+0,1.0E+0]
; AVX2-NEXT:    vpcmpeqq %ymm5, %ymm6, %ymm5
; AVX2-NEXT:    vblendvpd %ymm5, %ymm3, %ymm7, %ymm3
; AVX2-NEXT:    vpmovsxbq {{.*#+}} ymm5 = [1,2,4,8]
; AVX2-NEXT:    vpand %ymm5, %ymm4, %ymm4
...
; SSE2-LABEL: add_v8i32_cast_cond:
; SSE2:       # %bb.0:
; SSE2-NEXT:    movd %edi, %xmm4
; SSE2-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,0,0]
; SSE2-NEXT:    movdqa {{.*#+}} xmm5 = [16,32,64,128]
...
; SSE2-NEXT:    retq
;
; SSE42-LABEL: add_v8i32_cast_cond:
; SSE42:       # %bb.0:
; SSE42-NEXT:    movd %edi, %xmm4
; SSE42-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,0,0]
; SSE42-NEXT:    pmovzxbd {{.*#+}} xmm5 = [16,32,64,128]
...
; SSE2-LABEL: sub_v8i32_cast_cond:
; SSE2:       # %bb.0:
; SSE2-NEXT:    movd %edi, %xmm4
; SSE2-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,0,0]
; SSE2-NEXT:    movdqa {{.*#+}} xmm5 = [16,32,64,128]
...
; SSE2-NEXT:    retq
;
; SSE42-LABEL: sub_v8i32_cast_cond:
; SSE42:       # %bb.0:
; SSE42-NEXT:    movd %edi, %xmm4
; SSE42-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,0,0]
; SSE42-NEXT:    pmovzxbd {{.*#+}} xmm5 = [16,32,64,128]
...
; AVX512F-NEXT:    vpmulld %xmm3, %xmm1, %xmm0
; AVX512F-NEXT:    vzeroupper
; AVX512F-NEXT:    retq
;
...
; AVX512F-NEXT:    vpmovsxwq %xmm0, %zmm0
; AVX512F-NEXT:    vpsllq $63, %zmm0, %zmm0
; AVX512F-NEXT:    vpbroadcastd {{.*#+}} ymm3 = [1,1,1,1,1,1,1,1]
; AVX512F-NEXT:    vptestmq %zmm0, %zmm0, %k1
; AVX512F-NEXT:    vmovdqa32 %zmm2, %zmm3 {%k1}
; AVX512F-NEXT:    vpmulld %ymm1, %ymm3, %ymm0
; AVX512F-NEXT:    retq
;
...
; SSE42-NEXT:    pcmpeqq %xmm10, %xmm8
; SSE42-NEXT:    pand %xmm7, %xmm8
; SSE42-NEXT:    pmovsxbq {{.*#+}} xmm10 = [16,32]
; SSE42-NEXT:    movdqa %xmm9, %xmm7
; SSE42-NEXT:    pand %xmm10, %xmm7
; SSE42-NEXT:    pcmpeqq %xmm10, %xmm7
; SSE42-NEXT:    movdqa %xmm9, %xmm10
; SSE42-NEXT:    pmovsxbq {{.*#+}} xmm11 = [1,2]
; SSE42-NEXT:    pand %xmm11, %xmm9
; SSE42-NEXT:    pcmpeqq %xmm11, %xmm9
; SSE42-NEXT:    pmovsxbq {{.*#+}} xmm11 = [4,8]
; SSE42-NEXT:    pand %xmm11, %xmm10
; SSE42-NEXT:    pand %xmm4, %xmm9
; SSE42-NEXT:    movdqa %xmm0, %xmm4
; SSE42-NEXT:    psllq %xmm9, %xmm4
; SSE42-NEXT:    pcmpeqq %xmm11, %xmm10
; SSE42-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[2,3,2,3]
; SSE42-NEXT:    psllq %xmm9, %xmm0
; SSE42-NEXT:    pand %xmm5, %xmm10
; SSE42-NEXT:    movdqa %xmm1, %xmm5
; SSE42-NEXT:    psllq %xmm10, %xmm5
; SSE42-NEXT:    pand %xmm6, %xmm7
; SSE42-NEXT:    pshufd {{.*#+}} xmm6 = xmm10[2,3,2,3]
; SSE42-NEXT:    psllq %xmm6, %xmm1
...
; SSE42-NEXT:    pshuflw {{.*#+}} xmm4 = xmm0[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm1, %xmm0
; SSE42-NEXT:    psrld %xmm4, %xmm0
...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm6 = xmm3[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm0, %xmm7
...
; SSE42-NEXT:    pshuflw {{.*#+}} xmm6 = xmm3[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm0, %xmm7
; SSE42-NEXT:    psrld %xmm6, %xmm7
; SSE42-NEXT:    pshuflw {{.*#+}} xmm6 = xmm1[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm0, %xmm8
...
; SSE42-NEXT:    pblendw {{.*#+}} xmm0 = xmm0[0,1],xmm8[2,3],xmm0[4,5],xmm8[6,7]
...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm11 = xmm8[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm1, %xmm0
; SSE2-NEXT:    psrld %xmm11, %xmm0
; SSE2-NEXT:    punpckhbw {{.*#+}} xmm9 = xmm9[8,8,9,9,10,10,11,11,12,12,13,13,14,14,15,15]
; SSE2-NEXT:    pshufd {{.*#+}} xmm11 = xmm8[2,3,2,3]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm8 = xmm11[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm1, %xmm12
; SSE2-NEXT:    psrld %xmm8, %xmm12
; SSE2-NEXT:    movdqa %xmm9, %xmm8
; SSE2-NEXT:    punpckhwd {{.*#+}} xmm8 = xmm8[4,4,5,5,6,6,7,7]
; SSE2-NEXT:    pslld $31, %xmm8
; SSE2-NEXT:    psrad $31, %xmm8
...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm6 = xmm11[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    psrld %xmm6, %xmm1
; SSE2-NEXT:    punpcklqdq {{.*#+}} xmm0 = xmm0[0],xmm5[0]
; SSE2-NEXT:    punpckhqdq {{.*#+}} xmm1 = xmm1[1],xmm12[1]
; SSE2-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,3],xmm1[0,3]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm1 = xmm10[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm2, %xmm5
; SSE2-NEXT:    psrld %xmm1, %xmm5
; SSE2-NEXT:    pshuflw {{.*#+}} xmm6 = xmm10[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm2, %xmm1
; SSE2-NEXT:    psrld %xmm6, %xmm1
; SSE2-NEXT:    pshufd {{.*#+}} xmm6 = xmm10[2,3,2,3]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm7 = xmm6[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm2, %xmm10
; SSE2-NEXT:    psrld %xmm7, %xmm10
; SSE2-NEXT:    punpcklqdq {{.*#+}} xmm1 = xmm1[0],xmm5[0]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm5 = xmm6[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    psrld %xmm5, %xmm2
; SSE2-NEXT:    punpckhqdq {{.*#+}} xmm2 = xmm2[1],xmm10[1]
; SSE2-NEXT:    shufps {{.*#+}} xmm1 = xmm1[0,3],xmm2[0,3]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm2 = xmm9[2,3,3,3,4,5,6,7]
...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm7 = xmm8[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm4, %xmm5
; SSE2-NEXT:    psrld %xmm7, %xmm5
; SSE2-NEXT:    shufps {{.*#+}} xmm2 = xmm2[0,3],xmm3[0,3]
; SSE2-NEXT:    punpcklqdq {{.*#+}} xmm5 = xmm5[0],xmm6[0]
; SSE2-NEXT:    pshufd {{.*#+}} xmm3 = xmm8[2,3,2,3]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm6 = xmm3[2,3,3,3,4,5,6,7]
...
; SSE2-NEXT:    shufps {{.*#+}} xmm5 = xmm5[0,3],xmm4[0,3]
...
; SSE42-NEXT:    pmovzxbd {{.*#+}} xmm9 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero,xmm0[2],zero,zero,zero,xmm0[3],zero,zero,zero
...
; SSE42-NEXT:    psrld %xmm5, %xmm10
; SSE42-NEXT:    pandn %xmm7, %xmm9
; SSE42-NEXT:    pshufd {{.*#+}} xmm7 = xmm0[2,3,2,3]
; SSE42-NEXT:    pshuflw {{.*#+}} xmm5 = xmm7[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm1, %xmm11
; SSE42-NEXT:    psrld %xmm5, %xmm11
; SSE42-NEXT:    pshuflw {{.*#+}} xmm5 = xmm0[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm1, %xmm0
; SSE42-NEXT:    psrld %xmm5, %xmm0
; SSE42-NEXT:    pshufd {{.*#+}} xmm5 = xmm8[1,1,1,1]
; SSE42-NEXT:    pmovzxbd {{.*#+}} xmm12 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero,xmm5[2],zero,zero,zero,xmm5[3],zero,zero,zero
; SSE42-NEXT:    pslld $31, %xmm12
; SSE42-NEXT:    psrad $31, %xmm12
; SSE42-NEXT:    pshufd {{.*#+}} xmm5 = xmm8[3,3,3,3]
; SSE42-NEXT:    pmovzxbd {{.*#+}} xmm5 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero,xmm5[2],zero,zero,zero,xmm5[3],zero,zero,zero
; SSE42-NEXT:    pslld $31, %xmm5
; SSE42-NEXT:    psrad $31, %xmm5
; SSE42-NEXT:    pandn {{[0-9]+}}(%rsp), %xmm5
; SSE42-NEXT:    pandn %xmm6, %xmm12
; SSE42-NEXT:    pshuflw {{.*#+}} xmm6 = xmm7[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    psrld %xmm6, %xmm1
; SSE42-NEXT:    pblendw {{.*#+}} xmm11 = xmm10[0,1,2,3],xmm11[4,5,6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm0 = xmm0[0,1,2,3],xmm1[4,5,6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm0 = xmm0[0,1],xmm11[2,3],xmm0[4,5],xmm11[6,7]
; SSE42-NEXT:    pshuflw {{.*#+}} xmm1 = xmm12[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm2, %xmm6
; SSE42-NEXT:    psrld %xmm1, %xmm6
; SSE42-NEXT:    pshufd {{.*#+}} xmm7 = xmm12[2,3,2,3]
; SSE42-NEXT:    pshuflw {{.*#+}} xmm1 = xmm7[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm2, %xmm8
; SSE42-NEXT:    psrld %xmm1, %xmm8
; SSE42-NEXT:    pshuflw {{.*#+}} xmm10 = xmm12[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm2, %xmm1
; SSE42-NEXT:    psrld %xmm10, %xmm1
...
; SSE2-NEXT:    punpckhqdq {{.*#+}} xmm12 = xmm12[1],xmm11[1]
; SSE2-NEXT:    punpcklqdq {{.*#+}} xmm0 = xmm0[0],xmm13[0]
; SSE2-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,3],xmm12[0,3]
...
; SSE2-NEXT:    movdqa %xmm1, %xmm6
; SSE2-NEXT:    psrld %xmm5, %xmm6
; SSE2-NEXT:    pshuflw {{.*#+}} xmm5 = xmm2[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm1, %xmm9
; SSE2-NEXT:    psrld %xmm5, %xmm9
; SSE2-NEXT:    punpckhqdq {{.*#+}} xmm6 = xmm6[1],xmm7[1]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm2 = xmm2[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    psrld %xmm2, %xmm1
; SSE2-NEXT:    punpcklqdq {{.*#+}} xmm1 = xmm1[0],xmm9[0]
...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm2 = xmm3[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    psrld %xmm2, %xmm10
; SSE2-NEXT:    punpcklqdq {{.*#+}} xmm10 = xmm10[0],xmm6[0]
; SSE2-NEXT:    shufps {{.*#+}} xmm10 = xmm10[0,3],xmm5[0,3]
...
; SSE2-NEXT:    psrld %xmm2, %xmm3
; SSE2-NEXT:    punpckhqdq {{.*#+}} xmm3 = xmm3[1],xmm5[1]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm2 = xmm4[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm8, %xmm5
; SSE2-NEXT:    psrld %xmm2, %xmm5
; SSE2-NEXT:    pshuflw {{.*#+}} xmm2 = xmm4[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    psrld %xmm2, %xmm8
; SSE2-NEXT:    punpcklqdq {{.*#+}} xmm8 = xmm8[0],xmm5[0]
; SSE2-NEXT:    shufps {{.*#+}} xmm8 = xmm8[0,3],xmm3[0,3]
; SSE2-NEXT:    movaps %xmm10, %xmm2
...
; SSE42-NEXT:    pshuflw {{.*#+}} xmm5 = xmm1[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm0, %xmm11
; SSE42-NEXT:    psrld %xmm5, %xmm11
; SSE42-NEXT:    pshuflw {{.*#+}} xmm5 = xmm8[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm0, %xmm12
; SSE42-NEXT:    psrld %xmm5, %xmm12
; SSE42-NEXT:    pshuflw {{.*#+}} xmm1 = xmm1[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm0, %xmm5
; SSE42-NEXT:    psrld %xmm1, %xmm5
; SSE42-NEXT:    pshufd {{.*#+}} xmm1 = xmm9[1,1,1,1]
...
; SSE42-NEXT:    pshufd {{.*#+}} xmm7 = xmm9[3,3,3,3]
; SSE42-NEXT:    pmovzxbd {{.*#+}} xmm7 = xmm7[0],zero,zero,zero,xmm7[1],zero,zero,zero,xmm7[2],zero,zero,zero,xmm7[3],zero,zero,zero
; SSE42-NEXT:    pslld $31, %xmm7
; SSE42-NEXT:    psrad $31, %xmm7
; SSE42-NEXT:    pandn {{[0-9]+}}(%rsp), %xmm7
; SSE42-NEXT:    pandn %xmm6, %xmm1
; SSE42-NEXT:    pshuflw {{.*#+}} xmm6 = xmm8[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    psrld %xmm6, %xmm0
; SSE42-NEXT:    pblendw {{.*#+}} xmm12 = xmm12[0,1,2,3],xmm11[4,5,6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm0 = xmm0[0,1,2,3],xmm5[4,5,6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm0 = xmm0[0,1],xmm12[2,3],xmm0[4,5],xmm12[6,7]
...
; SSE42-NEXT:    pblendw {{.*#+}} xmm9 = xmm9[0,1,2,3],xmm8[4,5,6,7]
...
; SSE42-NEXT:    pshufd {{.*#+}} xmm5 = xmm3[2,3,2,3]
; SSE42-NEXT:    pshuflw {{.*#+}} xmm6 = xmm5[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm2, %xmm8
; SSE42-NEXT:    psrld %xmm6, %xmm8
; SSE42-NEXT:    pshuflw {{.*#+}} xmm6 = xmm3[2,3,3,3,4,5,6,7]
...
; SSE42-NEXT:    psrld %xmm5, %xmm6
; SSE42-NEXT:    pshuflw {{.*#+}} xmm3 = xmm3[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    psrld %xmm3, %xmm2
; SSE42-NEXT:    pblendw {{.*#+}} xmm2 = xmm2[0,1,2,3],xmm6[4,5,6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm2 = xmm2[0,1],xmm9[2,3],xmm2[4,5],xmm9[6,7]
; SSE42-NEXT:    pshufd {{.*#+}} xmm3 = xmm4[2,3,2,3]
; SSE42-NEXT:    pshuflw {{.*#+}} xmm5 = xmm3[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm7, %xmm6
; SSE42-NEXT:    psrld %xmm5, %xmm6
; SSE42-NEXT:    pshuflw {{.*#+}} xmm5 = xmm4[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm7, %xmm8
; SSE42-NEXT:    psrld %xmm5, %xmm8
; SSE42-NEXT:    pblendw {{.*#+}} xmm8 = xmm8[0,1,2,3],xmm6[4,5,6,7]
; SSE42-NEXT:    pshuflw {{.*#+}} xmm3 = xmm3[0,1,1,1,4,5,6,7]
...
; SSE42-NEXT:    pblendw {{.*#+}} xmm7 = xmm7[0,1,2,3],xmm5[4,5,6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm7 = xmm7[0,1],xmm8[2,3],xmm7[4,5],xmm8[6,7]
...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm7 = xmm5[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm0, %xmm8
; SSE2-NEXT:    psrld %xmm7, %xmm8
; SSE2-NEXT:    pand %xmm3, %xmm4
; SSE2-NEXT:    pshuflw {{.*#+}} xmm3 = xmm5[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    psrld %xmm3, %xmm0
; SSE2-NEXT:    punpcklqdq {{.*#+}} xmm2 = xmm2[0],xmm6[0]
; SSE2-NEXT:    punpckhqdq {{.*#+}} xmm0 = xmm0[1],xmm8[1]
...
; SSE42-NEXT:    pmovsxbd {{.*#+}} xmm6 = [1,2,4,8]
; SSE42-NEXT:    pand %xmm6, %xmm5
; SSE42-NEXT:    pcmpeqd %xmm6, %xmm5
; SSE42-NEXT:    pand %xmm2, %xmm5
; SSE42-NEXT:    pshuflw {{.*#+}} xmm2 = xmm5[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm0, %xmm6
; SSE42-NEXT:    psrld %xmm2, %xmm6
; SSE42-NEXT:    pshufd {{.*#+}} xmm2 = xmm5[2,3,2,3]
; SSE42-NEXT:    pshuflw {{.*#+}} xmm7 = xmm2[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm0, %xmm8
; SSE42-NEXT:    psrld %xmm7, %xmm8
; SSE42-NEXT:    pshuflw {{.*#+}} xmm5 = xmm5[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm0, %xmm7
; SSE42-NEXT:    psrld %xmm5, %xmm7
; SSE42-NEXT:    pand %xmm3, %xmm4
; SSE42-NEXT:    pshuflw {{.*#+}} xmm2 = xmm2[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    psrld %xmm2, %xmm0
; SSE42-NEXT:    pblendw {{.*#+}} xmm8 = xmm6[0,1,2,3],xmm8[4,5,6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm0 = xmm7[0,1,2,3],xmm0[4,5,6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm0 = xmm0[0,1],xmm8[2,3],xmm0[4,5],xmm8[6,7]
...
; SSE2-NEXT:    pand %xmm6, %xmm9
; SSE2-NEXT:    movdqa %xmm0, %xmm6
; SSE2-NEXT:    psrlq %xmm9, %xmm6
; SSE2-NEXT:    pand %xmm5, %xmm11
; SSE2-NEXT:    pshufd {{.*#+}} xmm5 = xmm9[2,3,2,3]
; SSE2-NEXT:    psrlq %xmm5, %xmm0
; SSE2-NEXT:    pand %xmm4, %xmm11
; SSE2-NEXT:    movdqa %xmm1, %xmm4
; SSE2-NEXT:    psrlq %xmm11, %xmm4
; SSE2-NEXT:    pand %xmm10, %xmm7
; SSE2-NEXT:    pshufd {{.*#+}} xmm5 = xmm11[2,3,2,3]
...
; SSE42-NEXT:    pcmpeqq %xmm11, %xmm10
; SSE42-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[2,3,2,3]
; SSE42-NEXT:    psrlq %xmm9, %xmm0
; SSE42-NEXT:    pand %xmm5, %xmm10
; SSE42-NEXT:    movdqa %xmm1, %xmm5
; SSE42-NEXT:    psrlq %xmm10, %xmm5
; SSE42-NEXT:    pand %xmm6, %xmm7
; SSE42-NEXT:    pshufd {{.*#+}} xmm6 = xmm10[2,3,2,3]
; SSE42-NEXT:    psrlq %xmm6, %xmm1
; SSE42-NEXT:    pblendw {{.*#+}} xmm0 = xmm4[0,1,2,3],xmm0[4,5,6,7]
; SSE42-NEXT:    movdqa %xmm2, %xmm4
...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm11 = xmm8[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm1, %xmm0
; SSE2-NEXT:    psrad %xmm11, %xmm0
; SSE2-NEXT:    punpckhbw {{.*#+}} xmm9 = xmm9[8,8,9,9,10,10,11,11,12,12,13,13,14,14,15,15]
; SSE2-NEXT:    pshufd {{.*#+}} xmm11 = xmm8[2,3,2,3]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm8 = xmm11[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm1, %xmm12
; SSE2-NEXT:    psrad %xmm8, %xmm12
; SSE2-NEXT:    movdqa %xmm9, %xmm8
; SSE2-NEXT:    punpckhwd {{.*#+}} xmm8 = xmm8[4,4,5,5,6,6,7,7]
; SSE2-NEXT:    pslld $31, %xmm8
; SSE2-NEXT:    psrad $31, %xmm8
...
; SSE42-NEXT:    pshuflw {{.*#+}} xmm5 = xmm0[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm1, %xmm10
; SSE42-NEXT:    psrad %xmm5, %xmm10
; SSE42-NEXT:    pandn %xmm7, %xmm9
; SSE42-NEXT:    pshufd {{.*#+}} xmm7 = xmm0[2,3,2,3]
; SSE42-NEXT:    pshuflw {{.*#+}} xmm5 = xmm7[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm1, %xmm11
; SSE42-NEXT:    psrad %xmm5, %xmm11
; SSE42-NEXT:    pshuflw {{.*#+}} xmm5 = xmm0[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm1, %xmm0
...
; SSE42-NEXT:    pshuflw {{.*#+}} xmm1 = xmm7[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm2, %xmm8
; SSE42-NEXT:    psrad %xmm1, %xmm8
; SSE42-NEXT:    pshuflw {{.*#+}} xmm10 = xmm12[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm2, %xmm1
; SSE42-NEXT:    psrad %xmm10, %xmm1
; SSE42-NEXT:    pblendw {{.*#+}} xmm8 = xmm6[0,1,2,3],xmm8[4,5,6,7]
; SSE42-NEXT:    pshuflw {{.*#+}} xmm6 = xmm7[0,1,1,1,4,5,6,7]
...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm8 = xmm5[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm0, %xmm11
; SSE2-NEXT:    psrad %xmm8, %xmm11
; SSE2-NEXT:    pshuflw {{.*#+}} xmm5 = xmm5[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm0, %xmm12
; SSE2-NEXT:    psrad %xmm5, %xmm12
; SSE2-NEXT:    pshuflw {{.*#+}} xmm5 = xmm9[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm0, %xmm13
; SSE2-NEXT:    psrad %xmm5, %xmm13
; SSE2-NEXT:    movdqa %xmm10, %xmm8
; SSE2-NEXT:    punpckhwd {{.*#+}} xmm8 = xmm8[4,4,5,5,6,6,7,7]
; SSE2-NEXT:    pslld $31, %xmm8
; SSE2-NEXT:    psrad $31, %xmm8
...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm2 = xmm3[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm10, %xmm6
; SSE2-NEXT:    psrad %xmm2, %xmm6
; SSE2-NEXT:    pshuflw {{.*#+}} xmm2 = xmm3[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    psrad %xmm2, %xmm10
; SSE2-NEXT:    punpcklqdq {{.*#+}} xmm10 = xmm10[0],xmm6[0]
; SSE2-NEXT:    shufps {{.*#+}} xmm10 = xmm10[0,3],xmm5[0,3]
; SSE2-NEXT:    pshufd {{.*#+}} xmm2 = xmm4[2,3,2,3]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm3 = xmm2[2,3,3,3,4,5,6,7]
...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm7 = xmm5[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm0, %xmm2
; SSE2-NEXT:    psrad %xmm7, %xmm2
; SSE2-NEXT:    pshufd {{.*#+}} xmm5 = xmm5[2,3,2,3]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm7 = xmm5[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm0, %xmm8
; SSE2-NEXT:    psrad %xmm7, %xmm8
; SSE2-NEXT:    pand %xmm3, %xmm4
; SSE2-NEXT:    pshuflw {{.*#+}} xmm3 = xmm5[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    psrad %xmm3, %xmm0
; SSE2-NEXT:    punpcklqdq {{.*#+}} xmm2 = xmm2[0],xmm6[0]
...
; SSE42-NEXT:    pshuflw {{.*#+}} xmm7 = xmm2[2,3,3,3,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm0, %xmm8
; SSE42-NEXT:    psrad %xmm7, %xmm8
; SSE42-NEXT:    pshuflw {{.*#+}} xmm5 = xmm5[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm0, %xmm7
; SSE42-NEXT:    psrad %xmm5, %xmm7
; SSE42-NEXT:    pand %xmm3, %xmm4
; SSE42-NEXT:    pshuflw {{.*#+}} xmm2 = xmm2[0,1,1,1,4,5,6,7]
...
; SSE2-NEXT:    movdqa %xmm3, %xmm7
; SSE2-NEXT:    psrlq %xmm8, %xmm7
; SSE2-NEXT:    psrlq %xmm6, %xmm3
; SSE2-NEXT:    movsd {{.*#+}} xmm4 = xmm5[0],xmm4[1]
; SSE2-NEXT:    movsd {{.*#+}} xmm3 = xmm7[0],xmm3[1]
...
; SSE42-NEXT:    psrlq %xmm8, %xmm7
; SSE42-NEXT:    psrlq %xmm6, %xmm3
; SSE42-NEXT:    pblendw {{.*#+}} xmm4 = xmm5[0,1,2,3],xmm4[4,5,6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm3 = xmm7[0,1,2,3],xmm3[4,5,6,7]
