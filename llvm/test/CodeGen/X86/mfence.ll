...
; X64-NEXT:    retq
;
; X64-MFENCE-LABEL: test:
; X64-MFENCE:       # %bb.0:
; X64-MFENCE-NEXT:    lock orl $0, -{{[0-9]+}}(%rsp)
; X64-MFENCE-NEXT:    retq
  fence seq_cst
  ret void
}
...
; X64-NEXT:    retq
;
; X64-MFENCE-LABEL: fence:
; X64-MFENCE:       # %bb.0:
; X64-MFENCE-NEXT:    lock orl $0, -{{[0-9]+}}(%rsp)
; X64-MFENCE-NEXT:    movl (%rdi), %eax
; X64-MFENCE-NEXT:    retq
...
; X64-NEXT:    retq
;
; X64-MFENCE-LABEL: mfence:
; X64-MFENCE:       # %bb.0:
; X64-MFENCE-NEXT:    mfence
; X64-MFENCE-NEXT:    retq
