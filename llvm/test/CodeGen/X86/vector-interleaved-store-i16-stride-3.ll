...
; AVX512-FCP-NEXT:    vpermd %ymm2, %ymm3, %ymm3
...
; AVX512-FCP-NEXT:    vpternlogq $244, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm3, %ymm0
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0],xmm2[1],xmm1[2,3],xmm2[4],xmm1[5,6],xmm2[7]
...
; AVX512DQ-FCP-NEXT:    vpermd %ymm2, %ymm3, %ymm3
...
; AVX512DQ-FCP-NEXT:    vpternlogq $244, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm3, %ymm0
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0],xmm2[1],xmm1[2,3],xmm2[4],xmm1[5,6],xmm2[7]
...
; AVX512-NEXT:    vpshufb {{.*#+}} xmm4 = xmm4[4,5,u,u,10,11,8,9,u,u,14,15,12,13,u,u]
...
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} xmm4 = xmm4[4,5,u,u,10,11,8,9,u,u,14,15,12,13,u,u]
...
; AVX512DQ-NEXT:    vpshufb {{.*#+}} xmm4 = xmm4[4,5,u,u,10,11,8,9,u,u,14,15,12,13,u,u]
...
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} xmm4 = xmm4[4,5,u,u,10,11,8,9,u,u,14,15,12,13,u,u]
...
; AVX2-NEXT:    vpunpckhwd {{.*#+}} xmm4 = xmm3[4],xmm1[4],xmm3[5],xmm1[5],xmm3[6],xmm1[6],xmm3[7],xmm1[7]
; AVX2-NEXT:    vmovdqa {{.*#+}} xmm5 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX2-NEXT:    vpshufb %xmm5, %xmm4, %xmm4
; AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[1,1,2,2]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm3[3,3,3,3,4,5,6,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,4,4,4,4]
; AVX2-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0,1],xmm3[2],xmm1[3,4],xmm3[5],xmm1[6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm4, %ymm1, %ymm1
; AVX2-NEXT:    vpmovsxbd {{.*#+}} ymm4 = [5,5,0,6,6,0,7,7]
; AVX2-NEXT:    vpermd %ymm0, %ymm4, %ymm3
; AVX2-NEXT:    vpmovsxbw {{.*#+}} ymm6 = [0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0]
...
; AVX2-NEXT:    vmovdqa 16(%rsi), %xmm11
; AVX2-NEXT:    vpunpckhwd {{.*#+}} xmm12 = xmm11[4],xmm8[4],xmm11[5],xmm8[5],xmm11[6],xmm8[6],xmm11[7],xmm8[7]
; AVX2-NEXT:    vpshufb %xmm5, %xmm12, %xmm5
; AVX2-NEXT:    vpshufd {{.*#+}} xmm8 = xmm8[1,1,2,2]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm11[3,3,3,3,4,5,6,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,4,4,4,4]
; AVX2-NEXT:    vpblendw {{.*#+}} xmm8 = xmm8[0,1],xmm11[2],xmm8[3,4],xmm11[5],xmm8[6,7]
...
; AVX2-NEXT:    vpshufd {{.*#+}} xmm6 = xmm7[1,1,2,2]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm10[3,3,3,3,4,5,6,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,4,4,4,4]
; AVX2-NEXT:    vpblendw {{.*#+}} xmm6 = xmm6[0,1],xmm8[2],xmm6[3,4],xmm8[5],xmm6[6,7]
...
; AVX2-NEXT:    vpermd %ymm3, %ymm7, %ymm10
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm5[3,3,3,3,4,5,6,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm12[0,1,2,3,4,4,4,4]
; AVX2-NEXT:    vpblendw {{.*#+}} xmm10 = xmm10[0,1],xmm12[2],xmm10[3,4],xmm12[5],xmm10[6,7]
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm9[0],xmm5[0],xmm9[1],xmm5[1],xmm9[2],xmm5[2],xmm9[3],xmm5[3]
...
; AVX2-NEXT:    vmovdqa {{.*#+}} ymm7 = [10,11,0,1,12,13,12,13,2,3,2,3,14,15,4,5,26,27,16,17,28,29,28,29,18,19,18,19,30,31,20,21]
; AVX2-NEXT:    vpmovsxbd {{.*#+}} ymm8 = [0,3,3,0,4,4,0,5]
; AVX2-NEXT:    vpermd (%rdi), %ymm8, %ymm9
; AVX2-NEXT:    vpshufb %ymm7, %ymm2, %ymm2
; AVX2-NEXT:    vpmovsxbw {{.*#+}} ymm10 = [65535,0,0,65535,0,0,65535,0,0,65535,0,0,65535,0,0,65535]
; AVX2-NEXT:    vpblendvb %ymm10, %ymm2, %ymm9, %ymm2
; AVX2-NEXT:    vmovdqa 32(%rsi), %ymm9
; AVX2-NEXT:    vpmovsxbd {{.*#+}} ymm11 = [2,0,3,3,0,4,4,0]
...
; AVX2-NEXT:    vpblendvb %ymm12, %ymm2, %ymm3, %ymm2
; AVX2-NEXT:    vpermd 32(%rdi), %ymm8, %ymm3
; AVX2-NEXT:    vpshufb %ymm7, %ymm9, %ymm7
; AVX2-NEXT:    vpblendvb %ymm10, %ymm7, %ymm3, %ymm3
...
; AVX512-NEXT:    vpermd %ymm7, %ymm4, %ymm4
...
; AVX512-NEXT:    vpshufb %ymm9, %ymm7, %ymm7
...
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm4, %zmm7, %zmm4
...
; AVX512DQ-NEXT:    vpermd %ymm7, %ymm4, %ymm4
; AVX512DQ-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm4, %ymm4
; AVX512DQ-NEXT:    vpshufb %ymm8, %ymm7, %ymm7
...
; AVX512DQ-NEXT:    vpshufb %ymm9, %ymm7, %ymm7
...
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm4, %zmm7, %zmm4
...
; AVX2-NEXT:    vinserti128 $1, %xmm10, %ymm5, %ymm5
; AVX2-NEXT:    vpermd %ymm1, %ymm8, %ymm6
...
; AVX2-NEXT:    vpermd %ymm0, %ymm8, %ymm10
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm10[3,3,3,3,4,5,6,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm14 = xmm14[0,1,2,3,4,4,4,4]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm15[1,1,2,2]
; AVX2-NEXT:    vpblendw {{.*#+}} xmm2 = xmm2[0,1],xmm14[2],xmm2[3,4],xmm14[5],xmm2[6,7]
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm15[0],xmm10[0],xmm15[1],xmm10[1],xmm15[2],xmm10[2],xmm15[3],xmm10[3]
; AVX2-NEXT:    vpshufb %xmm11, %xmm10, %xmm10
; AVX2-NEXT:    vinserti128 $1, %xmm2, %ymm10, %ymm2
; AVX2-NEXT:    vpermd %ymm1, %ymm12, %ymm10
...
; AVX2-NEXT:    vpermd %ymm0, %ymm12, %ymm5
...
; AVX2-NEXT:    vpblendvb %ymm14, %ymm2, %ymm0, %ymm0
; AVX2-NEXT:    vmovdqa %ymm0, 320(%rcx)
; AVX2-NEXT:    vmovdqa %ymm1, 128(%rcx)
...
; AVX2-FP-NEXT:    vmovdqa (%rsi), %xmm2
; AVX2-FP-NEXT:    vpbroadcastd {{.*#+}} xmm7 = [6,7,8,9,6,7,8,9,6,7,8,9,6,7,8,9]
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm2, %xmm3
; AVX2-FP-NEXT:    vmovdqa (%rdi), %xmm4
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm5 = xmm4[1,1,2,2]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} xmm3 = xmm5[0,1],xmm3[2],xmm5[3,4],xmm3[5],xmm5[6,7]
...
; AVX2-FP-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm5[4],xmm3[4],xmm5[5],xmm3[5],xmm5[6],xmm3[6],xmm5[7],xmm3[7]
...
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[1,1,2,2]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} xmm3 = xmm3[0,1],xmm5[2],xmm3[3,4],xmm5[5],xmm3[6,7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm6, %ymm3, %ymm3
; AVX2-FP-NEXT:    vpmovsxbd {{.*#+}} ymm10 = [5,5,0,6,6,0,7,7]
...
; AVX2-FP-NEXT:    vpblendvb %ymm11, %ymm3, %ymm5, %ymm2
; AVX2-FP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vpblendw {{.*#+}} xmm6 = xmm15[0,1],xmm6[2],xmm15[3,4],xmm6[5],xmm15[6,7]
; AVX2-FP-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm8[0],xmm5[0],xmm8[1],xmm5[1],xmm8[2],xmm5[2],xmm8[3],xmm5[3]
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm5, %xmm5
; AVX2-FP-NEXT:    vinserti128 $1, %xmm6, %ymm5, %ymm5
; AVX2-FP-NEXT:    vpermd %ymm4, %ymm13, %ymm6
; AVX2-FP-NEXT:    vpblendvb %ymm14, %ymm5, %ymm6, %ymm2
; AVX2-FP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovdqa 48(%rdi), %xmm6
; AVX2-FP-NEXT:    vmovdqa 48(%rsi), %xmm8
; AVX2-FP-NEXT:    vpunpckhwd {{.*#+}} xmm15 = xmm8[4],xmm6[4],xmm8[5],xmm6[5],xmm8[6],xmm6[6],xmm8[7],xmm6[7]
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm8, %xmm8
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[1,1,2,2]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} xmm6 = xmm6[0,1],xmm8[2],xmm6[3,4],xmm8[5],xmm6[6,7]
; AVX2-FP-NEXT:    vmovdqa 32(%rsi), %xmm8
; AVX2-FP-NEXT:    vpshufb %xmm9, %xmm15, %xmm15
; AVX2-FP-NEXT:    vinserti128 $1, %xmm15, %ymm6, %ymm6
; AVX2-FP-NEXT:    vmovdqa %ymm0, %ymm5
; AVX2-FP-NEXT:    vpermd %ymm0, %ymm10, %ymm15
; AVX2-FP-NEXT:    vpblendvb %ymm11, %ymm6, %ymm15, %ymm6
; AVX2-FP-NEXT:    vmovdqa 32(%rdi), %xmm15
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm8, %xmm0
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm2 = xmm15[1,1,2,2]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} xmm0 = xmm2[0,1],xmm0[2],xmm2[3,4],xmm0[5],xmm2[6,7]
; AVX2-FP-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm15[0],xmm8[0],xmm15[1],xmm8[1],xmm15[2],xmm8[2],xmm15[3],xmm8[3]
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm2, %xmm2
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm2, %ymm0
; AVX2-FP-NEXT:    vpermd %ymm5, %ymm13, %ymm2
; AVX2-FP-NEXT:    vpblendvb %ymm14, %ymm0, %ymm2, %ymm8
; AVX2-FP-NEXT:    vmovdqa 96(%rsi), %xmm0
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm0, %xmm2
; AVX2-FP-NEXT:    vmovdqa 96(%rdi), %xmm15
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm3 = xmm15[1,1,2,2]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} xmm2 = xmm3[0,1],xmm2[2],xmm3[3,4],xmm2[5],xmm3[6,7]
...
; AVX2-FP-NEXT:    vpermd %ymm15, %ymm13, %ymm2
; AVX2-FP-NEXT:    vpblendvb %ymm14, %ymm0, %ymm2, %ymm12
; AVX2-FP-NEXT:    vmovdqa 112(%rdi), %xmm0
; AVX2-FP-NEXT:    vmovdqa 112(%rsi), %xmm2
; AVX2-FP-NEXT:    vpunpckhwd {{.*#+}} xmm3 = xmm2[4],xmm0[4],xmm2[5],xmm0[5],xmm2[6],xmm0[6],xmm2[7],xmm0[7]
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm2, %xmm2
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[1,1,2,2]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm2[2],xmm0[3,4],xmm2[5],xmm0[6,7]
; AVX2-FP-NEXT:    vpshufb %xmm9, %xmm3, %xmm2
; AVX2-FP-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm0
; AVX2-FP-NEXT:    vpermd %ymm15, %ymm10, %ymm2
; AVX2-FP-NEXT:    vpblendvb %ymm11, %ymm0, %ymm2, %ymm13
; AVX2-FP-NEXT:    vmovdqa 16(%rsi), %xmm0
; AVX2-FP-NEXT:    vmovdqa 16(%rdi), %xmm2
; AVX2-FP-NEXT:    vpunpckhwd {{.*#+}} xmm3 = xmm0[4],xmm2[4],xmm0[5],xmm2[5],xmm0[6],xmm2[6],xmm0[7],xmm2[7]
; AVX2-FP-NEXT:    vpshufb %xmm9, %xmm3, %xmm3
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm0, %xmm0
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[1,1,2,2]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} xmm0 = xmm2[0,1],xmm0[2],xmm2[3,4],xmm0[5],xmm2[6,7]
; AVX2-FP-NEXT:    vmovdqa (%rsi), %ymm2
; AVX2-FP-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm0
; AVX2-FP-NEXT:    vpermd %ymm1, %ymm10, %ymm3
; AVX2-FP-NEXT:    vpblendvb %ymm11, %ymm0, %ymm3, %ymm7
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm0 = [10,11,0,1,12,13,12,13,2,3,2,3,14,15,4,5,26,27,16,17,28,29,28,29,18,19,18,19,30,31,20,21]
; AVX2-FP-NEXT:    vpmovsxbd {{.*#+}} ymm3 = [0,3,3,0,4,4,0,5]
; AVX2-FP-NEXT:    vpermd (%rdi), %ymm3, %ymm9
; AVX2-FP-NEXT:    vpshufb %ymm0, %ymm2, %ymm2
; AVX2-FP-NEXT:    vpmovsxbw {{.*#+}} ymm10 = [65535,0,0,65535,0,0,65535,0,0,65535,0,0,65535,0,0,65535]
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm2, %ymm9, %ymm2
; AVX2-FP-NEXT:    vmovdqa 64(%rsi), %ymm9
; AVX2-FP-NEXT:    vpshufb %ymm0, %ymm9, %ymm9
; AVX2-FP-NEXT:    vpermd 64(%rdi), %ymm3, %ymm11
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm9, %ymm11, %ymm9
; AVX2-FP-NEXT:    vmovdqa 32(%rsi), %ymm11
; AVX2-FP-NEXT:    vpshufb %ymm0, %ymm11, %ymm11
; AVX2-FP-NEXT:    vpermd 32(%rdi), %ymm3, %ymm14
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm11, %ymm14, %ymm11
; AVX2-FP-NEXT:    vpermd 96(%rdi), %ymm3, %ymm3
; AVX2-FP-NEXT:    vmovdqa 96(%rsi), %ymm14
; AVX2-FP-NEXT:    vpshufb %ymm0, %ymm14, %ymm0
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm0, %ymm3, %ymm0
; AVX2-FP-NEXT:    vpmovsxbd {{.*#+}} ymm3 = [2,0,3,3,0,4,4,0]
...
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm2, %ymm1, %ymm1
; AVX2-FP-NEXT:    vpermd %ymm4, %ymm3, %ymm2
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm9, %ymm2, %ymm2
; AVX2-FP-NEXT:    vpermd %ymm5, %ymm3, %ymm4
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm11, %ymm4, %ymm4
; AVX2-FP-NEXT:    vpermd %ymm15, %ymm3, %ymm3
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm0, %ymm3, %ymm0
; AVX2-FP-NEXT:    vmovdqa %ymm0, 320(%rcx)
; AVX2-FP-NEXT:    vmovdqa %ymm4, 128(%rcx)
; AVX2-FP-NEXT:    vmovdqa %ymm2, 224(%rcx)
; AVX2-FP-NEXT:    vmovdqa %ymm1, 32(%rcx)
; AVX2-FP-NEXT:    vmovdqa %ymm7, 64(%rcx)
; AVX2-FP-NEXT:    vmovdqa %ymm12, 288(%rcx)
; AVX2-FP-NEXT:    vmovdqa %ymm13, 352(%rcx)
; AVX2-FP-NEXT:    vmovdqa %ymm8, 96(%rcx)
; AVX2-FP-NEXT:    vmovdqa %ymm6, 160(%rcx)
...
; AVX2-FCP-NEXT:    vmovdqa (%rsi), %xmm2
; AVX2-FCP-NEXT:    vpbroadcastd {{.*#+}} xmm7 = [6,7,8,9,6,7,8,9,6,7,8,9,6,7,8,9]
; AVX2-FCP-NEXT:    vpshufb %xmm7, %xmm2, %xmm3
; AVX2-FCP-NEXT:    vmovdqa (%rdi), %xmm4
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm5 = xmm4[1,1,2,2]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} xmm3 = xmm5[0,1],xmm3[2],xmm5[3,4],xmm3[5],xmm5[6,7]
...
; AVX2-FCP-NEXT:    vpblendvb %ymm14, %ymm2, %ymm3, %ymm2
...
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm5[4],xmm3[4],xmm5[5],xmm3[5],xmm5[6],xmm3[6],xmm5[7],xmm3[7]
...
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[1,1,2,2]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} xmm3 = xmm3[0,1],xmm5[2],xmm3[3,4],xmm5[5],xmm3[6,7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm3, %ymm3
; AVX2-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm10 = [5,5,0,6,6,0,7,7]
...
; AVX2-FCP-NEXT:    vpblendvb %ymm11, %ymm3, %ymm5, %ymm2
; AVX2-FCP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 64(%rsi), %xmm5
; AVX2-FCP-NEXT:    vpshufb %xmm7, %xmm5, %xmm6
; AVX2-FCP-NEXT:    vmovdqa 64(%rdi), %xmm8
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm15 = xmm8[1,1,2,2]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} xmm6 = xmm15[0,1],xmm6[2],xmm15[3,4],xmm6[5],xmm15[6,7]
...
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm5, %ymm5
; AVX2-FCP-NEXT:    vpermd %ymm4, %ymm13, %ymm6
; AVX2-FCP-NEXT:    vpblendvb %ymm14, %ymm5, %ymm6, %ymm2
; AVX2-FCP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 48(%rdi), %xmm6
; AVX2-FCP-NEXT:    vmovdqa 48(%rsi), %xmm8
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm15 = xmm8[4],xmm6[4],xmm8[5],xmm6[5],xmm8[6],xmm6[6],xmm8[7],xmm6[7]
; AVX2-FCP-NEXT:    vpshufb %xmm7, %xmm8, %xmm8
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[1,1,2,2]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} xmm6 = xmm6[0,1],xmm8[2],xmm6[3,4],xmm8[5],xmm6[6,7]
; AVX2-FCP-NEXT:    vmovdqa 32(%rsi), %xmm8
; AVX2-FCP-NEXT:    vpshufb %xmm9, %xmm15, %xmm15
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm15, %ymm6, %ymm6
; AVX2-FCP-NEXT:    vmovdqa %ymm0, %ymm5
; AVX2-FCP-NEXT:    vpermd %ymm0, %ymm10, %ymm15
; AVX2-FCP-NEXT:    vpblendvb %ymm11, %ymm6, %ymm15, %ymm6
; AVX2-FCP-NEXT:    vmovdqa 32(%rdi), %xmm15
; AVX2-FCP-NEXT:    vpshufb %xmm7, %xmm8, %xmm0
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm2 = xmm15[1,1,2,2]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} xmm0 = xmm2[0,1],xmm0[2],xmm2[3,4],xmm0[5],xmm2[6,7]
; AVX2-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm15[0],xmm8[0],xmm15[1],xmm8[1],xmm15[2],xmm8[2],xmm15[3],xmm8[3]
; AVX2-FCP-NEXT:    vpshufb %xmm12, %xmm2, %xmm2
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm2, %ymm0
; AVX2-FCP-NEXT:    vpermd %ymm5, %ymm13, %ymm2
; AVX2-FCP-NEXT:    vpblendvb %ymm14, %ymm0, %ymm2, %ymm8
; AVX2-FCP-NEXT:    vmovdqa 96(%rsi), %xmm0
; AVX2-FCP-NEXT:    vpshufb %xmm7, %xmm0, %xmm2
; AVX2-FCP-NEXT:    vmovdqa 96(%rdi), %xmm15
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm3 = xmm15[1,1,2,2]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} xmm2 = xmm3[0,1],xmm2[2],xmm3[3,4],xmm2[5],xmm3[6,7]
...
; AVX2-FCP-NEXT:    vpblendvb %ymm10, %ymm2, %ymm1, %ymm1
; AVX2-FCP-NEXT:    vpermd %ymm4, %ymm3, %ymm2
; AVX2-FCP-NEXT:    vpblendvb %ymm10, %ymm9, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vpermd %ymm5, %ymm3, %ymm4
; AVX2-FCP-NEXT:    vpblendvb %ymm10, %ymm11, %ymm4, %ymm4
; AVX2-FCP-NEXT:    vpermd %ymm15, %ymm3, %ymm3
; AVX2-FCP-NEXT:    vpblendvb %ymm10, %ymm0, %ymm3, %ymm0
; AVX2-FCP-NEXT:    vmovdqa %ymm0, 320(%rcx)
; AVX2-FCP-NEXT:    vmovdqa %ymm4, 128(%rcx)
; AVX2-FCP-NEXT:    vmovdqa %ymm2, 224(%rcx)
; AVX2-FCP-NEXT:    vmovdqa %ymm1, 32(%rcx)
; AVX2-FCP-NEXT:    vmovdqa %ymm7, 64(%rcx)
; AVX2-FCP-NEXT:    vmovdqa %ymm12, 288(%rcx)
; AVX2-FCP-NEXT:    vmovdqa %ymm13, 352(%rcx)
; AVX2-FCP-NEXT:    vmovdqa %ymm8, 96(%rcx)
; AVX2-FCP-NEXT:    vmovdqa %ymm6, 160(%rcx)
...
; AVX512-NEXT:    vinserti64x4 $1, %ymm10, %zmm0, %zmm13
; AVX512-NEXT:    vmovdqa 80(%rdi), %xmm10
; AVX512-NEXT:    vmovdqa 80(%rsi), %xmm12
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm12[4],xmm10[4],xmm12[5],xmm10[5],xmm12[6],xmm10[6],xmm12[7],xmm10[7]
...
; AVX512-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm0[0,1,2,3],zmm13[4,5,6,7]
...
; AVX512-NEXT:    vpermd (%rdx), %zmm18, %zmm2
; AVX512-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm1[0,1,2,3],zmm0[4,5,6,7]
; AVX512-NEXT:    vpternlogd $184, %zmm0, %zmm22, %zmm2
...
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm10, %zmm0, %zmm13
; AVX512-FCP-NEXT:    vmovdqa 80(%rdi), %xmm10
; AVX512-FCP-NEXT:    vmovdqa 80(%rsi), %xmm12
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm12[4],xmm10[4],xmm12[5],xmm10[5],xmm12[6],xmm10[6],xmm12[7],xmm10[7]
...
; AVX512-FCP-NEXT:    vpermd (%rdx), %zmm18, %zmm2
; AVX512-FCP-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm1[0,1,2,3],zmm0[4,5,6,7]
; AVX512-FCP-NEXT:    vpternlogd $184, %zmm0, %zmm22, %zmm2
...
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm10, %zmm0, %zmm13
; AVX512DQ-NEXT:    vmovdqa 80(%rdi), %xmm10
; AVX512DQ-NEXT:    vmovdqa 80(%rsi), %xmm12
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm12[4],xmm10[4],xmm12[5],xmm10[5],xmm12[6],xmm10[6],xmm12[7],xmm10[7]
...
; AVX512DQ-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm0[0,1,2,3],zmm13[4,5,6,7]
...
; AVX512DQ-NEXT:    vpermd (%rdx), %zmm18, %zmm2
; AVX512DQ-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm1[0,1,2,3],zmm0[4,5,6,7]
; AVX512DQ-NEXT:    vpternlogd $184, %zmm0, %zmm22, %zmm2
...
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm10, %zmm0, %zmm13
; AVX512DQ-FCP-NEXT:    vmovdqa 80(%rdi), %xmm10
; AVX512DQ-FCP-NEXT:    vmovdqa 80(%rsi), %xmm12
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm12[4],xmm10[4],xmm12[5],xmm10[5],xmm12[6],xmm10[6],xmm12[7],xmm10[7]
...
; AVX512DQ-FCP-NEXT:    vpermd (%rdx), %zmm18, %zmm2
; AVX512DQ-FCP-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm1[0,1,2,3],zmm0[4,5,6,7]
; AVX512DQ-FCP-NEXT:    vpternlogd $184, %zmm0, %zmm22, %zmm2
