...
@B = global %struct.W { x86_fp80 f0x4001A000000000000000, x86_fp80 f0x4001C000000000000000 }, align 32
@.cpx = internal constant %struct.W { x86_fp80 f0x4001E000000000000000, x86_fp80 f0x40028000000000000000 }
...
; CHECK-NEXT:    retl
entry:
	tail call void (i32, ...) @bar( i32 3, ptr byval(%struct.W) @.cpx ) nounwind
	tail call void (i32, ...) @baz( i32 3, ptr byval(%struct.W)  @B ) nounwind
	ret i32 undef
}
