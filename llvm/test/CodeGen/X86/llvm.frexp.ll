...
; WIN32-NEXT:    movzwl 28(%esp), %eax
; WIN32-NEXT:    movl %eax, (%esp)
; WIN32-NEXT:    calll ___gnu_h2f_ieee
; WIN32-NEXT:    leal 16(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    fstps 12(%esp)
; WIN32-NEXT:    flds 12(%esp)
; WIN32-NEXT:    fstps (%esp)
; WIN32-NEXT:    movl 16(%esp), %esi
...
; WIN32-NEXT:    movzwl 20(%esp), %eax
; WIN32-NEXT:    movl %eax, (%esp)
; WIN32-NEXT:    calll ___gnu_h2f_ieee
; WIN32-NEXT:    leal 12(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    fstp %st(0)
; WIN32-NEXT:    movl 12(%esp), %eax
...
; WIN32-NEXT:    leal 16(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 24(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    fstps 12(%esp)
; WIN32-NEXT:    movl 16(%esp), %eax
; WIN32-NEXT:    flds 12(%esp)
; WIN32-NEXT:    addl $20, %esp
; WIN32-NEXT:    retl
...
; WIN32-NEXT:    movl 72(%esp), %esi
; WIN32-NEXT:    leal 32(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 84(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    fstpl {{[-0-9]+}}(%e{{[sb]}}p) # 8-byte Folded Spill
; WIN32-NEXT:    leal 36(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 80(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    fstpl {{[-0-9]+}}(%e{{[sb]}}p) # 8-byte Folded Spill
; WIN32-NEXT:    leal 40(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 76(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    leal 28(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 88(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    fstps 12(%esp)
; WIN32-NEXT:    fldl {{[-0-9]+}}(%e{{[sb]}}p) # 8-byte Folded Reload
; WIN32-NEXT:    fstps 16(%esp)
; WIN32-NEXT:    fldl {{[-0-9]+}}(%e{{[sb]}}p) # 8-byte Folded Reload
; WIN32-NEXT:    fstps 20(%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    fstps 24(%esp)
; WIN32-NEXT:    flds 12(%esp)
; WIN32-NEXT:    flds 16(%esp)
; WIN32-NEXT:    flds 20(%esp)
; WIN32-NEXT:    flds 24(%esp)
; WIN32-NEXT:    movl 40(%esp), %eax
; WIN32-NEXT:    movl 36(%esp), %ecx
; WIN32-NEXT:    movl 32(%esp), %edx
; WIN32-NEXT:    movl 28(%esp), %edi
...
; X64-NEXT:    movaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; X64-NEXT:    shufps {{.*#+}} xmm0 = xmm0[3,3,3,3]
; X64-NEXT:    leaq 32(%rsp), %rdi
; X64-NEXT:    callq frexpf@PLT
; X64-NEXT:    movaps %xmm0, (%rsp) # 16-byte Spill
; X64-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; X64-NEXT:    movhlps {{.*#+}} xmm0 = xmm0[1,1]
; X64-NEXT:    leaq 36(%rsp), %rdi
; X64-NEXT:    callq frexpf@PLT
; X64-NEXT:    unpcklps (%rsp), %xmm0 # 16-byte Folded Reload
; X64-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1]
; X64-NEXT:    movaps %xmm0, (%rsp) # 16-byte Spill
; X64-NEXT:    leaq 44(%rsp), %rdi
; X64-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; X64-NEXT:    callq frexpf@PLT
; X64-NEXT:    movaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; X64-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; X64-NEXT:    shufps {{.*#+}} xmm0 = xmm0[1,1,1,1]
; X64-NEXT:    leaq 40(%rsp), %rdi
; X64-NEXT:    callq frexpf@PLT
; X64-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; X64-NEXT:    unpcklps {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
...
; WIN32-NEXT:    pushl %esi
; WIN32-NEXT:    subl $60, %esp
; WIN32-NEXT:    movl 68(%esp), %esi
; WIN32-NEXT:    leal 48(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 80(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    fstpl {{[-0-9]+}}(%e{{[sb]}}p) # 8-byte Folded Spill
; WIN32-NEXT:    leal 52(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 76(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    fstpl {{[-0-9]+}}(%e{{[sb]}}p) # 8-byte Folded Spill
; WIN32-NEXT:    leal 56(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 72(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    leal 44(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 84(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    fstps 12(%esp)
...
; WIN32-NEXT:    movl 40(%esp), %esi
; WIN32-NEXT:    leal 20(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 48(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    fstp %st(0)
; WIN32-NEXT:    leal 16(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 52(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    fstp %st(0)
; WIN32-NEXT:    leal 24(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 44(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    fstp %st(0)
; WIN32-NEXT:    leal 12(%esp), %eax
; WIN32-NEXT:    movl %eax, 8(%esp)
; WIN32-NEXT:    flds 56(%esp)
; WIN32-NEXT:    fstpl (%esp)
; WIN32-NEXT:    calll _frexp
; WIN32-NEXT:    fstp %st(0)
; WIN32-NEXT:    movl 24(%esp), %eax
; WIN32-NEXT:    movl 20(%esp), %ecx
; WIN32-NEXT:    movl 16(%esp), %edx
; WIN32-NEXT:    movl 12(%esp), %edi
