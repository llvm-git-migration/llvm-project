...
; AVX512F-NEXT:    vpsllw $5, %ymm5, %ymm8
; AVX512F-NEXT:    vpblendvb %ymm8, %ymm7, %ymm4, %ymm4
; AVX512F-NEXT:    vpsrlw $2, %ymm4, %ymm7
...
; AVX512F-NEXT:    vpblendvb %ymm8, %ymm7, %ymm4, %ymm4
; AVX512F-NEXT:    vpsrlw $1, %ymm4, %ymm7
...
; AVX512F-NEXT:    vpbroadcastb {{.*#+}} ymm8 = [240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240]
; AVX512F-NEXT:    vpand %ymm7, %ymm8, %ymm7
; AVX512F-NEXT:    vpxor %ymm3, %ymm5, %ymm5
; AVX512F-NEXT:    vpsllw $5, %ymm5, %ymm5
; AVX512F-NEXT:    vpblendvb %ymm5, %ymm7, %ymm6, %ymm6
...
; AVX512F-NEXT:    vpaddb %ymm5, %ymm5, %ymm5
; AVX512F-NEXT:    vpblendvb %ymm5, %ymm7, %ymm6, %ymm5
...
; AVX512F-NEXT:    vpblendvb %ymm2, %ymm6, %ymm0, %ymm0
...
; AVX512VL-NEXT:    vpand %ymm5, %ymm4, %ymm6
...
; AVX512VL-NEXT:    vpsllw $5, %ymm4, %ymm8
...
; AVX512VL-NEXT:    vpbroadcastd {{.*#+}} ymm8 = [240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240]
; AVX512VL-NEXT:    vpand %ymm6, %ymm8, %ymm6
; AVX512VL-NEXT:    vpxor %ymm7, %ymm4, %ymm4
...
; AVX512BW-NEXT:    vpandq %zmm4, %zmm3, %zmm1
...
; AVX512VLBW-NEXT:    vpandq %zmm4, %zmm3, %zmm1
