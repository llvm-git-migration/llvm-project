...
; X64-AVX-NEXT:    vcvtss2si %xmm0, %rcx
; X64-AVX-NEXT:    vmovq %rax, %xmm0
; X64-AVX-NEXT:    vmovq %rcx, %xmm1
; X64-AVX-NEXT:    vpunpcklqdq {{.*#+}} xmm0 = xmm0[0],xmm1[0]
; X64-AVX-NEXT:    retq
...
; X64-SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[1,1],xmm0[1,1]
; X64-SSE-NEXT:    cvtss2si %xmm2, %rcx
; X64-SSE-NEXT:    movq %rax, %xmm4
; X64-SSE-NEXT:    movq %rcx, %xmm2
; X64-SSE-NEXT:    punpcklqdq {{.*#+}} xmm4 = xmm4[0],xmm2[0]
; X64-SSE-NEXT:    movaps %xmm0, %xmm2
; X64-SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[3,3],xmm0[3,3]
; X64-SSE-NEXT:    cvtss2si %xmm2, %rax
; X64-SSE-NEXT:    movq %rax, %xmm2
; X64-SSE-NEXT:    movhlps {{.*#+}} xmm0 = xmm0[1,1]
; X64-SSE-NEXT:    cvtss2si %xmm0, %rax
; X64-SSE-NEXT:    movq %rax, %xmm5
; X64-SSE-NEXT:    punpcklqdq {{.*#+}} xmm5 = xmm5[0],xmm2[0]
; X64-SSE-NEXT:    cvtss2si %xmm1, %rax
; X64-SSE-NEXT:    movq %rax, %xmm2
; X64-SSE-NEXT:    movaps %xmm1, %xmm0
; X64-SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[1,1],xmm1[1,1]
; X64-SSE-NEXT:    cvtss2si %xmm0, %rax
; X64-SSE-NEXT:    movq %rax, %xmm0
...
; X64-SSE-NEXT:    movaps %xmm1, %xmm5
; X64-SSE-NEXT:    shufps {{.*#+}} xmm5 = xmm5[1,1],xmm1[1,1]
; X64-SSE-NEXT:    cvtss2si %xmm5, %rdx
; X64-SSE-NEXT:    movq %rcx, %xmm5
; X64-SSE-NEXT:    movq %rdx, %xmm6
...
; X64-SSE-NEXT:    cvtss2si %xmm8, %rdx
; X64-SSE-NEXT:    movq %rcx, %xmm8
; X64-SSE-NEXT:    movhlps {{.*#+}} xmm3 = xmm3[1,1]
; X64-SSE-NEXT:    cvtss2si %xmm3, %rcx
; X64-SSE-NEXT:    movq %rdx, %xmm3
; X64-SSE-NEXT:    punpcklqdq {{.*#+}} xmm7 = xmm7[0],xmm8[0]
; X64-SSE-NEXT:    movq %rcx, %xmm8
; X64-SSE-NEXT:    punpcklqdq {{.*#+}} xmm8 = xmm8[0],xmm3[0]
; X64-SSE-NEXT:    movdqa %xmm8, 112(%rdi)
...
; X64-SSE-NEXT:    cvtsd2si %xmm0, %rcx
; X64-SSE-NEXT:    movq %rax, %xmm0
; X64-SSE-NEXT:    movq %rcx, %xmm1
; X64-SSE-NEXT:    punpcklqdq {{.*#+}} xmm0 = xmm0[0],xmm1[0]
; X64-SSE-NEXT:    retq
...
; X64-AVX-NEXT:    vcvtsd2si %xmm0, %rcx
; X64-AVX-NEXT:    vmovq %rax, %xmm0
; X64-AVX-NEXT:    vmovq %rcx, %xmm1
; X64-AVX-NEXT:    vpunpcklqdq {{.*#+}} xmm0 = xmm0[0],xmm1[0]
; X64-AVX-NEXT:    retq
