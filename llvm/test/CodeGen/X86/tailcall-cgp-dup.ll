...
define ptr @memset_tailc(ptr %0, i64 %1) {
...
define ptr @memcpy_tailc(ptr %0, i64 %1, ptr %2) {
...
define ptr @strcpy_tailc(i64 %0, ptr %1) {
...
; CHECK:    popq %r14
; CHECK:    retq
  %3 = tail call noalias dereferenceable_or_null(20) ptr @malloc(i64 20)
  %4 = icmp eq i64 %0, 0
  br i1 %4, label %7, label %5

5:
  %6 = tail call ptr @strcpy(ptr dereferenceable(1) %3, ptr dereferenceable(1) %1)
  br label %7
...
define ptr @not_to_tailc(ptr %0, i64 %1, ptr %2) {
...
5:
  tail call void @baz(ptr %0, ptr %2, i64 %1)
  br label %6
