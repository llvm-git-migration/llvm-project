...
; SSE-NEXT:    movdqa {{.*#+}} xmm6 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
; SSE-NEXT:    pxor %xmm6, %xmm0
; SSE-NEXT:    psubb %xmm0, %xmm4
...
; SSE-NEXT:    psrlw $1, %xmm1
; SSE-NEXT:    movdqa {{.*#+}} xmm10 = [127,127,127,127,127,127,127,127,127,127,127,127,127,127,127,127]
...
; AVX1-NEXT:    vpsubb %xmm5, %xmm2, %xmm2
...
; AVX1-NEXT:    vpaddb %xmm7, %xmm0, %xmm0
...
; AVX2-NEXT:    vpsubb %ymm0, %ymm4, %ymm0
