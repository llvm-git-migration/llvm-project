...
; SSE2-NEXT:    movabsq $5270498306774157605, %rdi # imm = 0x4924924924924925
...
; SSE41-NEXT:    movabsq $5270498306774157605, %rdi # imm = 0x4924924924924925
; SSE41-NEXT:    movq %rcx, %rax
; SSE41-NEXT:    imulq %rdi
; SSE41-NEXT:    movq %rdx, %rsi
; SSE41-NEXT:    movq %rdx, %rax
; SSE41-NEXT:    shrq $63, %rax
; SSE41-NEXT:    sarq %rsi
; SSE41-NEXT:    addq %rax, %rsi
; SSE41-NEXT:    leaq (,%rsi,8), %rax
...
; AVX-NEXT:    movabsq $5270498306774157605, %rdi # imm = 0x4924924924924925
...
; AVX512BW-NEXT:    vpmovsxbw %xmm0, %ymm1
; AVX512BW-NEXT:    vpmullw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm1, %ymm1
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} ymm2 = [2,2,1,2,3,1,2,3,3,2,1,3,2,1,1,2]
; AVX512BW-NEXT:    vpsrlw $8, %ymm1, %ymm1
; AVX512BW-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm3
; AVX512BW-NEXT:    vpmovwb %zmm1, %ymm1
; AVX512BW-NEXT:    vpaddb %xmm3, %xmm1, %xmm1
; AVX512BW-NEXT:    vpmovsxbw %xmm1, %ymm3
; AVX512BW-NEXT:    vpsravw %zmm2, %zmm3, %zmm2
; AVX512BW-NEXT:    vpmovwb %zmm2, %ymm2
; AVX512BW-NEXT:    vpsrlw $7, %xmm1, %xmm1
; AVX512BW-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm1, %xmm1
; AVX512BW-NEXT:    vpaddb %xmm1, %xmm2, %xmm1
