...
; GFNIAVX512-NEXT:    vpaddw %xmm0, %xmm0, %xmm0
; GFNIAVX512-NEXT:    vpternlogd $228, {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to4}, %xmm1, %xmm0
; GFNIAVX512-NEXT:    retq
...
; GFNIAVX512BW-NEXT:    vpaddw %zmm0, %zmm0, %zmm0
; GFNIAVX512BW-NEXT:    vpternlogd $228, {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to16}, %zmm1, %zmm0
; GFNIAVX512BW-NEXT:    retq
