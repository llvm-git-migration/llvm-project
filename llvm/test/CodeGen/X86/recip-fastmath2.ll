...
; FMA-RECIP-NEXT:    vrcpps %ymm1, %ymm5
...
; FMA-RECIP-NEXT:    vmulps %ymm2, %ymm5, %ymm3
; FMA-RECIP-NEXT:    vfmsub213ps {{.*#+}} ymm1 = (ymm3 * ymm1) - ymm2
; FMA-RECIP-NEXT:    vfnmadd213ps {{.*#+}} ymm1 = -(ymm5 * ymm1) + ymm3
; FMA-RECIP-NEXT:    retq
;
...
; FMA-RECIP-NEXT:    vrcpps %ymm1, %ymm4
