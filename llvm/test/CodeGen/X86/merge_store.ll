...
define void @indexed_store_merge(i64 %p, ptr %v) {
...
entry:
  %p2 = add nsw i64 %p, 2
  %v2 = getelementptr i8, ptr %v, i64 %p2
  store i8 0, ptr %v2, align 2
  %p3 = add nsw i64 %p, 3
  %v3 = getelementptr i8, ptr %v, i64 %p3
  store i8 0, ptr %v3, align 1
  %p4 = add nsw i64 %p, 4
  %v4 = getelementptr i8, ptr %v, i64 %p4
  store i8 0, ptr %v4, align 2
  %p5 = add nsw i64 %p, 5
  %v5 = getelementptr i8, ptr %v, i64 %p5
  store i8 0, ptr %v5, align 1
  store i8 0, ptr %v, align 2
  ret void
}
