...
; X64-SSE:       # %bb.0:
; X64-SSE-NEXT:    movq glob64(%rip), %rax
; X64-SSE-NEXT:    movq %rax, glob64(%rip)
; X64-SSE-NEXT:    retq
;
; X64-AVX-LABEL: fmul_64g:
; X64-AVX:       # %bb.0:
; X64-AVX-NEXT:    movq glob64(%rip), %rax
; X64-AVX-NEXT:    movq %rax, glob64(%rip)
; X64-AVX-NEXT:    retq
  %i = load atomic i64, ptr @glob64 monotonic, align 8
  %f = bitcast i64 %i to double
  %mul = fmul double %f, 1.000000e+00
...
; X64-AVX-NEXT:    retq
  %i = load atomic i64, ptr @glob64 monotonic, align 8
  %f = bitcast i64 %i to double
  %div = fdiv double %f, 1.000000e+00
