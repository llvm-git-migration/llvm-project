...
; DXIL-LOWER-SAME: <3 x double> noundef [[D:%.*]]) {
; DXIL-LOWER-COUNT-3: [[D]].[[D_I0:.*]] = extractelement <3 x double> [[D]], i64 {{[0-2]}}
; DXIL-LOWER: call %dx.types.splitdouble @dx.op.splitDouble.f64(i32 102, double [[D]].[[D_I0]])
;
