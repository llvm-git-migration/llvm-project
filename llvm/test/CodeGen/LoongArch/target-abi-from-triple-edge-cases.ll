...
; LP64S-LP64F-NOF:       # %bb.0:
; LP64S-LP64F-NOF-NEXT:    addi.d $sp, $sp, -16
; LP64S-LP64F-NOF-NEXT:    .cfi_def_cfa_offset 16
; LP64S-LP64F-NOF-NEXT:    st.d $ra, $sp, 8 # 8-byte Folded Spill
; LP64S-LP64F-NOF-NEXT:    .cfi_offset 1, -8
; LP64S-LP64F-NOF-NEXT:    lu12i.w $a1, 260096
; LP64S-LP64F-NOF-NEXT:    bl %plt(__addsf3)
; LP64S-LP64F-NOF-NEXT:    ld.d $ra, $sp, 8 # 8-byte Folded Reload
; LP64S-LP64F-NOF-NEXT:    addi.d $sp, $sp, 16
; LP64S-LP64F-NOF-NEXT:    ret
;
...
; LP64D-LP64F-NOF:       # %bb.0:
; LP64D-LP64F-NOF-NEXT:    addi.d $sp, $sp, -16
; LP64D-LP64F-NOF-NEXT:    .cfi_def_cfa_offset 16
; LP64D-LP64F-NOF-NEXT:    st.d $ra, $sp, 8 # 8-byte Folded Spill
; LP64D-LP64F-NOF-NEXT:    .cfi_offset 1, -8
; LP64D-LP64F-NOF-NEXT:    lu12i.w $a1, 260096
; LP64D-LP64F-NOF-NEXT:    bl %plt(__addsf3)
; LP64D-LP64F-NOF-NEXT:    ld.d $ra, $sp, 8 # 8-byte Folded Reload
; LP64D-LP64F-NOF-NEXT:    addi.d $sp, $sp, 16
; LP64D-LP64F-NOF-NEXT:    ret
;
; LP64D-NONE-NOF-LABEL: f:
; LP64D-NONE-NOF:       # %bb.0:
; LP64D-NONE-NOF-NEXT:    addi.d $sp, $sp, -16
; LP64D-NONE-NOF-NEXT:    .cfi_def_cfa_offset 16
; LP64D-NONE-NOF-NEXT:    st.d $ra, $sp, 8 # 8-byte Folded Spill
; LP64D-NONE-NOF-NEXT:    .cfi_offset 1, -8
; LP64D-NONE-NOF-NEXT:    lu12i.w $a1, 260096
; LP64D-NONE-NOF-NEXT:    bl %plt(__addsf3)
; LP64D-NONE-NOF-NEXT:    ld.d $ra, $sp, 8 # 8-byte Folded Reload
; LP64D-NONE-NOF-NEXT:    addi.d $sp, $sp, 16
; LP64D-NONE-NOF-NEXT:    ret
  %1 = fadd float %a, 1.0
  ret float %1
}
