...
; MEDIUM_NO_SCH-NEXT:    ldx.d $a0, $a1, $tp
; MEDIUM_NO_SCH-NEXT:    ldx.d $a0, $a2, $tp
...
; MEDIUM_SCH-NEXT:    ldx.d $a0, $a1, $tp
; MEDIUM_SCH-NEXT:    ldx.d $a0, $a2, $tp
...
; LARGE_NO_SCH-NEXT:    ldx.d $a0, $a1, $tp
; LARGE_NO_SCH-NEXT:    ldx.d $a0, $a2, $tp
...
; LARGE_SCH-NEXT:    ldx.d $a0, $a1, $tp
; LARGE_SCH-NEXT:    ldx.d $a0, $a2, $tp
