...
; 32BIT-NEXT:    stfs 2, 168(1)
; 32BIT-NEXT:    stfs 3, 172(1)
; 32BIT-NEXT:    stfd 4, 176(1)
; 32BIT-NEXT:    stfd 5, 184(1)
...
define signext i32 @mixed_4(ptr byval(%struct.foo) align 16 %foo) #0 {
; 32BIT-LABEL: mixed_4:
; 32BIT:       # %bb.0: # %entry
