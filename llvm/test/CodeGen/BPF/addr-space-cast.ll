...
; CHECK-LABEL: foo:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    r0 = cast_user(r1, 1) # encoding: [0xbf,0x10,0x02,0x00,0x01,0x00,0x00,0x00]
...
; CHECK-LABEL: bar:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    r0 = cast_kern(r1, 1) # encoding: [0xbf,0x10,0x01,0x00,0x01,0x00,0x00,0x00]
; CHECK-NEXT:    exit                  # encoding: [0x95,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
entry:
