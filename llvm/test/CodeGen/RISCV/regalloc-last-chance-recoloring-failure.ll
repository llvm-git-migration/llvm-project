...
entry:
  %i = call target("riscv_m4x2", i8, i8, 5, 2) @llvm.riscv.vloxseg2.nxv16f16.nxv16i32.i64(target("riscv_m4x2", i8, i8, 5, 2) undef, ptr nonnull poison, <vscale x 16 x i32> poison, i64 55, i64 4)
  %i1 = tail call <vscale x 16 x half> @llvm.riscv.vector.extract.v16f16.triscv_m4x2_i8_i8_5_2t(target("riscv_m4x2", i8, i8, 5, 2) %i, i64 0)
...
declare void @func()
declare target("riscv_m4x2", i8, i8, 5, 2) @llvm.riscv.vloxseg2.nxv16f16.nxv16i32.i64(target("riscv_m4x2", i8, i8, 5, 2), ptr nocapture, <vscale x 16 x i32>, i64, i64)
declare <vscale x 16 x half> @llvm.riscv.vector.extract.v16f16.triscv_m4x2_i8_i8_5_2t(target("riscv_m4x2", i8, i8, 5, 2), i64)
