...
; CHECK-FP16-LABEL: fcanonicalize_v4f16_nnan:
; CHECK-FP16:       # %bb.0:
; CHECK-FP16-NEXT:    fmin.h fa5, fa0, fa0
; CHECK-FP16-NEXT:    fmin.h fa4, fa1, fa1
; CHECK-FP16-NEXT:    fmin.h fa2, fa2, fa2
...
; CHECK-FP16-LABEL: fcanonicalize_v8f16:
; CHECK-FP16:       # %bb.0:
; CHECK-FP16-NEXT:    fmin.h fa0, fa0, fa0
; CHECK-FP16-NEXT:    fmin.h fa1, fa1, fa1
; CHECK-FP16-NEXT:    fmin.h fa2, fa2, fa2
; CHECK-FP16-NEXT:    fmin.h fa3, fa3, fa3
; CHECK-FP16-NEXT:    fmin.h fa4, fa4, fa4
; CHECK-FP16-NEXT:    fmin.h fa5, fa5, fa5
; CHECK-FP16-NEXT:    fmin.h ft0, fa6, fa6
; CHECK-FP16-NEXT:    fmin.h ft1, fa7, fa7
; CHECK-FP16-NEXT:    fsh fa4, 8(a0)
; CHECK-FP16-NEXT:    fsh fa5, 10(a0)
; CHECK-FP16-NEXT:    fsh ft0, 12(a0)
; CHECK-FP16-NEXT:    fsh ft1, 14(a0)
; CHECK-FP16-NEXT:    fsh fa0, 0(a0)
; CHECK-FP16-NEXT:    fsh fa1, 2(a0)
; CHECK-FP16-NEXT:    fsh fa2, 4(a0)
; CHECK-FP16-NEXT:    fsh fa3, 6(a0)
; CHECK-FP16-NEXT:    ret
...
; CHECK-FP16-LABEL: fcanonicalize_v8f16_nnan:
; CHECK-FP16:       # %bb.0:
; CHECK-FP16-NEXT:    fmin.h fa0, fa0, fa0
; CHECK-FP16-NEXT:    fmin.h fa1, fa1, fa1
; CHECK-FP16-NEXT:    fmin.h fa2, fa2, fa2
