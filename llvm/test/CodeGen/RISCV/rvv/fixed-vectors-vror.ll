...
; CHECK-RV32:       # %bb.0:
; CHECK-RV32-NEXT:    vsetivli zero, 2, e32, m1, ta, ma
; CHECK-RV32-NEXT:    vslide1down.vx v9, v8, a0
...
; CHECK-RV64-NEXT:    ret
;
; CHECK32-ZVKB-LABEL: vror_vx_v1i64:
; CHECK32-ZVKB:       # %bb.0:
...
; CHECK32-ZVKB-NEXT:    vror.vv v8, v8, v9
; CHECK32-ZVKB-NEXT:    ret
;
; CHECK64-ZVKB-LABEL: vror_vx_v1i64:
; CHECK64-ZVKB:       # %bb.0:
; CHECK64-ZVKB-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; CHECK64-ZVKB-NEXT:    vror.vx v8, v8, a0
