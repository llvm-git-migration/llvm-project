...
; CHECK-NEXT:    ret
  %vc = and <vscale x 1 x i8> %va, splat (i8 -10)
  ret <vscale x 1 x i8> %vc
}
...
; CHECK-NEXT:    ret
  %vc = and <vscale x 1 x i8> %va, splat (i8 8)
  ret <vscale x 1 x i8> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 1 x i8> %va, splat (i8 16)
  ret <vscale x 1 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 2 x i8> %va, splat (i8 -10)
  ret <vscale x 2 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 2 x i8> %va, splat (i8 8)
  ret <vscale x 2 x i8> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 2 x i8> %va, splat (i8 16)
  ret <vscale x 2 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 4 x i8> %va, splat (i8 -10)
  ret <vscale x 4 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 4 x i8> %va, splat (i8 8)
  ret <vscale x 4 x i8> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 4 x i8> %va, splat (i8 16)
  ret <vscale x 4 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 8 x i8> %va, splat (i8 -10)
  ret <vscale x 8 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 8 x i8> %va, splat (i8 8)
  ret <vscale x 8 x i8> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 8 x i8> %va, splat (i8 16)
  ret <vscale x 8 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 16 x i8> %va, splat (i8 -10)
  ret <vscale x 16 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 16 x i8> %va, splat (i8 8)
  ret <vscale x 16 x i8> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 16 x i8> %va, splat (i8 16)
  ret <vscale x 16 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 32 x i8> %va, splat (i8 -10)
  ret <vscale x 32 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 32 x i8> %va, splat (i8 8)
  ret <vscale x 32 x i8> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 32 x i8> %va, splat (i8 16)
  ret <vscale x 32 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 64 x i8> %va, splat (i8 -10)
  ret <vscale x 64 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 64 x i8> %va, splat (i8 8)
  ret <vscale x 64 x i8> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 64 x i8> %va, splat (i8 16)
  ret <vscale x 64 x i8> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 1 x i16> %va, splat (i16 -10)
  ret <vscale x 1 x i16> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 1 x i16> %va, splat (i16 8)
  ret <vscale x 1 x i16> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 1 x i16> %va, splat (i16 16)
  ret <vscale x 1 x i16> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 2 x i16> %va, splat (i16 -10)
  ret <vscale x 2 x i16> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 2 x i16> %va, splat (i16 8)
  ret <vscale x 2 x i16> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 2 x i16> %va, splat (i16 16)
  ret <vscale x 2 x i16> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 4 x i16> %va, splat (i16 -10)
  ret <vscale x 4 x i16> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 4 x i16> %va, splat (i16 8)
  ret <vscale x 4 x i16> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 4 x i16> %va, splat (i16 16)
  ret <vscale x 4 x i16> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 8 x i16> %va, splat (i16 -10)
  ret <vscale x 8 x i16> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 8 x i16> %va, splat (i16 8)
  ret <vscale x 8 x i16> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 8 x i16> %va, splat (i16 16)
  ret <vscale x 8 x i16> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 16 x i16> %va, splat (i16 -10)
  ret <vscale x 16 x i16> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 16 x i16> %va, splat (i16 8)
  ret <vscale x 16 x i16> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 16 x i16> %va, splat (i16 16)
  ret <vscale x 16 x i16> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 32 x i16> %va, splat (i16 -10)
  ret <vscale x 32 x i16> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 32 x i16> %va, splat (i16 8)
  ret <vscale x 32 x i16> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 32 x i16> %va, splat (i16 16)
  ret <vscale x 32 x i16> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 1 x i32> %va, splat (i32 -10)
  ret <vscale x 1 x i32> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 1 x i32> %va, splat (i32 8)
  ret <vscale x 1 x i32> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 1 x i32> %va, splat (i32 16)
  ret <vscale x 1 x i32> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 2 x i32> %va, splat (i32 -10)
  ret <vscale x 2 x i32> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 2 x i32> %va, splat (i32 8)
  ret <vscale x 2 x i32> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 2 x i32> %va, splat (i32 16)
  ret <vscale x 2 x i32> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 4 x i32> %va, splat (i32 -10)
  ret <vscale x 4 x i32> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 4 x i32> %va, splat (i32 8)
  ret <vscale x 4 x i32> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 4 x i32> %va, splat (i32 16)
  ret <vscale x 4 x i32> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 8 x i32> %va, splat (i32 -10)
  ret <vscale x 8 x i32> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 8 x i32> %va, splat (i32 8)
  ret <vscale x 8 x i32> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 8 x i32> %va, splat (i32 16)
  ret <vscale x 8 x i32> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 16 x i32> %va, splat (i32 -10)
  ret <vscale x 16 x i32> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 16 x i32> %va, splat (i32 8)
  ret <vscale x 16 x i32> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 16 x i32> %va, splat (i32 16)
  ret <vscale x 16 x i32> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 1 x i64> %va, splat (i64 -10)
  ret <vscale x 1 x i64> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 1 x i64> %va, splat (i64 8)
  ret <vscale x 1 x i64> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 1 x i64> %va, splat (i64 16)
  ret <vscale x 1 x i64> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 2 x i64> %va, splat (i64 -10)
  ret <vscale x 2 x i64> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 2 x i64> %va, splat (i64 8)
  ret <vscale x 2 x i64> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 2 x i64> %va, splat (i64 16)
  ret <vscale x 2 x i64> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 4 x i64> %va, splat (i64 -10)
  ret <vscale x 4 x i64> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 4 x i64> %va, splat (i64 8)
  ret <vscale x 4 x i64> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 4 x i64> %va, splat (i64 16)
  ret <vscale x 4 x i64> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, -10
; CHECK-NEXT:    ret
  %vc = and <vscale x 8 x i64> %va, splat (i64 -10)
  ret <vscale x 8 x i64> %vc
}
...
; CHECK-NEXT:    vand.vi v8, v8, 8
; CHECK-NEXT:    ret
  %vc = and <vscale x 8 x i64> %va, splat (i64 8)
  ret <vscale x 8 x i64> %vc
}
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = and <vscale x 8 x i64> %va, splat (i64 16)
  ret <vscale x 8 x i64> %vc
}
