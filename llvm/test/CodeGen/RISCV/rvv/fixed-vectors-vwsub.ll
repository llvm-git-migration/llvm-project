...
define <2 x i16> @vwsub_v2i16(ptr %x, ptr %y) {
...
define <4 x i16> @vwsub_v4i16(ptr %x, ptr %y) {
...
define <2 x i32> @vwsub_v2i32(ptr %x, ptr %y) {
...
define <8 x i16> @vwsub_v8i16(ptr %x, ptr %y) {
...
define <4 x i32> @vwsub_v4i32(ptr %x, ptr %y) {
...
define <2 x i64> @vwsub_v2i64(ptr %x, ptr %y) {
...
define <16 x i16> @vwsub_v16i16(ptr %x, ptr %y) {
...
define <8 x i32> @vwsub_v8i32(ptr %x, ptr %y) {
...
define <4 x i64> @vwsub_v4i64(ptr %x, ptr %y) {
...
define <32 x i16> @vwsub_v32i16(ptr %x, ptr %y) {
...
define <16 x i32> @vwsub_v16i32(ptr %x, ptr %y) {
...
define <8 x  i64> @vwsub_v8i64(ptr %x, ptr %y) {
...
define <64 x i16> @vwsub_v64i16(ptr %x, ptr %y) {
...
define <32 x i32> @vwsub_v32i32(ptr %x, ptr %y) {
...
define <16 x i64> @vwsub_v16i64(ptr %x, ptr %y) {
...
define <128 x i16> @vwsub_v128i16(ptr %x, ptr %y) nounwind {
...
define <64 x i32> @vwsub_v64i32(ptr %x, ptr %y) nounwind {
...
define <32 x i64> @vwsub_v32i64(ptr %x, ptr %y) nounwind {
...
define <2 x i32> @vwsub_v2i32_v2i8(ptr %x, ptr %y) {
...
define <4 x i32> @vwsub_v4i32_v4i8_v4i16(ptr %x, ptr %y) {
...
define <4 x i64> @vwsub_v4i64_v4i32_v4i8(ptr %x, ptr %y) {
...
define <2 x i16> @vwsub_vx_v2i16(ptr %x, i8 %y) {
...
define <4 x i16> @vwsub_vx_v4i16(ptr %x, i8 %y) {
...
define <2 x i32> @vwsub_vx_v2i32(ptr %x, i16 %y) {
...
define <8 x i16> @vwsub_vx_v8i16(ptr %x, i8 %y) {
...
define <4 x i32> @vwsub_vx_v4i32(ptr %x, i16 %y) {
...
define <2 x i64> @vwsub_vx_v2i64(ptr %x, i32 %y) {
...
define <16 x i16> @vwsub_vx_v16i16(ptr %x, i8 %y) {
...
define <8 x i32> @vwsub_vx_v8i32(ptr %x, i16 %y) {
...
define <4 x i64> @vwsub_vx_v4i64(ptr %x, i32 %y) {
...
define <32 x i16> @vwsub_vx_v32i16(ptr %x, i8 %y) {
...
define <16 x i32> @vwsub_vx_v16i32(ptr %x, i16 %y) {
...
define <8 x i64> @vwsub_vx_v8i64(ptr %x, i32 %y) {
...
define <64 x i16> @vwsub_vx_v64i16(ptr %x, i8 %y) {
...
define <32 x i32> @vwsub_vx_v32i32(ptr %x, i16 %y) {
...
define <16 x i64> @vwsub_vx_v16i64(ptr %x, i32 %y) {
...
define <2 x i64> @vwsub_vx_v2i64_i64(ptr %x, ptr %y) nounwind {
