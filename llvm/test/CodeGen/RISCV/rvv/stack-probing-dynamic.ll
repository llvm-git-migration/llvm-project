...
; RV64I:       # %bb.0: # %entry
; RV64I-NEXT:    addi sp, sp, -1472
; RV64I-NEXT:    .cfi_def_cfa_offset 1472
; RV64I-NEXT:    sd ra, 1464(sp) # 8-byte Folded Spill
; RV64I-NEXT:    .cfi_offset ra, -8
; RV64I-NEXT:    addi a0, sp, 1064
; RV64I-NEXT:    call callee_stack_args
; RV64I-NEXT:    ld ra, 1464(sp) # 8-byte Folded Reload
; RV64I-NEXT:    .cfi_restore ra
; RV64I-NEXT:    addi sp, sp, 1472
; RV64I-NEXT:    .cfi_def_cfa_offset 0
; RV64I-NEXT:    ret
...
; RV32I:       # %bb.0: # %entry
; RV32I-NEXT:    addi sp, sp, -1488
; RV32I-NEXT:    .cfi_def_cfa_offset 1488
; RV32I-NEXT:    sw ra, 1484(sp) # 4-byte Folded Spill
; RV32I-NEXT:    .cfi_offset ra, -4
; RV32I-NEXT:    addi a0, sp, 1084
; RV32I-NEXT:    call callee_stack_args
; RV32I-NEXT:    lw ra, 1484(sp) # 4-byte Folded Reload
; RV32I-NEXT:    .cfi_restore ra
; RV32I-NEXT:    addi sp, sp, 1488
; RV32I-NEXT:    .cfi_def_cfa_offset 0
; RV32I-NEXT:    ret
