...
define void @test_vector_tuple_type0(target("riscv_m1x3", i8, i8, 3, 3) %val, ptr %base) nounwind {
...
; CHECK-NEXT:    ret
entry:
  tail call void asm "vsseg3e8.v $0, ($1)", "^vr,r"(target("riscv_m1x3", i8, i8, 3, 3) %val, ptr %base)
  ret void
}

define void @test_vector_tuple_type1(target("riscv_mf4x3", i8, i8, 1, 3) %val, ptr %base) nounwind {
...
; CHECK-NEXT:    ret
entry:
  tail call void asm "vsseg3e8.v $0, ($1)", "^vr,r"(target("riscv_mf4x3", i8, i8, 1, 3) %val, ptr %base)
  ret void
}

define void @test_vector_tuple_type2(target("riscv_m2x4", i8, i8, 4, 4) %val, target("riscv_m1x7", i8, i8, 3, 7) %val2, target("riscv_m1x7", i8, i8, 3, 7) %val3, ptr %base) nounwind {
...
; CHECK-NEXT:    ret
entry:
  tail call void asm "vsseg3e8.v $0, ($1)", "^vr,r"(target("riscv_m2x4", i8, i8, 4, 4) %val, ptr %base)
  tail call void asm "vsseg7e8.v $0, ($1)", "^vr,r"(target("riscv_m1x7", i8, i8, 3, 7) %val2, ptr %base)
  tail call void asm "vsseg7e8.v $0, ($1)", "^vr,r"(target("riscv_m1x7", i8, i8, 3, 7) %val3, ptr %base)
  ret void
}
