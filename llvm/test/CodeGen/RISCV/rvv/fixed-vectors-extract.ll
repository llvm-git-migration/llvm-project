...
; RV32NOM:       # %bb.0:
; RV32NOM-NEXT:    addi sp, sp, -400
; RV32NOM-NEXT:    sw ra, 396(sp) # 4-byte Folded Spill
; RV32NOM-NEXT:    sw s0, 392(sp) # 4-byte Folded Spill
; RV32NOM-NEXT:    addi s0, sp, 400
; RV32NOM-NEXT:    csrr a1, vlenb
; RV32NOM-NEXT:    slli a1, a1, 3
; RV32NOM-NEXT:    sub sp, sp, a1
; RV32NOM-NEXT:    andi sp, sp, -128
; RV32NOM-NEXT:    addi a1, sp, 384
; RV32NOM-NEXT:    vs8r.v v8, (a1) # Unknown-size Folded Spill
; RV32NOM-NEXT:    andi a0, a0, 31
; RV32NOM-NEXT:    li a1, 4
; RV32NOM-NEXT:    call __mulsi3
; RV32NOM-NEXT:    addi a1, sp, 128
; RV32NOM-NEXT:    li a2, 32
; RV32NOM-NEXT:    add a0, a1, a0
; RV32NOM-NEXT:    addi a3, sp, 384
; RV32NOM-NEXT:    vl8r.v v8, (a3) # Unknown-size Folded Reload
; RV32NOM-NEXT:    vsetvli zero, a2, e32, m8, ta, ma
; RV32NOM-NEXT:    vadd.vv v8, v8, v8
; RV32NOM-NEXT:    vse32.v v8, (a1)
; RV32NOM-NEXT:    lw a0, 0(a0)
; RV32NOM-NEXT:    addi sp, s0, -400
; RV32NOM-NEXT:    lw ra, 396(sp) # 4-byte Folded Reload
; RV32NOM-NEXT:    lw s0, 392(sp) # 4-byte Folded Reload
; RV32NOM-NEXT:    addi sp, sp, 400
; RV32NOM-NEXT:    ret
;
...
; RV64NOM:       # %bb.0:
; RV64NOM-NEXT:    addi sp, sp, -384
; RV64NOM-NEXT:    sd ra, 376(sp) # 8-byte Folded Spill
; RV64NOM-NEXT:    sd s0, 368(sp) # 8-byte Folded Spill
; RV64NOM-NEXT:    addi s0, sp, 384
; RV64NOM-NEXT:    csrr a1, vlenb
; RV64NOM-NEXT:    slli a1, a1, 3
; RV64NOM-NEXT:    sub sp, sp, a1
; RV64NOM-NEXT:    andi sp, sp, -128
; RV64NOM-NEXT:    addi a1, sp, 368
; RV64NOM-NEXT:    vs8r.v v8, (a1) # Unknown-size Folded Spill
; RV64NOM-NEXT:    andi a0, a0, 31
; RV64NOM-NEXT:    li a1, 4
; RV64NOM-NEXT:    call __muldi3
; RV64NOM-NEXT:    addi a1, sp, 128
; RV64NOM-NEXT:    li a2, 32
; RV64NOM-NEXT:    add a0, a1, a0
; RV64NOM-NEXT:    addi a3, sp, 368
; RV64NOM-NEXT:    vl8r.v v8, (a3) # Unknown-size Folded Reload
; RV64NOM-NEXT:    vsetvli zero, a2, e32, m8, ta, ma
; RV64NOM-NEXT:    vadd.vv v8, v8, v8
; RV64NOM-NEXT:    vse32.v v8, (a1)
; RV64NOM-NEXT:    lw a0, 0(a0)
; RV64NOM-NEXT:    addi sp, s0, -384
; RV64NOM-NEXT:    ld ra, 376(sp) # 8-byte Folded Reload
; RV64NOM-NEXT:    ld s0, 368(sp) # 8-byte Folded Reload
; RV64NOM-NEXT:    addi sp, sp, 384
; RV64NOM-NEXT:    ret
;
...
; RV64M-NEXT:    andi a0, a0, 31
; RV64M-NEXT:    mv a1, sp
; RV64M-NEXT:    li a2, 32
; RV64M-NEXT:    slli a0, a0, 2
; RV64M-NEXT:    vsetvli zero, a2, e32, m8, ta, ma
; RV64M-NEXT:    vadd.vv v8, v8, v8
; RV64M-NEXT:    or a0, a1, a0
; RV64M-NEXT:    vse32.v v8, (a1)
; RV64M-NEXT:    lw a0, 0(a0)
