...
; VLA-NEXT:    vmv1r.v v14, v9
; VLA-NEXT:    vsetivli zero, 4, e32, m2, tu, ma
; VLA-NEXT:    vslideup.vi v8, v14, 2
; VLA-NEXT:    vsetivli zero, 6, e32, m2, tu, ma
; VLA-NEXT:    vslideup.vi v8, v10, 4
; VLA-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
...
; VLS-NEXT:    vmv.v.v v9, v10
; VLS-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; VLS-NEXT:    vslideup.vi v9, v11, 2
; VLS-NEXT:    ret
...
; VLA-NEXT:    vmv1r.v v20, v11
; VLA-NEXT:    vmv1r.v v22, v9
; VLA-NEXT:    vsetivli zero, 2, e32, m2, tu, ma
; VLA-NEXT:    vslideup.vi v8, v22, 1
; VLA-NEXT:    vsetivli zero, 3, e32, m2, tu, ma
; VLA-NEXT:    vslideup.vi v8, v10, 2
; VLA-NEXT:    vsetivli zero, 4, e32, m2, tu, ma
; VLA-NEXT:    vslideup.vi v8, v20, 3
; VLA-NEXT:    vsetivli zero, 5, e32, m2, tu, ma
; VLA-NEXT:    vslideup.vi v8, v12, 4
; VLA-NEXT:    vsetivli zero, 6, e32, m2, tu, ma
; VLA-NEXT:    vslideup.vi v8, v18, 5
; VLA-NEXT:    vsetivli zero, 7, e32, m2, tu, ma
; VLA-NEXT:    vslideup.vi v8, v14, 6
; VLA-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; VLA-NEXT:    vslideup.vi v8, v16, 7
; VLA-NEXT:    ret
;
; VLS-LABEL: concat_8xv1i32:
; VLS:       # %bb.0:
; VLS-NEXT:    vsetivli zero, 2, e32, m1, tu, ma
; VLS-NEXT:    vslideup.vi v8, v9, 1
; VLS-NEXT:    vsetivli zero, 3, e32, m1, tu, ma
; VLS-NEXT:    vslideup.vi v8, v10, 2
; VLS-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; VLS-NEXT:    vslideup.vi v8, v11, 3
; VLS-NEXT:    vsetivli zero, 1, e32, m1, tu, ma
; VLS-NEXT:    vmv.v.v v9, v12
; VLS-NEXT:    vsetivli zero, 2, e32, m1, tu, ma
; VLS-NEXT:    vslideup.vi v9, v13, 1
; VLS-NEXT:    vsetivli zero, 3, e32, m1, tu, ma
; VLS-NEXT:    vslideup.vi v9, v14, 2
; VLS-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; VLS-NEXT:    vslideup.vi v9, v15, 3
; VLS-NEXT:    ret
...
; VLA:       # %bb.0:
; VLA-NEXT:    vmv1r.v v12, v11
; VLA-NEXT:    vmv1r.v v16, v10
; VLA-NEXT:    vmv1r.v v20, v9
; VLA-NEXT:    vsetivli zero, 8, e32, m4, tu, ma
; VLA-NEXT:    vslideup.vi v8, v20, 4
; VLA-NEXT:    vsetivli zero, 12, e32, m4, tu, ma
; VLA-NEXT:    vslideup.vi v8, v16, 8
; VLA-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; VLA-NEXT:    vslideup.vi v8, v12, 12
; VLA-NEXT:    ret
;
...
; VLA-NEXT:    vmv1r.v v28, v11
; VLA-NEXT:    vmv1r.v v4, v10
; VLA-NEXT:    vmv1r.v v0, v9
; VLA-NEXT:    vsetivli zero, 4, e32, m4, tu, ma
; VLA-NEXT:    vslideup.vi v8, v0, 2
; VLA-NEXT:    vsetivli zero, 6, e32, m4, tu, ma
; VLA-NEXT:    vslideup.vi v8, v4, 4
; VLA-NEXT:    vsetivli zero, 8, e32, m4, tu, ma
; VLA-NEXT:    vslideup.vi v8, v28, 6
; VLA-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
; VLA-NEXT:    vslideup.vi v8, v12, 8
; VLA-NEXT:    vsetivli zero, 12, e32, m4, tu, ma
; VLA-NEXT:    vslideup.vi v8, v24, 10
; VLA-NEXT:    vsetivli zero, 14, e32, m4, tu, ma
; VLA-NEXT:    vslideup.vi v8, v20, 12
; VLA-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; VLA-NEXT:    vslideup.vi v8, v16, 14
; VLA-NEXT:    ret
;
...
; VLS-NEXT:    vslideup.vi v9, v11, 2
; VLS-NEXT:    vsetivli zero, 2, e32, m1, tu, ma
; VLS-NEXT:    vmv.v.v v10, v12
; VLS-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; VLS-NEXT:    vslideup.vi v10, v13, 2
; VLS-NEXT:    vsetivli zero, 2, e32, m1, tu, ma
; VLS-NEXT:    vmv.v.v v11, v14
; VLS-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; VLS-NEXT:    vslideup.vi v11, v15, 2
; VLS-NEXT:    ret
  %ab = shufflevector <2 x i32> %a, <2 x i32> %b, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %cd = shufflevector <2 x i32> %c, <2 x i32> %d, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %abcd = shufflevector <4 x i32> %ab, <4 x i32> %cd, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
