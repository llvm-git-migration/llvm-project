...
; RUN: llc -mtriple=riscv32 -mattr=+v,+zvkb -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK-ZVKB,CHECK32-ZVKB
; RUN: llc -mtriple=riscv64 -mattr=+v,+zvkb -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK-ZVKB,CHECK64-ZVKB
...
; CHECK32-LABEL: vrol_vx_v1i64:
; CHECK32:       # %bb.0:
; CHECK32-NEXT:    vsetivli zero, 2, e32, m1, ta, ma
; CHECK32-NEXT:    vslide1down.vx v9, v8, a0
; CHECK32-NEXT:    li a0, 63
; CHECK32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; CHECK32-NEXT:    vand.vx v10, v9, a0
; CHECK32-NEXT:    vsll.vv v10, v8, v10
; CHECK32-NEXT:    vrsub.vi v9, v9, 0
; CHECK32-NEXT:    vand.vx v9, v9, a0
; CHECK32-NEXT:    vsrl.vv v8, v8, v9
; CHECK32-NEXT:    vor.vv v8, v10, v8
; CHECK32-NEXT:    ret
;
; CHECK64-LABEL: vrol_vx_v1i64:
; CHECK64:       # %bb.0:
; CHECK64-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; CHECK64-NEXT:    vmv.s.x v9, a0
; CHECK64-NEXT:    li a0, 63
; CHECK64-NEXT:    vand.vx v10, v9, a0
; CHECK64-NEXT:    vsll.vv v10, v8, v10
; CHECK64-NEXT:    vrsub.vi v9, v9, 0
; CHECK64-NEXT:    vand.vx v9, v9, a0
; CHECK64-NEXT:    vsrl.vv v8, v8, v9
; CHECK64-NEXT:    vor.vv v8, v10, v8
; CHECK64-NEXT:    ret
;
; CHECK32-ZVKB-LABEL: vrol_vx_v1i64:
; CHECK32-ZVKB:       # %bb.0:
; CHECK32-ZVKB-NEXT:    vsetivli zero, 2, e32, m1, ta, ma
; CHECK32-ZVKB-NEXT:    vslide1down.vx v9, v8, a0
; CHECK32-ZVKB-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; CHECK32-ZVKB-NEXT:    vrol.vv v8, v8, v9
; CHECK32-ZVKB-NEXT:    ret
;
; CHECK64-ZVKB-LABEL: vrol_vx_v1i64:
; CHECK64-ZVKB:       # %bb.0:
; CHECK64-ZVKB-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; CHECK64-ZVKB-NEXT:    vrol.vx v8, v8, a0
; CHECK64-ZVKB-NEXT:    ret
