...
define <2 x i16> @vwmulsu_v2i16(ptr %x, ptr %y) {
...
define <2 x i16> @vwmulsu_v2i16_swap(ptr %x, ptr %y) {
...
define <4 x i16> @vwmulsu_v4i16(ptr %x, ptr %y) {
...
define <2 x i32> @vwmulsu_v2i32(ptr %x, ptr %y) {
...
define <8 x i16> @vwmulsu_v8i16(ptr %x, ptr %y) {
...
define <4 x i32> @vwmulsu_v4i32(ptr %x, ptr %y) {
...
define <2 x i64> @vwmulsu_v2i64(ptr %x, ptr %y) {
...
define <16 x i16> @vwmulsu_v16i16(ptr %x, ptr %y) {
...
define <8 x i32> @vwmulsu_v8i32(ptr %x, ptr %y) {
...
define <4 x i64> @vwmulsu_v4i64(ptr %x, ptr %y) {
...
define <32 x i16> @vwmulsu_v32i16(ptr %x, ptr %y) {
...
define <16 x i32> @vwmulsu_v16i32(ptr %x, ptr %y) {
...
define <8 x  i64> @vwmulsu_v8i64(ptr %x, ptr %y) {
...
define <64 x i16> @vwmulsu_v64i16(ptr %x, ptr %y) {
...
define <32 x i32> @vwmulsu_v32i32(ptr %x, ptr %y) {
...
define <16 x i64> @vwmulsu_v16i64(ptr %x, ptr %y) {
...
define <128 x i16> @vwmulsu_v128i16(ptr %x, ptr %y) {
...
define <64 x i32> @vwmulsu_v64i32(ptr %x, ptr %y) {
...
define <32 x i64> @vwmulsu_v32i64(ptr %x, ptr %y) {
...
define <2 x i32> @vwmulsu_v2i32_v2i8(ptr %x, ptr %y) {
...
define <4 x i32> @vwmulsu_v4i32_v4i8_v4i16(ptr %x, ptr %y) {
...
define <4 x i64> @vwmulsu_v4i64_v4i32_v4i8(ptr %x, ptr %y) {
...
define <2 x i16> @vwmulsu_vx_v2i16(ptr %x, i8 %y) {
...
define <2 x i16> @vwmulsu_vx_v2i16_swap(ptr %x, i8 %y) {
...
define <4 x i16> @vwmulsu_vx_v4i16(ptr %x, i8 %y) {
...
define <2 x i32> @vwmulsu_vx_v2i32(ptr %x, i16 %y) {
...
define <8 x i16> @vwmulsu_vx_v8i16(ptr %x, i8 %y) {
...
define <4 x i32> @vwmulsu_vx_v4i32(ptr %x, i16 %y) {
...
define <2 x i64> @vwmulsu_vx_v2i64(ptr %x, i32 %y) {
...
define <16 x i16> @vwmulsu_vx_v16i16(ptr %x, i8 %y) {
...
define <8 x i32> @vwmulsu_vx_v8i32(ptr %x, i16 %y) {
...
define <4 x i64> @vwmulsu_vx_v4i64(ptr %x, i32 %y) {
...
define <32 x i16> @vwmulsu_vx_v32i16(ptr %x, i8 %y) {
...
define <16 x i32> @vwmulsu_vx_v16i32(ptr %x, i16 %y) {
...
define <8 x i64> @vwmulsu_vx_v8i64(ptr %x, i32 %y) {
...
define <64 x i16> @vwmulsu_vx_v64i16(ptr %x, i8 %y) {
...
define <32 x i32> @vwmulsu_vx_v32i32(ptr %x, i16 %y) {
...
define <16 x i64> @vwmulsu_vx_v16i64(ptr %x, i32 %y) {
...
define <4 x i32> @vwmulsu_vx_v4i32_i8(ptr %x, ptr %y) {
...
define <2 x i64> @vwmulsu_vx_v2i64_i8(ptr %x, ptr %y) {
...
define <2 x i64> @vwmulsu_vx_v2i64_i16(ptr %x, ptr %y) {
...
define <2 x i64> @vwmulsu_vx_v2i64_i32(ptr %x, ptr %y) {
...
define <8 x i16> @vwmulsu_vx_v8i16_i8_and(ptr %x, i16 %y) {
...
define <8 x i16> @vwmulsu_vx_v8i16_i8_and1(ptr %x, i16 %y) {
...
define <4 x i32> @vwmulsu_vx_v4i32_i16_and(ptr %x, i32 %y) {
...
define <4 x i32> @vwmulsu_vx_v4i32_i16_zext(ptr %x, i16 %y) {
