...
; ZVFH-NEXT:    vfnmsub.vv v8, v9, v10
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vfnmsub.vv v8, v10, v9
; ZVFH-NEXT:    ret
;
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFH-NEXT:    vfnmsac.vf v8, fa0, v10
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vfnmsub.vv v8, v16, v12
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vfnmsub.vv v8, v24, v16
; ZVFH-NEXT:    ret
;
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli a0, zero, e16, m8, ta, ma
; ZVFH-NEXT:    vfnmsac.vf v8, fa0, v16
; ZVFH-NEXT:    ret
;
