...
; CHECK-NEXT:    ret
  %vc = add <vscale x 1 x i8> %va, splat (i8 -1)
  ret <vscale x 1 x i8> %vc
}
...
; CHECK-NEXT:    ret
  %vc = add <vscale x 1 x i8> %va, splat (i8 2)
  ret <vscale x 1 x i8> %vc
}
...
; CHECK-NEXT:    ret
  %vc = add <vscale x 1 x i8> splat (i8 2), splat (i8 3)
  ret <vscale x 1 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 2 x i8> %va, splat (i8 -1)
  ret <vscale x 2 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 2 x i8> %va, splat (i8 2)
  ret <vscale x 2 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 4 x i8> %va, splat (i8 -1)
  ret <vscale x 4 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 4 x i8> %va, splat (i8 2)
  ret <vscale x 4 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 8 x i8> %va, splat (i8 -1)
  ret <vscale x 8 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 8 x i8> %va, splat (i8 2)
  ret <vscale x 8 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 16 x i8> %va, splat (i8 -1)
  ret <vscale x 16 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 16 x i8> %va, splat (i8 2)
  ret <vscale x 16 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 32 x i8> %va, splat (i8 -1)
  ret <vscale x 32 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 32 x i8> %va, splat (i8 2)
  ret <vscale x 32 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 64 x i8> %va, splat (i8 -1)
  ret <vscale x 64 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 64 x i8> %va, splat (i8 2)
  ret <vscale x 64 x i8> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 1 x i16> %va, splat (i16 -1)
  ret <vscale x 1 x i16> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 1 x i16> %va, splat (i16 2)
  ret <vscale x 1 x i16> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 2 x i16> %va, splat (i16 -1)
  ret <vscale x 2 x i16> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 2 x i16> %va, splat (i16 2)
  ret <vscale x 2 x i16> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 4 x i16> %va, splat (i16 -1)
  ret <vscale x 4 x i16> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 4 x i16> %va, splat (i16 2)
  ret <vscale x 4 x i16> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 8 x i16> %va, splat (i16 -1)
  ret <vscale x 8 x i16> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 8 x i16> %va, splat (i16 2)
  ret <vscale x 8 x i16> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 16 x i16> %va, splat (i16 -1)
  ret <vscale x 16 x i16> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 16 x i16> %va, splat (i16 2)
  ret <vscale x 16 x i16> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 32 x i16> %va, splat (i16 -1)
  ret <vscale x 32 x i16> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 32 x i16> %va, splat (i16 2)
  ret <vscale x 32 x i16> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 1 x i32> %va, splat (i32 -1)
  ret <vscale x 1 x i32> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 1 x i32> %va, splat (i32 2)
  ret <vscale x 1 x i32> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 2 x i32> %va, splat (i32 -1)
  ret <vscale x 2 x i32> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 2 x i32> %va, splat (i32 2)
  ret <vscale x 2 x i32> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 4 x i32> %va, splat (i32 -1)
  ret <vscale x 4 x i32> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 4 x i32> %va, splat (i32 2)
  ret <vscale x 4 x i32> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 8 x i32> %va, splat (i32 -1)
  ret <vscale x 8 x i32> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 8 x i32> %va, splat (i32 2)
  ret <vscale x 8 x i32> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 16 x i32> %va, splat (i32 -1)
  ret <vscale x 16 x i32> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 16 x i32> %va, splat (i32 2)
  ret <vscale x 16 x i32> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 1 x i64> %va, splat (i64 -1)
  ret <vscale x 1 x i64> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 1 x i64> %va, splat (i64 2)
  ret <vscale x 1 x i64> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 2 x i64> %va, splat (i64 -1)
  ret <vscale x 2 x i64> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 2 x i64> %va, splat (i64 2)
  ret <vscale x 2 x i64> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 4 x i64> %va, splat (i64 -1)
  ret <vscale x 4 x i64> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 4 x i64> %va, splat (i64 2)
  ret <vscale x 4 x i64> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, -1
; CHECK-NEXT:    ret
  %vc = add <vscale x 8 x i64> %va, splat (i64 -1)
  ret <vscale x 8 x i64> %vc
}
...
; CHECK-NEXT:    vadd.vi v8, v8, 2
; CHECK-NEXT:    ret
  %vc = add <vscale x 8 x i64> %va, splat (i64 2)
  ret <vscale x 8 x i64> %vc
}
