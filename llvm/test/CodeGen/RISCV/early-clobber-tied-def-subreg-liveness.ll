...
entry:
  ...
  %v_0 = call target("riscv_m2x4", i8, i8, 4, 4) @llvm.riscv.vector.insert.triscv_m2x4_i8_i8_4_4t.nxv8i16(target("riscv_m2x4", i8, i8, 4, 4) poison, <vscale x 8 x i16> %10, i64 0)
  %v_1 = call target("riscv_m2x4", i8, i8, 4, 4) @llvm.riscv.vector.insert.triscv_m2x4_i8_i8_4_4t.nxv8i16(target("riscv_m2x4", i8, i8, 4, 4) %v_0, <vscale x 8 x i16> %2, i64 1)
  %v_2 = call target("riscv_m2x4", i8, i8, 4, 4) @llvm.riscv.vector.insert.triscv_m2x4_i8_i8_4_4t.nxv8i16(target("riscv_m2x4", i8, i8, 4, 4) %v_1, <vscale x 8 x i16> %3, i64 2)
  %v_3 = call target("riscv_m2x4", i8, i8, 4, 4) @llvm.riscv.vector.insert.triscv_m2x4_i8_i8_4_4t.nxv8i16(target("riscv_m2x4", i8, i8, 4, 4) %v_2, <vscale x 8 x i16> %4, i64 3)
  tail call void @llvm.riscv.vsseg4.nxv8i16.i64(target("riscv_m2x4", i8, i8, 4, 4) %v_3, ptr nonnull @var_47, i64 2, i64 4)
  ret void
}
...
declare target("riscv_m2x4", i8, i8, 4, 4) @llvm.riscv.vector.insert.triscv_m2x4_i8_i8_4_4t.nxv8i16(target("riscv_m2x4", i8, i8, 4, 4), <vscale x 8 x i16>, i64)

declare void @llvm.riscv.vsseg4.nxv8i16.i64(target("riscv_m2x4", i8, i8, 4, 4), ptr nocapture, i64, i64)
