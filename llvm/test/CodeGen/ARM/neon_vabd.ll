...
; CHECK-NEXT:    vmin.s8 d18, d17, d16
...
; CHECK-NEXT:    vmov d16, r2, r3
; CHECK-NEXT:    vmov d17, r0, r1
; CHECK-NEXT:    vmin.s16 d18, d17, d16
...
; CHECK-NEXT:    vmov d16, r2, r3
; CHECK-NEXT:    vmov d17, r0, r1
; CHECK-NEXT:    vmin.s32 d18, d17, d16
...
; CHECK-NEXT:    vmov d16, r2, r3
; CHECK-NEXT:    vmov d17, r0, r1
; CHECK-NEXT:    vmin.u32 d18, d17, d16
...
; CHECK-NEXT:    vmin.u32 d18, d16, d17
; CHECK-NEXT:    vmax.u32 d16, d16, d17
; CHECK-NEXT:    vsub.i32 d16, d16, d18
; CHECK-NEXT:    vmov r0, r1, d16
; CHECK-NEXT:    mov pc, lr
