...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    vcvta.s16.f16 d0, d0
; CHECK-NEXT:    bx lr
entry:
...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    vcvta.u16.f16 d0, d0
; CHECK-NEXT:    bx lr
entry:
...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    vcvtm.s16.f16 d0, d0
; CHECK-NEXT:    bx lr
entry:
...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    vcvtm.u16.f16 d0, d0
; CHECK-NEXT:    bx lr
entry:
...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    vcvtn.s16.f16 d0, d0
; CHECK-NEXT:    bx lr
entry:
...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    vcvtn.u16.f16 d0, d0
; CHECK-NEXT:    bx lr
entry:
...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    vcvtp.s16.f16 d0, d0
; CHECK-NEXT:    bx lr
entry:
...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    vcvtp.u16.f16 d0, d0
; CHECK-NEXT:    bx lr
entry:
...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    vmaxnm.f16 d0, d0, d1
; CHECK-NEXT:    bx lr
entry:
...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    vminnm.f16 d0, d0, d1
; CHECK-NEXT:    bx lr
entry:
...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    vmul.f16 d0, d0, d1[3]
; CHECK-NEXT:    bx lr
entry:
...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    @ kill: def $s2 killed $s2 def $d1
; CHECK-NEXT:    vmul.f16 d0, d0, d1[0]
; CHECK-NEXT:    bx lr
entry:
...
; CHECK:       @ %bb.0: @ %entry
; CHECK-NEXT:    @ kill: def $s4 killed $s4 def $d2
; CHECK-NEXT:    vmul.f16 q0, q0, d2[0]
; CHECK-NEXT:    bx lr
entry:
  %0 = bitcast float %b.coerce to i32
  %tmp.0.extract.trunc = trunc i32 %0 to i16
