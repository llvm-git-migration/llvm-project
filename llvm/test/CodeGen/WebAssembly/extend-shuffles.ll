...
; SIMD128-NEXT:    return $pop2
 %shuffle = shufflevector <8 x i8> %in, <8 x i8> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
...
; SIMD128-NEXT:    return $pop0
 %shuffle = shufflevector <16 x i8> %in, <16 x i8> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
...
; SIMD128-NEXT:    return $pop1
 %shuffle = shufflevector <4 x i16> %in, <4 x i16> undef, <2 x i32> <i32 2, i32 3>
...
; SIMD128-NEXT:    return $pop0
 %shuffle = shufflevector <8 x i16> %in, <8 x i16> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
...
; SIMD128-NEXT:    return $pop0
 %shuffle = shufflevector <4 x i32> %in, <4 x i32> undef, <2 x i32> <i32 2, i32 3>
...
; SIMD128-NEXT:    i32x4.extend_low_i16x8_s $push1=, $pop0
; SIMD128-NEXT:    return $pop1
 %shuffle = shufflevector <8 x i8> %in, <8 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
 %res = sext <4 x i8> %shuffle to <4 x i32>
 ret <4 x i32> %res
}
...
; SIMD128-NEXT:    i16x8.extend_low_i8x16_s $push0=, $0
; SIMD128-NEXT:    return $pop0
 %shuffle = shufflevector <16 x i8> %in, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
 %res = sext <8 x i8> %shuffle to <8 x i16>
 ret <8 x i16> %res
}
...
; SIMD128-NEXT:    return $pop0
 %shuffle = shufflevector <8 x i16> %in, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
 %res = sext <4 x i16> %shuffle to <4 x i32>
 ret <4 x i32> %res
}
...
; SIMD128-NEXT:    return $pop0
 %shuffle = shufflevector <4 x i32> %in, <4 x i32> undef, <2 x i32> <i32 0, i32 1>
 %res = sext <2 x i32> %shuffle to <2 x i64>
 ret <2 x i64> %res
}
