...
; CHECK-NEXT:    i32.const $push2=, -1
; CHECK-NEXT:    local.get $push8=, 0
; CHECK-NEXT:    i32.extend16_s $push7=, $pop8
; CHECK-NEXT:    local.tee $push6=, 0, $pop7
; CHECK-NEXT:    local.get $push9=, 1
; CHECK-NEXT:    i32.extend16_s $push5=, $pop9
; CHECK-NEXT:    local.tee $push4=, 1, $pop5
; CHECK-NEXT:    i32.gt_s $push1=, $pop6, $pop4
; CHECK-NEXT:    local.get $push11=, 0
; CHECK-NEXT:    local.get $push10=, 1
