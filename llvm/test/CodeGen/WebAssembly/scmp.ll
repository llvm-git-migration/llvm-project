...
; CHECK-NEXT:  # %bb.0:
; CHECK-NEXT:    local.get $push7=, 0
; CHECK-NEXT:    i32.extend16_s $push6=, $pop7
; CHECK-NEXT:    local.tee $push5=, 0, $pop6
; CHECK-NEXT:    local.get $push8=, 1
; CHECK-NEXT:    i32.extend16_s $push4=, $pop8
; CHECK-NEXT:    local.tee $push3=, 1, $pop4
; CHECK-NEXT:    i32.gt_s $push1=, $pop5, $pop3
; CHECK-NEXT:    local.get $push10=, 0
; CHECK-NEXT:    local.get $push9=, 1
