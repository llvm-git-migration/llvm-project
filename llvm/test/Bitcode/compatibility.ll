...
declare void @f.sanitize_numericalstability() sanitize_numericalstability
; CHECK: declare void @f.sanitize_numericalstability() #51
...
; CHECK: attributes #51 = { sanitize_numericalstability }
