...
@constant.splat.f16 = constant <2 x half> splat (half f0xBC00)
...
@constant.splat.128 = constant <8 x fp128> splat (fp128 f0x80000000000000000000000000000001)

; CHECK: @constant.splat.bf16 = constant <1 x bfloat> splat (bfloat f0xC0A0)
@constant.splat.bf16 = constant <1 x bfloat> splat (bfloat f0xC0A0)
...
@constant.splat.ppc_fp128 = constant <7 x ppc_fp128> splat (ppc_fp128 f0x00000000000000008000000000000000)
