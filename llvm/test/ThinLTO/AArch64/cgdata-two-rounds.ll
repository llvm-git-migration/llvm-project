...
; RUN:  -r %t/thin-one.bc,_f3,px -r %t/thin-one.bc,_g,pl \
; RUN:  -r %t/thin-two.bc,_f1,px -r %t/thin-two.bc,_f2,px -r %t/thin-two.bc,_g,pl \
...
; RUN:  -r %t/thin-one.bc,_f3,px -r %t/thin-one.bc,_g,pl \
; RUN:  -r %t/thin-two.bc,_f1,px -r %t/thin-two.bc,_f2,px -r %t/thin-two.bc,_g,pl \
; RUN:  -r %t/lto.bc,_f4,px -r %t/lto.bc,_f5,px -r %t/lto.bc,_f6,px -r %t/lto.bc,_g,pl \
; RUN:  -codegen-data-thinlto-two-rounds-path=%t/two-rounds
