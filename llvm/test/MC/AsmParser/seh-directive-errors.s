...
.seh_proc f
	...
	.seh_stackalloc 32
	.seh_startepilogue
	# CHECK: :[[@LINE-1]]:{{[0-9]+}}: error: starting epilogue (.seh_startepilogue) before prologue has ended (.seh_endprologue)
	.seh_endprologue
	nop
	.seh_endepilogue
	# CHECK: :[[@LINE-1]]:{{[0-9]+}}: error: .seh_endepilogue without a corresponding .seh_startepilogue
	.seh_startepilogue
	addq	$32, %rsp
	popq	%rbx
	popq	%rdi
