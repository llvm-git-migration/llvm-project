...
; CHECK: cas.b %d3, %d2, (5,%pc)
; CHECK-SAME: ; encoding: [0x0a,0xfa,0x00,0x83]
cas.b %d3, %d2, (5, %pc)

; CHECK: cas.w %d4, %d5, (6,%pc)
; CHECK-SAME: ; encoding: [0x0c,0xfa,0x01,0x44]
cas.w %d4, %d5, (6, %pc)

; CHECK: cas.l %d6, %d7, (7,%pc)
; CHECK-SAME: ; encoding: [0x0e,0xfa,0x01,0xc
cas.l %d6, %d7, (7, %pc)

; Program Counter with Index (Scale = 1)
; CHECK: cas.b %d3, %d2, (5,%pc,%d1)
; CHECK-SAME: ; encoding: [0x0a,0xfb,0x00,0x83]
cas.b %d3, %d2, (5, %pc, %d1)

; CHECK: cas.w %d4, %d5, (6,%pc,%d1)
; CHECK-SAME: ; encoding: [0x0c,0xfb,0x01,0x44]
cas.w %d4, %d5, (6, %pc, %d1)

; CHECK: cas.l %d6, %d7, (7,%pc,%d1)
; CHECK-SAME: ; encoding: [0x0e,0xfb,0x01,0xc6]
cas.l %d6, %d7, (7, %pc, %d1)