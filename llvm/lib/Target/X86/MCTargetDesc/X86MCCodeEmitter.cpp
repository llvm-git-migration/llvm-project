...
static bool isDispOrCDisp8(uint64_t TSFlags, long Value, long &ImmOffset) {
  ...
  long CDisp8 = Value / static_cast<int>(CD8_Scale);
  if (!isInt<8>(CDisp8))
    return false;
