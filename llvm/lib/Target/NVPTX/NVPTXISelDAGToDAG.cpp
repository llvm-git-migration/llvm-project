...
void NVPTXDAGToDAGISel::SelectCpAsyncBulkTensorG2SCommon(SDNode *N,
  ...
  auto getDimsFromIntrinsic = [](unsigned IID) {
    ...
    default:
      llvm_unreachable(
          "Invalid intrinsic for SelectCpAsyncBulkTensorG2SIm2Col.");
    }
  };
  ...
  size_t NumArgs = NumDims + NumOffsets + 3; // for {dst, mbar, src}
  size_t MultiCastIdx = NumArgs + 2;         // for Chain and IID
