  ...
  while (true) {
    ...
    case bitc::CST_CODE_FLOAT: {    // FLOAT: [fpval]
      ...
      if (ScalarTy->isHalfTy())
        ...
        V = ConstantFP::get(CurTy, APFloat(APFloat::BFloat(),
        ...
        V = ConstantFP::get(CurTy, APFloat(APFloat::IEEEdouble(),
                                           APInt(64, Record[0])));
        ...
        V = ConstantFP::get(CurTy, APFloat(APFloat::x87DoubleExtended(),
                                           APInt(80, Rearrange)));
      } else if (ScalarTy->isFP128Ty())
        V = ConstantFP::get(CurTy, APFloat(APFloat::IEEEquad(),
                                           APInt(128, Record)));
      else if (ScalarTy->isPPC_FP128Ty())
        V = ConstantFP::get(CurTy, APFloat(APFloat::PPCDoubleDouble(),
                                           APInt(128, Record)));
      else
        V = UndefValue::get(CurTy);
      break;
