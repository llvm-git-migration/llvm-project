...
#undef INSTRUCTION
  ...
  case Intrinsic::vector_insert: {
    ...
    if (auto *VecTup = dyn_cast<TargetExtType>(Vec->getType())) {
      Check(IdxN < VecTup->getIntParameter(1),
      ...
      int SubVecLog2LMUL =
          Log2_64(SubVecTy->getElementCount().getKnownMinValue() *
                  SubVecTy->getElementType()->getScalarSizeInBits()) -
          6;

      Check(SubVecLog2LMUL == (int)VecTup->getIntParameter(0) - 3,
    ...
    if (auto *VecTup = dyn_cast<TargetExtType>(Vec->getType())) {
      ...
      int SubVecLog2LMUL =
          Log2_64(ResultTy->getElementCount().getKnownMinValue() *
                  ResultTy->getElementType()->getScalarSizeInBits()) -
          6;
