...
void IntrinsicEmitter::EmitIntrinsicToBuiltinMap(
  ...
  // DenseMap<TargetPrefix, DenseMap<BuiltinName, EnumName>>
  typedef DenseMap<StringRef, DenseMap<StringRef, StringRef>> BIMTy;
  BIMTy BuiltinMap;
  ...
  for (const CodeGenIntrinsic &Int : Ints) {
    ...
    DenseMap<StringRef, StringRef> &BIM = BuiltinMap[Int.TargetPrefix];
